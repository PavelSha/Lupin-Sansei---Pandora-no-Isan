...
C - - - - - 0x01C014 07:C004: 8D 00 20  STA $2000
C - - - - - 0x01C017 07:C007: 8D 01 20  STA $2001
C - - - - - 0x01C01A 07:C00A: 85 26     STA ram_0026
C - - - - - 0x01C01C 07:C00C: AD 02 20  LDA $2002
C - - - - - 0x01C01F 07:C00F: 10 FB     BPL $C00C
C - - - - - 0x01C021 07:C011: AD 02 20  LDA $2002
C - - - - - 0x01C024 07:C014: 10 FB     BPL $C011
C - - - - - 0x01C026 07:C016: A2 FF     LDX #$FF
C - - - - - 0x01C028 07:C018: 9A        TXS
C - - - - - 0x01C029 07:C019: A9 00     LDA #$00
C - - - - - 0x01C02B 07:C01B: AA        TAX
C - - - - - 0x01C02C 07:C01C: 9D 00 02  STA ram_0200,X
C - - - - - 0x01C02F 07:C01F: 9D 00 03  STA ram_0300,X
C - - - - - 0x01C032 07:C022: 9D 00 04  STA ram_0400,X
C - - - - - 0x01C035 07:C025: 9D 00 05  STA ram_0500,X
C - - - - - 0x01C038 07:C028: 9D 00 06  STA ram_0600,X
C - - - - - 0x01C03B 07:C02B: 9D 00 07  STA ram_0700,X
C - - - - - 0x01C03E 07:C02E: E8        INX
C - - - - - 0x01C03F 07:C02F: D0 EB     BNE $C01C
C - - - - - 0x01C041 07:C031: 95 00     STA ram_0000,X
C - - - - - 0x01C043 07:C033: E8        INX
C - - - - - 0x01C044 07:C034: E0 99     CPX #$99
C - - - - - 0x01C046 07:C036: 90 F9     BCC $C031
C - - - - - 0x01C048 07:C038: A2 A7     LDX #$A7
C - - - - - 0x01C04A 07:C03A: 95 00     STA ram_0000,X
C - - - - - 0x01C04C 07:C03C: E8        INX
C - - - - - 0x01C04D 07:C03D: D0 FB     BNE $C03A
C - - - - - 0x01C04F 07:C03F: 20 FB FD  JSR $FDFB
C - - - - - 0x01C052 07:C042: A9 FF     LDA #$FF
C - - - - - 0x01C054 07:C044: 85 37     STA ram_0037
C D 2 - - - 0x01C056 07:C046: A9 07     LDA #$07
C - - - - - 0x01C058 07:C048: 8D 00 80  STA $8000
C - - - - - 0x01C05B 07:C04B: A9 0D     LDA #$0D
C - - - - - 0x01C05D 07:C04D: 8D 01 80  STA $8001
...
C - - - - - 0x01C092 07:C082: 8D 17 40  STA $4017
C - - - - - 0x01C095 07:C085: A9 FC     LDA #$FC
C - - - - - 0x01C097 07:C087: 85 5F     STA ram_005F
C - - - - - 0x01C099 07:C089: 20 D4 C8  JSR $C8D4
C - - - - - 0x01C09C 07:C08C: 20 C7 B8  JSR $B8C7
C - - - - - 0x01C09F 07:C08F: 20 DA B9  JSR $B9DA
C - - - - - 0x01C0A2 07:C092: 20 96 EF  JSR $EF96
C D 2 - - - 0x01C0A5 07:C095: A5 37     LDA ram_0037
C - - - - - 0x01C0A7 07:C097: 30 03     BMI $C09C
C - - - - - 0x01C0A9 07:C099: 20 72 C6  JSR $C672
C D 2 - - - 0x01C0AC 07:C09C: 20 C0 FA  JSR $FAC0
C - - - - - 0x01C0AF 07:C09F: 20 46 EF  JSR $EF46
C - - - - - 0x01C0B2 07:C0A2: A4 46     LDY ram_0046
C - - - - - 0x01C0B4 07:C0A4: BE 38 85  LDX $8538,Y
...
C - - - - - 0x01C0C5 07:C0B5: D0 F9     BNE $C0B0
C D 2 - - - 0x01C0C7 07:C0B7: A9 00     LDA #$00
C - - - - - 0x01C0C9 07:C0B9: 8D 15 40  STA $4015
C - - - - - 0x01C0CC 07:C0BC: 20 19 C3  JSR $C319
C - - - - - 0x01C0CF 07:C0BF: 20 58 C3  JSR $C358
C - - - - - 0x01C0D2 07:C0C2: 20 FC EF  JSR $EFFC
...
C - - - - - 0x01C0DB 07:C0CB: 20 53 D4  JSR $D453
C - - - - - 0x01C0DE 07:C0CE: 20 13 CE  JSR $CE13
...
C - - - - - 0x01C0FD 07:C0ED: 20 57 DF  JSR $DF57
C - - - - - 0x01C100 07:C0F0: 8D B2 06  STA ram_06B2
C - - - - - 0x01C103 07:C0F3: EE B2 06  INC ram_06B2
C - - - - - 0x01C106 07:C0F6: 20 F8 E2  JSR $E2F8
C - - - - - 0x01C109 07:C0F9: 20 F3 CD  JSR $CDF3
C - - - - - 0x01C10C 07:C0FC: 20 ED C2  JSR $C2ED
C - - - - - 0x01C10F 07:C0FF: 20 A4 BB  JSR $BBA4
C - - - - - 0x01C112 07:C102: 20 14 FC  JSR $FC14
C - - - - - 0x01C115 07:C105: A9 00     LDA #$00
C - - - - - 0x01C117 07:C107: 85 3C     STA ram_003C
C - - - - - 0x01C119 07:C109: 20 0F C3  JSR $C30F
C - - - - - 0x01C11C 07:C10C: 20 FF C2  JSR $C2FF
C - - - - - 0x01C11F 07:C10F: A5 3B     LDA ram_003B
C - - - - - 0x01C121 07:C111: C9 0B     CMP #$0B
C - - - - - 0x01C123 07:C113: D0 03     BNE $C118
C - - - - - 0x01C125 07:C115: 4C A6 C2  JMP $C2A6
...
C - - - - - 0x01C15A 07:C14A: 30 12     BMI $C15E
C - - - - - 0x01C15C 07:C14C: A5 3B     LDA ram_003B
C - - - - - 0x01C15E 07:C14E: 29 10     AND #$10
C - - - - - 0x01C160 07:C150: F0 CE     BEQ $C120
C - - - - - 0x01C162 07:C152: A9 80     LDA #$80
C - - - - - 0x01C164 07:C154: 85 3C     STA ram_003C
C - - - - - 0x01C166 07:C156: 85 D6     STA ram_00D6
C - - - - - 0x01C168 07:C158: 20 72 C6  JSR $C672
C - - - - - 0x01C16B 07:C15B: 4C B7 C0  JMP $C0B7
C - - - - - 0x01C16E 07:C15E: 50 6E     BVC $C1CE
C - - - - - 0x01C170 07:C160: 20 05 C3  JSR $C305
C - - - - - 0x01C173 07:C163: 20 13 C3  JSR $C313
C - - - - - 0x01C176 07:C166: A5 39     LDA ram_0039
C - - - - - 0x01C178 07:C168: C9 E0     CMP #$E0
C - - - - - 0x01C17A 07:C16A: F0 03     BEQ $C16F
C - - - - - 0x01C17C 07:C16C: 4C 9C C0  JMP $C09C
C - - - - - 0x01C17F 07:C16F: A9 00     LDA #$00
C - - - - - 0x01C181 07:C171: 85 D6     STA ram_00D6
C - - - - - 0x01C183 07:C173: E6 5E     INC ram_005E
C - - - - - 0x01C185 07:C175: A5 5E     LDA ram_005E
C - - - - - 0x01C187 07:C177: C9 02     CMP #$02
C - - - - - 0x01C189 07:C179: D0 08     BNE $C183
C - - - - - 0x01C18B 07:C17B: 2C F6 FF  BIT $FFF6
C - - - - - 0x01C18E 07:C17E: 70 03     BVS $C183
- - - - - - 0x01C190 07:C180: 4C        .byte $4C   ; 
- - - - - - 0x01C191 07:C181: 5B        .byte $5B   ; 
- - - - - - 0x01C192 07:C182: C2        .byte $C2   ; 
C - - - - - 0x01C193 07:C183: CD 09 01  CMP ram_0109
C - - - - - 0x01C196 07:C186: 90 03     BCC $C18B
C - - - - - 0x01C198 07:C188: 8D 09 01  STA ram_0109
C - - - - - 0x01C19B 07:C18B: AA        TAX
C - - - - - 0x01C19C 07:C18C: BD CA C1  LDA $C1CA,X
C - - - - - 0x01C19F 07:C18F: 85 C4     STA ram_00C4
C - - - - - 0x01C1A1 07:C191: 4C B1 C1  JMP $C1B1
...
C - - - - - 0x01C1CD 07:C1BD: 20 72 C6  JSR $C672
C - - - - - 0x01C1D0 07:C1C0: 20 A5 EF  JSR $EFA5
C - - - - - 0x01C1D3 07:C1C3: A2 00     LDX #$00
C - - - - - 0x01C1D5 07:C1C5: 86 B6     STX ram_00B6
C - - - - - 0x01C1D7 07:C1C7: 4C 9C C0  JMP $C09C
- - - - - - 0x01C1DA 07:C1CA: 00        .byte $00   ; 
- D 2 - - - 0x01C1DB 07:C1CB: 06        .byte $06   ; 
- D 2 - - - 0x01C1DC 07:C1CC: 0F        .byte $0F   ; 
- D 2 - - - 0x01C1DD 07:C1CD: 19        .byte $19   ; 
C - - - - - 0x01C1DE 07:C1CE: A5 37     LDA ram_0037
C - - - - - 0x01C1E0 07:C1D0: 10 03     BPL $C1D5
C - - - - - 0x01C1E2 07:C1D2: 4C 8D C2  JMP $C28D
C - - - - - 0x01C1E5 07:C1D5: 20 05 C3  JSR $C305
C - - - - - 0x01C1E8 07:C1D8: A5 6A     LDA ram_006A
C - - - - - 0x01C1EA 07:C1DA: C9 DF     CMP #$DF
C - - - - - 0x01C1EC 07:C1DC: 90 14     BCC $C1F2
C - - - - - 0x01C1EE 07:C1DE: A9 20     LDA #$20
C - - - - - 0x01C1F0 07:C1E0: 85 3B     STA ram_003B
C - - - - - 0x01C1F2 07:C1E2: A9 00     LDA #$00
C - - - - - 0x01C1F4 07:C1E4: 85 2C     STA ram_002C
C - - - - - 0x01C1F6 07:C1E6: 20 FF C2  JSR $C2FF
C - - - - - 0x01C1F9 07:C1E9: A5 2C     LDA ram_002C
C - - - - - 0x01C1FB 07:C1EB: C9 40     CMP #$40
C - - - - - 0x01C1FD 07:C1ED: 90 FA     BCC $C1E9
C - - - - - 0x01C1FF 07:C1EF: 20 05 C3  JSR $C305
C - - - - - 0x01C202 07:C1F2: A9 40     LDA #$40
C - - - - - 0x01C204 07:C1F4: 85 D6     STA ram_00D6
C - - - - - 0x01C206 07:C1F6: 20 8D EF  JSR $EF8D
C - - - - - 0x01C209 07:C1F9: A9 A0     LDA #$A0
C - - - - - 0x01C20B 07:C1FB: 85 3C     STA ram_003C
C - - - - - 0x01C20D 07:C1FD: 20 57 DF  JSR $DF57
...
C - - - - - 0x01C217 07:C207: F0 05     BEQ $C20E
C - - - - - 0x01C219 07:C209: 20 8D EF  JSR $EF8D
...
C - - - - - 0x01C222 07:C212: 10 FB     BPL $C20F
C - - - - - 0x01C224 07:C214: 25 5F     AND ram_005F
C - - - - - 0x01C226 07:C216: 85 5F     STA ram_005F
C - - - - - 0x01C228 07:C218: 29 A8     AND #$A8
C - - - - - 0x01C22A 07:C21A: F0 20     BEQ $C23C
C - - - - - 0x01C22C 07:C21C: 24 6D     BIT ram_006D
C - - - - - 0x01C22E 07:C21E: 10 0C     BPL $C22C
C - - - - - 0x01C230 07:C220: A5 47     LDA ram_0047
C - - - - - 0x01C232 07:C222: 85 46     STA ram_0046
...
C - - - - - 0x01C240 07:C230: F0 03     BEQ $C235
C - - - - - 0x01C242 07:C232: 20 19 B3  JSR $B319
C - - - - - 0x01C245 07:C235: A5 46     LDA ram_0046
C - - - - - 0x01C247 07:C237: 85 C4     STA ram_00C4
C - - - - - 0x01C249 07:C239: 4C 95 C0  JMP $C095
C - - - - - 0x01C24C 07:C23C: A5 5E     LDA ram_005E
C - - - - - 0x01C24E 07:C23E: CD 09 01  CMP ram_0109
C - - - - - 0x01C251 07:C241: 90 03     BCC $C246
C - - - - - 0x01C253 07:C243: 8D 09 01  STA ram_0109
C - - - - - 0x01C256 07:C246: A9 20     LDA #$20
C - - - - - 0x01C258 07:C248: 85 3B     STA ram_003B
C - - - - - 0x01C25A 07:C24A: A9 00     LDA #$00
C - - - - - 0x01C25C 07:C24C: 85 2C     STA ram_002C
C - - - - - 0x01C25E 07:C24E: 20 FF C2  JSR $C2FF
C - - - - - 0x01C261 07:C251: A5 2C     LDA ram_002C
C - - - - - 0x01C263 07:C253: C9 40     CMP #$40
C - - - - - 0x01C265 07:C255: 90 FA     BCC $C251
C - - - - - 0x01C267 07:C257: A9 06     LDA #$06
C - - - - - 0x01C269 07:C259: 85 24     STA ram_0024
C - - - - - 0x01C26B 07:C25B: 20 13 C3  JSR $C313
C - - - - - 0x01C26E 07:C25E: 20 05 C3  JSR $C305
...
C - - - - - 0x01C28E 07:C27E: 20 F4 C3  JSR $C3F4
C - - - - - 0x01C291 07:C281: 20 0F C3  JSR $C30F
C - - - - - 0x01C294 07:C284: 20 FF C2  JSR $C2FF
C - - - - - 0x01C297 07:C287: A5 D8     LDA ram_00D8
C - - - - - 0x01C299 07:C289: C9 11     CMP #$11
C - - - - - 0x01C29B 07:C28B: 90 FA     BCC $C287
C D 2 - - - 0x01C29D 07:C28D: 20 13 C3  JSR $C313
C - - - - - 0x01C2A0 07:C290: 20 05 C3  JSR $C305
C - - - - - 0x01C2A3 07:C293: E6 24     INC ram_0024
C - - - - - 0x01C2A5 07:C295: A5 24     LDA ram_0024
C - - - - - 0x01C2A7 07:C297: C9 07     CMP #$07
C - - - - - 0x01C2A9 07:C299: 90 08     BCC $C2A3
C - - - - - 0x01C2AB 07:C29B: A9 FF     LDA #$FF
C - - - - - 0x01C2AD 07:C29D: 85 37     STA ram_0037
C - - - - - 0x01C2AF 07:C29F: A9 00     LDA #$00
C - - - - - 0x01C2B1 07:C2A1: 85 24     STA ram_0024
C - - - - - 0x01C2B3 07:C2A3: 4C 46 C0  JMP $C046
C D 2 - - - 0x01C2B6 07:C2A6: A5 D8     LDA ram_00D8
C - - - - - 0x01C2B8 07:C2A8: C9 0A     CMP #$0A
C - - - - - 0x01C2BA 07:C2AA: 90 FA     BCC $C2A6
C - - - - - 0x01C2BC 07:C2AC: 20 05 C3  JSR $C305
C - - - - - 0x01C2BF 07:C2AF: 20 13 C3  JSR $C313
C - - - - - 0x01C2C2 07:C2B2: 20 DB B7  JSR $B7DB
C - - - - - 0x01C2C5 07:C2B5: A9 93     LDA #$93
C - - - - - 0x01C2C7 07:C2B7: 85 3B     STA ram_003B
C - - - - - 0x01C2C9 07:C2B9: 20 F4 C3  JSR $C3F4
C - - - - - 0x01C2CC 07:C2BC: 20 0F C3  JSR $C30F
C - - - - - 0x01C2CF 07:C2BF: 20 FF C2  JSR $C2FF
C - - - - - 0x01C2D2 07:C2C2: A5 D8     LDA ram_00D8
C - - - - - 0x01C2D4 07:C2C4: C9 0C     CMP #$0C
C - - - - - 0x01C2D6 07:C2C6: 90 FA     BCC $C2C2
C - - - - - 0x01C2D8 07:C2C8: 20 13 C3  JSR $C313
C - - - - - 0x01C2DB 07:C2CB: 20 05 C3  JSR $C305
C - - - - - 0x01C2DE 07:C2CE: A9 30     LDA #$30
C - - - - - 0x01C2E0 07:C2D0: 20 60 C9  JSR $C960
C - - - - - 0x01C2E3 07:C2D3: 20 0D B8  JSR $B80D
C - - - - - 0x01C2E6 07:C2D6: 20 F4 C3  JSR $C3F4
C - - - - - 0x01C2E9 07:C2D9: 20 0F C3  JSR $C30F
C - - - - - 0x01C2EC 07:C2DC: 20 FF C2  JSR $C2FF
C - - - - - 0x01C2EF 07:C2DF: A5 D8     LDA ram_00D8
C - - - - - 0x01C2F1 07:C2E1: C9 0E     CMP #$0E
C - - - - - 0x01C2F3 07:C2E3: 90 FA     BCC $C2DF
C - - - - - 0x01C2F5 07:C2E5: A9 00     LDA #$00
C - - - - - 0x01C2F7 07:C2E7: 8D 09 01  STA ram_0109
C - - - - - 0x01C2FA 07:C2EA: 4C 00 C0  JMP $C000
C - - - - - 0x01C2FD 07:C2ED: A5 46     LDA ram_0046
C - - - - - 0x01C2FF 07:C2EF: C9 24     CMP #$24
C - - - - - 0x01C301 07:C2F1: 90 0B     BCC $C2FE
C - - - - - 0x01C303 07:C2F3: C9 42     CMP #$42
C - - - - - 0x01C305 07:C2F5: B0 07     BCS $C2FE
C - - - - - 0x01C307 07:C2F7: A9 80     LDA #$80
C - - - - - 0x01C309 07:C2F9: 85 6D     STA ram_006D
C - - - - - 0x01C30B 07:C2FB: 4C DF CC  JMP $CCDF
C - - - - - 0x01C30E 07:C2FE: 60        RTS
C - - - - - 0x01C30F 07:C2FF: A5 26     LDA ram_0026
C - - - - - 0x01C311 07:C301: 09 80     ORA #$80
C - - - - - 0x01C313 07:C303: D0 04     BNE $C309
C - - - - - 0x01C315 07:C305: A5 26     LDA ram_0026
C - - - - - 0x01C317 07:C307: 29 7F     AND #$7F
C - - - - - 0x01C319 07:C309: 85 26     STA ram_0026
C - - - - - 0x01C31B 07:C30B: 8D 00 20  STA $2000
C - - - - - 0x01C31E 07:C30E: 60        RTS
C D 2 - - - 0x01C31F 07:C30F: A9 1E     LDA #$1E
C - - - - - 0x01C321 07:C311: D0 02     BNE $C315
C - - - - - 0x01C323 07:C313: A9 00     LDA #$00
C - - - - - 0x01C325 07:C315: 8D 01 20  STA $2001
C - - - - - 0x01C328 07:C318: 60        RTS
C - - - - - 0x01C329 07:C319: A9 01     LDA #$01
C - - - - - 0x01C32B 07:C31B: D0 02     BNE $C31F
C - - - - - 0x01C32D 07:C31D: A9 00     LDA #$00
C - - - - - 0x01C32F 07:C31F: 85 12     STA ram_0012
C - - - - - 0x01C331 07:C321: 20 05 C3  JSR $C305
C - - - - - 0x01C334 07:C324: 20 13 C3  JSR $C313
C - - - - - 0x01C337 07:C327: AD 02 20  LDA $2002
C - - - - - 0x01C33A 07:C32A: A9 20     LDA #$20
C - - - - - 0x01C33C 07:C32C: 20 31 C3  JSR $C331
C - - - - - 0x01C33F 07:C32F: A9 24     LDA #$24
C - - - - - 0x01C341 07:C331: 8D 06 20  STA $2006
C - - - - - 0x01C344 07:C334: A9 00     LDA #$00
C - - - - - 0x01C346 07:C336: 8D 06 20  STA $2006
C - - - - - 0x01C349 07:C339: A8        TAY
C - - - - - 0x01C34A 07:C33A: A2 03     LDX #$03
C - - - - - 0x01C34C 07:C33C: A5 12     LDA ram_0012
C - - - - - 0x01C34E 07:C33E: 8D 07 20  STA $2007
C - - - - - 0x01C351 07:C341: C8        INY
C - - - - - 0x01C352 07:C342: D0 FA     BNE $C33E
C - - - - - 0x01C354 07:C344: CA        DEX
C - - - - - 0x01C355 07:C345: D0 F7     BNE $C33E
C - - - - - 0x01C357 07:C347: 8D 07 20  STA $2007
C - - - - - 0x01C35A 07:C34A: C8        INY
C - - - - - 0x01C35B 07:C34B: C0 C0     CPY #$C0
C - - - - - 0x01C35D 07:C34D: 90 F8     BCC $C347
C - - - - - 0x01C35F 07:C34F: A9 00     LDA #$00
C - - - - - 0x01C361 07:C351: 8D 07 20  STA $2007
C - - - - - 0x01C364 07:C354: C8        INY
C - - - - - 0x01C365 07:C355: D0 FA     BNE $C351
C - - - - - 0x01C367 07:C357: 60        RTS
C - - - - - 0x01C368 07:C358: A2 00     LDX #$00
C - - - - - 0x01C36A 07:C35A: A0 00     LDY #$00
C - - - - - 0x01C36C 07:C35C: A9 F0     LDA #$F0
C - - - - - 0x01C36E 07:C35E: 9D 00 07  STA ram_0700,X
C - - - - - 0x01C371 07:C361: 99 B7 06  STA ram_06B7,Y
C - - - - - 0x01C374 07:C364: C8        INY
C - - - - - 0x01C375 07:C365: E8        INX
C - - - - - 0x01C376 07:C366: E8        INX
C - - - - - 0x01C377 07:C367: E8        INX
C - - - - - 0x01C378 07:C368: E8        INX
C - - - - - 0x01C379 07:C369: D0 F3     BNE $C35E
...
C - - - - - 0x01C3C3 07:C3B3: 90 C7     BCC $C37C
C - - - - - 0x01C3C5 07:C3B5: A9 3F     LDA #$3F
C - - - - - 0x01C3C7 07:C3B7: 8D 06 20  STA $2006
C - - - - - 0x01C3CA 07:C3BA: A9 00     LDA #$00
C - - - - - 0x01C3CC 07:C3BC: 8D 06 20  STA $2006
C - - - - - 0x01C3CF 07:C3BF: 8D 06 20  STA $2006
C - - - - - 0x01C3D2 07:C3C2: 8D 06 20  STA $2006
C - - - - - 0x01C3D5 07:C3C5: 60        RTS
C - - - - - 0x01C3D6 07:C3C6: A5 26     LDA ram_0026
C - - - - - 0x01C3D8 07:C3C8: 8D 00 20  STA $2000
C - - - - - 0x01C3DB 07:C3CB: AD 02 20  LDA $2002
...
C - - - - - 0x01C3E9 07:C3D9: E6 2B     INC ram_002B
C - - - - - 0x01C3EB 07:C3DB: 60        RTS
- - - - - - 0x01C3EC 07:C3DC: A5        .byte $A5   ; 
- - - - - - 0x01C3ED 07:C3DD: 2B        .byte $2B   ; 
- - - - - - 0x01C3EE 07:C3DE: 29        .byte $29   ; 
- - - - - - 0x01C3EF 07:C3DF: 03        .byte $03   ; 
- - - - - - 0x01C3F0 07:C3E0: 6A        .byte $6A   ; 
- - - - - - 0x01C3F1 07:C3E1: 6A        .byte $6A   ; 
- - - - - - 0x01C3F2 07:C3E2: 6A        .byte $6A   ; 
- - - - - - 0x01C3F3 07:C3E3: AA        .byte $AA   ; 
- - - - - - 0x01C3F4 07:C3E4: 8E        .byte $8E   ; 
- - - - - - 0x01C3F5 07:C3E5: 03        .byte $03   ; 
- - - - - - 0x01C3F6 07:C3E6: 20        .byte $20   ; 
- - - - - - 0x01C3F7 07:C3E7: A0        .byte $A0   ; 
- - - - - - 0x01C3F8 07:C3E8: 40        .byte $40   ; 
- - - - - - 0x01C3F9 07:C3E9: BD        .byte $BD   ; 
- - - - - - 0x01C3FA 07:C3EA: 00        .byte $00   ; 
- - - - - - 0x01C3FB 07:C3EB: 07        .byte $07   ; 
- - - - - - 0x01C3FC 07:C3EC: 8D        .byte $8D   ; 
- - - - - - 0x01C3FD 07:C3ED: 04        .byte $04   ; 
- - - - - - 0x01C3FE 07:C3EE: 20        .byte $20   ; 
- - - - - - 0x01C3FF 07:C3EF: E8        .byte $E8   ; 
- - - - - - 0x01C400 07:C3F0: 88        .byte $88   ; 
- - - - - - 0x01C401 07:C3F1: D0        .byte $D0   ; 
- - - - - - 0x01C402 07:C3F2: F6        .byte $F6   ; 
- - - - - - 0x01C403 07:C3F3: 60        .byte $60   ; 
C - - - - - 0x01C404 07:C3F4: AD 02 20  LDA $2002
C - - - - - 0x01C407 07:C3F7: A9 00     LDA #$00
C - - - - - 0x01C409 07:C3F9: 8D 03 20  STA $2003
...
C - - - - - 0x01C42D 07:C41D: D0 F2     BNE $C411
...
C - - - - - 0x01C436 07:C426: 20 3B EF  JSR $EF3B
...
C - - - - - 0x01C46E 07:C45E: 8D 00 80  STA $8000
C - - - - - 0x01C471 07:C461: AD B5 06  LDA ram_06B5
C - - - - - 0x01C474 07:C464: 8D 01 80  STA $8001
...
C - - - - - 0x01C482 07:C472: 10 5C     BPL $C4D0
C - - - - - 0x01C484 07:C474: 20 46 EF  JSR $EF46
C - - - - - 0x01C487 07:C477: A5 22     LDA ram_0022
C - - - - - 0x01C489 07:C479: D0 1E     BNE $C499
C - - - - - 0x01C48B 07:C47B: A6 24     LDX ram_0024
...
C - - - - - 0x01C4AF 07:C49F: D0 06     BNE $C4A7
...
C - - - - - 0x01C52E 07:C51E: 20 F5 C4  JSR $C4F5
C - - - - - 0x01C531 07:C521: 20 F4 C3  JSR $C3F4
C - - - - - 0x01C534 07:C524: 20 F3 D4  JSR $D4F3
C - - - - - 0x01C537 07:C527: A9 90     LDA #$90
C - - - - - 0x01C539 07:C529: 85 26     STA ram_0026
C - - - - - 0x01C53B 07:C52B: 8D 00 20  STA $2000
C - - - - - 0x01C53E 07:C52E: AD 02 20  LDA $2002
C - - - - - 0x01C541 07:C531: A9 00     LDA #$00
C - - - - - 0x01C543 07:C533: 8D 05 20  STA $2005
C - - - - - 0x01C546 07:C536: 8D 05 20  STA $2005
C - - - - - 0x01C549 07:C539: 4C 0F C3  JMP $C30F
C - - - - - 0x01C54C 07:C53C: A5 3D     LDA ram_003D
C - - - - - 0x01C54E 07:C53E: D0 0F     BNE $C54F
C - - - - - 0x01C550 07:C540: A5 2C     LDA ram_002C
C - - - - - 0x01C552 07:C542: C9 40     CMP #$40
C - - - - - 0x01C554 07:C544: D0 22     BNE $C568
C - - - - - 0x01C556 07:C546: E6 3D     INC ram_003D
C - - - - - 0x01C558 07:C548: A6 24     LDX ram_0024
C - - - - - 0x01C55A 07:C54A: E8        INX
C - - - - - 0x01C55B 07:C54B: 8A        TXA
C - - - - - 0x01C55C 07:C54C: 4C 34 B2  JMP $B234
C - - - - - 0x01C55F 07:C54F: C9 01     CMP #$01
C - - - - - 0x01C561 07:C551: F0 0B     BEQ $C55E
C - - - - - 0x01C563 07:C553: A9 80     LDA #$80
C - - - - - 0x01C565 07:C555: C5 2C     CMP ram_002C
C - - - - - 0x01C567 07:C557: B0 0F     BCS $C568
C - - - - - 0x01C569 07:C559: A9 FF     LDA #$FF
C - - - - - 0x01C56B 07:C55B: 85 3D     STA ram_003D
C - - - - - 0x01C56D 07:C55D: 60        RTS
C - - - - - 0x01C56E 07:C55E: A5 C8     LDA ram_00C8
C - - - - - 0x01C570 07:C560: D0 06     BNE $C568
C - - - - - 0x01C572 07:C562: 85 2D     STA ram_002D
C - - - - - 0x01C574 07:C564: 85 2C     STA ram_002C
C - - - - - 0x01C576 07:C566: E6 3D     INC ram_003D
C - - - - - 0x01C578 07:C568: 60        RTS
C - - - - - 0x01C579 07:C569: A9 08     LDA #$08
C - - - - - 0x01C57B 07:C56B: 20 79 D0  JSR $D079
C - - - - - 0x01C57E 07:C56E: F0 02     BEQ $C572
C - - - - - 0x01C580 07:C570: E6 3D     INC ram_003D
C - - - - - 0x01C582 07:C572: 20 D5 C5  JSR $C5D5
C - - - - - 0x01C585 07:C575: 20 2A BB  JSR $BB2A
C - - - - - 0x01C588 07:C578: A5 2D     LDA ram_002D
C - - - - - 0x01C58A 07:C57A: F0 4E     BEQ $C5CA
C - - - - - 0x01C58C 07:C57C: C9 02     CMP #$02
C - - - - - 0x01C58E 07:C57E: F0 4A     BEQ $C5CA
C - - - - - 0x01C590 07:C580: A5 2C     LDA ram_002C
C - - - - - 0x01C592 07:C582: C9 E0     CMP #$E0
C - - - - - 0x01C594 07:C584: 90 44     BCC $C5CA
C - - - - - 0x01C596 07:C586: F0 43     BEQ $C5CB
C - - - - - 0x01C598 07:C588: A0 00     LDY #$00
C - - - - - 0x01C59A 07:C58A: C9 E4     CMP #$E4
C - - - - - 0x01C59C 07:C58C: 90 3C     BCC $C5CA
C - - - - - 0x01C59E 07:C58E: F0 18     BEQ $C5A8
C - - - - - 0x01C5A0 07:C590: A0 02     LDY #$02
C - - - - - 0x01C5A2 07:C592: C9 E8     CMP #$E8
C - - - - - 0x01C5A4 07:C594: F0 12     BEQ $C5A8
C - - - - - 0x01C5A6 07:C596: A0 04     LDY #$04
C - - - - - 0x01C5A8 07:C598: C9 EC     CMP #$EC
C - - - - - 0x01C5AA 07:C59A: F0 0C     BEQ $C5A8
C - - - - - 0x01C5AC 07:C59C: A0 06     LDY #$06
C - - - - - 0x01C5AE 07:C59E: C9 F0     CMP #$F0
C - - - - - 0x01C5B0 07:C5A0: F0 06     BEQ $C5A8
C - - - - - 0x01C5B2 07:C5A2: A0 08     LDY #$08
C - - - - - 0x01C5B4 07:C5A4: C9 F4     CMP #$F4
C - - - - - 0x01C5B6 07:C5A6: D0 22     BNE $C5CA
C - - - - - 0x01C5B8 07:C5A8: 20 46 EF  JSR $EF46
C - - - - - 0x01C5BB 07:C5AB: A2 33     LDX #$33
C - - - - - 0x01C5BD 07:C5AD: A9 00     LDA #$00
C - - - - - 0x01C5BF 07:C5AF: 20 41 CA  JSR $CA41
C - - - - - 0x01C5C2 07:C5B2: B9 00 80  LDA $8000,Y
C - - - - - 0x01C5C5 07:C5B5: 85 12     STA ram_0012
C - - - - - 0x01C5C7 07:C5B7: B9 01 80  LDA $8001,Y
...
C - - - - - 0x01C5D2 07:C5C2: F0 06     BEQ $C5CA
C - - - - - 0x01C5D4 07:C5C4: 99 7B 06  STA ram_067B,Y
C - - - - - 0x01C5D7 07:C5C7: C8        INY
C - - - - - 0x01C5D8 07:C5C8: D0 F4     BNE $C5BE
C - - - - - 0x01C5DA 07:C5CA: 60        RTS
C - - - - - 0x01C5DB 07:C5CB: A9 51     LDA #$51
C - - - - - 0x01C5DD 07:C5CD: 20 20 C4  JSR $C420
C - - - - - 0x01C5E0 07:C5D0: A9 52     LDA #$52
C - - - - - 0x01C5E2 07:C5D2: 4C 20 C4  JMP $C420
C - - - - - 0x01C5E5 07:C5D5: AD 09 01  LDA ram_0109
C - - - - - 0x01C5E8 07:C5D8: F0 39     BEQ $C613
C - - - - - 0x01C5EA 07:C5DA: A5 AD     LDA ram_00AD
C - - - - - 0x01C5EC 07:C5DC: F0 35     BEQ $C613
C - - - - - 0x01C5EE 07:C5DE: A5 1C     LDA ram_001C
C - - - - - 0x01C5F0 07:C5E0: 29 30     AND #$30
C - - - - - 0x01C5F2 07:C5E2: F0 0A     BEQ $C5EE
C - - - - - 0x01C5F4 07:C5E4: A2 8F     LDX #$8F
C - - - - - 0x01C5F6 07:C5E6: C9 10     CMP #$10
C - - - - - 0x01C5F8 07:C5E8: F0 02     BEQ $C5EC
C - - - - - 0x01C5FA 07:C5EA: A2 9F     LDX #$9F
C - - - - - 0x01C5FC 07:C5EC: 86 AD     STX ram_00AD
C - - - - - 0x01C5FE 07:C5EE: A5 AD     LDA ram_00AD
C - - - - - 0x01C600 07:C5F0: 8D 04 07  STA ram_0704
C - - - - - 0x01C603 07:C5F3: 8D 08 07  STA ram_0708
C - - - - - 0x01C606 07:C5F6: A9 62     LDA #$62
C - - - - - 0x01C608 07:C5F8: 8D 05 07  STA ram_0705
C - - - - - 0x01C60B 07:C5FB: A9 63     LDA #$63
C - - - - - 0x01C60D 07:C5FD: 8D 09 07  STA ram_0709
C - - - - - 0x01C610 07:C600: A9 00     LDA #$00
C - - - - - 0x01C612 07:C602: 8D 06 07  STA ram_0706
C - - - - - 0x01C615 07:C605: 8D 0A 07  STA ram_070A
C - - - - - 0x01C618 07:C608: A9 50     LDA #$50
C - - - - - 0x01C61A 07:C60A: 8D 07 07  STA ram_0707
C - - - - - 0x01C61D 07:C60D: 18        CLC
C - - - - - 0x01C61E 07:C60E: 69 08     ADC #$08
C - - - - - 0x01C620 07:C610: 8D 0B 07  STA ram_070B
...
C - - - - - 0x01C63F 07:C62F: 20 1D C3  JSR $C31D
C - - - - - 0x01C642 07:C632: 20 58 C3  JSR $C358
C - - - - - 0x01C645 07:C635: 20 46 EF  JSR $EF46
C - - - - - 0x01C648 07:C638: 20 02 C4  JSR $C402
...
C - - - - - 0x01C654 07:C644: 10 F7     BPL $C63D
...
C - - - - - 0x01C65F 07:C64F: 10 F7     BPL $C648
...
C - - - - - 0x01C670 07:C660: 20 5C C8  JSR $C85C
C - - - - - 0x01C673 07:C663: C6 1A     DEC ram_001A
C - - - - - 0x01C675 07:C665: 10 F7     BPL $C65E
C - - - - - 0x01C677 07:C667: 60        RTS
C - - - - - 0x01C678 07:C668: A5 00     LDA ram_0000
C - - - - - 0x01C67A 07:C66A: 20 86 D0  JSR $D086
C - - - - - 0x01C67D 07:C66D: C6 00     DEC ram_0000
C - - - - - 0x01C67F 07:C66F: 10 F7     BPL $C668
C - - - - - 0x01C681 07:C671: 60        RTS
C - - - - - 0x01C682 07:C672: 20 2F C6  JSR $C62F
...
C - - - - - 0x01C691 07:C681: 20 68 C6  JSR $C668
C - - - - - 0x01C694 07:C684: 20 52 C6  JSR $C652
C - - - - - 0x01C697 07:C687: 20 3B EF  JSR $EF3B
C - - - - - 0x01C69A 07:C68A: A9 0B     LDA #$0B
C - - - - - 0x01C69C 07:C68C: 85 1A     STA ram_001A
C - - - - - 0x01C69E 07:C68E: 20 DD C6  JSR $C6DD
C - - - - - 0x01C6A1 07:C691: C6 1A     DEC ram_001A
C - - - - - 0x01C6A3 07:C693: 10 F9     BPL $C68E
...
C - - - - - 0x01C6B8 07:C6A8: B0 03     BCS $C6AD
C - - - - - 0x01C6BA 07:C6AA: E8        INX
C - - - - - 0x01C6BB 07:C6AB: D0 F9     BNE $C6A6
C - - - - - 0x01C6BD 07:C6AD: 86 AD     STX ram_00AD
C - - - - - 0x01C6BF 07:C6AF: 20 53 C8  JSR $C853
C - - - - - 0x01C6C2 07:C6B2: A9 10     LDA #$10
C - - - - - 0x01C6C4 07:C6B4: 85 3B     STA ram_003B
C - - - - - 0x01C6C6 07:C6B6: 20 1E C5  JSR $C51E
C - - - - - 0x01C6C9 07:C6B9: A5 3D     LDA ram_003D
C - - - - - 0x01C6CB 07:C6BB: F0 FC     BEQ $C6B9
C - - - - - 0x01C6CD 07:C6BD: A5 3D     LDA ram_003D
C - - - - - 0x01C6CF 07:C6BF: 30 FC     BMI $C6BD
C - - - - - 0x01C6D1 07:C6C1: 20 13 C3  JSR $C313
C - - - - - 0x01C6D4 07:C6C4: 20 05 C3  JSR $C305
...
C - - - - - 0x01C6DE 07:C6CE: 90 07     BCC $C6D7
C - - - - - 0x01C6E0 07:C6D0: C0 1F     CPY #$1F
C - - - - - 0x01C6E2 07:C6D2: B0 03     BCS $C6D7
...
C - - - - - 0x01C700 07:C6F0: 20 7B C7  JSR $C77B
C - - - - - 0x01C703 07:C6F3: F0 07     BEQ $C6FC
C - - - - - 0x01C705 07:C6F5: 88        DEY
C - - - - - 0x01C706 07:C6F6: 88        DEY
C - - - - - 0x01C707 07:C6F7: 88        DEY
C - - - - - 0x01C708 07:C6F8: 88        DEY
C - - - - - 0x01C709 07:C6F9: 4C 1F C7  JMP $C71F
C - - - - - 0x01C70C 07:C6FC: A5 D6     LDA ram_00D6
C - - - - - 0x01C70E 07:C6FE: 10 1F     BPL $C71F
...
C - - - - - 0x01C71C 07:C70C: D0 04     BNE $C712
...
C - - - - - 0x01C72C 07:C71C: 4C 54 C7  JMP $C754
...
C - - - - - 0x01C739 07:C729: 4C 54 C7  JMP $C754
C - - - - - 0x01C73C 07:C72C: A5 1A     LDA ram_001A
C - - - - - 0x01C73E 07:C72E: 29 02     AND #$02
C - - - - - 0x01C740 07:C730: D0 06     BNE $C738
C - - - - - 0x01C742 07:C732: 20 7B C7  JSR $C77B
C - - - - - 0x01C745 07:C735: D0 01     BNE $C738
C - - - - - 0x01C747 07:C737: 60        RTS
C - - - - - 0x01C748 07:C738: A5 5E     LDA ram_005E
...
C - - - - - 0x01C788 07:C778: 4C 89 D0  JMP $D089
...
C - - - - - 0x01C797 07:C787: 10 FB     BPL $C784
...
C - - - - - 0x01C7A1 07:C791: 30 13     BMI $C7A6
...
C - - - - - 0x01C84E 07:C83E: 4C 33 CE  JMP $CE33
C - - - - - 0x01C851 07:C841: A6 AE     LDX ram_00AE
C - - - - - 0x01C853 07:C843: 20 49 C8  JSR $C849
...
C - - - - - 0x01C85E 07:C84E: 10 FB     BPL $C84B
...
C - - - - - 0x01C86C 07:C85C: 20 A3 D0  JSR $D0A3
C - - - - - 0x01C86F 07:C85F: A9 03     LDA #$03
C - - - - - 0x01C871 07:C861: 85 0F     STA ram_000F
C - - - - - 0x01C873 07:C863: 20 89 D0  JSR $D089
...
C - - - - - 0x01C8CE 07:C8BE: 20 02 C4  JSR $C402
C - - - - - 0x01C8D1 07:C8C1: A9 0E     LDA #$0E
C - - - - - 0x01C8D3 07:C8C3: 4C 20 C4  JMP $C420
...
C - - - - - 0x01C8E6 07:C8D6: BD E2 C8  LDA $C8E2,X
C - - - - - 0x01C8E9 07:C8D9: DD 00 01  CMP ram_0100,X
C - - - - - 0x01C8EC 07:C8DC: D0 0E     BNE $C8EC
C - - - - - 0x01C8EE 07:C8DE: CA        DEX
C - - - - - 0x01C8EF 07:C8DF: 10 F5     BPL $C8D6
C - - - - - 0x01C8F1 07:C8E1: 60        RTS
- D 2 - - - 0x01C8F2 07:C8E2: 59        .byte $59   ; 
- D 2 - - - 0x01C8F3 07:C8E3: 6F        .byte $6F   ; 
- D 2 - - - 0x01C8F4 07:C8E4: 73        .byte $73   ; 
- D 2 - - - 0x01C8F5 07:C8E5: 68        .byte $68   ; 
- D 2 - - - 0x01C8F6 07:C8E6: 69        .byte $69   ; 
- D 2 - - - 0x01C8F7 07:C8E7: 6B        .byte $6B   ; 
- D 2 - - - 0x01C8F8 07:C8E8: 61        .byte $61   ; 
- D 2 - - - 0x01C8F9 07:C8E9: 77        .byte $77   ; 
- D 2 - - - 0x01C8FA 07:C8EA: 61        .byte $61   ; 
- - - - - - 0x01C8FB 07:C8EB: 00        .byte $00   ; 
- - - - - - 0x01C8FC 07:C8EC: A2        .byte $A2   ; 
- - - - - - 0x01C8FD 07:C8ED: 09        .byte $09   ; 
- - - - - - 0x01C8FE 07:C8EE: BD        .byte $BD   ; 
- - - - - - 0x01C8FF 07:C8EF: E2        .byte $E2   ; 
- - - - - - 0x01C900 07:C8F0: C8        .byte $C8   ; 
- - - - - - 0x01C901 07:C8F1: 9D        .byte $9D   ; 
- - - - - - 0x01C902 07:C8F2: 00        .byte $00   ; 
- - - - - - 0x01C903 07:C8F3: 01        .byte $01   ; 
- - - - - - 0x01C904 07:C8F4: CA        .byte $CA   ; 
- - - - - - 0x01C905 07:C8F5: 10        .byte $10   ; 
- - - - - - 0x01C906 07:C8F6: F7        .byte $F7   ; 
- - - - - - 0x01C907 07:C8F7: A9        .byte $A9   ; 
- - - - - - 0x01C908 07:C8F8: 00        .byte $00   ; 
- - - - - - 0x01C909 07:C8F9: 85        .byte $85   ; 
- - - - - - 0x01C90A 07:C8FA: 24        .byte $24   ; 
- - - - - - 0x01C90B 07:C8FB: A2        .byte $A2   ; 
- - - - - - 0x01C90C 07:C8FC: 99        .byte $99   ; 
- - - - - - 0x01C90D 07:C8FD: 20        .byte $20   ; 
- - - - - - 0x01C90E 07:C8FE: 11        .byte $11   ; 
- - - - - - 0x01C90F 07:C8FF: C9        .byte $C9   ; 
- - - - - - 0x01C910 07:C900: A9        .byte $A9   ; 
- - - - - - 0x01C911 07:C901: 05        .byte $05   ; 
- - - - - - 0x01C912 07:C902: 85        .byte $85   ; 
- - - - - - 0x01C913 07:C903: 9C        .byte $9C   ; 
C - - - - - 0x01C914 07:C904: A2 A0     LDX #$A0
C - - - - - 0x01C916 07:C906: 20 11 C9  JSR $C911
...
C - - - - - 0x01C929 07:C919: D0 FA     BNE $C915
...
C - - - - - 0x01C963 07:C953: 20 5F D0  JSR $D05F
...
C - - - - - 0x01C96E 07:C95E: F0 17     BEQ $C977
C - - - - - 0x01C970 07:C960: 48        PHA
C - - - - - 0x01C971 07:C961: A5 37     LDA ram_0037
C - - - - - 0x01C973 07:C963: 30 E0     BMI $C945
...
C - - - - - 0x01C97C 07:C96C: 20 5F D0  JSR $D05F
...
C - - - - - 0x01C98C 07:C97C: 10 FB     BPL $C979
...
C - - - - - 0x01C9BE 07:C9AE: 90 F7     BCC $C9A7
C - - - - - 0x01C9C0 07:C9B0: 68        PLA
C - - - - - 0x01C9C1 07:C9B1: AA        TAX
C - - - - - 0x01C9C2 07:C9B2: 60        RTS
C - - - - - 0x01C9C3 07:C9B3: A5 19     LDA ram_0019
C - - - - - 0x01C9C5 07:C9B5: D0 FB     BNE $C9B2
C - - - - - 0x01C9C7 07:C9B7: A5 3B     LDA ram_003B
C - - - - - 0x01C9C9 07:C9B9: 6A        ROR
C - - - - - 0x01C9CA 07:C9BA: B0 F6     BCS $C9B2
C - - - - - 0x01C9CC 07:C9BC: A5 2C     LDA ram_002C
C - - - - - 0x01C9CE 07:C9BE: 29 02     AND #$02
C - - - - - 0x01C9D0 07:C9C0: D0 03     BNE $C9C5
C - - - - - 0x01C9D2 07:C9C2: 4C 48 CA  JMP $CA48
C - - - - - 0x01C9D5 07:C9C5: A2 25     LDX #$25
C - - - - - 0x01C9D7 07:C9C7: 20 3F CA  JSR $CA3F
C - - - - - 0x01C9DA 07:C9CA: 20 13 CA  JSR $CA13
...
C - - - - - 0x01C9F4 07:C9E4: D0 08     BNE $C9EE
C - - - - - 0x01C9F6 07:C9E6: 24 07     BIT ram_0007
C - - - - - 0x01C9F8 07:C9E8: 30 04     BMI $C9EE
C - - - - - 0x01C9FA 07:C9EA: C0 03     CPY #$03
C - - - - - 0x01C9FC 07:C9EC: B0 07     BCS $C9F5
...
C - - - - - 0x01CA07 07:C9F7: D0 E9     BNE $C9E2
C - - - - - 0x01CA09 07:C9F9: A2 00     LDX #$00
C - - - - - 0x01CA0B 07:C9FB: BD 00 02  LDA ram_0200,X
C - - - - - 0x01CA0E 07:C9FE: F0 08     BEQ $CA08
C - - - - - 0x01CA10 07:CA00: 09 40     ORA #$40
C - - - - - 0x01CA12 07:CA02: BC CE CA  LDY $CACE,X
C - - - - - 0x01CA15 07:CA05: 99 7B 06  STA ram_067B,Y
C - - - - - 0x01CA18 07:CA08: E8        INX
C - - - - - 0x01CA19 07:CA09: E0 09     CPX #$09
C - - - - - 0x01CA1B 07:CA0B: D0 EE     BNE $C9FB
...
C - - - - - 0x01CA38 07:CA28: 50 08     BVC $CA32
C - - - - - 0x01CA3A 07:CA2A: A0 05     LDY #$05
C - - - - - 0x01CA3C 07:CA2C: A5 2C     LDA ram_002C
C - - - - - 0x01CA3E 07:CA2E: 29 18     AND #$18
C - - - - - 0x01CA40 07:CA30: F0 0C     BEQ $CA3E
C - - - - - 0x01CA42 07:CA32: B9 C4 CA  LDA $CAC4,Y
...
C - - - - - 0x01CA4C 07:CA3C: D0 F4     BNE $CA32
...
C - - - - - 0x01CA8D 07:CA7D: D0 DF     BNE $CA5E
...
C - - - - - 0x01CB4B 07:CB3B: B0 FA     BCS $CB37
C - - - - - 0x01CB4D 07:CB3D: 24 6D     BIT ram_006D
C - - - - - 0x01CB4F 07:CB3F: 30 F6     BMI $CB37
C - - - - - 0x01CB51 07:CB41: 70 F4     BVS $CB37
C - - - - - 0x01CB53 07:CB43: 2C 14 02  BIT ram_0214
C - - - - - 0x01CB56 07:CB46: 30 EF     BMI $CB37
C - - - - - 0x01CB58 07:CB48: 70 42     BVS $CB8C
...
C - - - - - 0x01CB66 07:CB56: 20 79 D0  JSR $D079
C - - - - - 0x01CB69 07:CB59: F0 31     BEQ $CB8C
C - - - - - 0x01CB6B 07:CB5B: C9 40     CMP #$40
C - - - - - 0x01CB6D 07:CB5D: D0 11     BNE $CB70
C - - - - - 0x01CB6F 07:CB5F: CA        DEX
C - - - - - 0x01CB70 07:CB60: 10 02     BPL $CB64
C - - - - - 0x01CB72 07:CB62: A2 04     LDX #$04
C - - - - - 0x01CB74 07:CB64: BD 00 02  LDA ram_0200,X
C - - - - - 0x01CB77 07:CB67: D0 17     BNE $CB80
C - - - - - 0x01CB79 07:CB69: C6 12     DEC ram_0012
C - - - - - 0x01CB7B 07:CB6B: D0 F2     BNE $CB5F
...
C - - - - - 0x01CB83 07:CB73: D0 02     BNE $CB77
C - - - - - 0x01CB85 07:CB75: A2 00     LDX #$00
C - - - - - 0x01CB87 07:CB77: BD 00 02  LDA ram_0200,X
C - - - - - 0x01CB8A 07:CB7A: D0 04     BNE $CB80
...
C - - - - - 0x01CB9E 07:CB8E: 30 48     BMI $CBD8
C - - - - - 0x01CBA0 07:CB90: A5 5F     LDA ram_005F
C - - - - - 0x01CBA2 07:CB92: 29 03     AND #$03
C - - - - - 0x01CBA4 07:CB94: F0 0D     BEQ $CBA3
C - - - - - 0x01CBA6 07:CB96: AD 00 02  LDA ram_0200
C - - - - - 0x01CBA9 07:CB99: F0 3D     BEQ $CBD8
...
C - - - - - 0x01CBE6 07:CBD6: D0 DD     BNE $CBB5
C - - - - - 0x01CBE8 07:CBD8: 60        RTS
C - - - - - 0x01CBE9 07:CBD9: 2C 14 02  BIT ram_0214
C - - - - - 0x01CBEC 07:CBDC: 30 4B     BMI $CC29
C - - - - - 0x01CBEE 07:CBDE: 70 49     BVS $CC29
C - - - - - 0x01CBF0 07:CBE0: A5 6D     LDA ram_006D
C - - - - - 0x01CBF2 07:CBE2: 29 FE     AND #$FE
C - - - - - 0x01CBF4 07:CBE4: D0 43     BNE $CC29
C - - - - - 0x01CBF6 07:CBE6: A5 6C     LDA ram_006C
C - - - - - 0x01CBF8 07:CBE8: 29 28     AND #$28
C - - - - - 0x01CBFA 07:CBEA: D0 3D     BNE $CC29
C - - - - - 0x01CBFC 07:CBEC: A9 04     LDA #$04
C - - - - - 0x01CBFE 07:CBEE: 20 79 D0  JSR $D079
C - - - - - 0x01CC01 07:CBF1: F0 36     BEQ $CC29
C - - - - - 0x01CC03 07:CBF3: 20 29 CB  JSR $CB29
C - - - - - 0x01CC06 07:CBF6: B0 31     BCS $CC29
C - - - - - 0x01CC08 07:CBF8: 20 2A CC  JSR $CC2A
C - - - - - 0x01CC0B 07:CBFB: B0 2C     BCS $CC29
C - - - - - 0x01CC0D 07:CBFD: AD 14 02  LDA ram_0214
C - - - - - 0x01CC10 07:CC00: 29 0F     AND #$0F
C - - - - - 0x01CC12 07:CC02: AA        TAX
C - - - - - 0x01CC13 07:CC03: 4C 13 CD  JMP $CD13
C - - - - - 0x01CC16 07:CC06: BD 00 02  LDA ram_0200,X
C - - - - - 0x01CC19 07:CC09: D0 1E     BNE $CC29
C - - - - - 0x01CC1B 07:CC0B: 2C 14 02  BIT ram_0214
C - - - - - 0x01CC1E 07:CC0E: 70 19     BVS $CC29
C - - - - - 0x01CC20 07:CC10: A9 05     LDA #$05
C - - - - - 0x01CC22 07:CC12: 85 12     STA ram_0012
C - - - - - 0x01CC24 07:CC14: E8        INX
C - - - - - 0x01CC25 07:CC15: E0 05     CPX #$05
C - - - - - 0x01CC27 07:CC17: D0 02     BNE $CC1B
C - - - - - 0x01CC29 07:CC19: A2 00     LDX #$00
C - - - - - 0x01CC2B 07:CC1B: BD 00 02  LDA ram_0200,X
C - - - - - 0x01CC2E 07:CC1E: D0 06     BNE $CC26
C - - - - - 0x01CC30 07:CC20: C6 12     DEC ram_0012
C - - - - - 0x01CC32 07:CC22: D0 F0     BNE $CC14
...
C - - - - - 0x01CC41 07:CC31: D0 04     BNE $CC37
...
C - - - - - 0x01CC49 07:CC39: B9 46 CC  LDA $CC46,Y
C - - - - - 0x01CC4C 07:CC3C: 85 00     STA ram_0000
C - - - - - 0x01CC4E 07:CC3E: B9 47 CC  LDA $CC47,Y
C - - - - - 0x01CC51 07:CC41: 85 01     STA ram_0001
C - - - - - 0x01CC53 07:CC43: 6C 00 00  JMP (ram_0000)
- D 2 - - - 0x01CC56 07:CC46: 58        .byte $58   ; 
- D 2 - - - 0x01CC57 07:CC47: CC        .byte $CC   ; 
- D 2 - - - 0x01CC58 07:CC48: 68        .byte $68   ; 
- D 2 - - - 0x01CC59 07:CC49: CC        .byte $CC   ; 
- D 2 - - - 0x01CC5A 07:CC4A: 88        .byte $88   ; 
- D 2 - - - 0x01CC5B 07:CC4B: CC        .byte $CC   ; 
- D 2 - - - 0x01CC5C 07:CC4C: 9B        .byte $9B   ; 
- D 2 - - - 0x01CC5D 07:CC4D: CC        .byte $CC   ; 
- D 2 - - - 0x01CC5E 07:CC4E: B0        .byte $B0   ; 
- D 2 - - - 0x01CC5F 07:CC4F: CC        .byte $CC   ; 
...
C - - - - - 0x01CC6C 07:CC5C: 20 F3 CD  JSR $CDF3
C - - - - - 0x01CC6F 07:CC5F: A9 11     LDA #$11
C - - - - - 0x01CC71 07:CC61: 20 20 C4  JSR $C420
...
C - - - - - 0x01CC7C 07:CC6C: D0 F8     BNE $CC66
...
C - - - - - 0x01CC87 07:CC77: 10 F7     BPL $CC70
C - - - - - 0x01CC89 07:CC79: A0 00     LDY #$00
C - - - - - 0x01CC8B 07:CC7B: A5 6C     LDA ram_006C
C - - - - - 0x01CC8D 07:CC7D: 6A        ROR
C - - - - - 0x01CC8E 07:CC7E: 90 02     BCC $CC82
C - - - - - 0x01CC90 07:CC80: A0 06     LDY #$06
C - - - - - 0x01CC92 07:CC82: 20 1C CD  JSR $CD1C
C - - - - - 0x01CC95 07:CC85: 4C 49 CD  JMP $CD49
C - - J - - 0x01CC98 07:CC88: 20 75 F0  JSR $F075
...
C - - - - - 0x01CCA8 07:CC98: 4C 49 CD  JMP $CD49
...
C - - - - - 0x01CCEA 07:CCDA: 20 20 C4  JSR $C420
...
C - - - - - 0x01CCF6 07:CCE6: 20 FF E2  JSR $E2FF
...
- D 2 - - - 0x01CD66 07:CD56: 0C        .byte $0C   ; 
- D 2 - - - 0x01CD67 07:CD57: 00        .byte $00   ; 
- D 2 - - - 0x01CD68 07:CD58: 40        .byte $40   ; 
- D 2 - - - 0x01CD69 07:CD59: 01        .byte $01   ; 
- D 2 - - - 0x01CD6A 07:CD5A: C2        .byte $C2   ; 
- D 2 - - - 0x01CD6B 07:CD5B: 00        .byte $00   ; 
- D 2 - - - 0x01CD6C 07:CD5C: F4        .byte $F4   ; 
- D 2 - - - 0x01CD6D 07:CD5D: FF        .byte $FF   ; 
- D 2 - - - 0x01CD6E 07:CD5E: 40        .byte $40   ; 
C - - - - - 0x01CD6F 07:CD5F: A5 D1     LDA ram_00D1
C - - - - - 0x01CD71 07:CD61: 10 1C     BPL $CD7F
C - - - - - 0x01CD73 07:CD63: A5 D3     LDA ram_00D3
C - - - - - 0x01CD75 07:CD65: D0 0B     BNE $CD72
C - - - - - 0x01CD77 07:CD67: A5 D2     LDA ram_00D2
C - - - - - 0x01CD79 07:CD69: D0 07     BNE $CD72
C - - - - - 0x01CD7B 07:CD6B: A9 00     LDA #$00
C - - - - - 0x01CD7D 07:CD6D: 85 D1     STA ram_00D1
C - - - - - 0x01CD7F 07:CD6F: 4C 45 D4  JMP $D445
...
C - - - - - 0x01CD92 07:CD82: D0 26     BNE $CDAA
C - - - - - 0x01CD94 07:CD84: AD 15 02  LDA ram_0215
C - - - - - 0x01CD97 07:CD87: D0 21     BNE $CDAA
C - - - - - 0x01CD99 07:CD89: 24 6D     BIT ram_006D
C - - - - - 0x01CD9B 07:CD8B: 30 43     BMI $CDD0
C - - - - - 0x01CD9D 07:CD8D: 70 5E     BVS $CDED
C - - - - - 0x01CD9F 07:CD8F: 2C 14 02  BIT ram_0214
C - - - - - 0x01CDA2 07:CD92: 30 59     BMI $CDED
C - - - - - 0x01CDA4 07:CD94: 50 57     BVC $CDED
...
C - - - - - 0x01CDAD 07:CD9D: B9 BE CD  LDA $CDBE,Y
C - - - - - 0x01CDB0 07:CDA0: 85 00     STA ram_0000
C - - - - - 0x01CDB2 07:CDA2: B9 BF CD  LDA $CDBF,Y
...
- - - - - - 0x01CDCE 07:CDBE: EE        .byte $EE   ; 
- - - - - - 0x01CDCF 07:CDBF: CD        .byte $CD   ; 
- D 2 - - - 0x01CDD0 07:CDC0: ED        .byte $ED   ; 
- D 2 - - - 0x01CDD1 07:CDC1: CD        .byte $CD   ; 
- D 2 - - - 0x01CDD2 07:CDC2: ED        .byte $ED   ; 
- D 2 - - - 0x01CDD3 07:CDC3: CD        .byte $CD   ; 
- D 2 - - - 0x01CDD4 07:CDC4: EE        .byte $EE   ; 
- D 2 - - - 0x01CDD5 07:CDC5: CD        .byte $CD   ; 
...
C - - - - - 0x01CDE0 07:CDD0: AD 05 02  LDA ram_0205
C - - - - - 0x01CDE3 07:CDD3: F0 08     BEQ $CDDD
C - - - - - 0x01CDE5 07:CDD5: 20 E9 CC  JSR $CCE9
C - - - - - 0x01CDE8 07:CDD8: A2 05     LDX #$05
C - - - - - 0x01CDEA 07:CDDA: 4C 13 CD  JMP $CD13
...
C - - - - - 0x01CE15 07:CE05: BD 00 02  LDA ram_0200,X
C - - - - - 0x01CE18 07:CE08: D0 08     BNE $CE12
C - - - - - 0x01CE1A 07:CE0A: CA        DEX
C - - - - - 0x01CE1B 07:CE0B: 10 F8     BPL $CE05
...
C - - - - - 0x01CE28 07:CE18: 90 02     BCC $CE1C
C - - - - - 0x01CE2A 07:CE1A: A2 37     LDX #$37
C - - - - - 0x01CE2C 07:CE1C: 8E 00 07  STX ram_0700
C - - - - - 0x01CE2F 07:CE1F: A9 3F     LDA #$3F
C - - - - - 0x01CE31 07:CE21: 8D 01 07  STA ram_0701
C - - - - - 0x01CE34 07:CE24: A9 20     LDA #$20
C - - - - - 0x01CE36 07:CE26: 8D 02 07  STA ram_0702
C - - - - - 0x01CE39 07:CE29: A9 00     LDA #$00
C - - - - - 0x01CE3B 07:CE2B: 8D 03 07  STA ram_0703
...
C - - - - - 0x01CE4A 07:CE3A: B0 1B     BCS $CE57
...
C - - - - - 0x01CE6C 07:CE5C: 85 08     STA ram_0008
C - - - - - 0x01CE6E 07:CE5E: 85 09     STA ram_0009
C - - - - - 0x01CE70 07:CE60: A9 06     LDA #$06
C - - - - - 0x01CE72 07:CE62: 8D 00 80  STA $8000
C - - - - - 0x01CE75 07:CE65: A9 0A     LDA #$0A
C - - - - - 0x01CE77 07:CE67: 8D 01 80  STA $8001
...
C - - - - - 0x01CED4 07:CEC4: 10 02     BPL $CEC8
...
C - - - - - 0x01CEE1 07:CED1: D0 1F     BNE $CEF2
C - - - - - 0x01CEE3 07:CED3: A5 06     LDA ram_0006
C - - - - - 0x01CEE5 07:CED5: C9 F9     CMP #$F9
C - - - - - 0x01CEE7 07:CED7: B0 19     BCS $CEF2
C - - - - - 0x01CEE9 07:CED9: 9D 03 07  STA ram_0703,X
C - - - - - 0x01CEEC 07:CEDC: E8        INX
C - - - - - 0x01CEED 07:CEDD: E8        INX
C - - - - - 0x01CEEE 07:CEDE: E8        INX
C - - - - - 0x01CEEF 07:CEDF: E8        INX
C - - - - - 0x01CEF0 07:CEE0: D0 03     BNE $CEE5
C - - - - - 0x01CEF2 07:CEE2: CA        DEX
C - - - - - 0x01CEF3 07:CEE3: D0 05     BNE $CEEA
C - - - - - 0x01CEF5 07:CEE5: C8        INY
C - - - - - 0x01CEF6 07:CEE6: C6 05     DEC ram_0005
C - - - - - 0x01CEF8 07:CEE8: D0 AF     BNE $CE99
...
C - - - - - 0x01CF04 07:CEF4: 9D 00 07  STA ram_0700,X
C - - - - - 0x01CF07 07:CEF7: D0 EC     BNE $CEE5
C - - - - - 0x01CF09 07:CEF9: A5 2C     LDA ram_002C
...
C - - - - - 0x01CF2A 07:CF1A: D0 03     BNE $CF1F
C - - - - - 0x01CF2C 07:CF1C: 4C C8 CF  JMP $CFC8
...
C - - - - - 0x01CF40 07:CF30: F0 08     BEQ $CF3A
C - - - - - 0x01CF42 07:CF32: A2 05     LDX #$05
C - - - - - 0x01CF44 07:CF34: C9 10     CMP #$10
C - - - - - 0x01CF46 07:CF36: F0 02     BEQ $CF3A
C - - - - - 0x01CF48 07:CF38: A2 0A     LDX #$0A
C - - - - - 0x01CF4A 07:CF3A: A9 06     LDA #$06
C - - - - - 0x01CF4C 07:CF3C: 8D 00 80  STA $8000
C - - - - - 0x01CF4F 07:CF3F: 8E 01 80  STX $8001
...
C - - - - - 0x01CF5A 07:CF4A: F0 02     BEQ $CF4E
...
C - - - - - 0x01CF81 07:CF71: F0 55     BEQ $CFC8
...
C - - - - - 0x01CFB3 07:CFA3: 10 02     BPL $CFA7
...
C - - - - - 0x01CFDE 07:CFCE: B0 03     BCS $CFD3
C - - - - - 0x01CFE0 07:CFD0: 4C 10 CF  JMP $CF10
...
C - - - - - 0x01CFE9 07:CFD9: 9D 00 07  STA ram_0700,X
C - - - - - 0x01CFEC 07:CFDC: D0 E3     BNE $CFC1
...
C - - - - - 0x01D0F0 07:D0E0: 8D 00 20  STA $2000
...
C - - - - - 0x01D128 07:D118: 4C EA D0  JMP $D0EA
C - - - - - 0x01D12B 07:D11B: A5 19     LDA ram_0019
C - - - - - 0x01D12D 07:D11D: D0 39     BNE $D158
C - - - - - 0x01D12F 07:D11F: AD 31 06  LDA ram_0631
C - - - - - 0x01D132 07:D122: F0 35     BEQ $D159
C - - - - - 0x01D134 07:D124: 30 AD     BMI $D0D3
C - - - - - 0x01D136 07:D126: AE 30 06  LDX ram_0630
C - - - - - 0x01D139 07:D129: 8D 06 20  STA $2006
C - - - - - 0x01D13C 07:D12C: 8E 06 20  STX $2006
C - - - - - 0x01D13F 07:D12F: AD 32 06  LDA ram_0632
C - - - - - 0x01D142 07:D132: 10 0B     BPL $D13F
C - - - - - 0x01D144 07:D134: 48        PHA
C - - - - - 0x01D145 07:D135: A5 26     LDA ram_0026
C - - - - - 0x01D147 07:D137: 09 04     ORA #$04
C - - - - - 0x01D149 07:D139: 8D 00 20  STA $2000
...
C - - - - - 0x01D1C7 07:D1B7: D0 03     BNE $D1BC
C - - - - - 0x01D1C9 07:D1B9: 4C A0 D2  JMP $D2A0
C - - - - - 0x01D1CC 07:D1BC: 48        PHA
C - - - - - 0x01D1CD 07:D1BD: 29 07     AND #$07
C - - - - - 0x01D1CF 07:D1BF: F0 02     BEQ $D1C3
...
C - - - - - 0x01D1F9 07:D1E9: D0 0E     BNE $D1F9
C - - - - - 0x01D1FB 07:D1EB: C9 04     CMP #$04
C - - - - - 0x01D1FD 07:D1ED: D0 03     BNE $D1F2
C - - - - - 0x01D1FF 07:D1EF: 4C A0 D2  JMP $D2A0
C - - - - - 0x01D202 07:D1F2: 48        PHA
C - - - - - 0x01D203 07:D1F3: 29 07     AND #$07
C - - - - - 0x01D205 07:D1F5: F0 02     BEQ $D1F9
...
C - - - - - 0x01D20D 07:D1FD: 90 02     BCC $D201
...
C - - - - - 0x01D217 07:D207: B0 EF     BCS $D1F8
...
C - - - - - 0x01D223 07:D213: 90 02     BCC $D217
...
C - - - - - 0x01D238 07:D228: 20 F7 D3  JSR $D3F7
...
C - - - - - 0x01D259 07:D249: 20 5E D0  JSR $D05E
...
C - - - - - 0x01D26F 07:D25F: 8D 00 80  STA $8000
C - - - - - 0x01D272 07:D262: A5 02     LDA ram_0002
C - - - - - 0x01D274 07:D264: 8D 01 80  STA $8001
...
C - - - - - 0x01D28C 07:D27C: 20 04 C5  JSR $C504
...
C - - - - - 0x01D297 07:D287: F0 02     BEQ $D28B
...
C - - - - - 0x01D2E5 07:D2D5: 20 04 C5  JSR $C504
...
C - - - - - 0x01D2F2 07:D2E2: 10 F8     BPL $D2DC
...
C - - - - - 0x01D323 07:D313: 20 04 C5  JSR $C504
...
C - - - - - 0x01D346 07:D336: F0 08     BEQ $D340
...
C - - - - - 0x01D357 07:D347: A5 5E     LDA ram_005E
C - - - - - 0x01D359 07:D349: C9 03     CMP #$03
C - - - - - 0x01D35B 07:D34B: D0 03     BNE $D350
C - - - - - 0x01D35D 07:D34D: A9 01     LDA #$01
C - - - - - 0x01D35F 07:D34F: 60        RTS
C - - - - - 0x01D360 07:D350: A9 F8     LDA #$F8
C - - - - - 0x01D362 07:D352: 20 F0 D7  JSR $D7F0
C - - - - - 0x01D365 07:D355: C9 01     CMP #$01
C - - - - - 0x01D367 07:D357: 60        RTS
C - - - - - 0x01D368 07:D358: 20 3F D9  JSR $D93F
C - - - - - 0x01D36B 07:D35B: 4C 70 D3  JMP $D370
...
C - - - - - 0x01D3A4 07:D394: 4C E5 D2  JMP $D2E5
C D 2 - - - 0x01D3A7 07:D397: 20 89 D3  JSR $D389
C - - - - - 0x01D3AA 07:D39A: C9 01     CMP #$01
C - - - - - 0x01D3AC 07:D39C: D0 17     BNE $D3B5
...
C - - - - - 0x01D409 07:D3F9: 20 04 C5  JSR $C504
...
C - - - - - 0x01D43A 07:D42A: 8D 00 80  STA $8000
C - - - - - 0x01D43D 07:D42D: A9 03     LDA #$03
C - - - - - 0x01D43F 07:D42F: 8D 01 80  STA $8001
...
C D 2 - - - 0x01D455 07:D445: 20 28 D4  JSR $D428
...
C - - - - - 0x01D498 07:D488: 10 F8     BPL $D482
...
C - - - - - 0x01D4A5 07:D495: 90 02     BCC $D499
...
C - - - - - 0x01D4B8 07:D4A8: 20 95 D1  JSR $D195
C - - - - - 0x01D4BB 07:D4AB: 20 95 D1  JSR $D195
C - - - - - 0x01D4BE 07:D4AE: 20 95 D1  JSR $D195
C - - - - - 0x01D4C1 07:D4B1: 20 95 D1  JSR $D195
C - - - - - 0x01D4C4 07:D4B4: 20 7F F0  JSR $F07F
C - - - - - 0x01D4C7 07:D4B7: AD 31 06  LDA ram_0631
C - - - - - 0x01D4CA 07:D4BA: F0 03     BEQ $D4BF
C - - - - - 0x01D4CC 07:D4BC: 20 1B D1  JSR $D11B
C - - - - - 0x01D4CF 07:D4BF: 68        PLA
C - - - - - 0x01D4D0 07:D4C0: AA        TAX
C - - - - - 0x01D4D1 07:D4C1: CA        DEX
C - - - - - 0x01D4D2 07:D4C2: 8A        TXA
C - - - - - 0x01D4D3 07:D4C3: D0 DE     BNE $D4A3
C - - - - - 0x01D4D5 07:D4C5: 20 46 EF  JSR $EF46
...
C - - - - - 0x01D4F6 07:D4E6: D0 03     BNE $D4EB
C - - - - - 0x01D4F8 07:D4E8: 20 8C B1  JSR $B18C
C - - - - - 0x01D4FB 07:D4EB: A5 3B     LDA ram_003B
C - - - - - 0x01D4FD 07:D4ED: 6A        ROR
C - - - - - 0x01D4FE 07:D4EE: 90 03     BCC $D4F3
C - - - - - 0x01D500 07:D4F0: 20 FB D4  JSR $D4FB
C - - - - - 0x01D503 07:D4F3: AD 02 20  LDA $2002
C - - - - - 0x01D506 07:D4F6: 10 FB     BPL $D4F3
C - - - - - 0x01D508 07:D4F8: 4C 71 C3  JMP $C371
C - - - - - 0x01D50B 07:D4FB: A5 B7     LDA ram_00B7
C - - - - - 0x01D50D 07:D4FD: 85 B8     STA ram_00B8
C - - - - - 0x01D50F 07:D4FF: AD 02 20  LDA $2002
C - - - - - 0x01D512 07:D502: A9 20     LDA #$20
C - - - - - 0x01D514 07:D504: 8D 06 20  STA $2006
C - - - - - 0x01D517 07:D507: A9 00     LDA #$00
C - - - - - 0x01D519 07:D509: 8D 06 20  STA $2006
C - - - - - 0x01D51C 07:D50C: A8        TAY
C - - - - - 0x01D51D 07:D50D: A9 00     LDA #$00
C - - - - - 0x01D51F 07:D50F: 8D 07 20  STA $2007
C - - - - - 0x01D522 07:D512: C8        INY
C - - - - - 0x01D523 07:D513: D0 FA     BNE $D50F
C - - - - - 0x01D525 07:D515: AD 02 20  LDA $2002
C - - - - - 0x01D528 07:D518: A9 20     LDA #$20
C - - - - - 0x01D52A 07:D51A: 8D 06 20  STA $2006
C - - - - - 0x01D52D 07:D51D: A9 E0     LDA #$E0
C - - - - - 0x01D52F 07:D51F: 8D 06 20  STA $2006
C - - - - - 0x01D532 07:D522: A9 01     LDA #$01
C - - - - - 0x01D534 07:D524: 8D 07 20  STA $2007
C - - - - - 0x01D537 07:D527: 8D 07 20  STA $2007
C - - - - - 0x01D53A 07:D52A: A9 23     LDA #$23
C - - - - - 0x01D53C 07:D52C: 8D 06 20  STA $2006
C - - - - - 0x01D53F 07:D52F: A9 C0     LDA #$C0
C - - - - - 0x01D541 07:D531: 8D 06 20  STA $2006
C - - - - - 0x01D544 07:D534: A2 00     LDX #$00
C - - - - - 0x01D546 07:D536: BD BE 85  LDA $85BE,X
C - - - - - 0x01D549 07:D539: 8D 07 20  STA $2007
C - - - - - 0x01D54C 07:D53C: E8        INX
C - - - - - 0x01D54D 07:D53D: E0 10     CPX #$10
C - - - - - 0x01D54F 07:D53F: D0 F5     BNE $D536
...
C - - - - - 0x01D557 07:D547: 8D 00 80  STA $8000
C - - - - - 0x01D55A 07:D54A: A9 03     LDA #$03
C - - - - - 0x01D55C 07:D54C: 8D 01 80  STA $8001
...
C - - - - - 0x01D574 07:D564: D0 06     BNE $D56C
C - - - - - 0x01D576 07:D566: A5 6C     LDA ram_006C
C - - - - - 0x01D578 07:D568: 29 A8     AND #$A8
C - - - - - 0x01D57A 07:D56A: F0 02     BEQ $D56E
C - - - - - 0x01D57C 07:D56C: 18        CLC
C - - - - - 0x01D57D 07:D56D: 60        RTS
C - - - - - 0x01D57E 07:D56E: A5 3A     LDA ram_003A
C - - - - - 0x01D580 07:D570: 30 FA     BMI $D56C
C - - - - - 0x01D582 07:D572: 20 42 D6  JSR $D642
C - - - - - 0x01D585 07:D575: 90 F5     BCC $D56C
C - - - - - 0x01D587 07:D577: A5 46     LDA ram_0046
C - - - - - 0x01D589 07:D579: C9 19     CMP #$19
C - - - - - 0x01D58B 07:D57B: F0 1E     BEQ $D59B
C - - - - - 0x01D58D 07:D57D: 20 57 DF  JSR $DF57
C - - - - - 0x01D590 07:D580: D0 19     BNE $D59B
C - - - - - 0x01D592 07:D582: A9 60     LDA #$60
C - - - - - 0x01D594 07:D584: 85 2E     STA ram_002E
C - - - - - 0x01D596 07:D586: A5 6D     LDA ram_006D
C - - - - - 0x01D598 07:D588: 30 11     BMI $D59B
C - - - - - 0x01D59A 07:D58A: 20 EE CD  JSR $CDEE
C - - - - - 0x01D59D 07:D58D: AD 07 02  LDA ram_0207
C - - - - - 0x01D5A0 07:D590: F0 09     BEQ $D59B
C - - - - - 0x01D5A2 07:D592: A5 3A     LDA ram_003A
C - - - - - 0x01D5A4 07:D594: 09 40     ORA #$40
C - - - - - 0x01D5A6 07:D596: 85 3A     STA ram_003A
C - - - - - 0x01D5A8 07:D598: 20 0D CD  JSR $CD0D
...
C - - - - - 0x01D5DD 07:D5CD: 20 D9 D5  JSR $D5D9
C - - - - - 0x01D5E0 07:D5D0: 90 06     BCC $D5D8
C - - - - - 0x01D5E2 07:D5D2: A9 21     LDA #$21
C - - - - - 0x01D5E4 07:D5D4: 20 20 C4  JSR $C420
...
C - - - - - 0x01D5EE 07:D5DE: B0 09     BCS $D5E9
C - - - - - 0x01D5F0 07:D5E0: 20 73 D0  JSR $D073
C - - - - - 0x01D5F3 07:D5E3: C5 B3     CMP ram_00B3
C - - - - - 0x01D5F5 07:D5E5: B0 1D     BCS $D604
C - - - - - 0x01D5F7 07:D5E7: 90 04     BCC $D5ED
C - - - - - 0x01D5F9 07:D5E9: C5 AF     CMP ram_00AF
C - - - - - 0x01D5FB 07:D5EB: B0 17     BCS $D604
...
C - - - - - 0x01D609 07:D5F9: B0 03     BCS $D5FE
C - - - - - 0x01D60B 07:D5FB: 20 73 D0  JSR $D073
C - - - - - 0x01D60E 07:D5FE: C5 12     CMP ram_0012
C - - - - - 0x01D610 07:D600: B0 02     BCS $D604
...
C - - - - - 0x01D646 07:D636: 20 D9 D5  JSR $D5D9
C - - - - - 0x01D649 07:D639: 90 06     BCC $D641
C - - - - - 0x01D64B 07:D63B: A9 19     LDA #$19
C - - - - - 0x01D64D 07:D63D: 20 20 C4  JSR $C420
...
C - - - - - 0x01D658 07:D648: F0 02     BEQ $D64C
...
C - - - - - 0x01D69C 07:D68C: 20 A2 D6  JSR $D6A2
C - - - - - 0x01D69F 07:D68F: B0 02     BCS $D693
...
C - - - - - 0x01D6B0 07:D6A0: 90 09     BCC $D6AB
...
C - - - - - 0x01D6C7 07:D6B7: D0 02     BNE $D6BB
C - - - - - 0x01D6C9 07:D6B9: 18        CLC
C - - - - - 0x01D6CA 07:D6BA: 60        RTS
C - - - - - 0x01D6CB 07:D6BB: 38        SEC
C - - - - - 0x01D6CC 07:D6BC: 60        RTS
C - - - - - 0x01D6CD 07:D6BD: 25 2C     AND ram_002C
C - - - - - 0x01D6CF 07:D6BF: D0 05     BNE $D6C6
C - - - - - 0x01D6D1 07:D6C1: 20 CA D6  JSR $D6CA
...
C - - - - - 0x01D6E7 07:D6D7: B0 01     BCS $D6DA
C - - - - - 0x01D6E9 07:D6D9: C8        INY
C - - - - - 0x01D6EA 07:D6DA: 60        RTS
C - - - - - 0x01D6EB 07:D6DB: 25 2C     AND ram_002C
C - - - - - 0x01D6ED 07:D6DD: D0 E7     BNE $D6C6
...
C - - - - - 0x01D6FC 07:D6EC: B0 01     BCS $D6EF
...
C - - - - - 0x01D70B 07:D6FB: 90 11     BCC $D70E
...
C - - - - - 0x01D72A 07:D71A: B0 F2     BCS $D70E
C D 2 - - - 0x01D72C 07:D71C: FE 38 03  INC ram_0338,X
C - - - - - 0x01D72F 07:D71F: D0 ED     BNE $D70E
...
C - - - - - 0x01D741 07:D731: F0 20     BEQ $D753
...
C - - - - - 0x01D74C 07:D73C: 90 02     BCC $D740
...
C - - - - - 0x01D75B 07:D74B: D0 05     BNE $D752
C - - - - - 0x01D75D 07:D74D: 20 9F D7  JSR $D79F
C - - - - - 0x01D760 07:D750: B0 2D     BCS $D77F
...
C - - - - - 0x01D76A 07:D75A: 20 DA D9  JSR $D9DA
C - - - - - 0x01D76D 07:D75D: 90 20     BCC $D77F
C - - - - - 0x01D76F 07:D75F: 20 9F D7  JSR $D79F
C - - - - - 0x01D772 07:D762: B0 1B     BCS $D77F
C D 2 - - - 0x01D774 07:D764: 48        PHA
C - - - - - 0x01D775 07:D765: C9 01     CMP #$01
C - - - - - 0x01D777 07:D767: D0 05     BNE $D76E
C - - - - - 0x01D779 07:D769: A9 36     LDA #$36
C - - - - - 0x01D77B 07:D76B: 20 20 C4  JSR $C420
...
C - - - - - 0x01D78C 07:D77C: 4C 33 CE  JMP $CE33
...
C - - - - - 0x01D797 07:D787: 20 17 DA  JSR $DA17
...
C - - - - - 0x01D7A2 07:D792: F0 05     BEQ $D799
C - - - - - 0x01D7A4 07:D794: CE 0A 03  DEC ram_030A
C - - - - - 0x01D7A7 07:D797: D0 05     BNE $D79E
...
C - - - - - 0x01D7BF 07:D7AF: F0 05     BEQ $D7B6
C - - - - - 0x01D7C1 07:D7B1: DE 2C 03  DEC ram_032C,X
C - - - - - 0x01D7C4 07:D7B4: D0 F2     BNE $D7A8
...
C - - - - - 0x01D7CF 07:D7BF: 20 37 D9  JSR $D937
C - - - - - 0x01D7D2 07:D7C2: A9 08     LDA #$08
C - - - - - 0x01D7D4 07:D7C4: 20 97 D3  JSR $D397
C - - - - - 0x01D7D7 07:D7C7: C9 01     CMP #$01
C - - - - - 0x01D7D9 07:D7C9: 60        RTS
C - - - - - 0x01D7DA 07:D7CA: 20 37 D9  JSR $D937
C - - - - - 0x01D7DD 07:D7CD: A9 F8     LDA #$F8
C - - - - - 0x01D7DF 07:D7CF: 20 AD D3  JSR $D3AD
C - - - - - 0x01D7E2 07:D7D2: C9 01     CMP #$01
C - - - - - 0x01D7E4 07:D7D4: 60        RTS
C - - - - - 0x01D7E5 07:D7D5: A5 5E     LDA ram_005E
C - - - - - 0x01D7E7 07:D7D7: C9 03     CMP #$03
C - - - - - 0x01D7E9 07:D7D9: D0 0A     BNE $D7E5
C - - - - - 0x01D7EB 07:D7DB: A9 E1     LDA #$E1
C - - - - - 0x01D7ED 07:D7DD: 20 39 D9  JSR $D939
C - - - - - 0x01D7F0 07:D7E0: 20 70 D3  JSR $D370
...
C - - - - - 0x01D806 07:D7F6: 20 3F D9  JSR $D93F
C - - - - - 0x01D809 07:D7F9: 4C E5 D2  JMP $D2E5
...
C - - - - - 0x01D817 07:D807: 90 11     BCC $D81A
...
C - - - - - 0x01D836 07:D826: B0 F2     BCS $D81A
C D 2 - - - 0x01D838 07:D828: FE 74 03  INC ram_0374,X
C - - - - - 0x01D83B 07:D82B: D0 ED     BNE $D81A
...
C - - - - - 0x01D84D 07:D83D: F0 20     BEQ $D85F
...
C - - - - - 0x01D858 07:D848: 90 02     BCC $D84C
...
C - - - - - 0x01D867 07:D857: D0 05     BNE $D85E
C - - - - - 0x01D869 07:D859: 20 93 D8  JSR $D893
C - - - - - 0x01D86C 07:D85C: B0 15     BCS $D873
...
C - - - - - 0x01D876 07:D866: 20 DA D9  JSR $D9DA
C - - - - - 0x01D879 07:D869: 90 08     BCC $D873
C - - - - - 0x01D87B 07:D86B: 20 93 D8  JSR $D893
C - - - - - 0x01D87E 07:D86E: B0 03     BCS $D873
C - - - - - 0x01D880 07:D870: 4C 64 D7  JMP $D764
...
C - - - - - 0x01D88B 07:D87B: 20 17 DA  JSR $DA17
...
C - - - - - 0x01D896 07:D886: F0 05     BEQ $D88D
C - - - - - 0x01D898 07:D888: CE 0B 03  DEC ram_030B
C - - - - - 0x01D89B 07:D88B: D0 05     BNE $D892
...
C - - - - - 0x01D8AC 07:D89C: 20 A8 D8  JSR $D8A8
...
C - - - - - 0x01D8F1 07:D8E1: 20 52 D9  JSR $D952
C - - - - - 0x01D8F4 07:D8E4: 4C E5 D2  JMP $D2E5
...
C - - - - - 0x01D926 07:D916: D0 ED     BNE $D905
...
C - - - - - 0x01D9AC 07:D99C: 4C 33 CE  JMP $CE33
...
C - - - - - 0x01D9EE 07:D9DE: 90 08     BCC $D9E8
C - - - - - 0x01D9F0 07:D9E0: C9 14     CMP #$14
C - - - - - 0x01D9F2 07:D9E2: 90 06     BCC $D9EA
C - - - - - 0x01D9F4 07:D9E4: C9 42     CMP #$42
C - - - - - 0x01D9F6 07:D9E6: B0 04     BCS $D9EC
...
C - - - - - 0x01DA00 07:D9F0: 20 3B EF  JSR $EF3B
...
C - - - - - 0x01DA14 07:DA04: 10 05     BPL $DA0B
C - - - - - 0x01DA16 07:DA06: 20 5D EF  JSR $EF5D
C - - - - - 0x01DA19 07:DA09: 18        CLC
C - - - - - 0x01DA1A 07:DA0A: 60        RTS
C - - - - - 0x01DA1B 07:DA0B: C5 D7     CMP ram_00D7
C - - - - - 0x01DA1D 07:DA0D: F0 03     BEQ $DA12
C - - - - - 0x01DA1F 07:DA0F: C8        INY
C - - - - - 0x01DA20 07:DA10: D0 F0     BNE $DA02
C - - - - - 0x01DA22 07:DA12: 20 5D EF  JSR $EF5D
C - - - - - 0x01DA25 07:DA15: 38        SEC
C - - - - - 0x01DA26 07:DA16: 60        RTS
C - - - - - 0x01DA27 07:DA17: 29 20     AND #$20
C - - - - - 0x01DA29 07:DA19: F0 CD     BEQ $D9E8
C - - - - - 0x01DA2B 07:DA1B: 20 3B EF  JSR $EF3B
C - - - - - 0x01DA2E 07:DA1E: B9 E0 95  LDA $95E0,Y
C - - - - - 0x01DA31 07:DA21: A8        TAY
C - - - - - 0x01DA32 07:DA22: D0 01     BNE $DA25
C - - - - - 0x01DA34 07:DA24: 60        RTS
C - - - - - 0x01DA35 07:DA25: 4C 47 C9  JMP $C947
C - - - - - 0x01DA38 07:DA28: D9 C0 DA  CMP $DAC0,Y
C - - - - - 0x01DA3B 07:DA2B: B0 03     BCS $DA30
C - - - - - 0x01DA3D 07:DA2D: C8        INY
C - - - - - 0x01DA3E 07:DA2E: D0 F8     BNE $DA28
C - - - - - 0x01DA40 07:DA30: B9 C5 DA  LDA $DAC5,Y
...
C - - - - - 0x01DA4D 07:DA3D: F0 6C     BEQ $DAAB
C - - - - - 0x01DA4F 07:DA3F: DE C8 03  DEC ram_03C8,X
C - - - - - 0x01DA52 07:DA42: D0 1A     BNE $DA5E
C - - - - - 0x01DA54 07:DA44: AD 31 06  LDA ram_0631
C - - - - - 0x01DA57 07:DA47: F0 05     BEQ $DA4E
...
C - - - - - 0x01DA5E 07:DA4E: 20 CD F9  JSR $F9CD
C - - - - - 0x01DA61 07:DA51: 20 1F D9  JSR $D91F
C - - - - - 0x01DA64 07:DA54: A9 10     LDA #$10
C - - - - - 0x01DA66 07:DA56: 9D C8 03  STA ram_03C8,X
C - - - - - 0x01DA69 07:DA59: A9 0F     LDA #$0F
C - - - - - 0x01DA6B 07:DA5B: 20 20 C4  JSR $C420
...
C - - - - - 0x01DA7A 07:DA6A: 20 AC D6  JSR $D6AC
C - - - - - 0x01DA7D 07:DA6D: 90 03     BCC $DA72
...
C - - - - - 0x01DA92 07:DA82: 4C 33 CE  JMP $CE33
C - - - - - 0x01DA95 07:DA85: 20 9F DA  JSR $DA9F
C - - - - - 0x01DA98 07:DA88: A9 00     LDA #$00
C - - - - - 0x01DA9A 07:DA8A: 9D 9E 03  STA ram_039E,X
C - - - - - 0x01DA9D 07:DA8D: 4C F3 CD  JMP $CDF3
C - - - - - 0x01DAA0 07:DA90: 29 04     AND #$04
C - - - - - 0x01DAA2 07:DA92: F0 0B     BEQ $DA9F
...
C - - - - - 0x01DAAC 07:DA9C: 10 FA     BPL $DA98
...
C - - - - - 0x01DB04 07:DAF4: 20 A6 E2  JSR $E2A6
...
C - - - - - 0x01DB0F 07:DAFF: D0 0C     BNE $DB0D
C - - - - - 0x01DB11 07:DB01: 20 0E E3  JSR $E30E
C - - - - - 0x01DB14 07:DB04: A5 6D     LDA ram_006D
C - - - - - 0x01DB16 07:DB06: 29 20     AND #$20
C - - - - - 0x01DB18 07:DB08: F0 0A     BEQ $DB14
C - - - - - 0x01DB1A 07:DB0A: 4C 10 E8  JMP $E810
C - - - - - 0x01DB1D 07:DB0D: C9 19     CMP #$19
C - - - - - 0x01DB1F 07:DB0F: D0 03     BNE $DB14
C - - - - - 0x01DB21 07:DB11: 4C DA E8  JMP $E8DA
C - - - - - 0x01DB24 07:DB14: 24 6D     BIT ram_006D
C - - - - - 0x01DB26 07:DB16: 10 03     BPL $DB1B
C - - - - - 0x01DB28 07:DB18: 4C BB E3  JMP $E3BB
C - - - - - 0x01DB2B 07:DB1B: 50 03     BVC $DB20
C - - - - - 0x01DB2D 07:DB1D: 4C 47 E8  JMP $E847
C - - - - - 0x01DB30 07:DB20: AD 14 02  LDA ram_0214
C - - - - - 0x01DB33 07:DB23: C9 43     CMP #$43
C - - - - - 0x01DB35 07:DB25: D0 03     BNE $DB2A
C - - - - - 0x01DB37 07:DB27: 4C 24 E6  JMP $E624
C - - - - - 0x01DB3A 07:DB2A: A5 6C     LDA ram_006C
C - - - - - 0x01DB3C 07:DB2C: 29 7F     AND #$7F
C - - - - - 0x01DB3E 07:DB2E: 20 5F D0  JSR $D05F
C - - - - - 0x01DB41 07:DB31: 20 C1 D0  JSR $D0C1
...
C - - - - - 0x01DB56 07:DB46: 20 AB E5  JSR $E5AB
C - - - - - 0x01DB59 07:DB49: D0 07     BNE $DB52
C D 2 - - - 0x01DB5B 07:DB4B: A9 1C     LDA #$1C
C - - - - - 0x01DB5D 07:DB4D: A0 02     LDY #$02
C - - - - - 0x01DB5F 07:DB4F: 4C 9D DD  JMP $DD9D
C - - - - - 0x01DB62 07:DB52: AD 14 02  LDA ram_0214
C - - - - - 0x01DB65 07:DB55: C9 42     CMP #$42
C - - - - - 0x01DB67 07:DB57: D0 07     BNE $DB60
C - - - - - 0x01DB69 07:DB59: A5 73     LDA ram_0073
C - - - - - 0x01DB6B 07:DB5B: F0 03     BEQ $DB60
C - - - - - 0x01DB6D 07:DB5D: 4C FB B1  JMP $B1FB
C - - - - - 0x01DB70 07:DB60: A9 01     LDA #$01
C - - - - - 0x01DB72 07:DB62: 20 79 D0  JSR $D079
C - - - - - 0x01DB75 07:DB65: F0 03     BEQ $DB6A
C - - - - - 0x01DB77 07:DB67: 4C 87 DD  JMP $DD87
C - - - - - 0x01DB7A 07:DB6A: AD 14 02  LDA ram_0214
C - - - - - 0x01DB7D 07:DB6D: C9 42     CMP #$42
C - - - - - 0x01DB7F 07:DB6F: F0 2C     BEQ $DB9D
C - - - - - 0x01DB81 07:DB71: A9 10     LDA #$10
C - - - - - 0x01DB83 07:DB73: 20 79 D0  JSR $D079
C - - - - - 0x01DB86 07:DB76: F0 1B     BEQ $DB93
C - - - - - 0x01DB88 07:DB78: 20 28 FC  JSR $FC28
C - - - - - 0x01DB8B 07:DB7B: B0 16     BCS $DB93
C - - - - - 0x01DB8D 07:DB7D: 20 1A F9  JSR $F91A
C - - - - - 0x01DB90 07:DB80: 90 11     BCC $DB93
...
C - - - - - 0x01DBA0 07:DB90: 4C 8D DF  JMP $DF8D
...
C - - - - - 0x01DBAB 07:DB9B: D0 17     BNE $DBB4
...
C - - - - - 0x01DBE3 07:DBD3: A5 64     LDA ram_0064
...
C - - - - - 0x01DC48 07:DC38: 4C 1A DC  JMP $DC1A
C - - - - - 0x01DC4B 07:DC3B: A9 04     LDA #$04
C - - - - - 0x01DC4D 07:DC3D: 24 42     BIT ram_0042
C - - - - - 0x01DC4F 07:DC3F: 50 0A     BVC $DC4B
C - - - - - 0x01DC51 07:DC41: A9 06     LDA #$06
C - - - - - 0x01DC53 07:DC43: A6 2F     LDX ram_002F
C - - - - - 0x01DC55 07:DC45: E0 04     CPX #$04
C - - - - - 0x01DC57 07:DC47: B0 02     BCS $DC4B
C - - - - - 0x01DC59 07:DC49: A9 08     LDA #$08
C - - - - - 0x01DC5B 07:DC4B: 18        CLC
C - - - - - 0x01DC5C 07:DC4C: 69 52     ADC #$52
C - - - - - 0x01DC5E 07:DC4E: AA        TAX
C - - - - - 0x01DC5F 07:DC4F: 4C 5A CE  JMP $CE5A
C D 2 - - - 0x01DC62 07:DC52: 30 1E     BMI $DC72
C - - - - - 0x01DC64 07:DC54: A5 6C     LDA ram_006C
C - - - - - 0x01DC66 07:DC56: 6A        ROR
C - - - - - 0x01DC67 07:DC57: B0 05     BCS $DC5E
C - - - - - 0x01DC69 07:DC59: E6 6C     INC ram_006C
C - - - - - 0x01DC6B 07:DC5B: 20 F1 DC  JSR $DCF1
C - - - - - 0x01DC6E 07:DC5E: 20 B1 DC  JSR $DCB1
C D 2 - - - 0x01DC71 07:DC61: 20 82 DC  JSR $DC82
C - - - - - 0x01DC74 07:DC64: 20 96 DC  JSR $DC96
C D 2 - - - 0x01DC77 07:DC67: A4 70     LDY ram_0070
C - - - - - 0x01DC79 07:DC69: BE 6F DC  LDX $DC6F,Y
C - - - - - 0x01DC7C 07:DC6C: 4C C2 DB  JMP $DBC2
...
C - - - - - 0x01DC85 07:DC75: 90 05     BCC $DC7C
C - - - - - 0x01DC87 07:DC77: C6 6C     DEC ram_006C
C D 2 - - - 0x01DC89 07:DC79: 20 F1 DC  JSR $DCF1
C - - - - - 0x01DC8C 07:DC7C: 20 E5 DC  JSR $DCE5
C - - - - - 0x01DC8F 07:DC7F: 4C 61 DC  JMP $DC61
C - - - - - 0x01DC92 07:DC82: A5 2C     LDA ram_002C
C - - - - - 0x01DC94 07:DC84: 29 03     AND #$03
C - - - - - 0x01DC96 07:DC86: D0 0C     BNE $DC94
C - - - - - 0x01DC98 07:DC88: A2 0C     LDX #$0C
C - - - - - 0x01DC9A 07:DC8A: E6 71     INC ram_0071
C D 2 - - - 0x01DC9C 07:DC8C: E4 71     CPX ram_0071
C - - - - - 0x01DC9E 07:DC8E: B0 02     BCS $DC92
...
C - - - - - 0x01DCBE 07:DCAE: 85 64     STA ram_0064
C - - - - - 0x01DCC0 07:DCB0: 60        RTS
C - - - - - 0x01DCC1 07:DCB1: 20 34 DD  JSR $DD34
C - - - - - 0x01DCC4 07:DCB4: F0 3B     BEQ $DCF1
C - - - - - 0x01DCC6 07:DCB6: A9 80     LDA #$80
C - - - - - 0x01DCC8 07:DCB8: D0 32     BNE $DCEC
...
C - - - - - 0x01DCD4 07:DCC4: 90 F4     BCC $DCBA
C - - - - - 0x01DCD6 07:DCC6: 20 D7 DC  JSR $DCD7
C - - - - - 0x01DCD9 07:DCC9: 20 A9 DC  JSR $DCA9
C - - - - - 0x01DCDC 07:DCCC: C9 70     CMP #$70
C - - - - - 0x01DCDE 07:DCCE: B0 EA     BCS $DCBA
C - - - - - 0x01DCE0 07:DCD0: A9 40     LDA #$40
C - - - - - 0x01DCE2 07:DCD2: 85 48     STA ram_0048
C - - - - - 0x01DCE4 07:DCD4: 4C 95 D1  JMP $D195
...
C - - - - - 0x01DCF5 07:DCE5: 20 19 DD  JSR $DD19
C - - - - - 0x01DCF8 07:DCE8: F0 07     BEQ $DCF1
C - - - - - 0x01DCFA 07:DCEA: A9 00     LDA #$00
C - - - - - 0x01DCFC 07:DCEC: 85 42     STA ram_0042
C - - - - - 0x01DCFE 07:DCEE: 4C 34 E5  JMP $E534
C - - - - - 0x01DD01 07:DCF1: A9 04     LDA #$04
C - - - - - 0x01DD03 07:DCF3: D0 02     BNE $DCF7
...
C - - - - - 0x01DD13 07:DD03: B0 B5     BCS $DCBA
C - - - - - 0x01DD15 07:DD05: E6 66     INC ram_0066
C - - - - - 0x01DD17 07:DD07: D0 02     BNE $DD0B
C - - - - - 0x01DD19 07:DD09: E6 68     INC ram_0068
C - - - - - 0x01DD1B 07:DD0B: 20 A9 DC  JSR $DCA9
C - - - - - 0x01DD1E 07:DD0E: C9 90     CMP #$90
C - - - - - 0x01DD20 07:DD10: 90 A8     BCC $DCBA
C - - - - - 0x01DD22 07:DD12: A9 80     LDA #$80
C - - - - - 0x01DD24 07:DD14: 85 48     STA ram_0048
C - - - - - 0x01DD26 07:DD16: 4C 95 D1  JMP $D195
C - - - - - 0x01DD29 07:DD19: A5 5E     LDA ram_005E
C - - - - - 0x01DD2B 07:DD1B: C9 03     CMP #$03
C - - - - - 0x01DD2D 07:DD1D: D0 0A     BNE $DD29
C - - - - - 0x01DD2F 07:DD1F: A9 E1     LDA #$E1
C - - - - - 0x01DD31 07:DD21: 20 6F D9  JSR $D96F
C - - - - - 0x01DD34 07:DD24: 20 2C DD  JSR $DD2C
C - - - - - 0x01DD37 07:DD27: F0 0A     BEQ $DD33
C - - - - - 0x01DD39 07:DD29: 20 6D D9  JSR $D96D
C - - - - - 0x01DD3C 07:DD2C: A9 08     LDA #$08
C - - - - - 0x01DD3E 07:DD2E: 20 97 D3  JSR $D397
C - - - - - 0x01DD41 07:DD31: C9 01     CMP #$01
C - - - - - 0x01DD43 07:DD33: 60        RTS
C - - - - - 0x01DD44 07:DD34: A5 5E     LDA ram_005E
C - - - - - 0x01DD46 07:DD36: C9 03     CMP #$03
C - - - - - 0x01DD48 07:DD38: D0 0A     BNE $DD44
C - - - - - 0x01DD4A 07:DD3A: A9 E1     LDA #$E1
C - - - - - 0x01DD4C 07:DD3C: 20 6F D9  JSR $D96F
C - - - - - 0x01DD4F 07:DD3F: 20 47 DD  JSR $DD47
C - - - - - 0x01DD52 07:DD42: F0 EF     BEQ $DD33
C - - - - - 0x01DD54 07:DD44: 20 6D D9  JSR $D96D
C - - - - - 0x01DD57 07:DD47: A9 F8     LDA #$F8
C - - - - - 0x01DD59 07:DD49: 20 AD D3  JSR $D3AD
C - - - - - 0x01DD5C 07:DD4C: C9 01     CMP #$01
C - - - - - 0x01DD5E 07:DD4E: 60        RTS
C - - - - - 0x01DD5F 07:DD4F: A5 5E     LDA ram_005E
C - - - - - 0x01DD61 07:DD51: C9 03     CMP #$03
C - - - - - 0x01DD63 07:DD53: D0 26     BNE $DD7B
C - - - - - 0x01DD65 07:DD55: A9 E0     LDA #$E0
C - - - - - 0x01DD67 07:DD57: 4C 7E DD  JMP $DD7E
C - - - - - 0x01DD6A 07:DD5A: A5 5E     LDA ram_005E
C - - - - - 0x01DD6C 07:DD5C: C9 03     CMP #$03
C - - - - - 0x01DD6E 07:DD5E: D0 1B     BNE $DD7B
C - - - - - 0x01DD70 07:DD60: A9 E1     LDA #$E1
C - - - - - 0x01DD72 07:DD62: 20 7E DD  JSR $DD7E
C - - - - - 0x01DD75 07:DD65: A9 01     LDA #$01
C - - - - - 0x01DD77 07:DD67: 4C 7E DD  JMP $DD7E
...
C D 2 - - - 0x01DD8E 07:DD7E: 20 6F D9  JSR $D96F
C - - - - - 0x01DD91 07:DD81: 20 70 D3  JSR $D370
...
C - - - - - 0x01DD9D 07:DD8D: F0 0B     BEQ $DD9A
C - - - - - 0x01DD9F 07:DD8F: C8        INY
C - - - - - 0x01DDA0 07:DD90: 29 E0     AND #$E0
C - - - - - 0x01DDA2 07:DD92: F0 06     BEQ $DD9A
C - - - - - 0x01DDA4 07:DD94: C8        INY
C - - - - - 0x01DDA5 07:DD95: 29 C0     AND #$C0
C - - - - - 0x01DDA7 07:DD97: F0 01     BEQ $DD9A
C - - - - - 0x01DDA9 07:DD99: C8        INY
C - - - - - 0x01DDAA 07:DD9A: B9 58 E3  LDA $E358,Y
...
C - - - - - 0x01DDBB 07:DDAB: B0 59     BCS $DE06
C - - - - - 0x01DDBD 07:DDAD: A5 6C     LDA ram_006C
C - - - - - 0x01DDBF 07:DDAF: 29 08     AND #$08
C - - - - - 0x01DDC1 07:DDB1: D0 23     BNE $DDD6
C - - - - - 0x01DDC3 07:DDB3: 20 57 DF  JSR $DF57
C - - - - - 0x01DDC6 07:DDB6: F0 04     BEQ $DDBC
...
C - - - - - 0x01DDD0 07:DDC0: 90 0E     BCC $DDD0
C - - - - - 0x01DDD2 07:DDC2: C9 15     CMP #$15
C - - - - - 0x01DDD4 07:DDC4: B0 0A     BCS $DDD0
C - - - - - 0x01DDD6 07:DDC6: A5 1C     LDA ram_001C
C - - - - - 0x01DDD8 07:DDC8: 29 01     AND #$01
C - - - - - 0x01DDDA 07:DDCA: D0 04     BNE $DDD0
...
C - - - - - 0x01DDE4 07:DDD4: D0 30     BNE $DE06
C - - - - - 0x01DDE6 07:DDD6: A5 6C     LDA ram_006C
C - - - - - 0x01DDE8 07:DDD8: 6A        ROR
C - - - - - 0x01DDE9 07:DDD9: 90 17     BCC $DDF2
C - - - - - 0x01DDEB 07:DDDB: 29 04     AND #$04
C - - - - - 0x01DDED 07:DDDD: D0 17     BNE $DDF6
C - - - - - 0x01DDEF 07:DDDF: 20 B1 DC  JSR $DCB1
C - - - - - 0x01DDF2 07:DDE2: A5 6C     LDA ram_006C
C - - - - - 0x01DDF4 07:DDE4: 29 08     AND #$08
C - - - - - 0x01DDF6 07:DDE6: D0 1E     BNE $DE06
C - - - - - 0x01DDF8 07:DDE8: 24 1C     BIT ram_001C
C - - - - - 0x01DDFA 07:DDEA: 10 03     BPL $DDEF
C - - - - - 0x01DDFC 07:DDEC: 20 80 DF  JSR $DF80
C - - - - - 0x01DDFF 07:DDEF: 4C 06 DE  JMP $DE06
C - - - - - 0x01DE02 07:DDF2: 29 04     AND #$04
C - - - - - 0x01DE04 07:DDF4: D0 E9     BNE $DDDF
C - - - - - 0x01DE06 07:DDF6: 20 E5 DC  JSR $DCE5
C - - - - - 0x01DE09 07:DDF9: A5 6C     LDA ram_006C
C - - - - - 0x01DE0B 07:DDFB: 29 08     AND #$08
C - - - - - 0x01DE0D 07:DDFD: D0 07     BNE $DE06
C - - - - - 0x01DE0F 07:DDFF: 24 1C     BIT ram_001C
C - - - - - 0x01DE11 07:DE01: 50 03     BVC $DE06
C - - - - - 0x01DE13 07:DE03: 20 80 DF  JSR $DF80
C D 2 - - - 0x01DE16 07:DE06: A6 6F     LDX ram_006F
C - - - - - 0x01DE18 07:DE08: BD 5D E3  LDA $E35D,X
C - - - - - 0x01DE1B 07:DE0B: 18        CLC
C - - - - - 0x01DE1C 07:DE0C: 65 6A     ADC ram_006A
C - - - - - 0x01DE1E 07:DE0E: C9 DF     CMP #$DF
C - - - - - 0x01DE20 07:DE10: 90 09     BCC $DE1B
C - - - - - 0x01DE22 07:DE12: A0 DF     LDY #$DF
C - - - - - 0x01DE24 07:DE14: C9 F8     CMP #$F8
C - - - - - 0x01DE26 07:DE16: 90 02     BCC $DE1A
...
C - - - - - 0x01DE36 07:DE26: F0 08     BEQ $DE30
C - - - - - 0x01DE38 07:DE28: A5 6E     LDA ram_006E
C - - - - - 0x01DE3A 07:DE2A: C9 02     CMP #$02
C - - - - - 0x01DE3C 07:DE2C: D0 02     BNE $DE30
C - - - - - 0x01DE3E 07:DE2E: A2 10     LDX #$10
C - - - - - 0x01DE40 07:DE30: A5 6F     LDA ram_006F
C - - - - - 0x01DE42 07:DE32: C9 18     CMP #$18
C - - - - - 0x01DE44 07:DE34: B0 03     BCS $DE39
C - - - - - 0x01DE46 07:DE36: 4C D2 DE  JMP $DED2
C - - - - - 0x01DE49 07:DE39: A5 6A     LDA ram_006A
C - - - - - 0x01DE4B 07:DE3B: 85 00     STA ram_0000
C - - - - - 0x01DE4D 07:DE3D: C9 DF     CMP #$DF
C - - - - - 0x01DE4F 07:DE3F: 90 03     BCC $DE44
C - - - - - 0x01DE51 07:DE41: 4C E6 DE  JMP $DEE6
C - - - - - 0x01DE54 07:DE44: E6 00     INC ram_0000
C - - - - - 0x01DE56 07:DE46: 20 6A D3  JSR $D36A
C - - - - - 0x01DE59 07:DE49: F0 3B     BEQ $DE86
C - - - - - 0x01DE5B 07:DE4B: C9 02     CMP #$02
C - - - - - 0x01DE5D 07:DE4D: F0 07     BEQ $DE56
C - - - - - 0x01DE5F 07:DE4F: 20 7C DD  JSR $DD7C
C - - - - - 0x01DE62 07:DE52: F0 32     BEQ $DE86
C - - - - - 0x01DE64 07:DE54: D0 11     BNE $DE67
C - - - - - 0x01DE66 07:DE56: 20 7C DD  JSR $DD7C
C - - - - - 0x01DE69 07:DE59: F0 2B     BEQ $DE86
C - - - - - 0x01DE6B 07:DE5B: A5 6E     LDA ram_006E
C - - - - - 0x01DE6D 07:DE5D: C9 02     CMP #$02
C - - - - - 0x01DE6F 07:DE5F: D0 06     BNE $DE67
C - - - - - 0x01DE71 07:DE61: A5 1C     LDA ram_001C
C - - - - - 0x01DE73 07:DE63: 29 20     AND #$20
C - - - - - 0x01DE75 07:DE65: D0 1F     BNE $DE86
C - - - - - 0x01DE77 07:DE67: A5 6D     LDA ram_006D
C - - - - - 0x01DE79 07:DE69: 29 01     AND #$01
C - - - - - 0x01DE7B 07:DE6B: D0 03     BNE $DE70
C - - - - - 0x01DE7D 07:DE6D: 20 32 E3  JSR $E332
C - - - - - 0x01DE80 07:DE70: A5 6C     LDA ram_006C
C - - - - - 0x01DE82 07:DE72: 29 08     AND #$08
C - - - - - 0x01DE84 07:DE74: F0 0D     BEQ $DE83
...
C - - - - - 0x01DED3 07:DEC3: 4C CF DE  JMP $DECF
C - - - - - 0x01DED6 07:DEC6: A5 2E     LDA ram_002E
C - - - - - 0x01DED8 07:DEC8: D0 03     BNE $DECD
C - - - - - 0x01DEDA 07:DECA: 20 31 DF  JSR $DF31
C - - - - - 0x01DEDD 07:DECD: A2 20     LDX #$20
C D 2 - - - 0x01DEDF 07:DECF: 4C C2 DB  JMP $DBC2
C D 2 - - - 0x01DEE2 07:DED2: A5 5E     LDA ram_005E
C - - - - - 0x01DEE4 07:DED4: C9 03     CMP #$03
C - - - - - 0x01DEE6 07:DED6: D0 0B     BNE $DEE3
C - - - - - 0x01DEE8 07:DED8: A9 E0     LDA #$E0
C - - - - - 0x01DEEA 07:DEDA: 20 7E DD  JSR $DD7E
C - - - - - 0x01DEED 07:DEDD: D0 04     BNE $DEE3
C - - - - - 0x01DEEF 07:DEDF: A9 18     LDA #$18
C - - - - - 0x01DEF1 07:DEE1: 85 6F     STA ram_006F
C - - - - - 0x01DEF3 07:DEE3: 4C 86 DE  JMP $DE86
C D 2 - - - 0x01DEF6 07:DEE6: A5 68     LDA ram_0068
C - - - - - 0x01DEF8 07:DEE8: 85 D7     STA ram_00D7
C - - - - - 0x01DEFA 07:DEEA: 20 DA D9  JSR $D9DA
C - - - - - 0x01DEFD 07:DEED: 90 2D     BCC $DF1C
C - - - - - 0x01DEFF 07:DEEF: 20 57 DF  JSR $DF57
C - - - - - 0x01DF02 07:DEF2: D0 0A     BNE $DEFE
C - - - - - 0x01DF04 07:DEF4: AD 05 02  LDA ram_0205
C - - - - - 0x01DF07 07:DEF7: D0 05     BNE $DEFE
C - - - - - 0x01DF09 07:DEF9: AD 06 02  LDA ram_0206
C - - - - - 0x01DF0C 07:DEFC: D0 28     BNE $DF26
C - - - - - 0x01DF0E 07:DEFE: 20 3E DF  JSR $DF3E
C - - - - - 0x01DF11 07:DF01: 90 16     BCC $DF19
C - - - - - 0x01DF13 07:DF03: 20 57 DF  JSR $DF57
C - - - - - 0x01DF16 07:DF06: D0 29     BNE $DF31
C - - - - - 0x01DF18 07:DF08: AD 05 02  LDA ram_0205
C - - - - - 0x01DF1B 07:DF0B: F0 24     BEQ $DF31
C - - - - - 0x01DF1D 07:DF0D: A2 05     LDX #$05
C - - - - - 0x01DF1F 07:DF0F: 20 13 CD  JSR $CD13
C - - - - - 0x01DF22 07:DF12: 20 DA FB  JSR $FBDA
C - - - - - 0x01DF25 07:DF15: A2 C1     LDX #$C1
C - - - - - 0x01DF27 07:DF17: 86 39     STX ram_0039
C - - - - - 0x01DF29 07:DF19: 4C 64 D7  JMP $D764
C - - - - - 0x01DF2C 07:DF1C: 20 57 DF  JSR $DF57
C - - - - - 0x01DF2F 07:DF1F: D0 10     BNE $DF31
C - - - - - 0x01DF31 07:DF21: AD 06 02  LDA ram_0206
C - - - - - 0x01DF34 07:DF24: F0 0B     BEQ $DF31
C - - - - - 0x01DF36 07:DF26: 20 F3 CD  JSR $CDF3
C - - - - - 0x01DF39 07:DF29: 20 EF CC  JSR $CCEF
C - - - - - 0x01DF3C 07:DF2C: A2 00     LDX #$00
C - - - - - 0x01DF3E 07:DF2E: 4C C2 DB  JMP $DBC2
C D 2 - - - 0x01DF41 07:DF31: A2 80     LDX #$80
C - - - - - 0x01DF43 07:DF33: A5 3A     LDA ram_003A
C - - - - - 0x01DF45 07:DF35: 29 20     AND #$20
C - - - - - 0x01DF47 07:DF37: D0 02     BNE $DF3B
...
C - - - - - 0x01DF52 07:DF42: A5 64     LDA ram_0064
...
C - - - - - 0x01DF5C 07:DF4C: D0 06     BNE $DF54
...
C - - - - - 0x01DF77 07:DF67: F0 23     BEQ $DF8C
C - - - - - 0x01DF79 07:DF69: 30 06     BMI $DF71
C - - - - - 0x01DF7B 07:DF6B: A5 6C     LDA ram_006C
C - - - - - 0x01DF7D 07:DF6D: 09 01     ORA #$01
C - - - - - 0x01DF7F 07:DF6F: D0 04     BNE $DF75
...
C - - - - - 0x01DF8A 07:DF7A: D0 06     BNE $DF82
...
C - - - - - 0x01DF92 07:DF82: 25 2C     AND ram_002C
C - - - - - 0x01DF94 07:DF84: D0 06     BNE $DF8C
C - - - - - 0x01DF96 07:DF86: C6 71     DEC ram_0071
C - - - - - 0x01DF98 07:DF88: 10 02     BPL $DF8C
...
C - - - - - 0x01DFC0 07:DFB0: 20 2F FA  JSR $FA2F
C - - - - - 0x01DFC3 07:DFB3: A9 02     LDA #$02
C - - - - - 0x01DFC5 07:DFB5: D0 05     BNE $DFBC
C - - - - - 0x01DFC7 07:DFB7: 20 2F FA  JSR $FA2F
...
C - - - - - 0x01DFD8 07:DFC8: 4C 05 E0  JMP $E005
C - - - - - 0x01DFDB 07:DFCB: 20 27 FA  JSR $FA27
C - - - - - 0x01DFDE 07:DFCE: 4C 0D E0  JMP $E00D
C - - - - - 0x01DFE1 07:DFD1: 20 27 FA  JSR $FA27
...
C - - - - - 0x01E0D1 07:E0C1: 90 02     BCC $E0C5
C - - - - - 0x01E0D3 07:E0C3: 09 10     ORA #$10
C - - - - - 0x01E0D5 07:E0C5: 95 8F     STA ram_008F,X
C - - - - - 0x01E0D7 07:E0C7: 29 10     AND #$10
C - - - - - 0x01E0D9 07:E0C9: D0 1A     BNE $E0E5
C - - - - - 0x01E0DB 07:E0CB: A5 46     LDA ram_0046
C - - - - - 0x01E0DD 07:E0CD: C9 19     CMP #$19
C - - - - - 0x01E0DF 07:E0CF: D0 03     BNE $E0D4
C - - - - - 0x01E0E1 07:E0D1: 4C 0A EC  JMP $EC0A
C - - - - - 0x01E0E4 07:E0D4: 20 F6 E0  JSR $E0F6
...
C - - - - - 0x01E0F5 07:E0E5: 20 F6 E0  JSR $E0F6
...
C - - - - - 0x01E146 07:E136: 20 3E E1  JSR $E13E
C - - - - - 0x01E149 07:E139: C6 10     DEC ram_0010
C - - - - - 0x01E14B 07:E13B: 10 F7     BPL $E134
C - - - - - 0x01E14D 07:E13D: 60        RTS
C - - - - - 0x01E14E 07:E13E: B5 8F     LDA ram_008F,X
C - - - - - 0x01E150 07:E140: 10 FB     BPL $E13D
C - - - - - 0x01E152 07:E142: 29 10     AND #$10
C - - - - - 0x01E154 07:E144: F0 06     BEQ $E14C
C - - - - - 0x01E156 07:E146: 20 7A E1  JSR $E17A
C - - - - - 0x01E159 07:E149: 4C 4F E1  JMP $E14F
C - - - - - 0x01E15C 07:E14C: 20 8B E1  JSR $E18B
C D 3 - - - 0x01E15F 07:E14F: 20 A8 E1  JSR $E1A8
C - - - - - 0x01E162 07:E152: B0 E9     BCS $E13D
C - - - - - 0x01E164 07:E154: A4 0A     LDY ram_000A
C - - - - - 0x01E166 07:E156: B5 8F     LDA ram_008F,X
C - - - - - 0x01E168 07:E158: 29 10     AND #$10
C - - - - - 0x01E16A 07:E15A: F0 02     BEQ $E15E
C - - - - - 0x01E16C 07:E15C: C8        INY
C - - - - - 0x01E16D 07:E15D: C8        INY
C - - - - - 0x01E16E 07:E15E: C0 18     CPY #$18
C - - - - - 0x01E170 07:E160: 90 03     BCC $E165
C - - - - - 0x01E172 07:E162: 8A        TXA
C - - - - - 0x01E173 07:E163: D0 D8     BNE $E13D
...
C - - - - - 0x01E187 07:E177: 4C 33 CE  JMP $CE33
C - - - - - 0x01E18A 07:E17A: 20 9C E1  JSR $E19C
...
C - - - - - 0x01E19B 07:E18B: 20 9C E1  JSR $E19C
...
C - - - - - 0x01E1B2 07:E1A2: F0 01     BEQ $E1A5
...
C - - - - - 0x01E1BE 07:E1AE: F0 0D     BEQ $E1BD
...
C - - - - - 0x01E1C9 07:E1B9: F0 02     BEQ $E1BD
...
C - - - - - 0x01E1D3 07:E1C3: F0 11     BEQ $E1D6
C - - - - - 0x01E1D5 07:E1C5: C0 00     CPY #$00
C - - - - - 0x01E1D7 07:E1C7: D0 3E     BNE $E207
...
C - - - - - 0x01E209 07:E1F9: 20 E5 D2  JSR $D2E5
C - - - - - 0x01E20C 07:E1FC: C9 01     CMP #$01
C - - - - - 0x01E20E 07:E1FE: D0 07     BNE $E207
C - - - - - 0x01E210 07:E200: 20 14 E2  JSR $E214
...
C - - - - - 0x01E21F 07:E20F: 20 AC D6  JSR $D6AC
C - - - - - 0x01E222 07:E212: 90 06     BCC $E21A
...
C - - - - - 0x01E282 07:E272: 90 02     BCC $E276
...
C - - - - - 0x01E28F 07:E27F: 4C 5A CE  JMP $CE5A
...
C - - - - - 0x01E29A 07:E28A: 4C 5A CE  JMP $CE5A
C - - - - - 0x01E29D 07:E28D: A5 78     LDA ram_0078
C - - - - - 0x01E29F 07:E28F: F0 66     BEQ $E2F7
C - - - - - 0x01E2A1 07:E291: A5 2C     LDA ram_002C
C - - - - - 0x01E2A3 07:E293: 6A        ROR
C - - - - - 0x01E2A4 07:E294: 90 02     BCC $E298
...
C - - - - - 0x01E2B9 07:E2A9: 30 4C     BMI $E2F7
...
C - - - - - 0x01E311 07:E301: BD A6 E3  LDA $E3A6,X
...
C - - - - - 0x01E31B 07:E30B: D0 F4     BNE $E301
...
C - - - - - 0x01E348 07:E338: F0 04     BEQ $E33E
C - - - - - 0x01E34A 07:E33A: C6 6A     DEC ram_006A
C - - - - - 0x01E34C 07:E33C: D0 F4     BNE $E332
C - - - - - 0x01E34E 07:E33E: 20 64 D0  JSR $D064
C - - - - - 0x01E351 07:E341: 29 0F     AND #$0F
C - - - - - 0x01E353 07:E343: A8        TAY
C - - - - - 0x01E354 07:E344: B9 48 E3  LDA $E348,Y
...
C - - - - - 0x01E3D3 07:E3C3: F0 03     BEQ $E3C8
C - - - - - 0x01E3D5 07:E3C5: 4C 4A E4  JMP $E44A
C - - - - - 0x01E3D8 07:E3C8: A9 80     LDA #$80
C - - - - - 0x01E3DA 07:E3CA: 85 79     STA ram_0079
C - - - - - 0x01E3DC 07:E3CC: 20 63 DF  JSR $DF63
C - - - - - 0x01E3DF 07:E3CF: A6 2E     LDX ram_002E
C - - - - - 0x01E3E1 07:E3D1: D0 0F     BNE $E3E2
C - - - - - 0x01E3E3 07:E3D3: A9 01     LDA #$01
C - - - - - 0x01E3E5 07:E3D5: 20 79 D0  JSR $D079
C - - - - - 0x01E3E8 07:E3D8: F0 38     BEQ $E412
...
C - - - - - 0x01E3F4 07:E3E4: B0 02     BCS $E3E8
C - - - - - 0x01E3F6 07:E3E6: C6 71     DEC ram_0071
C - - - - - 0x01E3F8 07:E3E8: A5 1C     LDA ram_001C
C - - - - - 0x01E3FA 07:E3EA: 29 80     AND #$80
C - - - - - 0x01E3FC 07:E3EC: F0 06     BEQ $E3F4
C - - - - - 0x01E3FE 07:E3EE: 20 15 E5  JSR $E515
C - - - - - 0x01E401 07:E3F1: 4C FD E3  JMP $E3FD
C - - - - - 0x01E404 07:E3F4: A5 1C     LDA ram_001C
C - - - - - 0x01E406 07:E3F6: 29 40     AND #$40
C - - - - - 0x01E408 07:E3F8: F0 03     BEQ $E3FD
C - - - - - 0x01E40A 07:E3FA: 20 1F E5  JSR $E51F
C D 3 - - - 0x01E40D 07:E3FD: A5 1C     LDA ram_001C
C - - - - - 0x01E40F 07:E3FF: 29 10     AND #$10
C - - - - - 0x01E411 07:E401: F0 06     BEQ $E409
C - - - - - 0x01E413 07:E403: 20 D5 E5  JSR $E5D5
C - - - - - 0x01E416 07:E406: 4C 12 E4  JMP $E412
C - - - - - 0x01E419 07:E409: A5 1C     LDA ram_001C
C - - - - - 0x01E41B 07:E40B: 29 20     AND #$20
C - - - - - 0x01E41D 07:E40D: F0 03     BEQ $E412
C - - - - - 0x01E41F 07:E40F: 20 BE E5  JSR $E5BE
C D 3 - - - 0x01E422 07:E412: 20 82 E5  JSR $E582
C - - - - - 0x01E425 07:E415: 20 B5 E5  JSR $E5B5
C - - - - - 0x01E428 07:E418: A5 6A     LDA ram_006A
C - - - - - 0x01E42A 07:E41A: C9 57     CMP #$57
C - - - - - 0x01E42C 07:E41C: B0 10     BCS $E42E
C - - - - - 0x01E42E 07:E41E: C9 48     CMP #$48
C - - - - - 0x01E430 07:E420: B0 04     BCS $E426
...
C - - - - - 0x01E43C 07:E42C: D0 16     BNE $E444
C - - - - - 0x01E43E 07:E42E: 20 6C E4  JSR $E46C
C - - - - - 0x01E441 07:E431: 20 64 D0  JSR $D064
C - - - - - 0x01E444 07:E434: A2 00     LDX #$00
C - - - - - 0x01E446 07:E436: A5 1C     LDA ram_001C
C - - - - - 0x01E448 07:E438: 29 F1     AND #$F1
C - - - - - 0x01E44A 07:E43A: F0 08     BEQ $E444
C - - - - - 0x01E44C 07:E43C: 20 96 DC  JSR $DC96
C - - - - - 0x01E44F 07:E43F: A4 70     LDY ram_0070
C - - - - - 0x01E451 07:E441: BE 47 E4  LDX $E447,Y
C - - - - - 0x01E454 07:E444: 4C C2 DB  JMP $DBC2
- D 3 - - - 0x01E457 07:E447: 04        .byte $04   ; 
- D 3 - - - 0x01E458 07:E448: 08        .byte $08   ; 
- D 3 - - - 0x01E459 07:E449: 0C        .byte $0C   ; 
C D 3 - - - 0x01E45A 07:E44A: 20 82 E5  JSR $E582
C - - - - - 0x01E45D 07:E44D: 20 B5 E5  JSR $E5B5
C - - - - - 0x01E460 07:E450: 20 8B E4  JSR $E48B
C - - - - - 0x01E463 07:E453: A2 10     LDX #$10
C - - - - - 0x01E465 07:E455: A5 2E     LDA ram_002E
C - - - - - 0x01E467 07:E457: D0 EB     BNE $E444
C - - - - - 0x01E469 07:E459: 4C 31 DF  JMP $DF31
...
C - - - - - 0x01E4CA 07:E4BA: 20 AC D6  JSR $D6AC
C - - - - - 0x01E4CD 07:E4BD: B0 9D     BCS $E45C
...
C - - - - - 0x01E4DF 07:E4CF: B0 08     BCS $E4D9
C - - - - - 0x01E4E1 07:E4D1: A9 02     LDA #$02
C - - - - - 0x01E4E3 07:E4D3: C0 08     CPY #$08
C - - - - - 0x01E4E5 07:E4D5: B0 02     BCS $E4D9
...
C - - - - - 0x01E525 07:E515: 20 F3 E5  JSR $E5F3
C - - - - - 0x01E528 07:E518: F0 15     BEQ $E52F
C - - - - - 0x01E52A 07:E51A: A9 00     LDA #$00
C - - - - - 0x01E52C 07:E51C: 4C 26 E5  JMP $E526
C - - - - - 0x01E52F 07:E51F: 20 E8 E5  JSR $E5E8
C - - - - - 0x01E532 07:E522: F0 0B     BEQ $E52F
C - - - - - 0x01E534 07:E524: A9 80     LDA #$80
C D 3 - - - 0x01E536 07:E526: 85 42     STA ram_0042
C - - - - - 0x01E538 07:E528: 20 34 E5  JSR $E534
C - - - - - 0x01E53B 07:E52B: A9 80     LDA #$80
C - - - - - 0x01E53D 07:E52D: D0 02     BNE $E531
...
C - - - - - 0x01E548 07:E538: 90 41     BCC $E57B
C - - - - - 0x01E54A 07:E53A: C9 04     CMP #$04
C - - - - - 0x01E54C 07:E53C: 90 39     BCC $E577
C - - - - - 0x01E54E 07:E53E: C9 06     CMP #$06
C - - - - - 0x01E550 07:E540: 90 1D     BCC $E55F
C - - - - - 0x01E552 07:E542: 48        PHA
C - - - - - 0x01E553 07:E543: 20 65 E5  JSR $E565
C - - - - - 0x01E556 07:E546: 68        PLA
C - - - - - 0x01E557 07:E547: C9 08     CMP #$08
C - - - - - 0x01E559 07:E549: 90 36     BCC $E581
C - - - - - 0x01E55B 07:E54B: C9 0C     CMP #$0C
C - - - - - 0x01E55D 07:E54D: 90 28     BCC $E577
C - - - - - 0x01E55F 07:E54F: 48        PHA
C - - - - - 0x01E560 07:E550: 20 65 E5  JSR $E565
C - - - - - 0x01E563 07:E553: 68        PLA
C - - - - - 0x01E564 07:E554: C9 10     CMP #$10
C - - - - - 0x01E566 07:E556: 90 29     BCC $E581
C - - - - - 0x01E568 07:E558: C9 14     CMP #$14
C - - - - - 0x01E56A 07:E55A: 90 1B     BCC $E577
C - - - - - 0x01E56C 07:E55C: 4C 65 E5  JMP $E565
C - - - - - 0x01E56F 07:E55F: A9 03     LDA #$03
C - - - - - 0x01E571 07:E561: 25 2C     AND ram_002C
C - - - - - 0x01E573 07:E563: F0 1C     BEQ $E581
C D 3 - - - 0x01E575 07:E565: A5 6D     LDA ram_006D
C - - - - - 0x01E577 07:E567: 29 20     AND #$20
C - - - - - 0x01E579 07:E569: F0 02     BEQ $E56D
C - - - - - 0x01E57B 07:E56B: E6 6A     INC ram_006A
C - - - - - 0x01E57D 07:E56D: A5 42     LDA ram_0042
C - - - - - 0x01E57F 07:E56F: 30 03     BMI $E574
C - - - - - 0x01E581 07:E571: 4C FA DC  JMP $DCFA
C - - - - - 0x01E584 07:E574: 4C BB DC  JMP $DCBB
C - - - - - 0x01E587 07:E577: A9 01     LDA #$01
C - - - - - 0x01E589 07:E579: D0 02     BNE $E57D
C - - - - - 0x01E58B 07:E57B: A9 03     LDA #$03
C - - - - - 0x01E58D 07:E57D: 25 2C     AND ram_002C
C - - - - - 0x01E58F 07:E57F: F0 E4     BEQ $E565
C - - - - - 0x01E591 07:E581: 60        RTS
C - - - - - 0x01E592 07:E582: A5 3F     LDA ram_003F
C - - - - - 0x01E594 07:E584: F0 FB     BEQ $E581
C - - - - - 0x01E596 07:E586: 30 0C     BMI $E594
C - - - - - 0x01E598 07:E588: 20 F3 E5  JSR $E5F3
C - - - - - 0x01E59B 07:E58B: F0 F4     BEQ $E581
C - - - - - 0x01E59D 07:E58D: A5 3F     LDA ram_003F
C - - - - - 0x01E59F 07:E58F: 85 42     STA ram_0042
C - - - - - 0x01E5A1 07:E591: 4C 36 E5  JMP $E536
C - - - - - 0x01E5A4 07:E594: 20 E8 E5  JSR $E5E8
C - - - - - 0x01E5A7 07:E597: F0 E8     BEQ $E581
C - - - - - 0x01E5A9 07:E599: A5 3F     LDA ram_003F
C - - - - - 0x01E5AB 07:E59B: 85 42     STA ram_0042
C - - - - - 0x01E5AD 07:E59D: 20 73 D0  JSR $D073
C - - - - - 0x01E5B0 07:E5A0: 4C 36 E5  JMP $E536
C - - - - - 0x01E5B3 07:E5A3: A9 FC     LDA #$FC
C - - - - - 0x01E5B5 07:E5A5: 20 AB E5  JSR $E5AB
...
C - - - - - 0x01E5C2 07:E5B2: 4C 6A D3  JMP $D36A
C - - - - - 0x01E5C5 07:E5B5: 20 A3 E5  JSR $E5A3
C - - - - - 0x01E5C8 07:E5B8: F0 1A     BEQ $E5D4
C - - - - - 0x01E5CA 07:E5BA: A5 3E     LDA ram_003E
C - - - - - 0x01E5CC 07:E5BC: D0 07     BNE $E5C5
C - - - - - 0x01E5CE 07:E5BE: 20 A3 E5  JSR $E5A3
C - - - - - 0x01E5D1 07:E5C1: F0 11     BEQ $E5D4
C - - - - - 0x01E5D3 07:E5C3: A9 01     LDA #$01
C - - - - - 0x01E5D5 07:E5C5: 25 2C     AND ram_002C
C - - - - - 0x01E5D7 07:E5C7: D0 0B     BNE $E5D4
C - - - - - 0x01E5D9 07:E5C9: A9 DF     LDA #$DF
C - - - - - 0x01E5DB 07:E5CB: C5 6A     CMP ram_006A
C - - - - - 0x01E5DD 07:E5CD: B0 03     BCS $E5D2
...
C - - - - - 0x01E5E7 07:E5D7: 20 A5 E5  JSR $E5A5
C - - - - - 0x01E5EA 07:E5DA: F0 F8     BEQ $E5D4
C - - - - - 0x01E5EC 07:E5DC: A9 47     LDA #$47
C - - - - - 0x01E5EE 07:E5DE: C5 6A     CMP ram_006A
C - - - - - 0x01E5F0 07:E5E0: 90 03     BCC $E5E5
...
C - - - - - 0x01E5F8 07:E5E8: 20 1A E6  JSR $E61A
C - - - - - 0x01E5FB 07:E5EB: A9 F8     LDA #$F8
C - - - - - 0x01E5FD 07:E5ED: 20 AD D3  JSR $D3AD
C - - - - - 0x01E600 07:E5F0: 4C FB E5  JMP $E5FB
C - - - - - 0x01E603 07:E5F3: 20 1A E6  JSR $E61A
C - - - - - 0x01E606 07:E5F6: A9 08     LDA #$08
C - - - - - 0x01E608 07:E5F8: 20 97 D3  JSR $D397
C D 3 - - - 0x01E60B 07:E5FB: C9 01     CMP #$01
C - - - - - 0x01E60D 07:E5FD: F0 1A     BEQ $E619
...
C - - - - - 0x01E616 07:E606: 20 E5 D2  JSR $D2E5
C - - - - - 0x01E619 07:E609: C9 01     CMP #$01
C - - - - - 0x01E61B 07:E60B: F0 0C     BEQ $E619
...
C - - - - - 0x01E624 07:E614: 20 E5 D2  JSR $D2E5
...
C - - - - - 0x01E631 07:E621: 4C 74 D9  JMP $D974
...
C - - - - - 0x01E640 07:E630: F0 06     BEQ $E638
C D 3 - - - 0x01E642 07:E632: 20 EE CD  JSR $CDEE
C - - - - - 0x01E645 07:E635: 4C 4B DB  JMP $DB4B
C - - - - - 0x01E648 07:E638: A9 01     LDA #$01
C - - - - - 0x01E64A 07:E63A: 20 79 D0  JSR $D079
C - - - - - 0x01E64D 07:E63D: D0 F3     BNE $E632
C - - - - - 0x01E64F 07:E63F: A5 2C     LDA ram_002C
C - - - - - 0x01E651 07:E641: 29 07     AND #$07
C - - - - - 0x01E653 07:E643: D0 05     BNE $E64A
C - - - - - 0x01E655 07:E645: A9 16     LDA #$16
C - - - - - 0x01E657 07:E647: 20 20 C4  JSR $C420
C - - - - - 0x01E65A 07:E64A: A5 2E     LDA ram_002E
C - - - - - 0x01E65C 07:E64C: F0 05     BEQ $E653
C - - - - - 0x01E65E 07:E64E: A2 08     LDX #$08
C - - - - - 0x01E660 07:E650: 4C C0 E6  JMP $E6C0
C - - - - - 0x01E663 07:E653: A9 80     LDA #$80
C - - - - - 0x01E665 07:E655: 85 79     STA ram_0079
C - - - - - 0x01E667 07:E657: 20 83 E7  JSR $E783
C - - - - - 0x01E66A 07:E65A: A5 1C     LDA ram_001C
C - - - - - 0x01E66C 07:E65C: 29 C0     AND #$C0
C - - - - - 0x01E66E 07:E65E: F0 31     BEQ $E691
C - - - - - 0x01E670 07:E660: C9 80     CMP #$80
C - - - - - 0x01E672 07:E662: F0 07     BEQ $E66B
C - - - - - 0x01E674 07:E664: A5 6C     LDA ram_006C
C - - - - - 0x01E676 07:E666: 6A        ROR
C - - - - - 0x01E677 07:E667: 90 15     BCC $E67E
C - - - - - 0x01E679 07:E669: B0 05     BCS $E670
C - - - - - 0x01E67B 07:E66B: A5 6C     LDA ram_006C
C - - - - - 0x01E67D 07:E66D: 6A        ROR
C - - - - - 0x01E67E 07:E66E: B0 0E     BCS $E67E
C - - - - - 0x01E680 07:E670: A5 2C     LDA ram_002C
C - - - - - 0x01E682 07:E672: 29 07     AND #$07
C - - - - - 0x01E684 07:E674: D0 1E     BNE $E694
C - - - - - 0x01E686 07:E676: A2 0C     LDX #$0C
C - - - - - 0x01E688 07:E678: 20 8A DC  JSR $DC8A
C - - - - - 0x01E68B 07:E67B: 4C 94 E6  JMP $E694
C - - - - - 0x01E68E 07:E67E: 20 78 E7  JSR $E778
C - - - - - 0x01E691 07:E681: 20 80 DF  JSR $DF80
C - - - - - 0x01E694 07:E684: A5 71     LDA ram_0071
C - - - - - 0x01E696 07:E686: D0 0C     BNE $E694
C - - - - - 0x01E698 07:E688: A5 6C     LDA ram_006C
C - - - - - 0x01E69A 07:E68A: 49 01     EOR #$01
C - - - - - 0x01E69C 07:E68C: 85 6C     STA ram_006C
C - - - - - 0x01E69E 07:E68E: 4C 94 E6  JMP $E694
C - - - - - 0x01E6A1 07:E691: 20 78 DF  JSR $DF78
C D 3 - - - 0x01E6A4 07:E694: 20 1D E7  JSR $E71D
C - - - - - 0x01E6A7 07:E697: 20 41 E7  JSR $E741
C - - - - - 0x01E6AA 07:E69A: A2 0C     LDX #$0C
C - - - - - 0x01E6AC 07:E69C: A5 2F     LDA ram_002F
C - - - - - 0x01E6AE 07:E69E: D0 19     BNE $E6B9
C - - - - - 0x01E6B0 07:E6A0: A2 04     LDX #$04
C - - - - - 0x01E6B2 07:E6A2: A9 20     LDA #$20
C - - - - - 0x01E6B4 07:E6A4: 20 79 D0  JSR $D079
C - - - - - 0x01E6B7 07:E6A7: F0 04     BEQ $E6AD
...
C - - - - - 0x01E71D 07:E70D: F0 02     BEQ $E711
...
C - - - - - 0x01E72A 07:E71A: 4C 5A CE  JMP $CE5A
C - - - - - 0x01E72D 07:E71D: A5 6C     LDA ram_006C
C - - - - - 0x01E72F 07:E71F: 6A        ROR
C - - - - - 0x01E730 07:E720: B0 0C     BCS $E72E
C - - - - - 0x01E732 07:E722: 20 19 DD  JSR $DD19
C - - - - - 0x01E735 07:E725: F0 3A     BEQ $E761
C - - - - - 0x01E737 07:E727: A5 42     LDA ram_0042
C - - - - - 0x01E739 07:E729: 29 7F     AND #$7F
C - - - - - 0x01E73B 07:E72B: 4C 37 E7  JMP $E737
C - - - - - 0x01E73E 07:E72E: 20 34 DD  JSR $DD34
C - - - - - 0x01E741 07:E731: F0 2E     BEQ $E761
...
C - - - - - 0x01E74E 07:E73E: 4C 36 E5  JMP $E536
C - - - - - 0x01E751 07:E741: A2 01     LDX #$01
C - - - - - 0x01E753 07:E743: A5 1C     LDA ram_001C
C - - - - - 0x01E755 07:E745: 29 30     AND #$30
C - - - - - 0x01E757 07:E747: F0 19     BEQ $E762
C - - - - - 0x01E759 07:E749: CA        DEX
C - - - - - 0x01E75A 07:E74A: C9 10     CMP #$10
C - - - - - 0x01E75C 07:E74C: F0 14     BEQ $E762
C - - - - - 0x01E75E 07:E74E: 20 5A DD  JSR $DD5A
C - - - - - 0x01E761 07:E751: F0 0E     BEQ $E761
C - - - - - 0x01E763 07:E753: A5 2C     LDA ram_002C
C - - - - - 0x01E765 07:E755: 29 01     AND #$01
C - - - - - 0x01E767 07:E757: D0 08     BNE $E761
C - - - - - 0x01E769 07:E759: A5 6A     LDA ram_006A
C - - - - - 0x01E76B 07:E75B: C9 BF     CMP #$BF
C - - - - - 0x01E76D 07:E75D: B0 02     BCS $E761
C - - - - - 0x01E76F 07:E75F: E6 6A     INC ram_006A
C - - - - - 0x01E771 07:E761: 60        RTS
C - - - - - 0x01E772 07:E762: 8A        TXA
C - - - - - 0x01E773 07:E763: 25 2C     AND ram_002C
C - - - - - 0x01E775 07:E765: D0 FA     BNE $E761
C - - - - - 0x01E777 07:E767: 20 4F DD  JSR $DD4F
C - - - - - 0x01E77A 07:E76A: F0 F5     BEQ $E761
C - - - - - 0x01E77C 07:E76C: A9 4F     LDA #$4F
C - - - - - 0x01E77E 07:E76E: C5 6A     CMP ram_006A
C - - - - - 0x01E780 07:E770: 90 03     BCC $E775
...
C - - - - - 0x01E7BD 07:E7AD: B0 16     BCS $E7C5
...
C - - - - - 0x01E7CC 07:E7BC: B0 0F     BCS $E7CD
...
C - - - - - 0x01E7D3 07:E7C3: D0 DB     BNE $E7A0
...
C - - - - - 0x01E7E1 07:E7D1: D0 31     BNE $E804
...
C - - - - - 0x01E7EB 07:E7DB: B0 07     BCS $E7E4
C - - - - - 0x01E7ED 07:E7DD: A5 01     LDA ram_0001
C - - - - - 0x01E7EF 07:E7DF: 20 73 D0  JSR $D073
...
C - - - - - 0x01E7FC 07:E7EC: B0 03     BCS $E7F1
C - - - - - 0x01E7FE 07:E7EE: 20 73 D0  JSR $D073
C - - - - - 0x01E801 07:E7F1: C9 04     CMP #$04
C - - - - - 0x01E803 07:E7F3: B0 D0     BCS $E7C5
...
C - - - - - 0x01E816 07:E806: 20 C5 E7  JSR $E7C5
C - - - - - 0x01E819 07:E809: A9 1C     LDA #$1C
C - - - - - 0x01E81B 07:E80B: A0 03     LDY #$03
C - - - - - 0x01E81D 07:E80D: 4C 9D DD  JMP $DD9D
C D 3 - - - 0x01E820 07:E810: 20 8A E7  JSR $E78A
C - - - - - 0x01E823 07:E813: 90 F1     BCC $E806
C - - - - - 0x01E825 07:E815: A5 2C     LDA ram_002C
C - - - - - 0x01E827 07:E817: 29 01     AND #$01
C - - - - - 0x01E829 07:E819: D0 05     BNE $E820
C - - - - - 0x01E82B 07:E81B: A2 18     LDX #$18
C - - - - - 0x01E82D 07:E81D: 20 8A DC  JSR $DC8A
C - - - - - 0x01E830 07:E820: A2 00     LDX #$00
C - - - - - 0x01E832 07:E822: A5 6C     LDA ram_006C
C - - - - - 0x01E834 07:E824: 6A        ROR
C - - - - - 0x01E835 07:E825: 90 02     BCC $E829
C - - - - - 0x01E837 07:E827: A2 80     LDX #$80
C - - - - - 0x01E839 07:E829: 86 42     STX ram_0042
C - - - - - 0x01E83B 07:E82B: A9 01     LDA #$01
C - - - - - 0x01E83D 07:E82D: 20 79 D0  JSR $D079
C - - - - - 0x01E840 07:E830: D0 0B     BNE $E83D
C - - - - - 0x01E842 07:E832: 20 34 E5  JSR $E534
C - - - - - 0x01E845 07:E835: A9 03     LDA #$03
C - - - - - 0x01E847 07:E837: 20 98 DC  JSR $DC98
C - - - - - 0x01E84A 07:E83A: 4C 67 DC  JMP $DC67
C - - - - - 0x01E84D 07:E83D: 20 C5 E7  JSR $E7C5
C - - - - - 0x01E850 07:E840: A9 00     LDA #$00
C - - - - - 0x01E852 07:E842: A0 03     LDY #$03
C - - - - - 0x01E854 07:E844: 4C 9D DD  JMP $DD9D
...
C - - - - - 0x01E863 07:E853: D0 6F     BNE $E8C4
C - - - - - 0x01E865 07:E855: 24 42     BIT ram_0042
C - - - - - 0x01E867 07:E857: 70 67     BVS $E8C0
C - - - - - 0x01E869 07:E859: A9 01     LDA #$01
C - - - - - 0x01E86B 07:E85B: 20 79 D0  JSR $D079
C - - - - - 0x01E86E 07:E85E: D0 6D     BNE $E8CD
...
C - - - - - 0x01E878 07:E868: F0 26     BEQ $E890
C - - - - - 0x01E87A 07:E86A: C9 80     CMP #$80
C - - - - - 0x01E87C 07:E86C: F0 0A     BEQ $E878
C - - - - - 0x01E87E 07:E86E: A5 6C     LDA ram_006C
C - - - - - 0x01E880 07:E870: 6A        ROR
C - - - - - 0x01E881 07:E871: B0 0F     BCS $E882
C - - - - - 0x01E883 07:E873: E6 6C     INC ram_006C
C - - - - - 0x01E885 07:E875: 4C 7F E8  JMP $E87F
C - - - - - 0x01E888 07:E878: A5 6C     LDA ram_006C
C - - - - - 0x01E88A 07:E87A: 6A        ROR
C - - - - - 0x01E88B 07:E87B: 90 05     BCC $E882
C - - - - - 0x01E88D 07:E87D: C6 6C     DEC ram_006C
C D 3 - - - 0x01E88F 07:E87F: 20 F1 DC  JSR $DCF1
C - - - - - 0x01E892 07:E882: A5 2C     LDA ram_002C
C - - - - - 0x01E894 07:E884: 29 07     AND #$07
C - - - - - 0x01E896 07:E886: D0 0B     BNE $E893
C - - - - - 0x01E898 07:E888: A2 04     LDX #$04
C - - - - - 0x01E89A 07:E88A: 20 8A DC  JSR $DC8A
C - - - - - 0x01E89D 07:E88D: 4C 93 E8  JMP $E893
C - - - - - 0x01E8A0 07:E890: 20 78 DF  JSR $DF78
C D 3 - - - 0x01E8A3 07:E893: 20 1D E7  JSR $E71D
C - - - - - 0x01E8A6 07:E896: A2 03     LDX #$03
C - - - - - 0x01E8A8 07:E898: A5 1C     LDA ram_001C
C - - - - - 0x01E8AA 07:E89A: 29 10     AND #$10
C - - - - - 0x01E8AC 07:E89C: F0 02     BEQ $E8A0
C - - - - - 0x01E8AE 07:E89E: A2 01     LDX #$01
C - - - - - 0x01E8B0 07:E8A0: 86 00     STX ram_0000
C - - - - - 0x01E8B2 07:E8A2: A5 2C     LDA ram_002C
C - - - - - 0x01E8B4 07:E8A4: 25 00     AND ram_0000
C - - - - - 0x01E8B6 07:E8A6: D0 02     BNE $E8AA
C - - - - - 0x01E8B8 07:E8A8: C6 6A     DEC ram_006A
C - - - - - 0x01E8BA 07:E8AA: A5 6A     LDA ram_006A
C - - - - - 0x01E8BC 07:E8AC: C9 6F     CMP #$6F
C - - - - - 0x01E8BE 07:E8AE: 90 1D     BCC $E8CD
C - - - - - 0x01E8C0 07:E8B0: A5 5E     LDA ram_005E
C - - - - - 0x01E8C2 07:E8B2: C9 03     CMP #$03
C - - - - - 0x01E8C4 07:E8B4: D0 1F     BNE $E8D5
C - - - - - 0x01E8C6 07:E8B6: A9 C0     LDA #$C0
C - - - - - 0x01E8C8 07:E8B8: 20 7E DD  JSR $DD7E
C - - - - - 0x01E8CB 07:E8BB: F0 10     BEQ $E8CD
C - - - - - 0x01E8CD 07:E8BD: 4C D5 E8  JMP $E8D5
C - - - - - 0x01E8D0 07:E8C0: A5 2F     LDA ram_002F
C - - - - - 0x01E8D2 07:E8C2: D0 11     BNE $E8D5
C - - - - - 0x01E8D4 07:E8C4: A5 6D     LDA ram_006D
C - - - - - 0x01E8D6 07:E8C6: 29 BF     AND #$BF
C - - - - - 0x01E8D8 07:E8C8: 85 6D     STA ram_006D
C - - - - - 0x01E8DA 07:E8CA: 4C 32 E6  JMP $E632
C - - - - - 0x01E8DD 07:E8CD: A9 28     LDA #$28
C - - - - - 0x01E8DF 07:E8CF: 20 20 C4  JSR $C420
C - - - - - 0x01E8E2 07:E8D2: 20 78 E7  JSR $E778
C D 3 - - - 0x01E8E5 07:E8D5: A2 00     LDX #$00
C - - - - - 0x01E8E7 07:E8D7: 4C C2 DB  JMP $DBC2
...
C - - - - - 0x01E8F3 07:E8E3: D0 0B     BNE $E8F0
C - - - - - 0x01E8F5 07:E8E5: 20 12 DD  JSR $DD12
C - - - - - 0x01E8F8 07:E8E8: A5 2C     LDA ram_002C
C - - - - - 0x01E8FA 07:E8EA: 6A        ROR
C - - - - - 0x01E8FB 07:E8EB: 90 03     BCC $E8F0
C - - - - - 0x01E8FD 07:E8ED: 20 12 DD  JSR $DD12
C - - - - - 0x01E900 07:E8F0: A5 4B     LDA ram_004B
C - - - - - 0x01E902 07:E8F2: C9 05     CMP #$05
C - - - - - 0x01E904 07:E8F4: 90 1C     BCC $E912
C - - - - - 0x01E906 07:E8F6: A2 00     LDX #$00
C - - - - - 0x01E908 07:E8F8: C9 0A     CMP #$0A
C - - - - - 0x01E90A 07:E8FA: 90 08     BCC $E904
C - - - - - 0x01E90C 07:E8FC: A2 08     LDX #$08
C - - - - - 0x01E90E 07:E8FE: C9 0C     CMP #$0C
C - - - - - 0x01E910 07:E900: 90 02     BCC $E904
C - - - - - 0x01E912 07:E902: A2 04     LDX #$04
C - - - - - 0x01E914 07:E904: A0 00     LDY #$00
C - - - - - 0x01E916 07:E906: BD 38 ED  LDA $ED38,X
...
C - - - - - 0x01E920 07:E910: D0 F4     BNE $E906
C - - - - - 0x01E922 07:E912: A5 6C     LDA ram_006C
C - - - - - 0x01E924 07:E914: 29 7F     AND #$7F
C - - - - - 0x01E926 07:E916: 20 5F D0  JSR $D05F
C - - - - - 0x01E929 07:E919: 20 C1 D0  JSR $D0C1
...
C - - - - - 0x01E980 07:E970: 90 08     BCC $E97A
...
C - - - - - 0x01E98C 07:E97C: 90 0F     BCC $E98D
C - - - - - 0x01E98E 07:E97E: D0 0A     BNE $E98A
...
C - - - - - 0x01E99A 07:E98A: 4C 1F EC  JMP $EC1F
C - - - - - 0x01E99D 07:E98D: 20 B3 E9  JSR $E9B3
C D 3 - - - 0x01E9A0 07:E990: A9 80     LDA #$80
C - - - - - 0x01E9A2 07:E992: 85 79     STA ram_0079
C - - - - - 0x01E9A4 07:E994: 20 CE EC  JSR $ECCE
C - - - - - 0x01E9A7 07:E997: A5 6C     LDA ram_006C
C - - - - - 0x01E9A9 07:E999: 29 08     AND #$08
C - - - - - 0x01E9AB 07:E99B: D0 07     BNE $E9A4
C - - - - - 0x01E9AD 07:E99D: 8A        TXA
C - - - - - 0x01E9AE 07:E99E: 48        PHA
C - - - - - 0x01E9AF 07:E99F: 20 4C E0  JSR $E04C
C - - - - - 0x01E9B2 07:E9A2: 68        PLA
C - - - - - 0x01E9B3 07:E9A3: AA        TAX
C - - - - - 0x01E9B4 07:E9A4: A5 5F     LDA ram_005F
C - - - - - 0x01E9B6 07:E9A6: 29 02     AND #$02
C - - - - - 0x01E9B8 07:E9A8: F0 03     BEQ $E9AD
C - - - - - 0x01E9BA 07:E9AA: 4C 5C EC  JMP $EC5C
C - - - - - 0x01E9BD 07:E9AD: 20 5C EC  JSR $EC5C
C - - - - - 0x01E9C0 07:E9B0: 4C 05 DC  JMP $DC05
C - - - - - 0x01E9C3 07:E9B3: A5 1C     LDA ram_001C
C - - - - - 0x01E9C5 07:E9B5: 29 C0     AND #$C0
C - - - - - 0x01E9C7 07:E9B7: F0 18     BEQ $E9D1
C - - - - - 0x01E9C9 07:E9B9: 29 40     AND #$40
C - - - - - 0x01E9CB 07:E9BB: F0 06     BEQ $E9C3
C - - - - - 0x01E9CD 07:E9BD: 20 80 DF  JSR $DF80
C - - - - - 0x01E9D0 07:E9C0: 4C D5 E9  JMP $E9D5
C - - - - - 0x01E9D3 07:E9C3: A5 2C     LDA ram_002C
C - - - - - 0x01E9D5 07:E9C5: 29 01     AND #$01
C - - - - - 0x01E9D7 07:E9C7: D0 0C     BNE $E9D5
C - - - - - 0x01E9D9 07:E9C9: A2 10     LDX #$10
C - - - - - 0x01E9DB 07:E9CB: 20 8A DC  JSR $DC8A
C - - - - - 0x01E9DE 07:E9CE: 4C D5 E9  JMP $E9D5
...
C - - - - - 0x01E9E9 07:E9D9: F0 36     BEQ $EA11
C - - - - - 0x01E9EB 07:E9DB: C9 10     CMP #$10
C - - - - - 0x01E9ED 07:E9DD: D0 0E     BNE $E9ED
C - - - - - 0x01E9EF 07:E9DF: A5 6A     LDA ram_006A
C - - - - - 0x01E9F1 07:E9E1: 85 00     STA ram_0000
C - - - - - 0x01E9F3 07:E9E3: 20 A3 EA  JSR $EAA3
C - - - - - 0x01E9F6 07:E9E6: 90 1F     BCC $EA07
C - - - - - 0x01E9F8 07:E9E8: C6 6A     DEC ram_006A
C - - - - - 0x01E9FA 07:E9EA: 4C FC E9  JMP $E9FC
...
C - - - - - 0x01EA05 07:E9F5: 20 A3 EA  JSR $EAA3
C - - - - - 0x01EA08 07:E9F8: 90 0D     BCC $EA07
...
C - - - - - 0x01EA14 07:EA04: 4C 11 EA  JMP $EA11
...
C D 3 - - - 0x01EA21 07:EA11: 20 6D D9  JSR $D96D
C - - - - - 0x01EA24 07:EA14: A9 0E     LDA #$0E
C - - - - - 0x01EA26 07:EA16: 20 97 D3  JSR $D397
C - - - - - 0x01EA29 07:EA19: C9 01     CMP #$01
C - - - - - 0x01EA2B 07:EA1B: D0 03     BNE $EA20
C - - - - - 0x01EA2D 07:EA1D: 4C 8F EB  JMP $EB8F
C - - - - - 0x01EA30 07:EA20: 20 5E EA  JSR $EA5E
...
C - - - - - 0x01EA49 07:EA39: 90 18     BCC $EA53
...
C - - - - - 0x01EA61 07:EA51: 90 08     BCC $EA5B
...
C - - - - - 0x01EAC5 07:EAB5: 90 34     BCC $EAEB
...
C - - - - - 0x01EAD3 07:EAC3: 90 28     BCC $EAED
...
C - - - - - 0x01EAE1 07:EAD1: 90 3E     BCC $EB11
...
C - - - - - 0x01EAEF 07:EADF: 90 27     BCC $EB08
...
C - - - - - 0x01EAF9 07:EAE9: 90 BF     BCC $EAAA
...
C - - - - - 0x01EB1E 07:EB0E: 4C F3 EA  JMP $EAF3
C - - - - - 0x01EB21 07:EB11: A9 30     LDA #$30
C - - - - - 0x01EB23 07:EB13: E0 05     CPX #$05
C - - - - - 0x01EB25 07:EB15: F0 DC     BEQ $EAF3
C - - - - - 0x01EB27 07:EB17: E0 11     CPX #$11
C - - - - - 0x01EB29 07:EB19: F0 D8     BEQ $EAF3
C - - - - - 0x01EB2B 07:EB1B: A9 40     LDA #$40
C - - - - - 0x01EB2D 07:EB1D: D0 D4     BNE $EAF3
...
C - - - - - 0x01EB76 07:EB66: 90 4E     BCC $EBB6
C - - - - - 0x01EB78 07:EB68: A5 6A     LDA ram_006A
C - - - - - 0x01EB7A 07:EB6A: C9 EF     CMP #$EF
C - - - - - 0x01EB7C 07:EB6C: 90 06     BCC $EB74
C - - - - - 0x01EB7E 07:EB6E: 20 31 DF  JSR $DF31
C - - - - - 0x01EB81 07:EB71: 4C B6 EB  JMP $EBB6
C - - - - - 0x01EB84 07:EB74: 85 00     STA ram_0000
C - - - - - 0x01EB86 07:EB76: E6 00     INC ram_0000
C - - - - - 0x01EB88 07:EB78: 20 6A D3  JSR $D36A
C - - - - - 0x01EB8B 07:EB7B: F0 39     BEQ $EBB6
C - - - - - 0x01EB8D 07:EB7D: C9 03     CMP #$03
C - - - - - 0x01EB8F 07:EB7F: F0 19     BEQ $EB9A
C - - - - - 0x01EB91 07:EB81: 20 32 E3  JSR $E332
C - - - - - 0x01EB94 07:EB84: A9 41     LDA #$41
C - - - - - 0x01EB96 07:EB86: 20 20 C4  JSR $C420
C - - - - - 0x01EB99 07:EB89: A5 6C     LDA ram_006C
C - - - - - 0x01EB9B 07:EB8B: 29 08     AND #$08
C - - - - - 0x01EB9D 07:EB8D: F0 1B     BEQ $EBAA
...
C - - - - - 0x01EBA7 07:EB97: 4C C3 EB  JMP $EBC3
...
C - - - - - 0x01EBB2 07:EBA2: 20 3E DF  JSR $DF3E
C - - - - - 0x01EBB5 07:EBA5: B0 32     BCS $EBD9
C - - - - - 0x01EBB7 07:EBA7: 4C 64 D7  JMP $D764
...
C - - - - - 0x01EBFD 07:EBED: A5 64     LDA ram_0064
C - - - - - 0x01EBFF 07:EBEF: 85 03     STA ram_0003
C - - - - - 0x01EC01 07:EBF1: A9 60     LDA #$60
C - - - - - 0x01EC03 07:EBF3: 85 02     STA ram_0002
C - - - - - 0x01EC05 07:EBF5: 4C 33 CE  JMP $CE33
C - - - - - 0x01EC08 07:EBF8: 20 11 EA  JSR $EA11
C - - - - - 0x01EC0B 07:EBFB: A5 2E     LDA ram_002E
C - - - - - 0x01EC0D 07:EBFD: D0 06     BNE $EC05
...
C - - - - - 0x01EC17 07:EC07: 4C 90 E9  JMP $E990
...
C - - - - - 0x01EC33 07:EC23: D9 44 ED  CMP $ED44,Y
C - - - - - 0x01EC36 07:EC26: B0 03     BCS $EC2B
C - - - - - 0x01EC38 07:EC28: C8        INY
C - - - - - 0x01EC39 07:EC29: D0 F8     BNE $EC23
C - - - - - 0x01EC3B 07:EC2B: BE 49 ED  LDX $ED49,Y
C - - - - - 0x01EC3E 07:EC2E: E0 30     CPX #$30
C - - - - - 0x01EC40 07:EC30: F0 08     BEQ $EC3A
C - - - - - 0x01EC42 07:EC32: A5 2E     LDA ram_002E
C - - - - - 0x01EC44 07:EC34: 29 08     AND #$08
C - - - - - 0x01EC46 07:EC36: D0 02     BNE $EC3A
C - - - - - 0x01EC48 07:EC38: E8        INX
C - - - - - 0x01EC49 07:EC39: E8        INX
C - - - - - 0x01EC4A 07:EC3A: A5 2C     LDA ram_002C
C - - - - - 0x01EC4C 07:EC3C: 29 03     AND #$03
C - - - - - 0x01EC4E 07:EC3E: F0 02     BEQ $EC42
C - - - - - 0x01EC50 07:EC40: C6 6A     DEC ram_006A
C - - - - - 0x01EC52 07:EC42: 29 01     AND #$01
C - - - - - 0x01EC54 07:EC44: F0 02     BEQ $EC48
...
C - - - - - 0x01EC69 07:EC59: 4C 5A CE  JMP $CE5A
C D 3 - - - 0x01EC6C 07:EC5C: 20 65 EC  JSR $EC65
C - - - - - 0x01EC6F 07:EC5F: 20 7A EC  JSR $EC7A
C - - - - - 0x01EC72 07:EC62: 4C B6 EC  JMP $ECB6
C - - - - - 0x01EC75 07:EC65: A5 6A     LDA ram_006A
C - - - - - 0x01EC77 07:EC67: 85 00     STA ram_0000
C - - - - - 0x01EC79 07:EC69: A5 64     LDA ram_0064
...
C - - - - - 0x01EC87 07:EC77: 4C 5A CE  JMP $CE5A
...
C - - - - - 0x01EC91 07:EC81: A5 64     LDA ram_0064
...
C - - - - - 0x01ECCD 07:ECBD: A5 64     LDA ram_0064
...
C - - - - - 0x01ED12 07:ED02: F0 10     BEQ $ED14
C - - - - - 0x01ED14 07:ED04: A2 02     LDX #$02
C - - - - - 0x01ED16 07:ED06: A5 6F     LDA ram_006F
C - - - - - 0x01ED18 07:ED08: C9 10     CMP #$10
C - - - - - 0x01ED1A 07:ED0A: 90 10     BCC $ED1C
C - - - - - 0x01ED1C 07:ED0C: C9 28     CMP #$28
C - - - - - 0x01ED1E 07:ED0E: B0 0C     BCS $ED1C
C - - - - - 0x01ED20 07:ED10: A2 03     LDX #$03
C - - - - - 0x01ED22 07:ED12: D0 08     BNE $ED1C
C - - - - - 0x01ED24 07:ED14: A5 2C     LDA ram_002C
C - - - - - 0x01ED26 07:ED16: 29 04     AND #$04
C - - - - - 0x01ED28 07:ED18: D0 02     BNE $ED1C
C - - - - - 0x01ED2A 07:ED1A: A2 01     LDX #$01
C - - - - - 0x01ED2C 07:ED1C: 20 46 EF  JSR $EF46
...
C - - - - - 0x01ED45 07:ED35: 10 F6     BPL $ED2D
...
C - - - - - 0x01ED63 07:ED53: AD 02 20  LDA $2002
C - - - - - 0x01ED66 07:ED56: A9 00     LDA #$00
C - - - - - 0x01ED68 07:ED58: 8D 03 20  STA $2003
C - - - - - 0x01ED6B 07:ED5B: A9 07     LDA #$07
C - - - - - 0x01ED6D 07:ED5D: 8D 14 40  STA $4014
C - - - - - 0x01ED70 07:ED60: 20 D9 C3  JSR $C3D9
C - - - - - 0x01ED73 07:ED63: 20 1B D1  JSR $D11B
C - - - - - 0x01ED76 07:ED66: A5 26     LDA ram_0026
C - - - - - 0x01ED78 07:ED68: 29 FC     AND #$FC
C - - - - - 0x01ED7A 07:ED6A: 8D 00 20  STA $2000
C - - - - - 0x01ED7D 07:ED6D: AD 02 20  LDA $2002
C - - - - - 0x01ED80 07:ED70: A9 00     LDA #$00
C - - - - - 0x01ED82 07:ED72: 8D 05 20  STA $2005
C - - - - - 0x01ED85 07:ED75: 8D 05 20  STA $2005
C - - - - - 0x01ED88 07:ED78: 20 D8 C4  JSR $C4D8
C - - - - - 0x01ED8B 07:ED7B: A5 3B     LDA ram_003B
C - - - - - 0x01ED8D 07:ED7D: 10 03     BPL $ED82
C - - - - - 0x01ED8F 07:ED7F: 4C 34 EE  JMP $EE34
C - - - - - 0x01ED92 07:ED82: 29 10     AND #$10
C - - - - - 0x01ED94 07:ED84: F0 03     BEQ $ED89
C - - - - - 0x01ED96 07:ED86: 4C 21 EE  JMP $EE21
C - - - - - 0x01ED99 07:ED89: 20 B3 C9  JSR $C9B3
C - - - - - 0x01ED9C 07:ED8C: 2C 02 20  BIT $2002
C - - - - - 0x01ED9F 07:ED8F: 70 FB     BVS $ED8C
C - - - - - 0x01EDA1 07:ED91: 2C 02 20  BIT $2002
C - - - - - 0x01EDA4 07:ED94: 50 FB     BVC $ED91
C - - - - - 0x01EDA6 07:ED96: 20 F5 C4  JSR $C4F5
C - - - - - 0x01EDA9 07:ED99: 20 C6 C3  JSR $C3C6
C - - - - - 0x01EDAC 07:ED9C: A5 19     LDA ram_0019
C - - - - - 0x01EDAE 07:ED9E: D0 68     BNE $EE08
C - - - - - 0x01EDB0 07:EDA0: E6 19     INC ram_0019
C - - - - - 0x01EDB2 07:EDA2: 24 3B     BIT ram_003B
C - - - - - 0x01EDB4 07:EDA4: 70 35     BVS $EDDB
C - - - - - 0x01EDB6 07:EDA6: A5 3B     LDA ram_003B
C - - - - - 0x01EDB8 07:EDA8: 29 20     AND #$20
C - - - - - 0x01EDBA 07:EDAA: D0 69     BNE $EE15
C - - - - - 0x01EDBC 07:EDAC: 20 58 C3  JSR $C358
C - - - - - 0x01EDBF 07:EDAF: 20 13 CE  JSR $CE13
C - - - - - 0x01EDC2 07:EDB2: 20 F4 DA  JSR $DAF4
C - - - - - 0x01EDC5 07:EDB5: A5 3B     LDA ram_003B
C - - - - - 0x01EDC7 07:EDB7: C9 0B     CMP #$0B
C - - - - - 0x01EDC9 07:EDB9: F0 54     BEQ $EE0F
C - - - - - 0x01EDCB 07:EDBB: 20 A9 F0  JSR $F0A9
C - - - - - 0x01EDCE 07:EDBE: 20 53 EE  JSR $EE53
C - - - - - 0x01EDD1 07:EDC1: A5 3B     LDA ram_003B
C - - - - - 0x01EDD3 07:EDC3: 6A        ROR
C - - - - - 0x01EDD4 07:EDC4: B0 55     BCS $EE1B
C - - - - - 0x01EDD6 07:EDC6: 20 9A B0  JSR $B09A
C - - - - - 0x01EDD9 07:EDC9: 20 4D AF  JSR $AF4D
C - - - - - 0x01EDDC 07:EDCC: 20 8C CB  JSR $CB8C
C - - - - - 0x01EDDF 07:EDCF: 20 D9 CB  JSR $CBD9
C - - - - - 0x01EDE2 07:EDD2: 20 5F CD  JSR $CD5F
C D 3 - - - 0x01EDE5 07:EDD5: 20 7B EF  JSR $EF7B
C - - - - - 0x01EDE8 07:EDD8: 4C E1 ED  JMP $EDE1
C - - - - - 0x01EDEB 07:EDDB: 20 86 EF  JSR $EF86
C - - - - - 0x01EDEE 07:EDDE: 20 38 CB  JSR $CB38
C D 3 - - - 0x01EDF1 07:EDE1: 20 6C C4  JSR $C46C
C - - - - - 0x01EDF4 07:EDE4: 20 85 C8  JSR $C885
C D 3 - - - 0x01EDF7 07:EDE7: A6 44     LDX ram_0044
C - - - - - 0x01EDF9 07:EDE9: 86 43     STX ram_0043
C - - - - - 0x01EDFB 07:EDEB: 20 F9 CE  JSR $CEF9
C - - - - - 0x01EDFE 07:EDEE: A9 07     LDA #$07
C - - - - - 0x01EE00 07:EDF0: A2 04     LDX #$04
C - - - - - 0x01EE02 07:EDF2: 8D 00 80  STA $8000
C - - - - - 0x01EE05 07:EDF5: 8E 01 80  STX $8001
C - - - - - 0x01EE08 07:EDF8: 20 F0 FF  JSR $FFF0
C - - - - - 0x01EE0B 07:EDFB: 20 1A EF  JSR $EF1A
...
C - - - - - 0x01EE1A 07:EE0A: 8D 00 80  STA $8000
C - - - - - 0x01EE1D 07:EE0D: D0 F3     BNE $EE02
C - - - - - 0x01EE1F 07:EE0F: 20 FE B5  JSR $B5FE
C - - - - - 0x01EE22 07:EE12: 20 6C C4  JSR $C46C
C - - - - - 0x01EE25 07:EE15: 20 7B EF  JSR $EF7B
C - - - - - 0x01EE28 07:EE18: 4C E7 ED  JMP $EDE7
C - - - - - 0x01EE2B 07:EE1B: 20 AA B3  JSR $B3AA
C - - - - - 0x01EE2E 07:EE1E: 4C D5 ED  JMP $EDD5
C D 3 - - - 0x01EE31 07:EE21: A5 19     LDA ram_0019
C - - - - - 0x01EE33 07:EE23: D0 E3     BNE $EE08
C - - - - - 0x01EE35 07:EE25: 20 58 C3  JSR $C358
C - - - - - 0x01EE38 07:EE28: 20 8E C7  JSR $C78E
C - - - - - 0x01EE3B 07:EE2B: 20 6C C4  JSR $C46C
C - - - - - 0x01EE3E 07:EE2E: 20 86 EF  JSR $EF86
C - - - - - 0x01EE41 07:EE31: 4C E7 ED  JMP $EDE7
C D 3 - - - 0x01EE44 07:EE34: 20 58 C3  JSR $C358
C - - - - - 0x01EE47 07:EE37: A5 3B     LDA ram_003B
C - - - - - 0x01EE49 07:EE39: C9 91     CMP #$91
C - - - - - 0x01EE4B 07:EE3B: F0 10     BEQ $EE4D
C - - - - - 0x01EE4D 07:EE3D: C9 93     CMP #$93
C - - - - - 0x01EE4F 07:EE3F: F0 CE     BEQ $EE0F
C - - - - - 0x01EE51 07:EE41: 20 69 C5  JSR $C569
C - - - - - 0x01EE54 07:EE44: 20 7B EF  JSR $EF7B
C - - - - - 0x01EE57 07:EE47: 20 6C C4  JSR $C46C
C - - - - - 0x01EE5A 07:EE4A: 4C E7 ED  JMP $EDE7
C - - - - - 0x01EE5D 07:EE4D: 20 3C C5  JSR $C53C
C - - - - - 0x01EE60 07:EE50: 4C D5 ED  JMP $EDD5
C - - - - - 0x01EE63 07:EE53: 20 69 EF  JSR $EF69
C - - - - - 0x01EE66 07:EE56: A2 00     LDX #$00
C - - - - - 0x01EE68 07:EE58: 20 5D EE  JSR $EE5D
...
C - - - - - 0x01EE72 07:EE62: B9 BA FC  LDA $FCBA,Y
C - - - - - 0x01EE75 07:EE65: 85 00     STA ram_0000
C - - - - - 0x01EE77 07:EE67: B9 BB FC  LDA $FCBB,Y
C - - - - - 0x01EE7A 07:EE6A: 85 01     STA ram_0001
C - - - - - 0x01EE7C 07:EE6C: 6C 00 00  JMP (ram_0000)
C - - J - - 0x01EE7F 07:EE6F: 20 25 EF  JSR $EF25
C - - - - - 0x01EE82 07:EE72: 20 00 A0  JSR $A000
C - - - - - 0x01EE85 07:EE75: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EE88 07:EE78: 20 25 EF  JSR $EF25
C - - - - - 0x01EE8B 07:EE7B: 20 03 A0  JSR $A003
C - - - - - 0x01EE8E 07:EE7E: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EE91 07:EE81: 20 25 EF  JSR $EF25
C - - - - - 0x01EE94 07:EE84: 20 06 A0  JSR $A006
C - - - - - 0x01EE97 07:EE87: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EE9A 07:EE8A: 20 25 EF  JSR $EF25
C - - - - - 0x01EE9D 07:EE8D: 20 09 A0  JSR $A009
C - - - - - 0x01EEA0 07:EE90: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEA3 07:EE93: 20 25 EF  JSR $EF25
C - - - - - 0x01EEA6 07:EE96: 20 0C A0  JSR $A00C
C - - - - - 0x01EEA9 07:EE99: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEAC 07:EE9C: 20 25 EF  JSR $EF25
C - - - - - 0x01EEAF 07:EE9F: 20 0F A0  JSR $A00F
C - - - - - 0x01EEB2 07:EEA2: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEB5 07:EEA5: 20 25 EF  JSR $EF25
C - - - - - 0x01EEB8 07:EEA8: 20 12 A0  JSR $A012
C - - - - - 0x01EEBB 07:EEAB: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEBE 07:EEAE: 20 25 EF  JSR $EF25
C - - - - - 0x01EEC1 07:EEB1: 20 15 A0  JSR $A015
C - - - - - 0x01EEC4 07:EEB4: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEC7 07:EEB7: 20 25 EF  JSR $EF25
C - - - - - 0x01EECA 07:EEBA: 20 18 A0  JSR $A018
C - - - - - 0x01EECD 07:EEBD: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EED0 07:EEC0: 20 25 EF  JSR $EF25
C - - - - - 0x01EED3 07:EEC3: 20 1B A0  JSR $A01B
C - - - - - 0x01EED6 07:EEC6: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EED9 07:EEC9: 20 25 EF  JSR $EF25
C - - - - - 0x01EEDC 07:EECC: 20 1E A0  JSR $A01E
C - - - - - 0x01EEDF 07:EECF: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEE2 07:EED2: 20 30 EF  JSR $EF30
C - - - - - 0x01EEE5 07:EED5: 20 00 A0  JSR $A000
C - - - - - 0x01EEE8 07:EED8: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEEB 07:EEDB: 20 30 EF  JSR $EF30
C - - - - - 0x01EEEE 07:EEDE: 20 03 A0  JSR $A003
C - - - - - 0x01EEF1 07:EEE1: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEF4 07:EEE4: 20 30 EF  JSR $EF30
C - - - - - 0x01EEF7 07:EEE7: 20 06 A0  JSR $A006
C - - - - - 0x01EEFA 07:EEEA: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EEFD 07:EEED: 20 30 EF  JSR $EF30
C - - - - - 0x01EF00 07:EEF0: 20 09 A0  JSR $A009
C - - - - - 0x01EF03 07:EEF3: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EF06 07:EEF6: 20 30 EF  JSR $EF30
C - - - - - 0x01EF09 07:EEF9: 20 0C A0  JSR $A00C
C - - - - - 0x01EF0C 07:EEFC: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EF0F 07:EEFF: 20 30 EF  JSR $EF30
C - - - - - 0x01EF12 07:EF02: 20 0F A0  JSR $A00F
C - - - - - 0x01EF15 07:EF05: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EF18 07:EF08: 20 30 EF  JSR $EF30
C - - - - - 0x01EF1B 07:EF0B: 20 12 A0  JSR $A012
C - - - - - 0x01EF1E 07:EF0E: 4C 1A EF  JMP $EF1A
C - - J - - 0x01EF21 07:EF11: 20 30 EF  JSR $EF30
C - - - - - 0x01EF24 07:EF14: 20 15 A0  JSR $A015
C - - - - - 0x01EF27 07:EF17: 4C 1A EF  JMP $EF1A
C D 3 - - - 0x01EF2A 07:EF1A: A9 07     LDA #$07
C - - - - - 0x01EF2C 07:EF1C: 8D 00 80  STA $8000
C - - - - - 0x01EF2F 07:EF1F: A9 0D     LDA #$0D
C - - - - - 0x01EF31 07:EF21: 8D 01 80  STA $8001
C - - - - - 0x01EF34 07:EF24: 60        RTS
C - - - - - 0x01EF35 07:EF25: A9 07     LDA #$07
C - - - - - 0x01EF37 07:EF27: 8D 00 80  STA $8000
C - - - - - 0x01EF3A 07:EF2A: A9 0C     LDA #$0C
C - - - - - 0x01EF3C 07:EF2C: 8D 01 80  STA $8001
C - - - - - 0x01EF3F 07:EF2F: 60        RTS
C - - - - - 0x01EF40 07:EF30: A9 07     LDA #$07
C - - - - - 0x01EF42 07:EF32: 8D 00 80  STA $8000
C - - - - - 0x01EF45 07:EF35: A9 07     LDA #$07
C - - - - - 0x01EF47 07:EF37: 8D 01 80  STA $8001
C - - - - - 0x01EF4A 07:EF3A: 60        RTS
C - - - - - 0x01EF4B 07:EF3B: A9 06     LDA #$06
C - - - - - 0x01EF4D 07:EF3D: 8D 00 80  STA $8000
C - - - - - 0x01EF50 07:EF40: A9 04     LDA #$04
C - - - - - 0x01EF52 07:EF42: 8D 01 80  STA $8001
C - - - - - 0x01EF55 07:EF45: 60        RTS
C - - - - - 0x01EF56 07:EF46: A9 06     LDA #$06
C - - - - - 0x01EF58 07:EF48: 8D 00 80  STA $8000
C - - - - - 0x01EF5B 07:EF4B: A9 08     LDA #$08
C - - - - - 0x01EF5D 07:EF4D: D0 07     BNE $EF56
C D 3 - - - 0x01EF5F 07:EF4F: A9 06     LDA #$06
C - - - - - 0x01EF61 07:EF51: 8D 00 80  STA $8000
C - - - - - 0x01EF64 07:EF54: A9 09     LDA #$09
C - - - - - 0x01EF66 07:EF56: 8D 01 80  STA $8001
C - - - - - 0x01EF69 07:EF59: 8D B5 06  STA ram_06B5
C - - - - - 0x01EF6C 07:EF5C: 60        RTS
C D 3 - - - 0x01EF6D 07:EF5D: A9 06     LDA #$06
C - - - - - 0x01EF6F 07:EF5F: 8D 00 80  STA $8000
C - - - - - 0x01EF72 07:EF62: AD B5 06  LDA ram_06B5
C - - - - - 0x01EF75 07:EF65: 8D 01 80  STA $8001
C - - - - - 0x01EF78 07:EF68: 60        RTS
C - - - - - 0x01EF79 07:EF69: A2 00     LDX #$00
C - - - - - 0x01EF7B 07:EF6B: AD 9E 03  LDA ram_039E
C - - - - - 0x01EF7E 07:EF6E: 10 0A     BPL $EF7A
C - - - - - 0x01EF80 07:EF70: AD 98 03  LDA ram_0398
C - - - - - 0x01EF83 07:EF73: C9 01     CMP #$01
C - - - - - 0x01EF85 07:EF75: D0 03     BNE $EF7A
C - - - - - 0x01EF87 07:EF77: 4C 38 DA  JMP $DA38
C - - - - - 0x01EF8A 07:EF7A: 60        RTS
C - - - - - 0x01EF8B 07:EF7B: A2 04     LDX #$04
C - - - - - 0x01EF8D 07:EF7D: B5 2E     LDA ram_002E,X
C - - - - - 0x01EF8F 07:EF7F: F0 02     BEQ $EF83
C - - - - - 0x01EF91 07:EF81: D6 2E     DEC ram_002E,X
C - - - - - 0x01EF93 07:EF83: CA        DEX
C - - - - - 0x01EF94 07:EF84: 10 F7     BPL $EF7D
C - - - - - 0x01EF96 07:EF86: E6 2C     INC ram_002C
C - - - - - 0x01EF98 07:EF88: D0 02     BNE $EF8C
C - - - - - 0x01EF9A 07:EF8A: E6 2D     INC ram_002D
...
C - - - - - 0x01EFC2 07:EFB2: 10 FA     BPL $EFAE
C - - - - - 0x01EFC4 07:EFB4: 20 4F EF  JSR $EF4F
...
C - - - - - 0x01EFE3 07:EFD3: D0 F8     BNE $EFCD
...
C - - - - - 0x01EFF8 07:EFE8: D0 F8     BNE $EFE2
C - - - - - 0x01EFFA 07:EFEA: 20 46 EF  JSR $EF46
...
C - - - - - 0x01F014 07:F004: 10 FA     BPL $F000
C - - - - - 0x01F016 07:F006: A2 05     LDX #$05
C - - - - - 0x01F018 07:F008: A4 3C     LDY ram_003C
C - - - - - 0x01F01A 07:F00A: 10 0C     BPL $F018
C - - - - - 0x01F01C 07:F00C: AC 00 03  LDY ram_0300
C - - - - - 0x01F01F 07:F00F: C0 0C     CPY #$0C
C - - - - - 0x01F021 07:F011: F0 10     BEQ $F023
C - - - - - 0x01F023 07:F013: 20 28 FC  JSR $FC28
C - - - - - 0x01F026 07:F016: B0 0B     BCS $F023
...
C - - - - - 0x01F04E 07:F03E: 10 C8     BPL $F008
...
C - - - - - 0x01F05E 07:F04E: 10 FA     BPL $F04A
...
C - - - - - 0x01F077 07:F067: 10 F4     BPL $F05D
C - - - - - 0x01F079 07:F069: 20 75 F0  JSR $F075
C - - - - - 0x01F07C 07:F06C: A9 00     LDA #$00
C - - - - - 0x01F07E 07:F06E: 8D 14 03  STA ram_0314
C - - - - - 0x01F081 07:F071: 8D 15 03  STA ram_0315
...
C - - - - - 0x01F08C 07:F07C: 10 FB     BPL $F079
C - - - - - 0x01F08E 07:F07E: 60        RTS
C - - - - - 0x01F08F 07:F07F: A5 6D     LDA ram_006D
C - - - - - 0x01F091 07:F081: 30 25     BMI $F0A8
C - - - - - 0x01F093 07:F083: A2 00     LDX #$00
C - - - - - 0x01F095 07:F085: A5 6C     LDA ram_006C
C - - - - - 0x01F097 07:F087: 6A        ROR
C - - - - - 0x01F098 07:F088: 90 02     BCC $F08C
C - - - - - 0x01F09A 07:F08A: A2 02     LDX #$02
C - - - - - 0x01F09C 07:F08C: 86 2C     STX ram_002C
C - - - - - 0x01F09E 07:F08E: 20 B2 F2  JSR $F2B2
C - - - - - 0x01F0A1 07:F091: 90 15     BCC $F0A8
C - - - - - 0x01F0A3 07:F093: A5 0A     LDA ram_000A
C - - - - - 0x01F0A5 07:F095: C9 0C     CMP #$0C
C - - - - - 0x01F0A7 07:F097: F0 1F     BEQ $F0B8
C - - - - - 0x01F0A9 07:F099: C9 30     CMP #$30
C - - - - - 0x01F0AB 07:F09B: 90 0B     BCC $F0A8
C - - - - - 0x01F0AD 07:F09D: C9 33     CMP #$33
C - - - - - 0x01F0AF 07:F09F: B0 07     BCS $F0A8
C - - - - - 0x01F0B1 07:F0A1: A9 18     LDA #$18
C - - - - - 0x01F0B3 07:F0A3: 8D B4 06  STA ram_06B4
C - - - - - 0x01F0B6 07:F0A6: D0 10     BNE $F0B8
C - - - - - 0x01F0B8 07:F0A8: 60        RTS
C - - - - - 0x01F0B9 07:F0A9: A5 6D     LDA ram_006D
C - - - - - 0x01F0BB 07:F0AB: 10 03     BPL $F0B0
C - - - - - 0x01F0BD 07:F0AD: 4C 59 F2  JMP $F259
C - - - - - 0x01F0C0 07:F0B0: 20 B2 F2  JSR $F2B2
C - - - - - 0x01F0C3 07:F0B3: B0 03     BCS $F0B8
C - - - - - 0x01F0C5 07:F0B5: 4C 46 F1  JMP $F146
C - - - - - 0x01F0C8 07:F0B8: A2 01     LDX #$01
C - - - - - 0x01F0CA 07:F0BA: A0 15     LDY #$15
C - - - - - 0x01F0CC 07:F0BC: A5 0A     LDA ram_000A
C - - - - - 0x01F0CE 07:F0BE: D9 FC F8  CMP $F8FC,Y
C - - - - - 0x01F0D1 07:F0C1: F0 04     BEQ $F0C7
C - - - - - 0x01F0D3 07:F0C3: 88        DEY
C - - - - - 0x01F0D4 07:F0C4: 10 F8     BPL $F0BE
C - - - - - 0x01F0D6 07:F0C6: CA        DEX
C D 3 - - - 0x01F0D7 07:F0C7: 20 EB F1  JSR $F1EB
C - - - - - 0x01F0DA 07:F0CA: 90 44     BCC $F110
C - - - - - 0x01F0DC 07:F0CC: BD 00 03  LDA ram_0300,X
C - - - - - 0x01F0DF 07:F0CF: F0 16     BEQ $F0E7
C - - - - - 0x01F0E1 07:F0D1: A5 0A     LDA ram_000A
C - - - - - 0x01F0E3 07:F0D3: DD 00 03  CMP ram_0300,X
C - - - - - 0x01F0E6 07:F0D6: F0 0F     BEQ $F0E7
C - - - - - 0x01F0E8 07:F0D8: C9 0C     CMP #$0C
C - - - - - 0x01F0EA 07:F0DA: D0 34     BNE $F110
...
C - - - - - 0x01F115 07:F105: 20 27 F3  JSR $F327
C - - - - - 0x01F118 07:F108: A9 00     LDA #$00
C - - - - - 0x01F11A 07:F10A: 8D 14 03  STA ram_0314
C - - - - - 0x01F11D 07:F10D: 8D 15 03  STA ram_0315
C - - - - - 0x01F120 07:F110: 24 3C     BIT ram_003C
C - - - - - 0x01F122 07:F112: 70 31     BVS $F145
C - - - - - 0x01F124 07:F114: A5 6D     LDA ram_006D
C - - - - - 0x01F126 07:F116: 30 0D     BMI $F125
C - - - - - 0x01F128 07:F118: A5 46     LDA ram_0046
C - - - - - 0x01F12A 07:F11A: C9 19     CMP #$19
C - - - - - 0x01F12C 07:F11C: F0 07     BEQ $F125
C - - - - - 0x01F12E 07:F11E: AD 17 03  LDA ram_0317
C - - - - - 0x01F131 07:F121: C9 4B     CMP #$4B
C - - - - - 0x01F133 07:F123: B0 66     BCS $F18B
C - - - - - 0x01F135 07:F125: A2 06     LDX #$06
C - - - - - 0x01F137 07:F127: FE 19 03  INC ram_0319,X
C - - - - - 0x01F13A 07:F12A: D0 03     BNE $F12F
C - - - - - 0x01F13C 07:F12C: FE 18 03  INC ram_0318,X
C - - - - - 0x01F13F 07:F12F: CA        DEX
C - - - - - 0x01F140 07:F130: CA        DEX
C - - - - - 0x01F141 07:F131: 10 F4     BPL $F127
C - - - - - 0x01F143 07:F133: EE 16 03  INC ram_0316
C - - - - - 0x01F146 07:F136: D0 0D     BNE $F145
C - - - - - 0x01F148 07:F138: EE 17 03  INC ram_0317
C - - - - - 0x01F14B 07:F13B: A9 4B     LDA #$4B
C - - - - - 0x01F14D 07:F13D: CD 17 03  CMP ram_0317
C - - - - - 0x01F150 07:F140: B0 03     BCS $F145
- - - - - - 0x01F152 07:F142: 8D        .byte $8D   ; 
- - - - - - 0x01F153 07:F143: 17        .byte $17   ; 
- - - - - - 0x01F154 07:F144: 03        .byte $03   ; 
C - - - - - 0x01F155 07:F145: 60        RTS
C D 3 - - - 0x01F156 07:F146: AD 0A 03  LDA ram_030A
C - - - - - 0x01F159 07:F149: D0 C5     BNE $F110
C - - - - - 0x01F15B 07:F14B: AD 0B 03  LDA ram_030B
C - - - - - 0x01F15E 07:F14E: D0 C0     BNE $F110
C - - - - - 0x01F160 07:F150: EE 14 03  INC ram_0314
C - - - - - 0x01F163 07:F153: D0 03     BNE $F158
C - - - - - 0x01F165 07:F155: EE 15 03  INC ram_0315
C - - - - - 0x01F168 07:F158: AD 15 03  LDA ram_0315
C - - - - - 0x01F16B 07:F15B: C9 03     CMP #$03
C - - - - - 0x01F16D 07:F15D: 90 B1     BCC $F110
C - - - - - 0x01F16F 07:F15F: AD 00 03  LDA ram_0300
C - - - - - 0x01F172 07:F162: C9 07     CMP #$07
C - - - - - 0x01F174 07:F164: F0 DF     BEQ $F145
C - - - - - 0x01F176 07:F166: A4 46     LDY ram_0046
C - - - - - 0x01F178 07:F168: A9 00     LDA #$00
C - - - - - 0x01F17A 07:F16A: 20 1F F2  JSR $F21F
C - - - - - 0x01F17D 07:F16D: 20 77 F1  JSR $F177
C - - - - - 0x01F180 07:F170: A4 46     LDY ram_0046
C - - - - - 0x01F182 07:F172: A9 01     LDA #$01
C - - - - - 0x01F184 07:F174: 20 1F F2  JSR $F21F
C - - - - - 0x01F187 07:F177: F0 CC     BEQ $F145
C - - - - - 0x01F189 07:F179: A5 0A     LDA ram_000A
C - - - - - 0x01F18B 07:F17B: C9 21     CMP #$21
C - - - - - 0x01F18D 07:F17D: F0 04     BEQ $F183
C - - - - - 0x01F18F 07:F17F: C9 27     CMP #$27
C - - - - - 0x01F191 07:F181: D0 05     BNE $F188
C - - - - - 0x01F193 07:F183: 20 95 F2  JSR $F295
C - - - - - 0x01F196 07:F186: B0 BD     BCS $F145
C - - - - - 0x01F198 07:F188: 4C E7 F0  JMP $F0E7
C - - - - - 0x01F19B 07:F18B: 20 FE BB  JSR $BBFE
C - - - - - 0x01F19E 07:F18E: B0 B5     BCS $F145
C - - - - - 0x01F1A0 07:F190: AD 0A 03  LDA ram_030A
C - - - - - 0x01F1A3 07:F193: D0 B0     BNE $F145
C - - - - - 0x01F1A5 07:F195: AD 0B 03  LDA ram_030B
C - - - - - 0x01F1A8 07:F198: D0 AB     BNE $F145
C - - - - - 0x01F1AA 07:F19A: 24 D1     BIT ram_00D1
C - - - - - 0x01F1AC 07:F19C: 30 A7     BMI $F145
...
C - - - - - 0x01F1BD 07:F1AD: 90 02     BCC $F1B1
...
C - - - - - 0x01F1CD 07:F1BD: 20 95 F2  JSR $F295
C - - - - - 0x01F1D0 07:F1C0: B0 83     BCS $F145
...
C - - - - - 0x01F1E2 07:F1D2: F0 04     BEQ $F1D8
...
C - - - - - 0x01F1F8 07:F1E8: 4C E7 F0  JMP $F0E7
C - - - - - 0x01F1FB 07:F1EB: 20 38 F2  JSR $F238
C - - - - - 0x01F1FE 07:F1EE: F0 2D     BEQ $F21D
...
C - - - - - 0x01F23F 07:F22F: 20 46 EF  JSR $EF46
...
C - - - - - 0x01F24C 07:F23C: F0 1A     BEQ $F258
C - - - - - 0x01F24E 07:F23E: C9 0D     CMP #$0D
C - - - - - 0x01F250 07:F240: F0 16     BEQ $F258
C - - - - - 0x01F252 07:F242: C9 15     CMP #$15
C - - - - - 0x01F254 07:F244: F0 12     BEQ $F258
C - - - - - 0x01F256 07:F246: C9 1E     CMP #$1E
C - - - - - 0x01F258 07:F248: F0 0E     BEQ $F258
C - - - - - 0x01F25A 07:F24A: C9 39     CMP #$39
C - - - - - 0x01F25C 07:F24C: F0 0A     BEQ $F258
C - - - - - 0x01F25E 07:F24E: C9 30     CMP #$30
C - - - - - 0x01F260 07:F250: F0 06     BEQ $F258
C - - - - - 0x01F262 07:F252: C9 31     CMP #$31
C - - - - - 0x01F264 07:F254: F0 02     BEQ $F258
C - - - - - 0x01F266 07:F256: C9 32     CMP #$32
C - - - - - 0x01F268 07:F258: 60        RTS
C D 3 - - - 0x01F269 07:F259: A5 2B     LDA ram_002B
C - - - - - 0x01F26B 07:F25B: 29 1F     AND #$1F
C - - - - - 0x01F26D 07:F25D: D0 F9     BNE $F258
C - - - - - 0x01F26F 07:F25F: 20 64 D0  JSR $D064
C - - - - - 0x01F272 07:F262: 29 03     AND #$03
C - - - - - 0x01F274 07:F264: D0 F2     BNE $F258
C - - - - - 0x01F276 07:F266: A9 08     LDA #$08
C - - - - - 0x01F278 07:F268: A0 00     LDY #$00
C - - - - - 0x01F27A 07:F26A: 24 35     BIT ram_0035
C - - - - - 0x01F27C 07:F26C: 30 03     BMI $F271
...
C - - - - - 0x01F292 07:F282: 20 3B EF  JSR $EF3B
C - - - - - 0x01F295 07:F285: 20 64 D0  JSR $D064
...
C - - - - - 0x01F2A2 07:F292: 4C C7 F0  JMP $F0C7
...
C - - - - - 0x01F2AF 07:F29F: 20 E5 D2  JSR $D2E5
C - - - - - 0x01F2B2 07:F2A2: C9 01     CMP #$01
C - - - - - 0x01F2B4 07:F2A4: D0 04     BNE $F2AA
...
C - - - - - 0x01F2C7 07:F2B7: F0 41     BEQ $F2FA
C - - - - - 0x01F2C9 07:F2B9: 20 4F EF  JSR $EF4F
...
C - - - - - 0x01F2DA 07:F2CA: A5 2C     LDA ram_002C
C - - - - - 0x01F2DC 07:F2CC: 29 07     AND #$07
C - - - - - 0x01F2DE 07:F2CE: F0 06     BEQ $F2D6
C - - - - - 0x01F2E0 07:F2D0: 29 01     AND #$01
C - - - - - 0x01F2E2 07:F2D2: D0 26     BNE $F2FA
...
C - - - - - 0x01F314 07:F304: B0 03     BCS $F309
C - - - - - 0x01F316 07:F306: 20 73 D0  JSR $D073
C - - - - - 0x01F319 07:F309: C9 0A     CMP #$0A
C - - - - - 0x01F31B 07:F30B: B0 E3     BCS $F2F0
...
C D 3 - - - 0x01F337 07:F327: BD 00 03  LDA ram_0300,X
C - - - - - 0x01F33A 07:F32A: 0A        ASL
C - - - - - 0x01F33B 07:F32B: AA        TAX
C - - - - - 0x01F33C 07:F32C: BD 88 F8  LDA $F888,X
C - - - - - 0x01F33F 07:F32F: 85 14     STA ram_0014
C - - - - - 0x01F341 07:F331: BD 89 F8  LDA $F889,X
...
C - - - - - 0x01F37C 07:F36C: 90 02     BCC $F370
...
C - - - - - 0x01F387 07:F377: 10 01     BPL $F37A
...
C - - - - - 0x01F39F 07:F38F: 10 01     BPL $F392
...
C - - J - - 0x01F3B2 07:F3A2: 20 72 F3  JSR $F372
C - - - - - 0x01F3B5 07:F3A5: 20 59 F3  JSR $F359
...
C - - - - - 0x01F3C4 07:F3B4: F0 05     BEQ $F3BB
C - - - - - 0x01F3C6 07:F3B6: C8        INY
C - - - - - 0x01F3C7 07:F3B7: C0 0F     CPY #$0F
C - - - - - 0x01F3C9 07:F3B9: D0 F6     BNE $F3B1
...
C - - - - - 0x01F4A2 07:F492: F0 09     BEQ $F49D
C - - - - - 0x01F4A4 07:F494: C0 27     CPY #$27
C - - - - - 0x01F4A6 07:F496: F0 1E     BEQ $F4B6
C - - - - - 0x01F4A8 07:F498: 8D B3 06  STA ram_06B3
C - - - - - 0x01F4AB 07:F49B: D0 03     BNE $F4A0
...
C - - - - - 0x01F4F9 07:F4E9: D0 11     BNE $F4FC
...
C - - - - - 0x01F565 07:F555: D0 06     BNE $F55D
...
C - - - - - 0x01F56D 07:F55D: 20 72 F3  JSR $F372
C - - - - - 0x01F570 07:F560: 20 59 F3  JSR $F359
...
C - - - - - 0x01F580 07:F570: F0 0C     BEQ $F57E
C - - - - - 0x01F582 07:F572: C9 20     CMP #$20
C - - - - - 0x01F584 07:F574: F0 04     BEQ $F57A
C - - - - - 0x01F586 07:F576: A9 11     LDA #$11
C - - - - - 0x01F588 07:F578: D0 06     BNE $F580
C - - - - - 0x01F58A 07:F57A: A9 15     LDA #$15
C - - - - - 0x01F58C 07:F57C: D0 02     BNE $F580
...
C - - - - - 0x01F59D 07:F58D: 4C 4A F8  JMP $F84A
C - - J - - 0x01F5A0 07:F590: 20 8A F3  JSR $F38A
C - - - - - 0x01F5A3 07:F593: 20 60 F3  JSR $F360
C - - - - - 0x01F5A6 07:F596: A0 00     LDY #$00
C - - - - - 0x01F5A8 07:F598: AD 01 03  LDA ram_0301
C - - - - - 0x01F5AB 07:F59B: D9 CC BD  CMP $BDCC,Y
C - - - - - 0x01F5AE 07:F59E: F0 05     BEQ $F5A5
C - - - - - 0x01F5B0 07:F5A0: C8        INY
C - - - - - 0x01F5B1 07:F5A1: C0 06     CPY #$06
C - - - - - 0x01F5B3 07:F5A3: D0 F6     BNE $F59B
...
C - - - - - 0x01F5E2 07:F5D2: F0 0F     BEQ $F5E3
C - - - - - 0x01F5E4 07:F5D4: C9 23     CMP #$23
C - - - - - 0x01F5E6 07:F5D6: F0 13     BEQ $F5EB
C - - - - - 0x01F5E8 07:F5D8: C9 21     CMP #$21
C - - - - - 0x01F5EA 07:F5DA: F0 1B     BEQ $F5F7
C - - - - - 0x01F5EC 07:F5DC: C9 34     CMP #$34
C - - - - - 0x01F5EE 07:F5DE: F0 25     BEQ $F605
C - - - - - 0x01F5F0 07:F5E0: 4C 20 F8  JMP $F820
C - - - - - 0x01F5F3 07:F5E3: A5 0B     LDA ram_000B
C - - - - - 0x01F5F5 07:F5E5: 6A        ROR
C - - - - - 0x01F5F6 07:F5E6: 90 33     BCC $F61B
C - - - - - 0x01F5F8 07:F5E8: 4C 20 F8  JMP $F820
C - - - - - 0x01F5FB 07:F5EB: 20 21 F6  JSR $F621
...
C - - - - - 0x01F60B 07:F5FB: D0 05     BNE $F602
C - - - - - 0x01F60D 07:F5FD: A5 0B     LDA ram_000B
C - - - - - 0x01F60F 07:F5FF: 6A        ROR
C - - - - - 0x01F610 07:F600: 90 19     BCC $F61B
C - - - - - 0x01F612 07:F602: 4C 20 F8  JMP $F820
C - - - - - 0x01F615 07:F605: 20 21 F6  JSR $F621
...
C - - - - - 0x01F628 07:F618: 4C 20 F8  JMP $F820
C D 3 - - - 0x01F62B 07:F61B: 20 7E D8  JSR $D87E
...
C - - J - - 0x01F644 07:F634: 20 39 F3  JSR $F339
C - - - - - 0x01F647 07:F637: 20 8A F3  JSR $F38A
...
C - - - - - 0x01F677 07:F667: 4C 20 F8  JMP $F820
C - - J - - 0x01F67A 07:F66A: 20 72 F3  JSR $F372
C - - - - - 0x01F67D 07:F66D: A0 D0     LDY #$D0
C - - - - - 0x01F67F 07:F66F: A5 0B     LDA ram_000B
C - - - - - 0x01F681 07:F671: 6A        ROR
C - - - - - 0x01F682 07:F672: 90 02     BCC $F676
...
C - - - - - 0x01F694 07:F684: F0 0E     BEQ $F694
...
C - - - - - 0x01F6A2 07:F692: D0 11     BNE $F6A5
...
C - - - - - 0x01F6B8 07:F6A8: 4C 4A F8  JMP $F84A
C - - J - - 0x01F6BB 07:F6AB: A2 00     LDX #$00
C - - - - - 0x01F6BD 07:F6AD: A5 01     LDA ram_0001
C - - - - - 0x01F6BF 07:F6AF: C9 C4     CMP #$C4
C - - - - - 0x01F6C1 07:F6B1: F0 05     BEQ $F6B8
C - - - - - 0x01F6C3 07:F6B3: C9 44     CMP #$44
C - - - - - 0x01F6C5 07:F6B5: F0 01     BEQ $F6B8
C - - - - - 0x01F6C7 07:F6B7: E8        INX
C - - - - - 0x01F6C8 07:F6B8: BD 20 03  LDA ram_0320,X
C - - - - - 0x01F6CB 07:F6BB: 10 03     BPL $F6C0
C - - - - - 0x01F6CD 07:F6BD: 4C 8F D7  JMP $D78F
C - - - - - 0x01F6D0 07:F6C0: 20 7A F3  JSR $F37A
...
C - - - - - 0x01F6EC 07:F6DC: 4C 4A F8  JMP $F84A
...
C - - - - - 0x01F717 07:F707: D0 3F     BNE $F748
...
C - - - - - 0x01F758 07:F748: 20 92 F3  JSR $F392
...
C - - - - - 0x01F76F 07:F75F: 4C 20 F8  JMP $F820
C - - J - - 0x01F772 07:F762: 20 8A F3  JSR $F38A
C - - - - - 0x01F775 07:F765: 20 60 F3  JSR $F360
...
C - - - - - 0x01F7AB 07:F79B: D0 06     BNE $F7A3
C - - - - - 0x01F7AD 07:F79D: 20 E0 F7  JSR $F7E0
C - - - - - 0x01F7B0 07:F7A0: 4C C1 F7  JMP $F7C1
...
C - - - - - 0x01F7FD 07:F7ED: F0 05     BEQ $F7F4
...
C - - - - - 0x01F82B 07:F81B: 10 C7     BPL $F7E4
C - - - - - 0x01F82D 07:F81D: A0 0C     LDY #$0C
C - - - - - 0x01F82F 07:F81F: 60        RTS
C D 3 - - - 0x01F830 07:F820: 20 46 EF  JSR $EF46
C - - - - - 0x01F833 07:F823: AD 01 03  LDA ram_0301
C - - - - - 0x01F836 07:F826: 20 74 F8  JSR $F874
...
C - - - - - 0x01F841 07:F831: 10 F8     BPL $F82B
...
C D 3 - - - 0x01F85A 07:F84A: 20 46 EF  JSR $EF46
C - - - - - 0x01F85D 07:F84D: AD 00 03  LDA ram_0300
C - - - - - 0x01F860 07:F850: 20 74 F8  JSR $F874
...
C - - - - - 0x01F86B 07:F85B: 10 F8     BPL $F855
...
- - - - - - 0x01F898 07:F888: 87        .byte $87   ; 
- - - - - - 0x01F899 07:F889: F8        .byte $F8   ; 
- D 3 - - - 0x01F89A 07:F88A: A2        .byte $A2   ; 
- D 3 - - - 0x01F89B 07:F88B: F3        .byte $F3   ; 
- D 3 - - - 0x01F89C 07:F88C: 3E        .byte $3E   ; 
- D 3 - - - 0x01F89D 07:F88D: F4        .byte $F4   ; 
- D 3 - - - 0x01F89E 07:F88E: 3E        .byte $3E   ; 
- D 3 - - - 0x01F89F 07:F88F: F4        .byte $F4   ; 
- D 3 - - - 0x01F8A0 07:F890: CB        .byte $CB   ; 
- D 3 - - - 0x01F8A1 07:F891: F4        .byte $F4   ; 
- D 3 - - - 0x01F8A2 07:F892: CB        .byte $CB   ; 
- D 3 - - - 0x01F8A3 07:F893: F4        .byte $F4   ; 
- D 3 - - - 0x01F8A4 07:F894: CB        .byte $CB   ; 
- D 3 - - - 0x01F8A5 07:F895: F4        .byte $F4   ; 
- D 3 - - - 0x01F8A6 07:F896: A2        .byte $A2   ; 
- D 3 - - - 0x01F8A7 07:F897: F3        .byte $F3   ; 
- D 3 - - - 0x01F8A8 07:F898: 3D        .byte $3D   ; 
- D 3 - - - 0x01F8A9 07:F899: F5        .byte $F5   ; 
- D 3 - - - 0x01F8AA 07:F89A: A2        .byte $A2   ; 
- D 3 - - - 0x01F8AB 07:F89B: F3        .byte $F3   ; 
- D 3 - - - 0x01F8AC 07:F89C: 90        .byte $90   ; 
- D 3 - - - 0x01F8AD 07:F89D: F5        .byte $F5   ; 
- D 3 - - - 0x01F8AE 07:F89E: 6A        .byte $6A   ; 
- D 3 - - - 0x01F8AF 07:F89F: F6        .byte $F6   ; 
- D 3 - - - 0x01F8B0 07:F8A0: AB        .byte $AB   ; 
- D 3 - - - 0x01F8B1 07:F8A1: F6        .byte $F6   ; 
- D 3 - - - 0x01F8B2 07:F8A2: 34        .byte $34   ; 
- D 3 - - - 0x01F8B3 07:F8A3: F6        .byte $F6   ; 
- D 3 - - - 0x01F8B4 07:F8A4: 3E        .byte $3E   ; 
- D 3 - - - 0x01F8B5 07:F8A5: F4        .byte $F4   ; 
- D 3 - - - 0x01F8B6 07:F8A6: 90        .byte $90   ; 
- D 3 - - - 0x01F8B7 07:F8A7: F5        .byte $F5   ; 
- D 3 - - - 0x01F8B8 07:F8A8: 6A        .byte $6A   ; 
- D 3 - - - 0x01F8B9 07:F8A9: F6        .byte $F6   ; 
- D 3 - - - 0x01F8BA 07:F8AA: A2        .byte $A2   ; 
- D 3 - - - 0x01F8BB 07:F8AB: F3        .byte $F3   ; 
- D 3 - - - 0x01F8BC 07:F8AC: 3E        .byte $3E   ; 
- D 3 - - - 0x01F8BD 07:F8AD: F4        .byte $F4   ; 
- D 3 - - - 0x01F8BE 07:F8AE: 3E        .byte $3E   ; 
- D 3 - - - 0x01F8BF 07:F8AF: F4        .byte $F4   ; 
- D 3 - - - 0x01F8C0 07:F8B0: 3D        .byte $3D   ; 
- D 3 - - - 0x01F8C1 07:F8B1: F5        .byte $F5   ; 
- D 3 - - - 0x01F8C2 07:F8B2: 34        .byte $34   ; 
- D 3 - - - 0x01F8C3 07:F8B3: F6        .byte $F6   ; 
- D 3 - - - 0x01F8C4 07:F8B4: 90        .byte $90   ; 
- D 3 - - - 0x01F8C5 07:F8B5: F5        .byte $F5   ; 
- D 3 - - - 0x01F8C6 07:F8B6: A2        .byte $A2   ; 
- D 3 - - - 0x01F8C7 07:F8B7: F3        .byte $F3   ; 
- D 3 - - - 0x01F8C8 07:F8B8: A2        .byte $A2   ; 
- D 3 - - - 0x01F8C9 07:F8B9: F3        .byte $F3   ; 
- D 3 - - - 0x01F8CA 07:F8BA: A2        .byte $A2   ; 
- D 3 - - - 0x01F8CB 07:F8BB: F3        .byte $F3   ; 
- D 3 - - - 0x01F8CC 07:F8BC: A2        .byte $A2   ; 
- D 3 - - - 0x01F8CD 07:F8BD: F3        .byte $F3   ; 
- D 3 - - - 0x01F8CE 07:F8BE: A2        .byte $A2   ; 
- D 3 - - - 0x01F8CF 07:F8BF: F3        .byte $F3   ; 
- D 3 - - - 0x01F8D0 07:F8C0: A2        .byte $A2   ; 
- D 3 - - - 0x01F8D1 07:F8C1: F3        .byte $F3   ; 
- D 3 - - - 0x01F8D2 07:F8C2: 90        .byte $90   ; 
- D 3 - - - 0x01F8D3 07:F8C3: F5        .byte $F5   ; 
- D 3 - - - 0x01F8D4 07:F8C4: 34        .byte $34   ; 
- D 3 - - - 0x01F8D5 07:F8C5: F6        .byte $F6   ; 
- D 3 - - - 0x01F8D6 07:F8C6: A2        .byte $A2   ; 
- D 3 - - - 0x01F8D7 07:F8C7: F3        .byte $F3   ; 
- D 3 - - - 0x01F8D8 07:F8C8: 3D        .byte $3D   ; 
- D 3 - - - 0x01F8D9 07:F8C9: F5        .byte $F5   ; 
- D 3 - - - 0x01F8DA 07:F8CA: 90        .byte $90   ; 
- D 3 - - - 0x01F8DB 07:F8CB: F5        .byte $F5   ; 
- D 3 - - - 0x01F8DC 07:F8CC: 90        .byte $90   ; 
- D 3 - - - 0x01F8DD 07:F8CD: F5        .byte $F5   ; 
- D 3 - - - 0x01F8DE 07:F8CE: 90        .byte $90   ; 
- D 3 - - - 0x01F8DF 07:F8CF: F5        .byte $F5   ; 
- D 3 - - - 0x01F8E0 07:F8D0: A2        .byte $A2   ; 
- D 3 - - - 0x01F8E1 07:F8D1: F3        .byte $F3   ; 
- D 3 - - - 0x01F8E2 07:F8D2: 62        .byte $62   ; 
- D 3 - - - 0x01F8E3 07:F8D3: F7        .byte $F7   ; 
- D 3 - - - 0x01F8E4 07:F8D4: A2        .byte $A2   ; 
- D 3 - - - 0x01F8E5 07:F8D5: F3        .byte $F3   ; 
- D 3 - - - 0x01F8E6 07:F8D6: 3E        .byte $3E   ; 
- D 3 - - - 0x01F8E7 07:F8D7: F4        .byte $F4   ; 
- D 3 - - - 0x01F8E8 07:F8D8: 81        .byte $81   ; 
- D 3 - - - 0x01F8E9 07:F8D9: F7        .byte $F7   ; 
- - - - - - 0x01F8EA 07:F8DA: 87        .byte $87   ; 
- - - - - - 0x01F8EB 07:F8DB: F8        .byte $F8   ; 
- D 3 - - - 0x01F8EC 07:F8DC: 7D        .byte $7D   ; 
- D 3 - - - 0x01F8ED 07:F8DD: F7        .byte $F7   ; 
- - - - - - 0x01F8EE 07:F8DE: 87        .byte $87   ; 
- - - - - - 0x01F8EF 07:F8DF: F8        .byte $F8   ; 
- D 3 - - - 0x01F8F0 07:F8E0: 79        .byte $79   ; 
- D 3 - - - 0x01F8F1 07:F8E1: F7        .byte $F7   ; 
- - - - - - 0x01F8F2 07:F8E2: 87        .byte $87   ; 
- - - - - - 0x01F8F3 07:F8E3: F8        .byte $F8   ; 
- D 3 - - - 0x01F8F4 07:F8E4: 75        .byte $75   ; 
- D 3 - - - 0x01F8F5 07:F8E5: F7        .byte $F7   ; 
- - - - - - 0x01F8F6 07:F8E6: 87        .byte $87   ; 
- - - - - - 0x01F8F7 07:F8E7: F8        .byte $F8   ; 
- D 3 - - - 0x01F8F8 07:F8E8: E7        .byte $E7   ; 
- D 3 - - - 0x01F8F9 07:F8E9: F6        .byte $F6   ; 
- D 3 - - - 0x01F8FA 07:F8EA: E7        .byte $E7   ; 
- D 3 - - - 0x01F8FB 07:F8EB: F6        .byte $F6   ; 
- D 3 - - - 0x01F8FC 07:F8EC: E7        .byte $E7   ; 
- D 3 - - - 0x01F8FD 07:F8ED: F6        .byte $F6   ; 
- D 3 - - - 0x01F8FE 07:F8EE: 34        .byte $34   ; 
- D 3 - - - 0x01F8FF 07:F8EF: F6        .byte $F6   ; 
- D 3 - - - 0x01F900 07:F8F0: 90        .byte $90   ; 
- D 3 - - - 0x01F901 07:F8F1: F5        .byte $F5   ; 
- D 3 - - - 0x01F902 07:F8F2: A2        .byte $A2   ; 
- D 3 - - - 0x01F903 07:F8F3: F3        .byte $F3   ; 
- D 3 - - - 0x01F904 07:F8F4: A2        .byte $A2   ; 
- D 3 - - - 0x01F905 07:F8F5: F3        .byte $F3   ; 
- D 3 - - - 0x01F906 07:F8F6: A2        .byte $A2   ; 
- D 3 - - - 0x01F907 07:F8F7: F3        .byte $F3   ; 
- D 3 - - - 0x01F908 07:F8F8: A2        .byte $A2   ; 
- D 3 - - - 0x01F909 07:F8F9: F3        .byte $F3   ; 
- D 3 - - - 0x01F90A 07:F8FA: 34        .byte $34   ; 
- D 3 - - - 0x01F90B 07:F8FB: F6        .byte $F6   ; 
...
C - - - - - 0x01F981 07:F971: D0 A1     BNE $F914
...
C - - - - - 0x01F98D 07:F97D: 50 3C     BVC $F9BB
...
C - - - - - 0x01F997 07:F987: BD 00 05  LDA ram_0500,X
...
C - - - - - 0x01F9A1 07:F991: 9D 00 05  STA ram_0500,X
...
C - - - - - 0x01F9AB 07:F99B: 90 17     BCC $F9B4
C - - - - - 0x01F9AD 07:F99D: C9 20     CMP #$20
C - - - - - 0x01F9AF 07:F99F: B0 13     BCS $F9B4
...
C - - - - - 0x01F9BC 07:F9AC: 20 DA FB  JSR $FBDA
C - - - - - 0x01F9BF 07:F9AF: A4 11     LDY ram_0011
C - - - - - 0x01F9C1 07:F9B1: 4C C0 F9  JMP $F9C0
C - - - - - 0x01F9C4 07:F9B4: A9 00     LDA #$00
C - - - - - 0x01F9C6 07:F9B6: 85 B6     STA ram_00B6
C - - - - - 0x01F9C8 07:F9B8: 4C C0 F9  JMP $F9C0
...
C - - - - - 0x01F9E4 07:F9D4: D0 F3     BNE $F9C9
C - - - - - 0x01F9E6 07:F9D6: 20 46 EF  JSR $EF46
C - - - - - 0x01F9E9 07:F9D9: A0 00     LDY #$00
C - - - - - 0x01F9EB 07:F9DB: B1 BF     LDA (ram_00BF),Y
C - - - - - 0x01F9ED 07:F9DD: C9 FF     CMP #$FF
C - - - - - 0x01F9EF 07:F9DF: F0 E8     BEQ $F9C9
...
C - - - - - 0x01FA2A 07:FA1A: 20 2F FA  JSR $FA2F
...
C - - - - - 0x01FA70 07:FA60: 90 02     BCC $FA64
...
C - - - - - 0x01FA7A 07:FA6A: F0 03     BEQ $FA6F
...
C - - - - - 0x01FA98 07:FA88: D0 EC     BNE $FA76
...
C - - - - - 0x01FAAD 07:FA9D: F0 08     BEQ $FAA7
C - - - - - 0x01FAAF 07:FA9F: C9 0B     CMP #$0B
C - - - - - 0x01FAB1 07:FAA1: F0 04     BEQ $FAA7
C - - - - - 0x01FAB3 07:FAA3: C9 07     CMP #$07
C - - - - - 0x01FAB5 07:FAA5: D0 03     BNE $FAAA
...
C - - - - - 0x01FAC8 07:FAB8: D0 F4     BNE $FAAE
C - - - - - 0x01FACA 07:FABA: A9 0D     LDA #$0D
C - - - - - 0x01FACC 07:FABC: 20 20 C4  JSR $C420
C - - - - - 0x01FACF 07:FABF: 60        RTS
C - - - - - 0x01FAD0 07:FAC0: A9 00     LDA #$00
C - - - - - 0x01FAD2 07:FAC2: 85 41     STA ram_0041
C - - - - - 0x01FAD4 07:FAC4: 85 3B     STA ram_003B
C - - - - - 0x01FAD6 07:FAC6: 85 C8     STA ram_00C8
C - - - - - 0x01FAD8 07:FAC8: 85 38     STA ram_0038
C - - - - - 0x01FADA 07:FACA: 20 46 EF  JSR $EF46
C - - - - - 0x01FADD 07:FACD: A5 39     LDA ram_0039
C - - - - - 0x01FADF 07:FACF: F0 1B     BEQ $FAEC
C - - - - - 0x01FAE1 07:FAD1: C9 E0     CMP #$E0
C - - - - - 0x01FAE3 07:FAD3: F0 17     BEQ $FAEC
C - - - - - 0x01FAE5 07:FAD5: C9 C0     CMP #$C0
C - - - - - 0x01FAE7 07:FAD7: F0 13     BEQ $FAEC
C - - - - - 0x01FAE9 07:FAD9: C9 C1     CMP #$C1
C - - - - - 0x01FAEB 07:FADB: F0 55     BEQ $FB32
C - - - - - 0x01FAED 07:FADD: C9 C2     CMP #$C2
C - - - - - 0x01FAEF 07:FADF: F0 5A     BEQ $FB3B
C - - - - - 0x01FAF1 07:FAE1: C9 C3     CMP #$C3
C - - - - - 0x01FAF3 07:FAE3: F0 53     BEQ $FB38
C - - - - - 0x01FAF5 07:FAE5: C9 C4     CMP #$C4
C - - - - - 0x01FAF7 07:FAE7: F0 16     BEQ $FAFF
C - - - - - 0x01FAF9 07:FAE9: 4C 41 FB  JMP $FB41
C D 3 - - - 0x01FAFC 07:FAEC: 20 9A FB  JSR $FB9A
C - - - - - 0x01FAFF 07:FAEF: 20 C7 C6  JSR $C6C7
C - - - - - 0x01FB02 07:FAF2: A0 C7     LDY #$C7
C - - - - - 0x01FB04 07:FAF4: A5 46     LDA ram_0046
C - - - - - 0x01FB06 07:FAF6: C9 19     CMP #$19
C - - - - - 0x01FB08 07:FAF8: F0 02     BEQ $FAFC
C - - - - - 0x01FB0A 07:FAFA: A0 BF     LDY #$BF
C - - - - - 0x01FB0C 07:FAFC: 84 6A     STY ram_006A
C - - - - - 0x01FB0E 07:FAFE: 60        RTS
C - - - - - 0x01FB0F 07:FAFF: A4 5E     LDY ram_005E
C - - - - - 0x01FB11 07:FB01: C0 03     CPY #$03
C - - - - - 0x01FB13 07:FB03: F0 1A     BEQ $FB1F
...
C - - - - - 0x01FB1C 07:FB0C: B9 2F FB  LDA $FB2F,Y
C - - - - - 0x01FB1F 07:FB0F: 85 B7     STA ram_00B7
C - - - - - 0x01FB21 07:FB11: 20 C7 C6  JSR $C6C7
...
C - - - - - 0x01FB2C 07:FB1C: 85 41     STA ram_0041
...
C - - - - - 0x01FB3C 07:FB2C: 4C 1A FB  JMP $FB1A
- D 3 - - - 0x01FB3F 07:FB2F: 03        .byte $03   ; 
- D 3 - - - 0x01FB40 07:FB30: 09        .byte $09   ; 
- D 3 - - - 0x01FB41 07:FB31: 04        .byte $04   ; 
C - - - - - 0x01FB42 07:FB32: 20 47 FC  JSR $FC47
C - - - - - 0x01FB45 07:FB35: 4C C7 C6  JMP $C6C7
C - - - - - 0x01FB48 07:FB38: 4C F7 FB  JMP $FBF7
C - - - - - 0x01FB4B 07:FB3B: 20 9C FC  JSR $FC9C
C - - - - - 0x01FB4E 07:FB3E: 4C EC FA  JMP $FAEC
...
C - - - - - 0x01FB67 07:FB57: 10 07     BPL $FB60
C - - - - - 0x01FB69 07:FB59: 20 8D FB  JSR $FB8D
C - - - - - 0x01FB6C 07:FB5C: B0 FB     BCS $FB59
C - - - - - 0x01FB6E 07:FB5E: 90 05     BCC $FB65
C - - - - - 0x01FB70 07:FB60: 20 8D FB  JSR $FB8D
C - - - - - 0x01FB73 07:FB63: 90 FB     BCC $FB60
C - - - - - 0x01FB75 07:FB65: C0 03     CPY #$03
C - - - - - 0x01FB77 07:FB67: D0 03     BNE $FB6C
C - - - - - 0x01FB79 07:FB69: 4C EC FA  JMP $FAEC
...
C - - - - - 0x01FB9A 07:FB8A: 85 64     STA ram_0064
...
C - - - - - 0x01FBAE 07:FB9E: 30 02     BMI $FBA2
...
C - - - - - 0x01FBBD 07:FBAD: 6D 0A 80  ADC $800A
C - - - - - 0x01FBC0 07:FBB0: 85 00     STA ram_0000
C - - - - - 0x01FBC2 07:FBB2: A5 01     LDA ram_0001
C - - - - - 0x01FBC4 07:FBB4: 6D 0B 80  ADC $800B
C - - - - - 0x01FBC7 07:FBB7: 85 01     STA ram_0001
C - - - - - 0x01FBC9 07:FBB9: A0 00     LDY #$00
C - - - - - 0x01FBCB 07:FBBB: B1 00     LDA (ram_0000),Y
C - - - - - 0x01FBCD 07:FBBD: 85 46     STA ram_0046
C - - - - - 0x01FBCF 07:FBBF: C8        INY
C - - - - - 0x01FBD0 07:FBC0: B1 00     LDA (ram_0000),Y
C - - - - - 0x01FBD2 07:FBC2: 85 4B     STA ram_004B
C - - - - - 0x01FBD4 07:FBC4: C8        INY
C - - - - - 0x01FBD5 07:FBC5: B1 00     LDA (ram_0000),Y
C - - - - - 0x01FBD7 07:FBC7: 85 27     STA ram_0027
C - - - - - 0x01FBD9 07:FBC9: C8        INY
C - - - - - 0x01FBDA 07:FBCA: B1 00     LDA (ram_0000),Y
C - - - - - 0x01FBDC 07:FBCC: 85 64     STA ram_0064
C - - - - - 0x01FBDE 07:FBCE: 18        CLC
C - - - - - 0x01FBDF 07:FBCF: 65 27     ADC ram_0027
C - - - - - 0x01FBE1 07:FBD1: 85 66     STA ram_0066
C - - - - - 0x01FBE3 07:FBD3: A5 4B     LDA ram_004B
C - - - - - 0x01FBE5 07:FBD5: 69 00     ADC #$00
C - - - - - 0x01FBE7 07:FBD7: 85 68     STA ram_0068
C - - - - - 0x01FBE9 07:FBD9: 60        RTS
C - - - - - 0x01FBEA 07:FBDA: A5 46     LDA ram_0046
C - - - - - 0x01FBEC 07:FBDC: 85 47     STA ram_0047
...
C - - - - - 0x01FBFA 07:FBEA: A5 64     LDA ram_0064
C - - - - - 0x01FBFC 07:FBEC: 85 65     STA ram_0065
C - - - - - 0x01FBFE 07:FBEE: A5 4B     LDA ram_004B
C - - - - - 0x01FC00 07:FBF0: 85 4C     STA ram_004C
C - - - - - 0x01FC02 07:FBF2: A5 27     LDA ram_0027
C - - - - - 0x01FC04 07:FBF4: 85 28     STA ram_0028
C - - - - - 0x01FC06 07:FBF6: 60        RTS
C D 3 - - - 0x01FC07 07:FBF7: A5 4C     LDA ram_004C
C - - - - - 0x01FC09 07:FBF9: 85 4B     STA ram_004B
C - - - - - 0x01FC0B 07:FBFB: A5 28     LDA ram_0028
C - - - - - 0x01FC0D 07:FBFD: 85 27     STA ram_0027
C - - - - - 0x01FC0F 07:FBFF: A5 65     LDA ram_0065
C - - - - - 0x01FC11 07:FC01: 85 64     STA ram_0064
...
C - - - - - 0x01FC1F 07:FC0F: A5 47     LDA ram_0047
C - - - - - 0x01FC21 07:FC11: 85 46     STA ram_0046
C - - - - - 0x01FC23 07:FC13: 60        RTS
C - - - - - 0x01FC24 07:FC14: 20 28 FC  JSR $FC28
C - - - - - 0x01FC27 07:FC17: 90 23     BCC $FC3C
C - - - - - 0x01FC29 07:FC19: D0 21     BNE $FC3C
C - - - - - 0x01FC2B 07:FC1B: A4 5E     LDY ram_005E
C - - - - - 0x01FC2D 07:FC1D: B9 43 FC  LDA $FC43,Y
C - - - - - 0x01FC30 07:FC20: 8D 00 03  STA ram_0300
C - - - - - 0x01FC33 07:FC23: A2 00     LDX #$00
C - - - - - 0x01FC35 07:FC25: 4C 27 F3  JMP $F327
C - - - - - 0x01FC38 07:FC28: 20 3E FC  JSR $FC3E
C - - - - - 0x01FC3B 07:FC2B: D0 0D     BNE $FC3A
C - - - - - 0x01FC3D 07:FC2D: 20 FE BB  JSR $BBFE
C - - - - - 0x01FC40 07:FC30: 90 0A     BCC $FC3C
C - - - - - 0x01FC42 07:FC32: A5 B6     LDA ram_00B6
C - - - - - 0x01FC44 07:FC34: 29 03     AND #$03
C - - - - - 0x01FC46 07:FC36: C9 03     CMP #$03
C - - - - - 0x01FC48 07:FC38: D0 02     BNE $FC3C
...
C - - - - - 0x01FC57 07:FC47: 20 3B EF  JSR $EF3B
C - - - - - 0x01FC5A 07:FC4A: A5 46     LDA ram_0046
C - - - - - 0x01FC5C 07:FC4C: C9 42     CMP #$42
C - - - - - 0x01FC5E 07:FC4E: 90 03     BCC $FC53
...
C - - - - - 0x01FC7E 07:FC6E: B0 07     BCS $FC77
...
C - - - - - 0x01FC85 07:FC75: D0 ED     BNE $FC64
...
C - - - - - 0x01FCA3 07:FC93: 85 64     STA ram_0064
...
C - - - - - 0x01FCAC 07:FC9C: 20 3B EF  JSR $EF3B
...
C - - - - - 0x01FCC7 07:FCB7: 4C 5D EF  JMP $EF5D
...
C - - - - - 0x01FE14 07:FE04: B9 A0 FF  LDA $FFA0,Y
...
C - - - - - 0x020000 07:FFF0: 20 3B EF  JSR $EF3B
...
.segment "VECTORS"
- D 3 - - - 0x02000A 07:FFFA: 4E        .byte $4E   ; 
- D 3 - - - 0x02000B 07:FFFB: ED        .byte $ED   ; 
- - - - - - 0x02000C 07:FFFC: 00        .byte $00   ; 
- - - - - - 0x02000D 07:FFFD: C0        .byte $C0   ; 
- - - - - - 0x02000E 07:FFFE: 07        .byte $07   ; 
- - - - - - 0x02000F 07:FFFF: EE        .byte $EE   ; 
