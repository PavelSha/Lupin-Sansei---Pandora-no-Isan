...
C - - - - - 0x01C01F 07:C00F: 10 FB     BPL bra_C00C
bra_C011:
C - - - - - 0x01C021 07:C011: AD 02 20  LDA $2002
C - - - - - 0x01C024 07:C014: 10 FB     BPL bra_C011
...
C - - - - - 0x01C03F 07:C02F: D0 EB     BNE bra_C01C
bra_C031:
...
C - - - - - 0x01C0A7 07:C097: 30 03     BMI bra_C09C
...
C - - - - - 0x01C196 07:C186: 90 03     BCC bra_C18B
...
C - - - - - 0x01C1E0 07:C1D0: 10 03     BPL bra_C1D5
...
C - - - - - 0x01C217 07:C207: F0 05     BEQ bra_C20E
...
C - - - - - 0x01C22A 07:C21A: F0 20     BEQ bra_C23C
C - - - - - 0x01C22C 07:C21C: 24 6D     BIT ram_006D
C - - - - - 0x01C22E 07:C21E: 10 0C     BPL bra_C22C
...
C - - - - - 0x01C240 07:C230: F0 03     BEQ bra_C235
...
C - - - - - 0x01C251 07:C241: 90 03     BCC bra_C246
...
C - - - - - 0x01C321 07:C311: D0 02     BNE bra_C315
...
C - - - - - 0x01C32B 07:C31B: D0 02     BNE bra_C31F
...
C - - - - - 0x01C379 07:C369: D0 F3     BNE bra_C35E
...
C - - - - - 0x01C54E 07:C53E: D0 0F     BNE bra_C54F
C - - - - - 0x01C550 07:C540: A5 2C     LDA ram_002C
C - - - - - 0x01C552 07:C542: C9 40     CMP #$40
C - - - - - 0x01C554 07:C544: D0 22     BNE bra_C568_RTS
...
C - - - - - 0x01C567 07:C557: B0 0F     BCS bra_C568_RTS
...
C - - - - - 0x01C570 07:C560: D0 06     BNE bra_C568_RTS
...
C - - - - - 0x01C5E8 07:C5D8: F0 39     BEQ bra_C613_RTS
...
C - - - - - 0x01C5F2 07:C5E2: F0 0A     BEQ bra_C5EE
C - - - - - 0x01C5F4 07:C5E4: A2 8F     LDX #$8F
C - - - - - 0x01C5F6 07:C5E6: C9 10     CMP #$10
C - - - - - 0x01C5F8 07:C5E8: F0 02     BEQ bra_C5EC
...
C - - - - - 0x01C6DE 07:C6CE: 90 07     BCC bra_C6D7
C - - - - - 0x01C6E0 07:C6D0: C0 1F     CPY #$1F
C - - - - - 0x01C6E2 07:C6D2: B0 03     BCS bra_C6D7
...
C - - - - - 0x01C76C 07:C75C: 10 F8     BPL bra_C756
...
C - - - - - 0x01C8EC 07:C8DC: D0 0E     BNE bra_C8EC
C - - - - - 0x01C8EE 07:C8DE: CA        DEX
C - - - - - 0x01C8EF 07:C8DF: 10 F5     BPL bra_C8D6
...
C - - - - - 0x01C929 07:C919: D0 FA     BNE bra_C915
...
C - - - - - 0x01C95A 07:C94A: 30 F9     BMI bra_C945
...
C - - - - - 0x01C973 07:C963: 30 E0     BMI bra_C945
...
C - - - - - 0x01CA0E 07:C9FE: F0 08     BEQ bra_CA08
...
C - - - - - 0x01CA1B 07:CA0B: D0 EE     BNE bra_C9FB
...
C - - - - - 0x01CACC 07:CABC: 10 C5     BPL bra_CA83
...
C - - - - - 0x01CC27 07:CC17: D0 02     BNE bra_CC1B
C - - - - - 0x01CC29 07:CC19: A2 00     LDX #$00
bra_CC1B:
C - - - - - 0x01CC2B 07:CC1B: BD 00 02  LDA ram_0200,X
C - - - - - 0x01CC2E 07:CC1E: D0 06     BNE bra_CC26
C - - - - - 0x01CC30 07:CC20: C6 12     DEC ram_0012
C - - - - - 0x01CC32 07:CC22: D0 F0     BNE bra_CC14
...
C - - - - - 0x01CC8E 07:CC7E: 90 02     BCC bra_CC82
...
C - - - - - 0x01CE1B 07:CE0B: 10 F8     BPL bra_CE05
...
C - - - - - 0x01CEAF 07:CE9F: 10 02     BPL bra_CEA3
...
C - - - - - 0x01CEBD 07:CEAD: D0 40     BNE bra_CEEF
...
C - - - - - 0x01CED4 07:CEC4: 10 02     BPL bra_CEC8
...
C - - - - - 0x01CEF0 07:CEE0: D0 03     BNE bra_CEE5
C - - - - - 0x01CEF2 07:CEE2: CA        DEX
C - - - - - 0x01CEF3 07:CEE3: D0 05     BNE bra_CEEA
bra_CEE5:
C - - - - - 0x01CEF5 07:CEE5: C8        INY
C - - - - - 0x01CEF6 07:CEE6: C6 05     DEC ram_0005
C - - - - - 0x01CEF8 07:CEE8: D0 AF     BNE bra_CE99
bra_CEEA:
...
C - - - - - 0x01CF07 07:CEF7: D0 EC     BNE bra_CEE5
...
C - - - - - 0x01CF2A 07:CF1A: D0 03     BNE bra_CF1F
...
C - - - - - 0x01CF8C 07:CF7C: 10 02     BPL bra_CF80
...
C - - - - - 0x01CFB3 07:CFA3: 10 02     BPL bra_CFA7
...
C - - - - - 0x01D0B0 07:D0A0: D0 F6     BNE bra_D098
...
C - - - - - 0x01D10F 07:D0FF: F0 4D     BEQ bra_D14E
...
C - - - - - 0x01D142 07:D132: 10 0B     BPL bra_D13F
...
C - - - - - 0x01D15C 07:D14C: D0 F5     BNE bra_D143
bra_D14E:
...
C - - - - - 0x01D16C 07:D15C: B0 0B     BCS bra_D169
bra_D15E:
C - - - - - 0x01D16E 07:D15E: A5 3B     LDA ram_003B
C - - - - - 0x01D170 07:D160: 6A        ROR
C - - - - - 0x01D171 07:D161: 90 03     BCC bra_D166
...
C - - - - - 0x01D4CA 07:D4BA: F0 03     BEQ bra_D4BF
...
C - - - - - 0x01D4D3 07:D4C3: D0 DE     BNE bra_D4A3
...
C - - - - - 0x01D506 07:D4F6: 10 FB     BPL bra_D4F3
...
C - - - - - 0x01D523 07:D513: D0 FA     BNE bra_D50F
...
C - - - - - 0x01D54F 07:D53F: D0 F5     BNE bra_D536
...
C - - - - - 0x01D5F5 07:D5E5: B0 1D     BCS bra_D604
C - - - - - 0x01D5F7 07:D5E7: 90 04     BCC bra_D5ED
bra_D5E9:
C - - - - - 0x01D5F9 07:D5E9: C5 AF     CMP ram_00AF
C - - - - - 0x01D5FB 07:D5EB: B0 17     BCS bra_D604
bra_D5ED:
...
C - - - - - 0x01D610 07:D600: B0 02     BCS bra_D604
...
C - - - - - 0x01D61A 07:D60A: 90 F8     BCC bra_D604
C - - - - - 0x01D61C 07:D60C: A5 6C     LDA ram_006C
C - - - - - 0x01D61E 07:D60E: 29 E8     AND #$E8
C - - - - - 0x01D620 07:D610: D0 F2     BNE bra_D604
...
C - - - - - 0x01D69F 07:D68F: B0 02     BCS bra_D693
...
C - - - - - 0x01D6CF 07:D6BF: D0 05     BNE bra_D6C6
...
C - - - - - 0x01D6ED 07:D6DD: D0 E7     BNE bra_D6C6
...
C - - - - - 0x01DC0A 07:DBFA: 70 28     BVS bra_DC24
...
C - - - - - 0x01E222 07:E212: 90 06     BCC bra_E21A
bra_E214:
...
C - - - - - 0x01E71D 07:E70D: F0 02     BEQ bra_E711
...
C - - - - - 0x01EC4E 07:EC3E: F0 02     BEQ bra_EC42
C - - - - - 0x01EC50 07:EC40: C6 6A     DEC ram_006A
bra_EC42:
C - - - - - 0x01EC52 07:EC42: 29 01     AND #$01
C - - - - - 0x01EC54 07:EC44: F0 02     BEQ bra_EC48
...
C - - - - - 0x01ED9F 07:ED8F: 70 FB     BVS bra_ED8C
bra_ED91:
C - - - - - 0x01EDA1 07:ED91: 2C 02 20  BIT $2002
C - - - - - 0x01EDA4 07:ED94: 50 FB     BVC bra_ED91
...
C - - - - - 0x01EF5D 07:EF4D: D0 07     BNE bra_EF56
...
C - - - - - 0x01F01A 07:F00A: 10 0C     BPL bra_F018
C - - - - - 0x01F01C 07:F00C: AC 00 03  LDY ram_0300
C - - - - - 0x01F01F 07:F00F: C0 0C     CPY #$0C
C - - - - - 0x01F021 07:F011: F0 10     BEQ bra_F023
C - - - - - 0x01F023 07:F013: 20 28 FC  JSR $FC28
C - - - - - 0x01F026 07:F016: B0 0B     BCS bra_F023
bra_F018:
...
C - - - - - 0x01F04E 07:F03E: 10 C8     BPL bra_F008
...
C - - - - - 0x01F08C 07:F07C: 10 FB     BPL bra_F079
...
C - - - - - 0x01F098 07:F088: 90 02     BCC bra_F08C
...
C - - - - - 0x01F0A7 07:F097: F0 1F     BEQ bra_F0B8
...
C - - - - - 0x01F0B6 07:F0A6: D0 10     BNE bra_F0B8
bra_F0A8_RTS:
...
C - - - - - 0x01F0C3 07:F0B3: B0 03     BCS bra_F0B8
...
C - - - - - 0x01F0D1 07:F0C1: F0 04     BEQ bra_F0C7
C - - - - - 0x01F0D3 07:F0C3: 88        DEY
C - - - - - 0x01F0D4 07:F0C4: 10 F8     BPL bra_F0BE
...
C - - - - - 0x01F150 07:F140: B0 03     BCS bra_F145_RTS
...
C - - - - - 0x01F16D 07:F15D: 90 B1     BCC bra_F110
...
C - - - - - 0x01F2C7 07:F2B7: F0 41     BEQ bra_F2FA
...
C - - - - - 0x01F2DE 07:F2CE: F0 06     BEQ bra_F2D6
C - - - - - 0x01F2E0 07:F2D0: 29 01     AND #$01
C - - - - - 0x01F2E2 07:F2D2: D0 26     BNE bra_F2FA
...
bra_F2FC:
C - - - - - 0x01F30C 07:F2FC: D0 FC     BNE bra_F2FA
...
C - - - - - 0x01F314 07:F304: B0 03     BCS bra_F309
C - - - - - 0x01F316 07:F306: 20 73 D0  JSR $D073
bra_F309:
C - - - - - 0x01F319 07:F309: C9 0A     CMP #$0A
C - - - - - 0x01F31B 07:F30B: B0 E3     BCS bra_F2F0
...
C - - - - - 0x01F5CC 07:F5BC: 30 03     BMI bra_F5C1
...
C - - - - - 0x01F9AB 07:F99B: 90 17     BCC bra_F9B4
C - - - - - 0x01F9AD 07:F99D: C9 20     CMP #$20
C - - - - - 0x01F9AF 07:F99F: B0 13     BCS bra_F9B4
...
C - - - - - 0x01FADF 07:FACF: F0 1B     BEQ bra_FAEC
C - - - - - 0x01FAE1 07:FAD1: C9 E0     CMP #$E0
C - - - - - 0x01FAE3 07:FAD3: F0 17     BEQ bra_FAEC
C - - - - - 0x01FAE5 07:FAD5: C9 C0     CMP #$C0
C - - - - - 0x01FAE7 07:FAD7: F0 13     BEQ bra_FAEC
C - - - - - 0x01FAE9 07:FAD9: C9 C1     CMP #$C1
C - - - - - 0x01FAEB 07:FADB: F0 55     BEQ bra_FB32
C - - - - - 0x01FAED 07:FADD: C9 C2     CMP #$C2
C - - - - - 0x01FAEF 07:FADF: F0 5A     BEQ bra_FB3B
C - - - - - 0x01FAF1 07:FAE1: C9 C3     CMP #$C3
C - - - - - 0x01FAF3 07:FAE3: F0 53     BEQ bra_FB38
C - - - - - 0x01FAF5 07:FAE5: C9 C4     CMP #$C4
C - - - - - 0x01FAF7 07:FAE7: F0 16     BEQ bra_FAFF
...
C - - - - - 0x01FB08 07:FAF8: F0 02     BEQ bra_FAFC
...
C - - - - - 0x01FC27 07:FC17: 90 23     BCC bra_FC3C
C - - - - - 0x01FC29 07:FC19: D0 21     BNE bra_FC3C
...
C - - - - - 0x01FE2F 07:FE1F: D0 EC     BNE bra_FE0D
