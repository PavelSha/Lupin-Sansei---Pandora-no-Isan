...
sub_CDEE_prepare_activable_items_after_damage:
...
C - - - - - 0x01D59A 07:D58A: 20 EE CD  JSR sub_CDEE_prepare_activable_items_after_damage ;
...
- - - - - - 0x01DA59 07:DA49: FE C8 03  INC ram_03C8,X
- - - - - - 0x01DA5C 07:DA4C: D0 10     BNE bra_DA5E
bra_DA4E:
...
- - - - - - 0x01DA7F 07:DA6F: 4C 88 DA  JMP loc_DA88
bra_DA72:
...
C - - - - - 0x01F0D4 07:F0C4: 10 F8     BPL @bra_F0BE_loop              ; If Register Y <= 0xF0
...
C - - - - - 0x01F387 07:F377: 10 01     BPL @bra_F37A_skip           ; If vEnemyAStatus < 0xF0, i.e. vEnemyAStatus2 is used
...
C - - - - - 0x01F39F 07:F38F: 10 01     BPL @bra_F392_skip           ; If vEnemyBStatus < 0xF0, i.e. vEnemyBStatus2 is used
...
C - - - - - 0x01F491 07:F481: 9D 92 03  STA vEnemyBJumpType,X
C - - - - - 0x01F494 07:F484: B9 9E BD  LDA tbl_ptr_enemy_t4_sprite_params_ + 2,Y
C - - - - - 0x01F497 07:F487: 9D 5C 03  STA vEnemyBStatus,X
C - - - - - 0x01F49A 07:F48A: B9 9F BD  LDA tbl_ptr_enemy_t4_sprite_params_ + 3,Y
...
@bra_F49D_black_hat:
C - - - - - 0x01F4AD 07:F49D: 8D B4 06  STA vCacheChrBankSelect + 5
bra_F4A0:
...
C - - - - - 0x01F4D5 07:F4C5: 8D 07 03  STA vEnemyBSpriteMagic3
...
- - - - - - 0x01F8EE 07:F8DE: 87 F8     .addr loc_enemy_RTS                 ; ???
...
C - - - - - 0x01F933 07:F923: 10 03     BPL bra_F928_skip              ; If Register A < 0xF0 (waiting for 0xFF)
bra_F925_fail:
