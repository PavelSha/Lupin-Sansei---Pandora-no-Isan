...
Комната, состоящая из одного экрана и включающая либо белые чемоданы с предметами, либо неиграбельного персонажа/заключеннного, либо босса будем называть ***уникальной***.
...
В игре все враги делятся на некоторые два типа - **тип А** и **тип Б**.
Одновременно может существовать только 2 копии врага из каждого типа.
Как следствие, одновременно может существовать не более 4 врагов.
К типу А обычно относятся более "активные" враги.
Дзэнигата и боссы относится к типу А.
В тоже время к типу Б относятся более "пассивные" враги, которые могут доставлять незначительный дискомфорт игроку, а также псевдо-враги - платформа, стена, сенсоры и др.
Существует [список](bestiary.md) всех врагов в игре.