...
.export sub_A006_barrel_or_stone
.export sub_A009_bazooka_man
.export sub_A00C_sensor
.export sub_A00F_diver
.export sub_A012_fly_man
.export sub_A015_shooter
.export sub_A018_Zenigata
.export sub_A01B_fat_sailor
.export sub_A01E_blade_trap
...
sub_A006_barrel_or_stone:
C - - - - - 0x018016 06:A006: 4C B3 A5  JMP loc_A5B3_enemy    ;
...
sub_A00F_diver:
C - - - - - 0x01801F 06:A00F: 4C 09 AE  JMP loc_AE09_enemy    ;
...
sub_A01B_fat_sailor:
C - - - - - 0x01802B 06:A01B: 4C FB BA  JMP loc_BAFB_enemy    ;

sub_A01E_blade_trap:
C - - - - - 0x01802E 06:A01E: 4C 96 BD  JMP loc_BD96_trap     ;
...
C - - - - - 0x0180BB 06:A0AB: 9D 44 03  STA vEnemyAFrameCounter,X      ; reset a counter
...
C - - - - - 0x018124 06:A114: 85 00     STA $0000                                     ;
C - - - - - 0x018126 06:A116: E6 00     INC $0000                                     ; prepare an input parameter (EnemyAPosY + 1)
...
C - - - - - 0x018143 06:A133: 85 00     STA $0000                       ; prepares the 1st parameter
C - - - - - 0x018145 06:A135: BD 3E 03  LDA vEnemyAPosXHigh,X           ;
C - - - - - 0x018148 06:A138: 85 01     STA $0001                       ; prepares the 2nd parameter
...
C - - - - - 0x018169 06:A159: 85 01     STA $0001                     ;
C - - - - - 0x01816B 06:A15B: AD 03 03  LDA vEnemyASpriteMagic3       ; ~> sprite_magic3
C - - - - - 0x01816E 06:A15E: 85 02     STA $0002                     ;
...
C - - - - - 0x01817F 06:A16F: BD 44 03  LDA vEnemyAFrameCounter,X             ;
...
C - - - - - 0x0181B4 06:A1A4: 9D 44 03  STA vEnemyAFrameCounter,X     ; reset a counter
bra_A1A7_RTS:
...
C - - - - - 0x0181E3 06:A1D3: 85 00     STA $0000                      ; prepares the 1st parameter
C - - - - - 0x0181E5 06:A1D5: BD 3E 03  LDA vEnemyAPosXHigh,X          ;
C - - - - - 0x0181E8 06:A1D8: 85 01     STA $0001                      ; prepares the 2nd parameter
...
C - - - - - 0x018205 06:A1F5: 85 00     STA $0000                      ; prepares the sprite magic1 (Y-position)
C - - - - - 0x018207 06:A1F7: A5 03     LDA $0003                      ; the out parameter, sprite magic4 (X-position) (see $A1E2)
...
C - - - - - 0x01823E 06:A22E: 9D 44 03  STA vEnemyAFrameCounter,X      ; reset a counter
; In: Register X - the enemyA number
loc_A231_jump:
bra_A231_jump:
...
; In: $0000 - EnemyAPosY
bra_A287_skip:
C - - - - - 0x018297 06:A287: 85 00     STA $0000                                    ;
C - - - - - 0x018299 06:A289: E6 00     INC $0000                                    ; prepare an input parameter
...
C - - - - - 0x018452 06:A442: BD 80 03  LDA vEnemyBFrameCounter,X              ;
...
C - - - - - 0x01845B 06:A44B: 85 00     STA $0000                              ; prepares the 1st parameter
C - - - - - 0x01845D 06:A44D: BD 7A 03  LDA vEnemyBPosXHigh,X                  ;
C - - - - - 0x018460 06:A450: 85 01     STA $0001                              ; prepares the 2nd parameter
...
C - - - - - 0x018484 06:A474: 85 01     STA $0001                      ;
C - - - - - 0x018486 06:A476: AD 07 03  LDA vEnemyBSpriteMagic3        ; ~> sprite_magic3
C - - - - - 0x018489 06:A479: 85 02     STA $0002                      ;
...
C - - - - - 0x0184A6 06:A496: B1 00     LDA ($0000),Y                     ;
...
C - - - - - 0x0184C9 06:A4B9: 65 02     ADC $0002                            ;
...
C - - - - - 0x018504 06:A4F4: 65 02     ADC $0002                                        ;
...
C - - - - - 0x01854F 06:A53F: B1 00     LDA ($0000),Y                        ;
...
C - - - - - 0x01858A 06:A57A: B1 00     LDA ($0000),Y                        ;
...
C - - - - - 0x01859F 06:A58F: A9 42     LDA #.lobyte(tbl_A342_offset_indexes)  ; 
C - - - - - 0x0185A1 06:A591: 85 00     STA $0000                              ;
C - - - - - 0x0185A3 06:A593: A9 A3     LDA #.hibyte(tbl_A342_offset_indexes)  ;
C - - - - - 0x0185A5 06:A595: 85 01     STA $0001                              ; ($0000),0 = $A342
...
C - - - - - 0x0185AE 06:A59E: B1 00     LDA ($0000),Y             ;
C - - - - - 0x0185B0 06:A5A0: 60        RTS                       ;

; 1 byte - the jump counter before the collision
; 2 byte - the jump counter after the collision
tbl_A5A1_jump_counters:
- D - - - - 0x0185B1 06:A5A1: 18        .byte $18, $18   ; 
- D 1 - - - 0x0185B3 06:A5A3: 1A        .byte $1A, $17   ; 
- D 1 - - - 0x0185B5 06:A5A5: 1D        .byte $1D, $16   ; 
- D 1 - - - 0x0185B7 06:A5A7: 20        .byte $20, $14   ; 
- D 1 - - - 0x0185B9 06:A5A9: 23        .byte $23, $12   ; 
- D 1 - - - 0x0185BB 06:A5AB: 26        .byte $26, $10   ; 
- D 1 - - - 0x0185BD 06:A5AD: 29        .byte $29, $0E   ; 
- D 1 - - - 0x0185BF 06:A5AF: 2C        .byte $2C, $0C   ; 
- D 1 - - - 0x0185C1 06:A5B1: 2F        .byte $2F, $0A   ; 

; The barrel, the cobblestone
loc_A5B3_enemy:
C D 1 - - - 0x0185C3 06:A5B3: A2 01     LDX #$01                             ;
C - - - - - 0x0185C5 06:A5B5: 86 1A     STX vTempCounter1A                   ; set loop counter (the enemyB number)
bra_A5B7_loop:
C - - - - - 0x0185C7 06:A5B7: A6 1A     LDX vTempCounter1A                   ; prepares an input parameter
C - - - - - 0x0185C9 06:A5B9: 20 1A A6  JSR sub_A61A_status_behavior         ;
C - - - - - 0x0185CC 06:A5BC: BD 5C 03  LDA vEnemyBStatus,X                  ;
C - - - - - 0x0185CF 06:A5BF: C9 E0     CMP #$E0                             ;
C - - - - - 0x0185D1 06:A5C1: B0 40     BCS bra_A603_next                    ; If vEnemyAStatus >= 0xE0
C - - - - - 0x0185D3 06:A5C3: C9 C0     CMP #$C0                             ;
C - - - - - 0x0185D5 06:A5C5: 90 3C     BCC bra_A603_next                    ; If vEnemyAStatus < 0xC0 else only 0xCX or 0xDX
C - - - - - 0x0185D7 06:A5C7: BD 68 03  LDA vEnemyBPosY,X                    ;
C - - - - - 0x0185DA 06:A5CA: 18        CLC                                  ;
C - - - - - 0x0185DB 06:A5CB: 69 06     ADC #$06                             ;
C - - - - - 0x0185DD 06:A5CD: 85 AD     STA vEnemyHitBoxY                    ; <~ posY + 0x06
C - - - - - 0x0185DF 06:A5CF: BD 6E 03  LDA vEnemyBScreenPosX,X              ;
C - - - - - 0x0185E2 06:A5D2: 85 AE     STA vEnemyHitBoxX                    ; <~ posX
C - - - - - 0x0185E4 06:A5D4: A9 0C     LDA #$0C                             ;
C - - - - - 0x0185E6 06:A5D6: 85 AF     STA vEnemyHitBoxH                    ; <~ hitBoxH
C - - - - - 0x0185E8 06:A5D8: A9 06     LDA #$06                             ;
C - - - - - 0x0185EA 06:A5DA: 85 B0     STA vEnemyHitBoxW                    ; <~ hitBoxW
C - - - - - 0x0185EC 06:A5DC: A5 5F     LDA vChrLiveStatus                   ;
C - - - - - 0x0185EE 06:A5DE: 29 02     AND #$02                             ; CONSTANT - Goemon
C - - - - - 0x0185F0 06:A5E0: F0 0B     BEQ bra_A5ED_check_bullets           ; If the character isn't Goemon
C - - - - - 0x0185F2 06:A5E2: 20 06 D6  JSR sub_D606_have_intersect_sword    ;
C - - - - - 0x0185F5 06:A5E5: 90 19     BCC bra_A600_no_intersect            ; If the intersect doesn't exist
C - - - - - 0x0185F7 06:A5E7: 20 08 A6  JSR sub_A608_hit                     ;
C - - - - - 0x0185FA 06:A5EA: 4C 03 A6  JMP loc_A603_next                    ;

bra_A5ED_check_bullets:
C - - - - - 0x0185FD 06:A5ED: A6 7A     LDX vBulletCount                     ; set loop counter
bra_A5EF_loop:                                                               ; loop by x
C - - - - - 0x0185FF 06:A5EF: 20 B6 D5  JSR sub_D5B6_have_intersect_bullet   ;
C - - - - - 0x018602 06:A5F2: 90 09     BCC @bra_A5FD_no_hit                 ; If the intersect isn't exist
C - - - - - 0x018604 06:A5F4: A9 10     LDA #$10                             ; The sound of a bullet hitting an armored enemy
C - - - - - 0x018606 06:A5F6: 20 20 C4  JSR sub_C420_add_sound_effect        ; bank FF
C - - - - - 0x018609 06:A5F9: A9 00     LDA #$00                             ;
C - - - - - 0x01860B 06:A5FB: 95 8F     STA vBulletStatus,X                  ; clear
@bra_A5FD_no_hit:
C - - - - - 0x01860D 06:A5FD: CA        DEX                                  ; decrement loop counter
C - - - - - 0x01860E 06:A5FE: 10 EF     BPL bra_A5EF_loop                    ; If Register X >= 0x00
bra_A600_no_intersect:
C - - - - - 0x018610 06:A600: 20 62 D5  JSR sub_D562_has_character_damage    ;
bra_A603_next:
loc_A603_next:
C D 1 - - - 0x018613 06:A603: C6 1A     DEC vTempCounter1A                   ; decrements loop counter
C - - - - - 0x018615 06:A605: 10 B0     BPL bra_A5B7_loop                    ; If vTempCounter1A >= 0x00
bra_A607_RTS:
C - - - - - 0x018617 06:A607: 60        RTS                                  ;

sub_A608_hit:
C - - - - - 0x018618 06:A608: A6 1A     LDX vTempCounter1A             ; X <~ the enemyB number
C - - - - - 0x01861A 06:A60A: BD 5C 03  LDA vEnemyBStatus,X            ;            
C - - - - - 0x01861D 06:A60D: 29 C0     AND #$C0                       ; clear substate
C - - - - - 0x01861F 06:A60F: 09 20     ORA #$20                       ; CONSTANT - 'the dying' status
C - - - - - 0x018621 06:A611: 9D 5C 03  STA vEnemyBStatus,X            ;
C - - - - - 0x018624 06:A614: A9 08     LDA #$08                       ;
C - - - - - 0x018626 06:A616: 9D 86 03  STA vEnemyBJumpCounter,X       ; Initializes a jump counter (flashing)
C - - - - - 0x018629 06:A619: 60        RTS                            ;

; In: Register X - the enemyB number
sub_A61A_status_behavior:
C - - - - - 0x01862A 06:A61A: BD 5C 03  LDA vEnemyBStatus,X                       ;
C - - - - - 0x01862D 06:A61D: 10 E8     BPL bra_A607_RTS                          ; If the status isn't used
C - - - - - 0x01862F 06:A61F: 4A        LSR                                       ;
C - - - - - 0x018630 06:A620: 20 B8 D0  JSR sub_D0B8_change_stack_pointer_by_bits ; bank_FF

- D 1 - I - 0x018633 06:A623: DE A6     .addr loc_A6DF_jump - 1              ; 0x02
- D - - - - 0x018635 06:A625: 30 A6     .addr loc_A631_main - 1              ; 0x04
- D - - - - 0x018637 06:A627: 30 A6     .addr loc_A631_main - 1              ; 0x08
- D - - - - 0x018639 06:A629: 30 A6     .addr loc_A631_main - 1              ; 0x10
- D 1 - I - 0x01863B 06:A62B: 46 A6     .addr loc_A647_prepare_rendering - 1 ; 0x20
- D 1 - I - 0x01863D 06:A62D: 30 A6     .addr loc_A631_main - 1              ; 0x40
- D 1 - I - 0x01863F 06:A62F: 30 A6     .addr loc_A631_main - 1              ; 0x80

; In: Register X - the enemyB number
loc_A631_main:
C - - - - - 0x018641 06:A631: A9 09     LDA #$09                                     ; prepare an input parameter (+9)
C - - - - - 0x018643 06:A633: 20 DB D8  JSR sub_D8DB_enemyB_collision_by_shift_posY  ;
C - - - - - 0x018646 06:A636: D0 49     BNE bra_A681_collision                       ; If the collision by posY exists
C - - - - - 0x018648 06:A638: BD 80 03  LDA vEnemyBFrameCounter,X                    ;
C - - - - - 0x01864B 06:A63B: 29 03     AND #$03                                     ; filters by 0%000000XX
C - - - - - 0x01864D 06:A63D: 9D 80 03  STA vEnemyBFrameCounter,X                    ;
C - - - - - 0x018650 06:A640: A9 1C     LDA #$1C                                     ; CONSTANT - a jump counter value
C - - - - - 0x018652 06:A642: A0 03     LDY #$03                                     ; CONSTANT - jump by side
C - - - - - 0x018654 06:A644: 4C CE A6  JMP loc_A6CE_activate_jump_status            ;

; In: Register X - the enemyB number
loc_A647_prepare_rendering:
C D 1 - - - 0x018657 06:A647: BD 74 03  LDA vEnemyBPosXLow,X               ;
C - - - - - 0x01865A 06:A64A: 85 00     STA $0000                          ; prepares the 1st parameter
C - - - - - 0x01865C 06:A64C: BD 7A 03  LDA vEnemyBPosXHigh,X              ;
C - - - - - 0x01865F 06:A64F: 85 01     STA $0001                          ; prepares the 2nd parameter
C - - - - - 0x018661 06:A651: 20 7B D6  JSR sub_D67B_out_of_sight          ;
C - - - - - 0x018664 06:A654: 90 03     BCC bra_A659_skip                  ; If the enemy is visible
C - - - - - 0x018666 06:A656: 4C 73 D8  JMP loc_D873_free_enemyB           ;

bra_A659_skip:
C - - - - - 0x018669 06:A659: 20 AC D6  JSR sub_D6AC_out_of_screen         ;
C - - - - - 0x01866C 06:A65C: 90 03     BCC bra_A661_skip                  ; If the enemy is on the screen
...
C - - - - - 0x018677 06:A667: 29 20     AND #$20                        ; CONSTANT - 'the dying' status
C - - - - - 0x018679 06:A669: F0 03     BEQ bra_A66E_skip               ; If 'the dying' status isn't activated
C - - - - - 0x01867B 06:A66B: 4C 52 A7  JMP loc_A752_dying              ;

bra_A66E_skip:
C - - - - - 0x01867E 06:A66E: BD 80 03  LDA vEnemyBFrameCounter,X     ;
C - - - - - 0x018681 06:A671: 29 06     AND #$06                      ; filters by vFrameCounter
C - - - - - 0x018683 06:A673: 18        CLC                           ;
C - - - - - 0x018684 06:A674: 6D 06 03  ADC vEnemyBSpriteMagic2       ; ~> sprite_magic2 + {0x00, 0x02, 0x04, 0x06}
C - - - - - 0x018687 06:A677: 85 01     STA $0001                     ;
C - - - - - 0x018689 06:A679: AD 07 03  LDA vEnemyBSpriteMagic3       ; ~> sprite_magic3
C - - - - - 0x01868C 06:A67C: 85 02     STA $0002                     ;
...
C - - - - - 0x018695 06:A685: 90 28     BCC bra_A6AF_right                       ; If the enemy is looking to the right
C - - - - - 0x018697 06:A687: 20 B5 A6  JSR sub_A6B5_try_movement_on_the_left    ;
loc_A68A_continue:
C D 1 - - - 0x01869A 06:A68A: 20 90 A6  JSR sub_A690_update_moving               ;
C - - - - - 0x01869D 06:A68D: 4C 47 A6  JMP loc_A647_prepare_rendering           ;

sub_A690_update_moving:
C - - - - - 0x0186A0 06:A690: A5 2C     LDA vLowCounter               ;
C - - - - - 0x0186A2 06:A692: 29 0F     AND #$0F                      ;
C - - - - - 0x0186A4 06:A694: D0 05     BNE @bra_A69B_skip            ; Branch if vLowCounter doesn't multiple of 16 (93.75% chance)
C - - - - - 0x0186A6 06:A696: A9 37     LDA #$37                      ; CONSTANT - The sound of a barrel moving
...
C - - - - - 0x0186AF 06:A69F: D0 0D     BNE bra_A6AE_RTS              ; Branch if vLowCounter doesn't multiple of 4 (75% chance)
C - - - - - 0x0186B1 06:A6A1: BD 5C 03  LDA vEnemyBStatus,X           ;
C - - - - - 0x0186B4 06:A6A4: 6A        ROR                           ;
C - - - - - 0x0186B5 06:A6A5: B0 04     BCS bra_A6AB_left             ; If the enemy is looking to the left
C - - - - - 0x0186B7 06:A6A7: FE 80 03  INC vEnemyBFrameCounter,X     ; direct updating
C - - - - - 0x0186BA 06:A6AA: 60        RTS                           ;

bra_A6AB_left:
C - - - - - 0x0186BB 06:A6AB: DE 80 03  DEC vEnemyBFrameCounter,X     ; reverse updating
bra_A6AE_RTS:
C - - - - - 0x0186BE 06:A6AE: 60        RTS                           ;

bra_A6AF_right:
C - - - - - 0x0186BF 06:A6AF: 20 C6 A6  JSR sub_A6C6_try_movement_on_the_right   ;
C - - - - - 0x0186C2 06:A6B2: 4C 8A A6  JMP loc_A68A_continue                    ;

; In: Register X - the enemyB number
sub_A6B5_try_movement_on_the_left:
C - - - - - 0x0186C5 06:A6B5: 20 C2 D8  JSR sub_D8C2_check_enemyB_movement_on_the_left      ;
C - - - - - 0x0186C8 06:A6B8: F0 03     BEQ bra_A6BD_change_direction                       ; If the movement isn't allowed
C - - - - - 0x0186CA 06:A6BA: 4C 09 D8  JMP loc_D809_short_dec_EnemyBPosXLow                ;

; In: Register X - the enemyB number
bra_A6BD_change_direction:
...
; In: Register X - the enemyB number
sub_A6C6_try_movement_on_the_right:
C - - - - - 0x0186D6 06:A6C6: 20 B7 D8  JSR sub_D8B7_check_enemyB_movement_on_the_right     ;
C - - - - - 0x0186D9 06:A6C9: F0 F2     BEQ bra_A6BD_change_direction                       ; If the movement isn't allowed
C - - - - - 0x0186DB 06:A6CB: 4C 28 D8  JMP loc_D828_short_inc_EnemyBPosXLow                ;

; In: Register X - the enemyB number
; In: Register A - a jump counter
; In: Register Y - a jump type
loc_A6CE_activate_jump_status:
C D 1 - - - 0x0186DE 06:A6CE: 9D 86 03  STA vEnemyBJumpCounter,X                         ;
...
C - - - - - 0x0186E8 06:A6D8: 29 FD     AND #$FD                                         ; reset 'jump' status
C - - - - - 0x0186EA 06:A6DA: 09 02     ORA #$02                                         ; CONSTANT - the 'jump' status
C - - - - - 0x0186EC 06:A6DC: 9D 5C 03  STA vEnemyBStatus,X                              ;
; In: Register X - the enemyB number
loc_A6DF_jump:
C - - - - - 0x0186EF 06:A6DF: BD 68 03  LDA vEnemyBPosY,X                                ;
C - - - - - 0x0186F2 06:A6E2: C9 D7     CMP #$D7                                         ; CONSTANT - Maximum allowed Y-value for the barrel (or stone)
C - - - - - 0x0186F4 06:A6E4: B0 0F     BCS bra_A6F5_skip                                ; If PosY >= 0xD7
C - - - - - 0x0186F6 06:A6E6: BD 5C 03  LDA vEnemyBStatus,X                              ;
C - - - - - 0x0186F9 06:A6E9: 6A        ROR                                              ;
C - - - - - 0x0186FA 06:A6EA: 90 06     BCC bra_A6F2_right                               ; If the enemy is looking to the right
C - - - - - 0x0186FC 06:A6EC: 20 B5 A6  JSR sub_A6B5_try_movement_on_the_left            ;
C - - - - - 0x0186FF 06:A6EF: 4C F5 A6  JMP loc_A6F5_continue                            ;

bra_A6F2_right:
C - - - - - 0x018702 06:A6F2: 20 C6 A6  JSR sub_A6C6_try_movement_on_the_right           ;
bra_A6F5_skip:
loc_A6F5_continue:
C D 1 - - - 0x018705 06:A6F5: BC 86 03  LDY vEnemyBJumpCounter,X                         ;
C - - - - - 0x018708 06:A6F8: B9 5D E3  LDA tbl_E35D_jump_posY_offset,Y                  ; Y = [0x00-0x2F]
C - - - - - 0x01870B 06:A6FB: 18        CLC                                              ;
C - - - - - 0x01870C 06:A6FC: 7D 68 03  ADC vEnemyBPosY,X                                ;
C - - - - - 0x01870F 06:A6FF: C9 D7     CMP #$D7                                         ; CONSTANT - Maximum allowed Y-value for the barrel (or stone)
C - - - - - 0x018711 06:A701: 90 02     BCC @bra_A705_skip                               ; If Register A < 0xD7
C - - - - - 0x018713 06:A703: A9 D7     LDA #$D7                                         ; 0xD7 -> EnemyPosY
@bra_A705_skip:
C - - - - - 0x018715 06:A705: 9D 68 03  STA vEnemyBPosY,X                                ;
C - - - - - 0x018718 06:A708: BC 86 03  LDY vEnemyBJumpCounter,X                         ;
C - - - - - 0x01871B 06:A70B: C0 18     CPY #$18                                         ; CONSTANT - a maximum amplitude
C - - - - - 0x01871D 06:A70D: 90 33     BCC bra_A742_inc                                 ; If vJumpCounter < 0x18
C - - - - - 0x01871F 06:A70F: C9 D7     CMP #$D7                                         ; CONSTANT - Maximum allowed Y-value for the barrel (or stone)
C - - - - - 0x018721 06:A711: 90 05     BCC bra_A718_skip                                ; If EnemyPosY < 0xD7
C - - - - - 0x018723 06:A713: A0 FF     LDY #$FF                                         ; prepares the sprite_magic2 (The offset by the address), death mark
C - - - - - 0x018725 06:A715: 4C 47 A6  JMP loc_A647_prepare_rendering                   ;

bra_A718_skip:
C - - - - - 0x018728 06:A718: A9 09     LDA #$09                                     ; prepare an input parameter (+9)
C - - - - - 0x01872A 06:A71A: 20 DB D8  JSR sub_D8DB_enemyB_collision_by_shift_posY  ;
C - - - - - 0x01872D 06:A71D: F0 23     BEQ bra_A742_inc                             ; If the collision by posY doesn't exist
C - - - - - 0x01872F 06:A71F: 20 A8 D8  JSR sub_D8A8_correction2_EnemyBPosY          ;
C - - - - - 0x018732 06:A722: A0 10     LDY #$10                                     ; set loop counter
C - - - - - 0x018734 06:A724: BD 86 03  LDA vEnemyBJumpCounter,X                     ; prepare the old jump counter
@bra_A727_repeat:
C - - - - - 0x018737 06:A727: D9 A1 A5  CMP tbl_A5A1_jump_counters,Y                 ;
C - - - - - 0x01873A 06:A72A: B0 04     BCS @bra_A730_break                          ; If vJumpCounter >= first value in the table
C - - - - - 0x01873C 06:A72C: 88        DEY                                          ; descrement loop counter
C - - - - - 0x01873D 06:A72D: 88        DEY                                          ; descrement loop counter
C - - - - - 0x01873E 06:A72E: D0 F7     BNE @bra_A727_repeat                         ; While Register Y != 0x00
@bra_A730_break:
C - - - - - 0x018740 06:A730: B9 A2 A5  LDA tbl_A5A1_jump_counters + 1,Y             ; load the new jump counter
C - - - - - 0x018743 06:A733: 9D 86 03  STA vEnemyBJumpCounter,X                     ;
C - - - - - 0x018746 06:A736: C9 18     CMP #$18                                     ; CONSTANT - a maximum amplitude
C - - - - - 0x018748 06:A738: D0 08     BNE bra_A742_inc                             ; If vJumpCounter != 0x18
C - - - - - 0x01874A 06:A73A: BD 5C 03  LDA vEnemyBStatus,X                          ;
C - - - - - 0x01874D 06:A73D: 29 E1     AND #$E1                                     ; clear substate
C - - - - - 0x01874F 06:A73F: 9D 5C 03  STA vEnemyBStatus,X                          ;
bra_A742_inc:
C - - - - - 0x018752 06:A742: FE 86 03  INC vEnemyBJumpCounter,X                  ;
C - - - - - 0x018755 06:A745: A9 2F     LDA #$2F                                  ; CONSTANT - a maximum jump value
C - - - - - 0x018757 06:A747: DD 86 03  CMP vEnemyBJumpCounter,X                  ;
C - - - - - 0x01875A 06:A74A: B0 03     BCS @bra_A74F_skip                        ; If vEnemyAJumpCounter <= 0x2F, i.e. less than maximum
C - - - - - 0x01875C 06:A74C: 9D 86 03  STA vEnemyBJumpCounter,X                  ; reassign
@bra_A74F_skip:
C - - - - - 0x01875F 06:A74F: 4C 47 A6  JMP loc_A647_prepare_rendering            ;

loc_A752_dying:
C D 1 - - - 0x018762 06:A752: DE 86 03  DEC vEnemyBJumpCounter,X             ;
C - - - - - 0x018765 06:A755: D0 03     BNE bra_A75A_render_dying            ; If vJumpCounter != 0x00
...
bra_A763_racing:
C - - - - - 0x018773 06:A763: BD 86 03  LDA vEnemyBJumpCounter,X             ; prepares the input parameter
...
C - - - - - 0x018803 06:A7F3: 9D 44 03  STA vEnemyAFrameCounter,X      ; reset a counter
bra_A7F6_RTS:
...
C - - - - - 0x018824 06:A814: 85 00     STA $0000                       ; prepares the 1st parameter
C - - - - - 0x018826 06:A816: BD 3E 03  LDA vEnemyAPosXHigh,X           ;
C - - - - - 0x018829 06:A819: 85 01     STA $0001                       ; prepares the 2nd parameter
...
C - - - - - 0x01884A 06:A83A: 85 01     STA $0001                      ;
C - - - - - 0x01884C 06:A83C: AD 03 03  LDA vEnemyASpriteMagic3        ; ~> sprite_magic3
C - - - - - 0x01884F 06:A83F: 85 02     STA $0002                      ;
...
@bra_A8A3_skip:
C - - - - - 0x0188B3 06:A8A3: 85 00     STA $0000                                        ;
C - - - - - 0x0188B5 06:A8A5: E6 00     INC $0000                                        ; prepare an input parameter
...
C - - - - - 0x018941 06:A931: 99 46 03  STA vEnemyAProjectileFrameCounter,Y      ; assign a counter
...
C - - - - - 0x01896C 06:A95C: 65 02     ADC $0002                          ;
...
- D 1 - I - 0x0189E8 06:A9D8: AB AB     .addr loc_ABAC_moving_along_horiz_parabola - 1  ; 0x08
...
C - - - - - 0x0189FF 06:A9EF: E5 00     SBC $0000                          ;
...
C - - - - - 0x018A14 06:AA04: 65 00     ADC $0000                          ;
...
C - - - - - 0x018A26 06:AA16: 85 00     STA $0000                     ;
...
C - - - - - 0x018A2F 06:AA1F: E6 00     INC $0000                     ;
bra_AA21_RTS:
...
; In: Register X - the projectile number
loc_AA45_main:
C - - - - - 0x018A55 06:AA45: BD 44 03  LDA vEnemyAFrameCounter,X         ;
...
; In: Register X - the projectile number
bra_AA73_zero:
C - - - - - 0x018A83 06:AA73: DE 44 03  DEC vEnemyAFrameCounter,X       ; 0x00 -> 0xFF
...
C - - - - - 0x018A9C 06:AA8C: 85 00     STA $0000                       ; prepares the 1st parameter
C - - - - - 0x018A9E 06:AA8E: BD 3E 03  LDA vEnemyAPosXHigh,X           ;
C - - - - - 0x018AA1 06:AA91: 85 01     STA $0001                       ; prepares the 2nd parameter
...
C - - - - - 0x018AD6 06:AAC6: 85 01     STA $0001                       ; Y + 0xA8 ~> sprite_magic2
...
bra_AAE3_add:
C - - - - - 0x018AF3 06:AAE3: 85 02     STA $0002                       ; ~> sprite_magic3
...
C - - - - - 0x018AFC 06:AAEC: 85 01     STA $0001                       ; Y + 0xAC ~> sprite_magic2
...
; Template 1 (vEnemyVelocity = 0)
- D 1 - I - 0x018B8C 06:AB7C: 04        .byte $04, $04, $05, $08, $09, $0B, $0C, $0E   ; offset indexes
- D 1 - I - 0x018B94 06:AB84: 08        .byte $08, $0C, $0C, $04, $04, $04, $08, $10   ; jump counters

; Template 2 (vEnemyVelocity = 1)
- D 1 - I - 0x018B9C 06:AB8C: 03        .byte $03, $03, $04, $06, $08, $0A, $0C, $0E   ; offset indexes
- D 1 - I - 0x018BA4 06:AB94: 08        .byte $08, $04, $10, $04, $04, $04, $10, $0C   ; jump counters

; Template 3 (vEnemyVelocity = 2)
- D 1 - I - 0x018BAC 06:AB9C: 02        .byte $02, $02, $04, $05, $07, $08, $0B, $0C   ; offset indexes
- D 1 - I - 0x018BB4 06:ABA4: 08        .byte $08, $08, $08, $04, $04, $04, $0C, $14   ; jump counters

; In: Register X - the projectile number
loc_ABAC_moving_along_horiz_parabola:
...
C - - - - - 0x018BC3 06:ABB3: 18        CLC                               ; A <~ 0x00, 0x10, 0x20
C - - - - - 0x018BC4 06:ABB4: 69 7C     ADC #$7C                          ;
C - - - - - 0x018BC6 06:ABB6: 85 00     STA $0000                         ;
C - - - - - 0x018BC8 06:ABB8: A9 AB     LDA #$AB                          ;
C - - - - - 0x018BCA 06:ABBA: 69 00     ADC #$00                          ;
C - - - - - 0x018BCC 06:ABBC: 85 01     STA $0001                         ; ($0000),0 = $AB7C or $AB8C or $AB9C
C - - - - - 0x018BCE 06:ABBE: 20 1A AC  JSR sub_AC1A_update_jump_params_  ;
C - - - - - 0x018BD1 06:ABC1: 20 DB AB  JSR sub_ABDB_execute_fly_step     ;
C - - - - - 0x018BD4 06:ABC4: A5 2C     LDA vLowCounter                   ;
C - - - - - 0x018BD6 06:ABC6: 29 03     AND #$03                          ;
C - - - - - 0x018BD8 06:ABC8: D0 03     BNE @bra_ABCD_skip                ; Branch if vLowCounter doesn't multiple of 4 (75% chance)
C - - - - - 0x018BDA 06:ABCA: FE 44 03  INC vEnemyAFrameCounter,X         ;
@bra_ABCD_skip:
C - - - - - 0x018BDD 06:ABCD: BD 44 03  LDA vEnemyAFrameCounter,X         ;
C - - - - - 0x018BE0 06:ABD0: 29 03     AND #$03                          ; adjust by mask
C - - - - - 0x018BE2 06:ABD2: 0A        ASL                               ;
C - - - - - 0x018BE3 06:ABD3: 0A        ASL                               ; *4
C - - - - - 0x018BE4 06:ABD4: 18        CLC                               ;
C - - - - - 0x018BE5 06:ABD5: 69 18     ADC #$18                          ; A <~ { 0x00, 0x01, 0x02, 0x03 } * 4 + 0x18
C - - - - - 0x018BE7 06:ABD7: A8        TAY                               ; prepares the sprite_magic2 (The offset by the address)
C - - - - - 0x018BE8 06:ABD8: 4C 89 AA  JMP loc_AA89_prepare_rendering    ;

; In: Register X - the projectile number
sub_ABDB_execute_fly_step:
C - - - - - 0x018BEB 06:ABDB: BC 56 03  LDY vEnemyAJumpType,X              ; vJumpType is {0x00, 0x01, ..., 0x07}
C - - - - - 0x018BEE 06:ABDE: B1 00     LDA ($0000),Y                      ;
C - - - - - 0x018BF0 06:ABE0: 85 0A     STA $000A                          ; $000A <~ the potential offset index
C - - - - - 0x018BF2 06:ABE2: BD 20 03  LDA vEnemyAStatus,X                ;
C - - - - - 0x018BF5 06:ABE5: 6A        ROR                                ;
C - - - - - 0x018BF6 06:ABE6: 90 09     BCC @bra_ABF1_right                ; If the enemy is looking to the right
C - - - - - 0x018BF8 06:ABE8: A9 10     LDA #$10                           ;
C - - - - - 0x018BFA 06:ABEA: 38        SEC                                ;
C - - - - - 0x018BFB 06:ABEB: E5 0A     SBC $000A                          ;
C - - - - - 0x018BFD 06:ABED: 29 0F     AND #$0F                           ; filters by mask
C - - - - - 0x018BFF 06:ABEF: 85 0A     STA $000A                          ; $000A <~ 0x10 - $000A, i.e. inverts the direction
@bra_ABF1_right:
C - - - - - 0x018C01 06:ABF1: A5 0A     LDA $000A                          ;
C - - - - - 0x018C03 06:ABF3: 0A        ASL                                ; *2, because the set contains 2 bytes
C - - - - - 0x018C04 06:ABF4: A8        TAY                                ; Y <~ the offset index
C - - - - - 0x018C05 06:ABF5: BD 2C 03  LDA vEnemyAPosY,X                  ;
C - - - - - 0x018C08 06:ABF8: 18        CLC                                ;
C - - - - - 0x018C09 06:ABF9: 79 D4 DA  ADC tbl_flying_track_offset,Y      ;
C - - - - - 0x018C0C 06:ABFC: 9D 2C 03  STA vEnemyAPosY,X                  ; <~ posY + offset
C - - - - - 0x018C0F 06:ABFF: A9 00     LDA #$00                           ;
C - - - - - 0x018C11 06:AC01: 85 02     STA $0002                          ; $0002 <~ 0x00
C - - - - - 0x018C13 06:AC03: B9 D5 DA  LDA tbl_flying_track_offset + 1,Y  ;
C - - - - - 0x018C16 06:AC06: 10 02     BPL @bra_AC0A_skip                 ; If the offset >= 0x00
C - - - - - 0x018C18 06:AC08: C6 02     DEC $0002                          ; $0002 <~ 0xFF, i.e. -1
@bra_AC0A_skip:
C - - - - - 0x018C1A 06:AC0A: 18        CLC                                ;
C - - - - - 0x018C1B 06:AC0B: 7D 38 03  ADC vEnemyAPosXLow,X               ;
C - - - - - 0x018C1E 06:AC0E: 9D 38 03  STA vEnemyAPosXLow,X               ; <~ posX + offset
C - - - - - 0x018C21 06:AC11: BD 3E 03  LDA vEnemyAPosXHigh,X              ;
C - - - - - 0x018C24 06:AC14: 65 02     ADC $0002                          ;
C - - - - - 0x018C26 06:AC16: 9D 3E 03  STA vEnemyAPosXHigh,X              ; changed PosXHigh (+1 or -1), if PosXLow was overflow
C - - - - - 0x018C29 06:AC19: 60        RTS                                ;

; In: Register X - the projectile number
; In: ($0000),0 = $AB7C or $AB8C or $AB9C
sub_AC1A_update_jump_params_:
C - - - - - 0x018C2A 06:AC1A: DE 4A 03  DEC vEnemyAJumpCounter,X           ;
C - - - - - 0x018C2D 06:AC1D: D0 1B     BNE bra_AC3A_RTS                   ; If vJumpCounter != 0x00
C - - - - - 0x018C2F 06:AC1F: FE 56 03  INC vEnemyAJumpType,X              ; set next jump type
C - - - - - 0x018C32 06:AC22: BD 56 03  LDA vEnemyAJumpType,X              ;
C - - - - - 0x018C35 06:AC25: C9 08     CMP #$08                           ; CONSTANT - the final value
C - - - - - 0x018C37 06:AC27: D0 03     BNE bra_AC2C_continue              ; If vJumpType == 0x08
...
C - - - - - 0x018C3E 06:AC2E: 9D 56 03  STA vEnemyAJumpType,X              ; adjust by mask
C - - - - - 0x018C41 06:AC31: 18        CLC                                ;
C - - - - - 0x018C42 06:AC32: 69 08     ADC #$08                           ;
C - - - - - 0x018C44 06:AC34: A8        TAY                                ; Y <~ { 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F }
C - - - - - 0x018C45 06:AC35: B1 00     LDA ($0000),Y                      ;
C - - - - - 0x018C47 06:AC37: 9D 4A 03  STA vEnemyAJumpCounter,X           ; Initializes a jump counter
bra_AC3A_RTS:
...
C - - - - - 0x018C7D 06:AC6D: 99 82 03  STA vEnemyBProjectileFrameCounter,Y    ; reset a counter
...
C - - - - - 0x018CA2 06:AC92: 9D 5C 03  STA vEnemyBStatus,X               ; clear a status
...
C - - - - - 0x018CB0 06:ACA0: 85 00     STA $0000                                  ; prepares the 1st parameter
C - - - - - 0x018CB2 06:ACA2: BD 7A 03  LDA vEnemyBPosXHigh,X                      ;
C - - - - - 0x018CB5 06:ACA5: 85 01     STA $0001                                  ; prepares the 2nd parameter
C - - - - - 0x018CB7 06:ACA7: 20 7B D6  JSR sub_D67B_out_of_sight                  ;
C - - - - - 0x018CBA 06:ACAA: B0 E2     BCS bra_AC8E_free_enemyB_while_creating    ; If the enemy isn't visible
C - - - - - 0x018CBC 06:ACAC: 20 AC D6  JSR sub_D6AC_out_of_screen                 ;
C - - - - - 0x018CBF 06:ACAF: B0 DD     BCS bra_AC8E_free_enemyB_while_creating    ; If the enemy isn't on the screen
C - - - - - 0x018CC1 06:ACB1: BD 68 03  LDA vEnemyBPosY,X                          ;
C - - - - - 0x018CC4 06:ACB4: 85 00     STA $0000                                  ; ~> sprite magic1
C - - - - - 0x018CC6 06:ACB6: A5 03     LDA $0003                                  ; from sub_D6AC_out_of_screen
C - - - - - 0x018CC8 06:ACB8: 9D 6E 03  STA vEnemyBScreenPosX,X                    ;
C - - - - - 0x018CCB 06:ACBB: 24 D1     BIT vGogglesActive                         ;
C - - - - - 0x018CCD 06:ACBD: 10 0B     BPL @bra_ACCA_not_active                   ; If the infrared goggles isn't activated
C - - - - - 0x018CCF 06:ACBF: A9 6E     LDA #$6E                                   ; ~> sprite_magic2
C - - - - - 0x018CD1 06:ACC1: 85 01     STA $0001                                  ;
C - - - - - 0x018CD3 06:ACC3: A9 44     LDA #$44                                   ; ~> sprite_magic3
C - - - - - 0x018CD5 06:ACC5: 85 02     STA $0002                                  ;
C - - - - - 0x018CD7 06:ACC7: 20 33 CE  JSR sub_CE33_add_sprite_magic              ; bank FF
@bra_ACCA_not_active:
C - - - - - 0x018CDA 06:ACCA: BD 5C 03  LDA vEnemyBStatus,X                        ;
C - - - - - 0x018CDD 06:ACCD: 10 30     BPL bra_ACFF_RTS                           ; If the status isn't used
C - - - - - 0x018CDF 06:ACCF: 24 D1     BIT vGogglesActive                         ;
C - - - - - 0x018CE1 06:ACD1: 70 2C     BVS bra_ACFF_RTS                           ; If the projectiles are falling
C - - - - - 0x018CE3 06:ACD3: BD 68 03  LDA vEnemyBPosY,X                          ;
C - - - - - 0x018CE6 06:ACD6: 85 AD     STA vEnemyHitBoxY                          ; <~ posY
C - - - - - 0x018CE8 06:ACD8: BD 6E 03  LDA vEnemyBScreenPosX,X                    ;
C - - - - - 0x018CEB 06:ACDB: 85 AE     STA vEnemyHitBoxX                          ; <~ screen posX
C - - - - - 0x018CED 06:ACDD: A9 08     LDA #$08                                   ;
C - - - - - 0x018CEF 06:ACDF: 85 AF     STA vEnemyHitBoxH                          ; <~ hitBoxH
C - - - - - 0x018CF1 06:ACE1: A9 04     LDA #$04                                   ;
C - - - - - 0x018CF3 06:ACE3: 85 B0     STA vEnemyHitBoxW                          ; <~ hitBoxW
C - - - - - 0x018CF5 06:ACE5: 20 42 D6  JSR sub_D642_have_intersect_with_character ;
C - - - - - 0x018CF8 06:ACE8: 90 15     BCC bra_ACFF_RTS                           ; If the character hasn't damage
...
C - - - - - 0x018D06 06:ACF6: 8D 18 02  STA vSensorActiveHighCounter               ; initializes the counter (a high value)
C - - - - - 0x018D09 06:ACF9: A5 D1     LDA vGogglesActive                         ;
C - - - - - 0x018D0B 06:ACFB: 09 40     ORA #$40                                   ; CONSTANT - the sensor is activated
...
C - - - - - 0x018D55 06:AD45: 10 BD     BPL bra_AD04_loop                ; If vTempCounter1A >= 0x00
C - - - - - 0x018D57 06:AD47: AD 18 02  LDA vSensorActiveHighCounter     ;
C - - - - - 0x018D5A 06:AD4A: D0 0C     BNE bra_AD58_update_counter      ; If a high counter != 0x00
C - - - - - 0x018D5C 06:AD4C: AD 17 02  LDA vSensorActiveLowCounter      ;
C - - - - - 0x018D5F 06:AD4F: D0 07     BNE bra_AD58_update_counter      ; If a low counter != 0x00
loc_AD51_deactivate:
C D 1 - - - 0x018D61 06:AD51: A5 D1     LDA vGogglesActive               ;
C - - - - - 0x018D63 06:AD53: 29 BF     AND #$BF                         ; CONSTANT - all statuses, except 'the sensor is activated'
C - - - - - 0x018D65 06:AD55: 85 D1     STA vGogglesActive               ;
C - - - - - 0x018D67 06:AD57: 60        RTS                              ;

bra_AD58_update_counter:
...
loc_AD6F_free_projectile:
C D 1 - - - 0x018D7F 06:AD6F: A6 1A     LDX vTempCounter1A        ; puts the projectile number
C - - - - - 0x018D81 06:AD71: A9 00     LDA #$00                  ;
C - - - - - 0x018D83 06:AD73: 9D 5E 03  STA vEnemyBStatus + 2,X   ; clear
bra_AD76_RTS:
...
; In: Register X - the projectile number
; In: Register Y - sprite_magic2 (The offset by the address)
bra_AD83_prepare_rendering:
loc_AD83_prepare_rendering:
C D 1 - - - 0x018D93 06:AD83: BD 76 03  LDA vEnemyBProjectilePosXLow,X       ;
C - - - - - 0x018D96 06:AD86: 85 00     STA $0000                            ; prepares the 1st parameter
C - - - - - 0x018D98 06:AD88: BD 7C 03  LDA vEnemyBProjectilePosXHigh,X      ;
C - - - - - 0x018D9B 06:AD8B: 85 01     STA $0001                            ; prepares the 2nd parameter
C - - - - - 0x018D9D 06:AD8D: 20 AC D6  JSR sub_D6AC_out_of_screen           ;
C - - - - - 0x018DA0 06:AD90: B0 DD     BCS bra_AD6F_free_projectile         ; If the enemy isn't on the screen
C - - - - - 0x018DA2 06:AD92: BD 6A 03  LDA vEnemyBProjectilePosY,X          ;
C - - - - - 0x018DA5 06:AD95: 85 00     STA $0000                            ; ~> sprite magic1
C - - - - - 0x018DA7 06:AD97: A5 03     LDA $0003                            ; from sub_D6AC_out_of_screen
C - - - - - 0x018DA9 06:AD99: 9D 70 03  STA vEnemyBProjectileScreenPosY,X    ;
C - - - - - 0x018DAC 06:AD9C: BD 5E 03  LDA vEnemyBStatus + 2,X              ;
C - - - - - 0x018DAF 06:AD9F: 29 20     AND #$20                             ; CONSTANT - the dying
C - - - - - 0x018DB1 06:ADA1: F0 03     BEQ bra_ADA6_skip                    ; If the projectile isn't destroyed
C - - - - - 0x018DB3 06:ADA3: 4C FB AD  JMP loc_ADFB_dying                   ;

; In: Register Y - sprite_magic2 (The offset by the address)
bra_ADA6_skip:
C - - - - - 0x018DB6 06:ADA6: 98        TYA                                  ;
C - - - - - 0x018DB7 06:ADA7: 18        CLC                                  ;
C - - - - - 0x018DB8 06:ADA8: 69 98     ADC #$98                             ; + Y ~> sprite_magic2
C - - - - - 0x018DBA 06:ADAA: 85 01     STA $0001                            ;
C - - - - - 0x018DBC 06:ADAC: A9 47     LDA #$47                             ; ~> sprite_magic3
C - - - - - 0x018DBE 06:ADAE: 85 02     STA $0002                            ;
C - - - - - 0x018DC0 06:ADB0: 4C 33 CE  JMP loc_CE33_add_sprite_magic        ; bank FF

; In: Register X - the projectile number
loc_ADB3_falling:
C D 1 - - - 0x018DC3 06:ADB3: BC 88 03  LDY vEnemyBProjectileJumpCounter,X    ;
C - - - - - 0x018DC6 06:ADB6: B9 5D E3  LDA tbl_E35D_jump_posY_offset,Y       ; Y = [0x00-0x2F]
C - - - - - 0x018DC9 06:ADB9: 18        CLC                                   ;
C - - - - - 0x018DCA 06:ADBA: 7D 6A 03  ADC vEnemyBProjectilePosY,X           ;
C - - - - - 0x018DCD 06:ADBD: 9D 6A 03  STA vEnemyBProjectilePosY,X           ; Resolves a new Y-position of the projectile
C - - - - - 0x018DD0 06:ADC0: C9 DF     CMP #$DF                              ; CONSTANT - Maximum allowed Y-value on the screen
C - - - - - 0x018DD2 06:ADC2: 90 03     BCC bra_ADC7_continue                 ; If PosY < 0xDF
C - - - - - 0x018DD4 06:ADC4: 4C 6F AD  JMP loc_AD6F_free_projectile          ;

bra_ADC7_continue:
C - - - - - 0x018DD7 06:ADC7: FE 88 03  INC vEnemyBProjectileJumpCounter,X    ;
C - - - - - 0x018DDA 06:ADCA: A9 1F     LDA #$1F                              ; CONSTANT - a maximum jump value for projectiles
C - - - - - 0x018DDC 06:ADCC: DD 88 03  CMP vEnemyBProjectileJumpCounter,X    ;
C - - - - - 0x018DDF 06:ADCF: B0 03     BCS @bra_ADD4_skip                    ; If vJumpCounter <= 0x1F, i.e. less than maximum
C - - - - - 0x018DE1 06:ADD1: 9D 88 03  STA vEnemyBProjectileJumpCounter,X    ; reassign
@bra_ADD4_skip:
C - - - - - 0x018DE4 06:ADD4: A5 2C     LDA vLowCounter                       ;
C - - - - - 0x018DE6 06:ADD6: 29 03     AND #$03                              ;
C - - - - - 0x018DE8 06:ADD8: D0 0F     BNE @bra_ADE9_assign                  ; Branch if vLowCounter doesn't multiple of 4 (75% chance)
C - - - - - 0x018DEA 06:ADDA: FE 82 03  INC vEnemyBProjectileFrameCounter,X   ; prepare a next frame
C - - - - - 0x018DED 06:ADDD: BD 82 03  LDA vEnemyBProjectileFrameCounter,X   ;
C - - - - - 0x018DF0 06:ADE0: C9 08     CMP #$08                              ; CONSTANT - the number of the frames
C - - - - - 0x018DF2 06:ADE2: 90 05     BCC @bra_ADE9_assign                  ; If vFrameCounter < 0x08
C - - - - - 0x018DF4 06:ADE4: A9 00     LDA #$00                              ; CONSTANT - 1st frame
C - - - - - 0x018DF6 06:ADE6: 9D 82 03  STA vEnemyBProjectileFrameCounter,X   ; reassign
@bra_ADE9_assign:
C - - - - - 0x018DF9 06:ADE9: BC 82 03  LDY vEnemyBProjectileFrameCounter,X   ;
C - - - - - 0x018DFC 06:ADEC: B9 F3 AD  LDA tbl_ADF3_offsets,Y                ;
C - - - - - 0x018DFF 06:ADEF: A8        TAY                                   ; prepares the sprite_magic2 (The offset by the address)
C - - - - - 0x018E00 06:ADF0: 4C 83 AD  JMP loc_AD83_prepare_rendering        ;
...
loc_ADFB_dying:
C - - - - - 0x018E0B 06:ADFB: DE 88 03  DEC vEnemyBProjectileJumpCounter,X     ;
C - - - - - 0x018E0E 06:ADFE: D0 03     BNE bra_AE03_flash_rendering           ; If vJumpCounter != 0x00
C - - - - - 0x018E10 06:AE00: 4C 6F AD  JMP loc_AD6F_free_projectile           ;

bra_AE03_flash_rendering:
C - - - - - 0x018E13 06:AE03: BD 88 03  LDA vEnemyBProjectileJumpCounter,X     ; prepare an input parameter
C - - - - - 0x018E16 06:AE06: 4C 80 D9  JMP loc_D980_add_flash_sprite_magic_ex ;

loc_AE09_enemy:
C D 1 - - - 0x018E19 06:AE09: A2 01     LDX #$01                            ;
C - - - - - 0x018E1B 06:AE0B: 86 1A     STX vTempCounter1A                  ; set loop counter (the enemyB number)
bra_AE0D_loop:                                                              ; loop by vTempCounter1A (2 times)
C - - - - - 0x018E1D 06:AE0D: A6 1A     LDX vTempCounter1A                  ; prepares the input parameter
C - - - - - 0x018E1F 06:AE0F: 20 58 AE  JSR sub_AE58_status_behavior        ;
C - - - - - 0x018E22 06:AE12: BD 5C 03  LDA vEnemyBStatus,X                 ;
C - - - - - 0x018E25 06:AE15: C9 E0     CMP #$E0                            ;
C - - - - - 0x018E27 06:AE17: B0 23     BCS bra_AE3C_next                   ; If EnemyAStatus >= 0xE0
C - - - - - 0x018E29 06:AE19: C9 C0     CMP #$C0                            ;
C - - - - - 0x018E2B 06:AE1B: 90 1F     BCC bra_AE3C_next                   ; If EnemyAStatus < 0xC0 else only 0xCX or 0xDX
C - - - - - 0x018E2D 06:AE1D: BD 68 03  LDA vEnemyBPosY,X                   ;
C - - - - - 0x018E30 06:AE20: 85 AD     STA vEnemyHitBoxY                   ; <~ posY
C - - - - - 0x018E32 06:AE22: BD 6E 03  LDA vEnemyBScreenPosX,X             ;
C - - - - - 0x018E35 06:AE25: 85 AE     STA vEnemyHitBoxX                   ; <~ posX
C - - - - - 0x018E37 06:AE27: A9 20     LDA #$20                            ;
C - - - - - 0x018E39 06:AE29: 85 AF     STA vEnemyHitBoxH                   ; <~ hitBoxH
C - - - - - 0x018E3B 06:AE2B: A9 06     LDA #$06                            ;
C - - - - - 0x018E3D 06:AE2D: 85 B0     STA vEnemyHitBoxW                   ; <~ hitBoxW
C - - - - - 0x018E3F 06:AE2F: A6 7A     LDX vBulletCount                    ; set loop counter
@bra_AE31_loop:
C - - - - - 0x018E41 06:AE31: 20 B6 D5  JSR sub_D5B6_have_intersect_bullet  ;
C - - - - - 0x018E44 06:AE34: B0 0B     BCS bra_AE41_bullet_hit             ; If the intersect is exist
C - - - - - 0x018E46 06:AE36: CA        DEX                                 ; decrement loop counter
C - - - - - 0x018E47 06:AE37: 10 F8     BPL @bra_AE31_loop                  ; If Register X >= 0x00
C - - - - - 0x018E49 06:AE39: 20 62 D5  JSR sub_D562_has_character_damage   ;
bra_AE3C_next:
loc_AE3C_next:
C D 1 - - - 0x018E4C 06:AE3C: C6 1A     DEC vTempCounter1A                  ; decrements loop counter
C - - - - - 0x018E4E 06:AE3E: 10 CD     BPL bra_AE0D_loop                   ; If vTempCounter1A >= 0x00
C - - - - - 0x018E50 06:AE40: 60        RTS                                 ;

bra_AE41_bullet_hit:
C - - - - - 0x018E51 06:AE41: A9 00     LDA #$00                            ;
C - - - - - 0x018E53 06:AE43: 95 8F     STA vBulletStatus,X                 ; clear
C - - - - - 0x018E55 06:AE45: 20 4B AE  JSR sub_AE4B_hit                    ; 
C - - - - - 0x018E58 06:AE48: 4C 3C AE  JMP loc_AE3C_next                   ;

sub_AE4B_hit:
C - - - - - 0x018E5B 06:AE4B: A6 1A     LDX vTempCounter1A             ; X <~ the enemyB number
C - - - - - 0x018E5D 06:AE4D: A9 20     LDA #$20                       ; CONSTANT - 'dying' status
C - - - - - 0x018E5F 06:AE4F: 20 7A AF  JSR sub_AF7A_change_substatus  ;
C - - - - - 0x018E62 06:AE52: A9 40     LDA #$40                       ; Initializes a jump counter
C - - - - - 0x018E64 06:AE54: 9D 86 03  STA vEnemyBJumpCounter,X       ;
bra_AE57_RTS:
C - - - - - 0x018E67 06:AE57: 60        RTS                            ;

sub_AE58_status_behavior:
C - - - - - 0x018E68 06:AE58: BD 5C 03  LDA vEnemyBStatus,X                       ;
C - - - - - 0x018E6B 06:AE5B: 10 FA     BPL bra_AE57_RTS                          ; If the status isn't used
C - - - - - 0x018E6D 06:AE5D: 4A        LSR                                       ;
C - - - - - 0x018E6E 06:AE5E: 20 B8 D0  JSR sub_D0B8_change_stack_pointer_by_bits ; bank_FF

- D - - - - 0x018E71 06:AE61: 6E AE     .addr loc_AE6F_main - 1  ; 0x02
- D - - - - 0x018E73 06:AE63: 6E AE     .addr loc_AE6F_main - 1  ; 0x04
- D - - - - 0x018E75 06:AE65: 6E AE     .addr loc_AE6F_main - 1  ; 0x08
- D - - - - 0x018E77 06:AE67: 6E AE     .addr loc_AE6F_main - 1  ; 0x10
- D 1 - I - 0x018E79 06:AE69: B4 AE     .addr loc_AEB5_dying - 1 ; 0x20
- D 1 - I - 0x018E7B 06:AE6B: 6E AE     .addr loc_AE6F_main - 1  ; 0x40
- D 1 - I - 0x018E7D 06:AE6D: 6E AE     .addr loc_AE6F_main - 1  ; 0x80

loc_AE6F_main:
C - - - - - 0x018E7F 06:AE6F: 20 C8 AE  JSR sub_AEC8_check_collision_by_posX    ;
C - - - - - 0x018E82 06:AE72: F0 06     BEQ bra_AE7A_no_collision               ; !(BUG?), Z = 1 always true
C - - - - - 0x018E84 06:AE74: 20 32 AF  JSR sub_AF32_vertical_movement          ;
C - - - - - 0x018E87 06:AE77: 4C 82 AE  JMP loc_AE82_continue                   ;

bra_AE7A_no_collision:
C - - - - - 0x018E8A 06:AE7A: A9 00     LDA #$00                                ;
C - - - - - 0x018E8C 06:AE7C: 20 7A AF  JSR sub_AF7A_change_substatus           ; clear all substatuses
C - - - - - 0x018E8F 06:AE7F: 20 68 AF  JSR sub_AF68_horizontal_movement        ;
loc_AE82_continue:
C - - - - - 0x018E92 06:AE82: 20 C4 D9  JSR sub_D9C4_inc_enemyB_frame_counter   ;
C - - - - - 0x018E95 06:AE85: BD 80 03  LDA vEnemyBFrameCounter,X               ;
C - - - - - 0x018E98 06:AE88: 0A        ASL                                     ;
C - - - - - 0x018E99 06:AE89: 0A        ASL                                     ;
C - - - - - 0x018E9A 06:AE8A: A8        TAY                                     ; Y <~ 4 * vFrameCounter
; In: Register Y - sprite_magic2 (The offset by the address)
bra_AE8B_prepare_rendering:
C - - - - - 0x018E9B 06:AE8B: BD 74 03  LDA vEnemyBPosXLow,X                    ;
C - - - - - 0x018E9E 06:AE8E: 85 00     STA $0000                               ; prepares the 1st parameter
C - - - - - 0x018EA0 06:AE90: BD 7A 03  LDA vEnemyBPosXHigh,X                   ;
C - - - - - 0x018EA3 06:AE93: 85 01     STA $0001                               ; prepares the 2nd parameter
C - - - - - 0x018EA5 06:AE95: 20 7B D6  JSR sub_D67B_out_of_sight               ;
C - - - - - 0x018EA8 06:AE98: 90 03     BCC bra_AE9D_skip                       ; If the enemy is visible
C - - - - - 0x018EAA 06:AE9A: 4C 73 D8  JMP loc_D873_free_enemyB                ;

; In: Register Y - sprite_magic2 (The offset by the address)
bra_AE9D_skip:
C - - - - - 0x018EAD 06:AE9D: 20 AC D6  JSR sub_D6AC_out_of_screen      ;
C - - - - - 0x018EB0 06:AEA0: 90 03     BCC bra_AEA5_skip               ; If the enemy is on the screen
...
C - - - - - 0x018EBA 06:AEAA: 69 1C     ADC #$1C                       ; + Y ~> sprite_magic2
C - - - - - 0x018EBC 06:AEAC: 85 01     STA $0001                      ;
C - - - - - 0x018EBE 06:AEAE: A9 13     LDA #$13                       ; ~> sprite_magic3
C - - - - - 0x018EC0 06:AEB0: 85 02     STA $0002                      ;
C - - - - - 0x018EC2 06:AEB2: 4C 33 CE  JMP loc_CE33_add_sprite_magic  ; bank FF

loc_AEB5_dying:
C - - - - - 0x018EC5 06:AEB5: DE 86 03  DEC vEnemyBJumpCounter,X          ; updates the counter value
C - - - - - 0x018EC8 06:AEB8: D0 03     BNE bra_AEBD_death_rendering      ; If JumpCounter != 0x00
C - - - - - 0x018ECA 06:AEBA: 4C 73 D8  JMP loc_D873_free_enemyB          ;

bra_AEBD_death_rendering:
C - - - - - 0x018ECD 06:AEBD: BD 86 03  LDA vEnemyBJumpCounter,X        ;
C - - - - - 0x018ED0 06:AEC0: 29 0C     AND #$0C                        ; filters (a mask)
C - - - - - 0x018ED2 06:AEC2: 18        CLC                             ;
C - - - - - 0x018ED3 06:AEC3: 69 0C     ADC #$0C                        ; A <~ (0x0C, 0x10, 0x14, 0x18)
C - - - - - 0x018ED5 06:AEC5: A8        TAY                             ; prepares the sprite_magic2 (The offset by the address)
C - - - - - 0x018ED6 06:AEC6: D0 C3     BNE bra_AE8B_prepare_rendering  ;

; Out: Zero flag - ??? (see loc_D3AD_left_collision_by_inc_posX)
sub_AEC8_check_collision_by_posX:
C - - - - - 0x018ED8 06:AEC8: BD 5C 03  LDA vEnemyBStatus,X                          ;
C - - - - - 0x018EDB 06:AECB: 6A        ROR                                          ;
C - - - - - 0x018EDC 06:AECC: 90 2A     BCC bra_AEF8_right                           ; If the enemy is looking to the right
C - - - - - 0x018EDE 06:AECE: 20 4A D9  JSR sub_D94A_init_absolute_enemyB_positions  ;
C - - - - - 0x018EE1 06:AED1: A9 F8     LDA #$F8                                     ; prepare an increment by X (-8)
C - - - - - 0x018EE3 06:AED3: 20 AD D3  JSR sub_D3AD_left_collision_by_inc_posX      ;
C - - - - - 0x018EE6 06:AED6: D0 4A     BNE bra_AF22_collision                       ; !(BUG?), Z = 1 always true
C - - - - - 0x018EE8 06:AED8: A5 00     LDA $0000                                    ;
C - - - - - 0x018EEA 06:AEDA: 38        SEC                                          ;
C - - - - - 0x018EEB 06:AEDB: E9 10     SBC #$10                                     ;
C - - - - - 0x018EED 06:AEDD: 85 00     STA $0000                                    ; prepare an input parameter (EnemyBPosY - 0x10)
C - - - - - 0x018EEF 06:AEDF: 20 52 D9  JSR sub_D952_init_short_enemyB_positions     ;
C - - - - - 0x018EF2 06:AEE2: A9 F8     LDA #$F8                                     ; prepare an increment by X (-8)
C - - - - - 0x018EF4 06:AEE4: 20 AD D3  JSR sub_D3AD_left_collision_by_inc_posX      ;
C - - - - - 0x018EF7 06:AEE7: D0 39     BNE bra_AF22_collision                       ; !(BUG?), Z = 1 always true
C - - - - - 0x018EF9 06:AEE9: A5 00     LDA $0000                                    ;
C - - - - - 0x018EFB 06:AEEB: 38        SEC                                          ;
C - - - - - 0x018EFC 06:AEEC: E9 0F     SBC #$0F                                     ;
C - - - - - 0x018EFE 06:AEEE: 85 00     STA $0000                                    ; prepare an input parameter (EnemyBPosY - 0x0F)
C - - - - - 0x018F00 06:AEF0: 20 52 D9  JSR sub_D952_init_short_enemyB_positions     ;
C - - - - - 0x018F03 06:AEF3: A9 F8     LDA #$F8                                     ; prepare an increment by X (-8)
...
C - - - - - 0x018F0B 06:AEFB: A9 08     LDA #$08                                     ; prepare an increment by X (+8)
C - - - - - 0x018F0D 06:AEFD: 20 97 D3  JSR sub_D397_right_collision_by_inc_posX     ;
C - - - - - 0x018F10 06:AF00: D0 20     BNE bra_AF22_collision                       ; !(BUG?), Z = 1 always true
C - - - - - 0x018F12 06:AF02: A5 00     LDA $0000                                    ;
C - - - - - 0x018F14 06:AF04: 38        SEC                                          ;
C - - - - - 0x018F15 06:AF05: E9 10     SBC #$10                                     ;
C - - - - - 0x018F17 06:AF07: 85 00     STA $0000                                    ; prepare an input parameter (EnemyBPosY - 0x10)
C - - - - - 0x018F19 06:AF09: 20 52 D9  JSR sub_D952_init_short_enemyB_positions     ;
C - - - - - 0x018F1C 06:AF0C: A9 08     LDA #$08                                     ; prepare an increment by X (+8)
C - - - - - 0x018F1E 06:AF0E: 20 97 D3  JSR sub_D397_right_collision_by_inc_posX     ;
C - - - - - 0x018F21 06:AF11: D0 0F     BNE bra_AF22_collision                       ; !(BUG?), Z = 1 always true
C - - - - - 0x018F23 06:AF13: A5 00     LDA $0000                                    ;
C - - - - - 0x018F25 06:AF15: 38        SEC                                          ;
C - - - - - 0x018F26 06:AF16: E9 0F     SBC #$0F                                     ;
C - - - - - 0x018F28 06:AF18: 85 00     STA $0000                                    ; prepare an input parameter (EnemyBPosY - 0x0F)
C - - - - - 0x018F2A 06:AF1A: 20 52 D9  JSR sub_D952_init_short_enemyB_positions     ;
C - - - - - 0x018F2D 06:AF1D: A9 08     LDA #$08                                     ; prepare an increment by X (+8)
C - - - - - 0x018F2F 06:AF1F: 4C 97 D3  JMP loc_D397_right_collision_by_inc_posX     ;

bra_AF22_collision:
C - - - - - 0x018F32 06:AF22: BD 5C 03  LDA vEnemyBStatus,X                          ;
C - - - - - 0x018F35 06:AF25: 29 04     AND #$04                                     ; CONSTANT - 'vertical' status
C - - - - - 0x018F37 06:AF27: D0 08     BNE @bra_AF31_skip                           ; If 'vertical' status is activated
C - - - - - 0x018F39 06:AF29: 20 64 D0  JSR sub_D064_generate_rng                    ;
C - - - - - 0x018F3C 06:AF2C: 29 02     AND #$02                                     ; CONSTANT - 'upward or downward direction'
C - - - - - 0x018F3E 06:AF2E: 4C 7A AF  JMP sub_AF7A_change_substatus                ;
@bra_AF31_skip:
C - - - - - 0x018F41 06:AF31: 60        RTS                                          ;

; In: Register X - the enemyB number
sub_AF32_vertical_movement:
C - - - - - 0x018F42 06:AF32: BD 5C 03  LDA vEnemyBStatus,X                       ;
C - - - - - 0x018F45 06:AF35: 29 02     AND #$02                                  ; CONSTANT - 'upward direction'
C - - - - - 0x018F47 06:AF37: F0 17     BEQ bra_AF50_move_down                    ; If 'upward direction' status isn't activated
C - - - - - 0x018F49 06:AF39: BD 68 03  LDA vEnemyBPosY,X                         ;
C - - - - - 0x018F4C 06:AF3C: 85 00     STA $0000                                 ;
C - - - - - 0x018F4E 06:AF3E: E6 00     INC $0000                                 ; prepare an input parameter ($0000 <~ posY + 1)
C - - - - - 0x018F50 06:AF40: 20 5E D3  JSR sub_D35E_check_enemyB_collision_by_Y  ;
C - - - - - 0x018F53 06:AF43: D0 07     BNE bra_AF4C_collision                    ; If the strong collision exists
C - - - - - 0x018F55 06:AF45: FE 68 03  INC vEnemyBPosY,X                         ;
C - - - - - 0x018F58 06:AF48: FE 68 03  INC vEnemyBPosY,X                         ; the diver moves down
C - - - - - 0x018F5B 06:AF4B: 60        RTS                                       ;

bra_AF4C_collision:
C - - - - - 0x018F5C 06:AF4C: A9 04     LDA #$04                                  ; 'vertical' + 'downward direction' statuses
C - - - - - 0x018F5E 06:AF4E: D0 2A     BNE bra_AF7A_change_substatus             ; Always true

bra_AF50_move_down:
C - - - - - 0x018F60 06:AF50: BD 68 03  LDA vEnemyBPosY,X                         ;
C - - - - - 0x018F63 06:AF53: 38        SEC                                       ;
C - - - - - 0x018F64 06:AF54: E9 20     SBC #$20                                  ;
C - - - - - 0x018F66 06:AF56: 85 00     STA $0000                                 ; prepare an input parameter ($0000 <~ posY - 0x20)
C - - - - - 0x018F68 06:AF58: 20 5E D3  JSR sub_D35E_check_enemyB_collision_by_Y  ;
C - - - - - 0x018F6B 06:AF5B: D0 07     BNE bra_AF64_collision                    ; If the strong collision exists
C - - - - - 0x018F6D 06:AF5D: DE 68 03  DEC vEnemyBPosY,X                         ;
C - - - - - 0x018F70 06:AF60: DE 68 03  DEC vEnemyBPosY,X                         ; the diver moves up
C - - - - - 0x018F73 06:AF63: 60        RTS                                       ;

bra_AF64_collision:
C - - - - - 0x018F74 06:AF64: A9 06     LDA #$06                                  ; 'vertical' + 'upward direction' statuses
C - - - - - 0x018F76 06:AF66: D0 12     BNE bra_AF7A_change_substatus             ; Always true

sub_AF68_horizontal_movement:
C - - - - - 0x018F78 06:AF68: A5 2C     LDA vLowCounter                         ;
C - - - - - 0x018F7A 06:AF6A: 29 01     AND #$01                                ;
C - - - - - 0x018F7C 06:AF6C: D0 18     BNE bra_AF86_RTS                        ; Branch if vLowCounter doesn't multiple of 2 (50% chance)
C - - - - - 0x018F7E 06:AF6E: BD 5C 03  LDA vEnemyBStatus,X                     ;
C - - - - - 0x018F81 06:AF71: 6A        ROR                                     ;
C - - - - - 0x018F82 06:AF72: 90 03     BCC bra_AF77_right                      ; If the enemy is looking to the right
...
C - - - - - 0x019032 06:B022: 9D 44 03  STA vEnemyAFrameCounter,X     ; reset a counter
bra_B025_RTS:
...
C - - - - - 0x01906B 06:B05B: 85 00     STA $0000                          ; prepares the 1st parameter
C - - - - - 0x01906D 06:B05D: BD 3E 03  LDA vEnemyAPosXHigh,X              ;
C - - - - - 0x019070 06:B060: 85 01     STA $0001                          ; prepares the 2nd parameter
...
C - - - - - 0x01908A 06:B07A: 85 01     STA $0001                          ;
C - - - - - 0x01908C 06:B07C: AD 03 03  LDA vEnemyASpriteMagic3            ; ~> sprite_magic3
C - - - - - 0x01908F 06:B07F: 85 02     STA $0002                          ;
...
C - - - - - 0x01909A 06:B08A: B1 00     LDA ($0000),Y                      ;
...
C - - - - - 0x0190BD 06:B0AD: 65 02     ADC $0002                          ;
...
C - - - - - 0x0190DD 06:B0CD: B1 00     LDA ($0000),Y                       ;
...
C - - - - - 0x0190F6 06:B0E6: B1 00     LDA ($0000),Y                       ;
...
C - - - - - 0x01910B 06:B0FB: A9 87     LDA #.lobyte(tbl_AF87_offset_indexes) ;
C - - - - - 0x01910D 06:B0FD: 85 00     STA $0000                             ;
C - - - - - 0x01910F 06:B0FF: A9 AF     LDA #.hibyte(tbl_AF87_offset_indexes) ;
C - - - - - 0x019111 06:B101: 85 01     STA $0001                             ; ($0000),0 = $AF87
...
C - - - - - 0x019132 06:B122: 99 46 03  STA vEnemyAProjectileFrameCounter,Y      ; assign a frame counter
...
C - - - - - 0x0192A4 06:B294: 9D 44 03  STA vEnemyAFrameCounter,X      ; reset a counter
C - - - - - 0x0192A7 06:B297: A0 10     LDY #$10                       ; the jump counter value #1
...
C - - - - - 0x0192B8 06:B2A8: A0 18     LDY #$18                       ; the jump counter value #2
@bra_B2AA_skip:
...
C - - - - - 0x0193B8 06:B3A8: 85 00     STA $0000                                 ;
C - - - - - 0x0193BA 06:B3AA: E6 00     INC $0000                                 ; prepare an input parameter (EnemyAPosY + 1)
...
C - - - - - 0x019419 06:B409: 85 00     STA $0000                         ; prepares the 1st parameter
C - - - - - 0x01941B 06:B40B: BD 3E 03  LDA vEnemyAPosXHigh,X             ;
C - - - - - 0x01941E 06:B40E: 85 01     STA $0001                         ; prepares the 2nd parameter
...
; In: $0000 - low X-position
; In: $0001 - high X-position
; In: Register Y - sprite_magic2 (The offset by the address)
...
@bra_B44E_skip:
C - - - - - 0x01945E 06:B44E: 84 04     STY $0004                        ; <~ vEnemyASpriteMagic2Ex1 or vEnemyASpriteMagic2Ex2
...
C - - - - - 0x019474 06:B464: 65 04     ADC $0004                        ; + Y ~> sprite_magic2
C - - - - - 0x019476 06:B466: 85 01     STA $0001                        ;
...
C - - - - - 0x01947F 06:B46F: A5 00     LDA $0000                        ;
C - - - - - 0x019481 06:B471: 18        CLC                              ;
C - - - - - 0x019482 06:B472: 69 05     ADC #$05                         ;
C - - - - - 0x019484 06:B474: 85 00     STA $0000                        ; sprite_magic1 <~ sprite_magic1 + 0x05
...
C - - - - - 0x019492 06:B482: 85 01     STA $0001                     ;
bra_B484_add_sprite:
...
C - - - - - 0x0194C3 06:B4B3: 85 01     STA $0001                            ;
C - - - - - 0x0194C5 06:B4B5: AD 03 03  LDA vEnemyASpriteMagic3              ; ~> sprite_magic3
C - - - - - 0x0194C8 06:B4B8: 85 02     STA $0002                            ;
...
C - - - - - 0x0194D0 06:B4C0: C6 00     DEC $0000                                    ; decrement EnemyAPosY for the ceiling area
...
C - - - - - 0x01950F 06:B4FF: BD 44 03  LDA vEnemyAFrameCounter,X                ;
...
C - - - - - 0x019559 06:B549: 9D 44 03  STA vEnemyAFrameCounter,X       ; reset a counter
bra_B54C_RTS:
...
C - - - - - 0x019596 06:B586: 9D 44 03  STA vEnemyAFrameCounter,X               ; reset a counter
loc_B589_jump:
...
; In: $0000 - EnemyAPosY
bra_B5D8_skip:
C - - - - - 0x0195E8 06:B5D8: 85 00     STA $0000                                    ;
C - - - - - 0x0195EA 06:B5DA: E6 00     INC $0000                                    ; prepare an input parameter (EnemyAPosY + 1)
...
C - - - - - 0x0197A2 06:B792: 9D 46 03  STA vEnemyAProjectileFrameCounter,X   ; Initializes a projectile frame counter
...
C - - - - - 0x0197B3 06:B7A3: 9D 46 03  STA vEnemyAProjectileFrameCounter,X   ; Initializes a projectile frame counter
loc_B7A6_continue:
C D 1 - - - 0x0197B6 06:B7A6: A9 C4     LDA #$C4                            ;
C - - - - - 0x0197B8 06:B7A8: 85 00     STA $0000                           ; $0000 <~ 0xC4
C - - - - - 0x0197BA 06:B7AA: BD 20 03  LDA vEnemyAStatus,X                 ;
C - - - - - 0x0197BD 06:B7AD: 29 01     AND #$01                            ; CONSTANT - 'direction' status
C - - - - - 0x0197BF 06:B7AF: 05 00     ORA $0000                           ;
...
C - - - - - 0x0197D4 06:B7C4: 9D 58 03  STA vEnemyAProjectileJumpType,X     ; !(UNUSED), not used
...
@bra_B7EE_skip:
C - - - - - 0x0197FE 06:B7EE: 84 00     STY $0000                           ; <~ 0x00 or 0x0E
...
tbl_B823_hitboxes:
- D 1 - - - 0x019833 06:B823: 00        .byte $00, $00, $20, $04   ; default
- D 1 - - - 0x019837 06:B827: 00        .byte $00, $00, $18, $04   ; squatting

tbl_B82B_status_flags:
- D 1 - - - 0x01983B 06:B82B: 00        .byte $00   ; nothing
- D 1 - - - 0x01983C 06:B82C: 00        .byte $00   ; nothing
- D 1 - - - 0x01983D 06:B82D: 00        .byte $00   ; nothing
- D 1 - - - 0x01983E 06:B82E: 10        .byte $10   ; squatting
- D 1 - - - 0x01983F 06:B82F: 10        .byte $10   ; squatting
- D 1 - - - 0x019840 06:B830: 0C        .byte $0C   ; stop + throw
- D 1 - - - 0x019841 06:B831: 0C        .byte $0C   ; stop + throw
- D 1 - - - 0x019842 06:B832: 0C        .byte $0C   ; stop + throw
...
C - - - - - 0x01984B 06:B83B: 86 1A     STX vTempCounter1A                   ; <~ the enemyA number (only one)
C - - - - - 0x01984D 06:B83D: A6 1A     LDX vTempCounter1A                   ; prepares the input parameter
C - - - - - 0x01984F 06:B83F: 20 95 B8  JSR sub_B895_status_behavior         ;
C - - - - - 0x019852 06:B842: A6 1A     LDX vTempCounter1A                   ; <~ the enemyA number
C - - - - - 0x019854 06:B844: BD 20 03  LDA vEnemyAStatus,X                  ;
C - - - - - 0x019857 06:B847: C9 E0     CMP #$E0                             ;
C - - - - - 0x019859 06:B849: B0 19     BCS bra_B864_RTS                     ; If EnemyAStatus >= 0xE0
C - - - - - 0x01985B 06:B84B: C9 C0     CMP #$C0                             ;
C - - - - - 0x01985D 06:B84D: 90 15     BCC bra_B864_RTS                     ; If EnemyAStatus < 0xC0 else only 0xCX or 0xDX
C - - - - - 0x01985F 06:B84F: 20 6D B8  JSR sub_B86D_prepare_hitbox          ;
C - - - - - 0x019862 06:B852: 20 62 D5  JSR sub_D562_has_character_damage    ;
C - - - - - 0x019865 06:B855: 90 0D     BCC bra_B864_RTS                     ; If the character haven't got damage
...
loc_B865_before_freeing_enemyA:
C D 1 - - - 0x019875 06:B865: A9 4A     LDA #$4A                           ; CONSTANT - almost the limit
C - - - - - 0x019877 06:B867: 8D 17 03  STA vZenigataTimerHigh1            ; reassign for next appearance
C - - - - - 0x01987A 06:B86A: 4C 7F D7  JMP loc_D77F_free_enemyA           ;

sub_B86D_prepare_hitbox:
C - - - - - 0x01987D 06:B86D: A0 00     LDY #$00                     ; the offset value #1
C - - - - - 0x01987F 06:B86F: BD 20 03  LDA vEnemyAStatus,X          ;
C - - - - - 0x019882 06:B872: 29 10     AND #$10                     ; CONSTANT - 'squatting' status
C - - - - - 0x019884 06:B874: F0 02     BEQ @bra_B878_assign         ; If 'squatting' status isn't activated
C - - - - - 0x019886 06:B876: A0 04     LDY #$04                     ; the offset value #2
@bra_B878_assign:
C - - - - - 0x019888 06:B878: BD 2C 03  LDA vEnemyAPosY,X            ;
C - - - - - 0x01988B 06:B87B: 18        CLC                          ;
C - - - - - 0x01988C 06:B87C: 79 23 B8  ADC tbl_B823_hitboxes,Y      ;
C - - - - - 0x01988F 06:B87F: 85 AD     STA vEnemyHitBoxY            ; <~ posY + absolute hitBoxY
C - - - - - 0x019891 06:B881: BD 32 03  LDA vEnemyAScreenPosX,X      ;
C - - - - - 0x019894 06:B884: 18        CLC                          ;
C - - - - - 0x019895 06:B885: 79 24 B8  ADC tbl_B823_hitboxes + 1,Y  ;
C - - - - - 0x019898 06:B888: 85 AE     STA vEnemyHitBoxX            ; <~ posX + absolute hitBoxX
C - - - - - 0x01989A 06:B88A: B9 25 B8  LDA tbl_B823_hitboxes + 2,Y  ;
C - - - - - 0x01989D 06:B88D: 85 AF     STA vEnemyHitBoxH            ; <~ hitBoxH
C - - - - - 0x01989F 06:B88F: B9 26 B8  LDA tbl_B823_hitboxes + 3,Y  ;
C - - - - - 0x0198A2 06:B892: 85 B0     STA vEnemyHitBoxW            ; <~ hitBoxW
bra_B894_RTS:
C - - - - - 0x0198A4 06:B894: 60        RTS                          ;

sub_B895_status_behavior:
C - - - - - 0x0198A5 06:B895: BD 20 03  LDA vEnemyAStatus,X                       ;
C - - - - - 0x0198A8 06:B898: 10 FA     BPL bra_B894_RTS                          ; If the status isn't used
C - - - - - 0x0198AA 06:B89A: 4A        LSR                                       ;
C - - - - - 0x0198AB 06:B89B: 20 B8 D0  JSR sub_D0B8_change_stack_pointer_by_bits ; bank_FF

- D 1 - I - 0x0198AE 06:B89E: A2 B9     .addr loc_B9A3_jump - 1      ; 0x02
- D 1 - I - 0x0198B0 06:B8A0: AB B8     .addr loc_B8AC_main - 1      ; 0x04
- D - - - - 0x0198B2 06:B8A2: AB B8     .addr loc_B8AC_main - 1      ; 0x08
- D 1 - I - 0x0198B4 06:B8A4: 73 B9     .addr loc_B974_squatting - 1 ; 0x10
- D - - - - 0x0198B6 06:B8A6: 49 BA     .addr loc_BA4A_dying - 1     ; 0x20
- D 1 - I - 0x0198B8 06:B8A8: AB B8     .addr loc_B8AC_main - 1      ; 0x40
- D 1 - I - 0x0198BA 06:B8AA: AB B8     .addr loc_B8AC_main - 1      ; 0x80

; In: Register X - the enemyA number
loc_B8AC_main:
C - - - - - 0x0198BC 06:B8AC: BD 2C 03  LDA vEnemyAPosY,X                           ;
C - - - - - 0x0198BF 06:B8AF: 85 00     STA $0000                                   ;
C - - - - - 0x0198C1 06:B8B1: E6 00     INC $0000                                   ; prepare an input parameter (EnemyAPosY + 1)
C - - - - - 0x0198C3 06:B8B3: 20 58 D3  JSR sub_D358_check_enemyA_collision_by_Y    ;
C - - - - - 0x0198C6 06:B8B6: D0 07     BNE bra_B8BF_skip                           ; If the collisions by Y-position exists
C - - - - - 0x0198C8 06:B8B8: A9 1C     LDA #$1C                                    ; CONSTANT - a jump counter value
C - - - - - 0x0198CA 06:B8BA: A0 02     LDY #$02                                    ; CONSTANT - jumping off, free fall
C - - - - - 0x0198CC 06:B8BC: 4C 92 B9  JMP loc_B992_activate_jump_status           ;

bra_B8BF_skip:
C - - - - - 0x0198CF 06:B8BF: 20 63 BA  JSR sub_BA63_try_to_change_self  ;
C - - - - - 0x0198D2 06:B8C2: BD 20 03  LDA vEnemyAStatus,X              ;
C - - - - - 0x0198D5 06:B8C5: 29 08     AND #$08                         ; CONSTANT - 'stop' status
C - - - - - 0x0198D7 06:B8C7: D0 03     BNE bra_B8CC_skip                ; If 'stop' status is activated
C - - - - - 0x0198D9 06:B8C9: 4C 13 B9  JMP loc_B913_try_movements       ;

bra_B8CC_skip:
C - - - - - 0x0198DC 06:B8CC: A0 0C     LDY #$0C                         ; the offset value #1 (stop frame)
C - - - - - 0x0198DE 06:B8CE: BD 20 03  LDA vEnemyAStatus,X              ;
C - - - - - 0x0198E1 06:B8D1: 29 04     AND #$04                         ; CONSTANT - 'throw' status
C - - - - - 0x0198E3 06:B8D3: F0 0B     BEQ bra_B8E0_prepare_rendering   ; If 'throw' status isn't activated
C - - - - - 0x0198E5 06:B8D5: A0 14     LDY #$14                         ; the offset value #1 (throw frame #1)
C - - - - - 0x0198E7 06:B8D7: BD 4A 03  LDA vEnemyAJumpCounter,X         ;
C - - - - - 0x0198EA 06:B8DA: C9 28     CMP #$28                         ; CONSTANT - start of throw after stopping
C - - - - - 0x0198EC 06:B8DC: 90 02     BCC bra_B8E0_prepare_rendering   ; If vJumpCounter < 0x28
C - - - - - 0x0198EE 06:B8DE: A0 10     LDY #$10                         ; the offset value #1 (throw frame #2)
; In: Register Y - sprite_magic2 (The offset by the address)
bra_B8E0_prepare_rendering:
loc_B8E0_prepare_rendering:
C D 1 - - - 0x0198F0 06:B8E0: BD 38 03  LDA vEnemyAPosXLow,X                ;
C - - - - - 0x0198F3 06:B8E3: 85 00     STA $0000                           ; prepares the 1st parameter
C - - - - - 0x0198F5 06:B8E5: BD 3E 03  LDA vEnemyAPosXHigh,X               ;
C - - - - - 0x0198F8 06:B8E8: 85 01     STA $0001                           ; prepares the 2nd parameter
C - - - - - 0x0198FA 06:B8EA: 20 7B D6  JSR sub_D67B_out_of_sight           ;
C - - - - - 0x0198FD 06:B8ED: 90 03     BCC bra_B8F2_skip                   ; If the enemy is visible
C - - - - - 0x0198FF 06:B8EF: 4C 65 B8  JMP loc_B865_before_freeing_enemyA  ;

; In: Register Y - sprite_magic2 (The offset by the address)
bra_B8F2_skip:
C - - - - - 0x019902 06:B8F2: 20 AC D6  JSR sub_D6AC_out_of_screen          ;
C - - - - - 0x019905 06:B8F5: 90 03     BCC bra_B8FA_skip                   ; If the enemy is on the screen
C - - - - - 0x019907 06:B8F7: 4C 41 D7  JMP loc_D741_enemyA_off_screen      ;

; In: Register Y - sprite_magic2 (The offset by the address)
bra_B8FA_skip:
C - - - - - 0x01990A 06:B8FA: 20 25 D7  JSR sub_D725_enemyA_on_screen           ;
C - - - - - 0x01990D 06:B8FD: C0 E0     CPY #$E0                                ; CONSTANT - death frame #1
C - - - - - 0x01990F 06:B8FF: 90 03     BCC bra_B904_add_sprite_magic_v2        ; If Register Y < 0xE0
C - - - - - 0x019911 06:B901: 4C 89 D9  JMP loc_D989_add_enemyA_sprite_magic_v1 ;

; In: Register Y - sprite_magic2 (The offset by the address)
bra_B904_add_sprite_magic_v2:
C - - - - - 0x019914 06:B904: 98        TYA                           ;
C - - - - - 0x019915 06:B905: 18        CLC                           ;
C - - - - - 0x019916 06:B906: 6D 02 03  ADC vEnemyASpriteMagic2       ; + Y ~> sprite_magic2
C - - - - - 0x019919 06:B909: 85 01     STA $0001                     ;
C - - - - - 0x01991B 06:B90B: AD 03 03  LDA vEnemyASpriteMagic3       ; ~> sprite_magic3
C - - - - - 0x01991E 06:B90E: 85 02     STA $0002                     ;
C - - - - - 0x019920 06:B910: 4C 33 CE  JMP loc_CE33_add_sprite_magic ; bank FF

loc_B913_try_movements:
C D 1 - - - 0x019923 06:B913: BD 20 03  LDA vEnemyAStatus,X                       ;
C - - - - - 0x019926 06:B916: 6A        ROR                                       ;
C - - - - - 0x019927 06:B917: 90 0F     BCC bra_B928_right                        ; If the enemy is looking to the right
C - - - - - 0x019929 06:B919: 20 2E B9  JSR sub_B92E_try_movement_on_the_left     ;
loc_B91C_prepare_rendering_by_frame_:
C D 1 - - - 0x01992C 06:B91C: 20 AE D9  JSR sub_D9AE_inc_enemyA_frame_counter     ;
C - - - - - 0x01992F 06:B91F: BD 44 03  LDA vEnemyAFrameCounter,X                 ;
C - - - - - 0x019932 06:B922: 0A        ASL                                       ;
C - - - - - 0x019933 06:B923: 0A        ASL                                       ; *4
C - - - - - 0x019934 06:B924: A8        TAY                                       ; prepares the sprite_magic2 (The offset by the address)
C - - - - - 0x019935 06:B925: 4C E0 B8  JMP loc_B8E0_prepare_rendering            ;

bra_B928_right:
C - - - - - 0x019938 06:B928: 20 62 B9  JSR sub_B962_try_movement_on_the_right    ;
C - - - - - 0x01993B 06:B92B: 4C 1C B9  JMP loc_B91C_prepare_rendering_by_frame_  ;

sub_B92E_try_movement_on_the_left:
C - - - - - 0x01993E 06:B92E: 20 CA D7  JSR sub_D7CA_check_enemyA_movement_on_the_left  ;
C - - - - - 0x019941 06:B931: C9 01     CMP #$01                                        ; CONSTANT - a strong collision
C - - - - - 0x019943 06:B933: F0 0B     BEQ bra_B940_try_jump_over                      ; If the movement isn't allowed
...
C - - - - - 0x01994B 06:B93B: 90 24     BCC bra_B961_RTS                                ; Branch if vLowCounter multiple of 2 (50% chance)
C - - - - - 0x01994D 06:B93D: 4C F0 D6  JMP loc_D6F0_dec_EnemyAPosXLow                  ;

bra_B940_try_jump_over:
...
C - - - - - 0x01995F 06:B94F: 9D 4A 03  STA vEnemyAJumpCounter,X       ; Initializes a jump counter
C - - - - - 0x019962 06:B952: A9 02     LDA #$02                       ; CONSTANT - 'jump' status
C - - - - - 0x019964 06:B954: 20 AD BA  JSR sub_BAAD_change_substatus  ;
C - - - - - 0x019967 06:B957: A9 03     LDA #$03                       ; CONSTANT - jump by side
C - - - - - 0x019969 06:B959: 9D 56 03  STA vEnemyAJumpType,X          ;
C - - - - - 0x01996C 06:B95C: A9 00     LDA #$00                       ;
C - - - - - 0x01996E 06:B95E: 9D 44 03  STA vEnemyAFrameCounter,X      ; reset a counter
bra_B961_RTS:
C - - - - - 0x019971 06:B961: 60        RTS                            ;

sub_B962_try_movement_on_the_right:
C - - - - - 0x019972 06:B962: 20 BF D7  JSR sub_D7BF_check_enemyA_movement_on_the_right  ;
C - - - - - 0x019975 06:B965: C9 01     CMP #$01                                         ; CONSTANT - a strong collision
C - - - - - 0x019977 06:B967: F0 D7     BEQ bra_B940_try_jump_over                       ; If the movement isn't allowed
...
C - - - - - 0x01997F 06:B96F: 90 F0     BCC bra_B961_RTS                                 ; Branch if vLowCounter multiple of 2 (50% chance)
C - - - - - 0x019981 06:B971: 4C 0F D7  JMP loc_D70F_inc_EnemyAPosXLow                   ;

; In: Register X - the enemyA number
loc_B974_squatting:
C - - - - - 0x019984 06:B974: DE 4A 03  DEC vEnemyAJumpCounter,X           ;
C - - - - - 0x019987 06:B977: F0 05     BEQ bra_B97E_skip                  ; If vJumpCounter == 0x00
C - - - - - 0x019989 06:B979: A0 18     LDY #$18                           ; an input parameter - sprite_magic2 (a squatting frame), the squatting frame
C - - - - - 0x01998B 06:B97B: 4C E0 B8  JMP loc_B8E0_prepare_rendering     ;

bra_B97E_skip:
C - - - - - 0x01998E 06:B97E: 20 3E E3  JSR sub_E332_generate_jump_type    ;
C - - - - - 0x019991 06:B981: BC 2C 03  LDY vEnemyAPosY,X                  ;
C - - - - - 0x019994 06:B984: C0 BF     CPY #$BF                           ; CONSTANT - Lower boundary of the first floor
C - - - - - 0x019996 06:B986: 90 06     BCC @bra_B98E_skip                 ; If vEnemyPosY < 0xBF
C - - - - - 0x019998 06:B988: 29 01     AND #$01                           ;
C - - - - - 0x01999A 06:B98A: D0 02     BNE @bra_B98E_skip                 ; If vEnemyPosY is odd
C - - - - - 0x01999C 06:B98C: A9 03     LDA #$03                           ; CONSTANT - jump by side
@bra_B98E_skip:
C - - - - - 0x01999E 06:B98E: A8        TAY                                ; Y <~ {0x00, 0x01, 0x02, 0x03, 0x04}
C - - - - - 0x01999F 06:B98F: B9 58 E3  LDA tbl_E358_init_counter,Y        ;
; In: Register A - a jump counter value
; In: Register Y - a jump type
; In: Register X - the enemyA number
; In: $0000 - EnemyAPosY
loc_B992_activate_jump_status:
C D 1 - - - 0x0199A2 06:B992: 9D 4A 03  STA vEnemyAJumpCounter,X                ;
C - - - - - 0x0199A5 06:B995: 98        TYA                                     ;
C - - - - - 0x0199A6 06:B996: 9D 56 03  STA vEnemyAJumpType,X                   ;
C - - - - - 0x0199A9 06:B999: A9 02     LDA #$02                                ; CONSTANT - the jump
C - - - - - 0x0199AB 06:B99B: 20 AD BA  JSR sub_BAAD_change_substatus           ;
C - - - - - 0x0199AE 06:B99E: A9 00     LDA #$00                                ;
C - - - - - 0x0199B0 06:B9A0: 9D 44 03  STA vEnemyAFrameCounter,X               ; reset a counter
loc_B9A3_jump:
C - - - - - 0x0199B3 06:B9A3: BD 2C 03  LDA vEnemyAPosY,X                       ;
C - - - - - 0x0199B6 06:B9A6: C9 DF     CMP #$DF                                ; CONSTANT - Maximum allowed Y-value on the screen
C - - - - - 0x0199B8 06:B9A8: B0 1E     BCS bra_B9C8_skip                       ; If PosY >= 0xDF
C - - - - - 0x0199BA 06:B9AA: BD 56 03  LDA vEnemyAJumpType,X                   ;
C - - - - - 0x0199BD 06:B9AD: C9 03     CMP #$03                                ; CONSTANT - jump by side
C - - - - - 0x0199BF 06:B9AF: D0 17     BNE bra_B9C8_skip                       ; If vJumpType != 0x03
C - - - - - 0x0199C1 06:B9B1: BD 20 03  LDA vEnemyAStatus,X                     ;
C - - - - - 0x0199C4 06:B9B4: 6A        ROR                                     ;
C - - - - - 0x0199C5 06:B9B5: 90 0A     BCC bra_B9C1_right                      ; If the enemy is looking to the right
C - - - - - 0x0199C7 06:B9B7: 29 10     AND #$10                                ; CONSTANT - the dying + shift right
C - - - - - 0x0199C9 06:B9B9: D0 0A     BNE bra_B9C5_invert                     ; If the enemy is dying
bra_B9BB_invert:
C - - - - - 0x0199CB 06:B9BB: 20 2E B9  JSR sub_B92E_try_movement_on_the_left   ;
C - - - - - 0x0199CE 06:B9BE: 4C C8 B9  JMP loc_B9C8_continue                   ;

bra_B9C1_right:
C - - - - - 0x0199D1 06:B9C1: 29 10     AND #$10                                ; CONSTANT - the dying + shift right
C - - - - - 0x0199D3 06:B9C3: D0 F6     BNE bra_B9BB_invert                     ; If the enemy is dying
bra_B9C5_invert:
C - - - - - 0x0199D5 06:B9C5: 20 62 B9  JSR sub_B962_try_movement_on_the_right  ;
bra_B9C8_skip:
loc_B9C8_continue:
C D 1 - - - 0x0199D8 06:B9C8: BC 4A 03  LDY vEnemyAJumpCounter,X                ;
C - - - - - 0x0199DB 06:B9CB: B9 5D E3  LDA tbl_E35D_jump_posY_offset,Y         ; Y = [0x00-0x2F]
C - - - - - 0x0199DE 06:B9CE: 18        CLC                                     ;
C - - - - - 0x0199DF 06:B9CF: 7D 2C 03  ADC vEnemyAPosY,X                       ;
C - - - - - 0x0199E2 06:B9D2: C9 DF     CMP #$DF                                ; CONSTANT - Limit 1 for Y-position
C - - - - - 0x0199E4 06:B9D4: 90 09     BCC @bra_B9DF_skip                      ; If Register A < 0xDF
C - - - - - 0x0199E6 06:B9D6: A0 DF     LDY #$DF                                ; 0xDF -> EnemyPosY
C - - - - - 0x0199E8 06:B9D8: C9 F8     CMP #$F8                                ; CONSTANT - Limit 2 for Y-position
C - - - - - 0x0199EA 06:B9DA: 90 02     BCC @bra_B9DE_skip                      ; If Register A < 0xF8
C - - - - - 0x0199EC 06:B9DC: A0 00     LDY #$00                                ; 0x00 -> EnemyPosY
@bra_B9DE_skip:
C - - - - - 0x0199EE 06:B9DE: 98        TYA                                     ; A <~ 0x00 or 0xDF
@bra_B9DF_skip:
C - - - - - 0x0199EF 06:B9DF: 9D 2C 03  STA vEnemyAPosY,X                       ; Resolves a new Y-position of the enemy after jumping
C - - - - - 0x0199F2 06:B9E2: BC 4A 03  LDY vEnemyAJumpCounter,X                ;
C - - - - - 0x0199F5 06:B9E5: C0 18     CPY #$18                                ; CONSTANT - a maximum amplitude
C - - - - - 0x0199F7 06:B9E7: 90 50     BCC bra_BA39_skip_for_maze              ; If vJumpCounter < 0x18
C - - - - - 0x0199F9 06:B9E9: C9 DF     CMP #$DF                                ; CONSTANT - Maximum allowed Y-value on the screen
C - - - - - 0x0199FB 06:B9EB: 90 05     BCC bra_B9F2_skip                       ; If EnemyPosY < 0xDF
C - - - - - 0x0199FD 06:B9ED: A0 FF     LDY #$FF                                ; prepares the sprite_magic2 (The offset by the address), death mark
C - - - - - 0x0199FF 06:B9EF: 4C E0 B8  JMP loc_B8E0_prepare_rendering          ;

; In: Register X - the enemyA number
; In: $0000 - EnemyAPosY
bra_B9F2_skip:
C - - - - - 0x019A02 06:B9F2: 85 00     STA $0000                                    ;
C - - - - - 0x019A04 06:B9F4: E6 00     INC $0000                                    ; prepare an input parameter (EnemyAPosY + 1)
C - - - - - 0x019A06 06:B9F6: 20 58 D3  JSR sub_D358_check_enemyA_collision_by_Y     ;
C - - - - - 0x019A09 06:B9F9: F0 23     BEQ bra_BA1E_inc                             ; If the collisions by Y-position doesn't exist
C - - - - - 0x019A0B 06:B9FB: C9 02     CMP #$02                                     ; CONSTANT - a weak collision
C - - - - - 0x019A0D 06:B9FD: F0 07     BEQ bra_BA06_weak                            ; If the collision is weak
C - - - - - 0x019A0F 06:B9FF: 20 47 D3  JSR sub_D347_check_landing_enemyA            ;
C - - - - - 0x019A12 06:BA02: D0 0E     BNE bra_BA12_landing                         ; If the landing is allow
C - - - - - 0x019A14 06:BA04: F0 18     BEQ bra_BA1E_inc                             ; Always true

bra_BA06_weak:
C - - - - - 0x019A16 06:BA06: 20 47 D3  JSR sub_D347_check_landing_enemyA            ;
C - - - - - 0x019A19 06:BA09: F0 13     BEQ bra_BA1E_inc                             ; If the landing is disallow
C - - - - - 0x019A1B 06:BA0B: BD 56 03  LDA vEnemyAJumpType,X                        ;
C - - - - - 0x019A1E 06:BA0E: C9 04     CMP #$04                                     ; CONSTANT - jump off after the squatting
C - - - - - 0x019A20 06:BA10: F0 0C     BEQ bra_BA1E_inc                             ; If the enemyA jumping off
bra_BA12_landing:
C - - - - - 0x019A22 06:BA12: 20 A8 D7  JSR sub_D7A8_correction_EnemyAPosY           ;
C - - - - - 0x019A25 06:BA15: BD 20 03  LDA vEnemyAStatus,X                          ;
C - - - - - 0x019A28 06:BA18: 29 20     AND #$20                                     ; CONSTANT - the dying
C - - - - - 0x019A2A 06:BA1A: D0 29     BNE bra_BA45_start_dying_ex                  ; If the enemy is dying
C - - - - - 0x019A2C 06:BA1C: F0 0A     BEQ bra_BA28_clear                           ; Always true

bra_BA1E_inc:
C - - - - - 0x019A2E 06:BA1E: FE 4A 03  INC vEnemyAJumpCounter,X                     ;
C - - - - - 0x019A31 06:BA21: A9 2F     LDA #$2F                                     ; CONSTANT - a maximum jump value
C - - - - - 0x019A33 06:BA23: DD 4A 03  CMP vEnemyAJumpCounter,X                     ;
C - - - - - 0x019A36 06:BA26: B0 03     BCS bra_BA2B_skip                            ; If vJumpCounter <= 0x2F, i.e. less than maximum
bra_BA28_clear:
...
C - - - - - 0x019A44 06:BA34: A0 08     LDY #$08                                     ; an input parameter - sprite_magic2 (a jump frame)
@bra_BA36_skip:
C - - - - - 0x019A46 06:BA36: 4C E0 B8  JMP loc_B8E0_prepare_rendering               ;

bra_BA39_skip_for_maze:
C - - - - - 0x019A49 06:BA39: 20 D5 D7  JSR sub_D7D5_check_enemyA_collision_by_Y_in_maze  ;
C - - - - - 0x019A4C 06:BA3C: D0 E0     BNE bra_BA1E_inc                                  ; If the strong collision isn't exist
C - - - - - 0x019A4E 06:BA3E: A9 18     LDA #$18                                          ; CONSTANT - a maximum amplitude
C - - - - - 0x019A50 06:BA40: 9D 4A 03  STA vEnemyAJumpCounter,X                          ;
C - - - - - 0x019A53 06:BA43: D0 D9     BNE bra_BA1E_inc                                  ; Always true

bra_BA45_start_dying_ex:
C - - - - - 0x019A55 06:BA45: A9 30     LDA #$30                                          ;
C - - - - - 0x019A57 06:BA47: 9D 4A 03  STA vEnemyAJumpCounter,X                          ; initializes a jump counter
loc_BA4A_dying:
C - - - - - 0x019A5A 06:BA4A: DE 4A 03  DEC vEnemyAJumpCounter,X                          ; updates the counter value
C - - - - - 0x019A5D 06:BA4D: D0 03     BNE bra_BA52_death_rendering                      ; If JumpCounter != 0x00
C - - - - - 0x019A5F 06:BA4F: 4C 65 B8  JMP loc_B865_before_freeing_enemyA                ;

bra_BA52_death_rendering:
C - - - - - 0x019A62 06:BA52: BD 4A 03  LDA vEnemyAJumpCounter,X              ;
C - - - - - 0x019A65 06:BA55: 20 5F D0  JSR sub_accumulator_shift_right_by_4  ;
C - - - - - 0x019A68 06:BA58: A8        TAY                                   ; y <~ 0, 1, or 2 (high byte value of the vJumpCounter)
C - - - - - 0x019A69 06:BA59: B9 60 BA  LDA tbl_BA60_frames_,Y                ;
C - - - - - 0x019A6C 06:BA5C: A8        TAY                                   ; prepares the sprite_magic2 (The offset by the address)
C - - - - - 0x019A6D 06:BA5D: 4C E0 B8  JMP loc_B8E0_prepare_rendering        ;

tbl_BA60_frames_:
- D - - - - 0x019A70 06:BA60: E4        .byte $E4   ; death frame #2
- D - - - - 0x019A71 06:BA61: E0        .byte $E0   ; death frame #1
- D - - - - 0x019A72 06:BA62: 18        .byte $18   ; damage frame

sub_BA63_try_to_change_self:
C - - - - - 0x019A73 06:BA63: BD 4A 03  LDA vEnemyAJumpCounter,X           ;
C - - - - - 0x019A76 06:BA66: F0 1D     BEQ bra_BA85_new_status            ; If vJumpCounter == 0x00
C - - - - - 0x019A78 06:BA68: DE 4A 03  DEC vEnemyAJumpCounter,X           ;
C - - - - - 0x019A7B 06:BA6B: F0 13     BEQ bra_BA80_new_status_with_clear ; If vJumpCounter == 0x00
C - - - - - 0x019A7D 06:BA6D: BD 20 03  LDA vEnemyAStatus,X                ;
C - - - - - 0x019A80 06:BA70: 29 0C     AND #$0C                           ;
C - - - - - 0x019A82 06:BA72: C9 0C     CMP #$0C                           ; CONSTANT - 'stop' + 'throw' status
C - - - - - 0x019A84 06:BA74: D0 43     BNE bra_BAB9_RTS                   ; If 'stop' + 'throw' status isn't activated
C - - - - - 0x019A86 06:BA76: BD 4A 03  LDA vEnemyAJumpCounter,X           ;
C - - - - - 0x019A89 06:BA79: C9 28     CMP #$28                           ; CONSTANT - start of throw after stopping
C - - - - - 0x019A8B 06:BA7B: D0 3C     BNE bra_BAB9_RTS                   ; If vJumpCounter != 0x28
C - - - - - 0x019A8D 06:BA7D: 4C BA BA  JMP loc_BABA_throw                 ;

bra_BA80_new_status_with_clear:
C - - - - - 0x019A90 06:BA80: A9 00     LDA #$00                           ; clear substatus
C - - - - - 0x019A92 06:BA82: 20 AD BA  JSR sub_BAAD_change_substatus      ;
bra_BA85_new_status:
C - - - - - 0x019A95 06:BA85: 20 E1 BA  JSR sub_BAE1_try_change_direction  ;
C - - - - - 0x019A98 06:BA88: A5 2C     LDA vLowCounter                    ;
C - - - - - 0x019A9A 06:BA8A: 29 3F     AND #$3F                           ;
C - - - - - 0x019A9C 06:BA8C: D0 2B     BNE bra_BAB9_RTS                   ; Branch if vLowCounter doesn't multiple of 64 (vLowCounter % 64 != 0)
C - - - - - 0x019A9E 06:BA8E: 20 64 D0  JSR sub_D064_generate_rng          ;
C - - - - - 0x019AA1 06:BA91: 6A        ROR                                ;
C - - - - - 0x019AA2 06:BA92: B0 25     BCS bra_BAB9_RTS                   ; 50% chance branch
...
C - - - - - 0x019AB2 06:BAA2: A9 40     LDA #$40                           ; An initialize jump value for 'stop' + 'throw'
C - - - - - 0x019AB4 06:BAA4: D0 02     BNE @bra_BAA8_skip                 ; Always true

@bra_BAA6_assign:
C - - - - - 0x019AB6 06:BAA6: A9 20     LDA #$20                           ; An initialize jump value for the squatting
@bra_BAA8_skip:
C - - - - - 0x019AB8 06:BAA8: 9D 4A 03  STA vEnemyAJumpCounter,X           ;
C - - - - - 0x019ABB 06:BAAB: D0 02     BNE bra_BAAF_change_substatus_ex   ; Always true (A = 0x20 or 0x40)
...
loc_BABA_throw:
C D 1 - - - 0x019ACA 06:BABA: A0 0C     LDY #$0C                               ; prepare the projectile params number
C - - - - - 0x019ACC 06:BABC: 20 2A A9  JSR sub_A92A_add_projectile_ex         ;
C - - - - - 0x019ACF 06:BABF: BD 22 03  LDA vEnemyAProjectileStatus,X          ;
C - - - - - 0x019AD2 06:BAC2: 09 02     ORA #$02                               ; CONSTANT - moving along a parabola
C - - - - - 0x019AD4 06:BAC4: 9D 22 03  STA vEnemyAProjectileStatus,X          ;
...
C - - - - - 0x019ADF 06:BACF: 9D 28 03  STA vEnemyAProjectileVelocity,X        ; vVelocity <~ (0x03, 0x04, 0x05, 0x06)
C - - - - - 0x019AE2 06:BAD2: A9 00     LDA #$00                               ;
C - - - - - 0x019AE4 06:BAD4: 9D 46 03  STA vEnemyAProjectileFrameCounter,X    ; Initializes a projectile frame counter
C - - - - - 0x019AE7 06:BAD7: A9 03     LDA #$03                               ; 
C - - - - - 0x019AE9 06:BAD9: 9D 4C 03  STA vEnemyAProjectileJumpCounter,X     ; Initializes a jump counter
C - - - - - 0x019AEC 06:BADC: A9 31     LDA #$31                               ; sound of fist swings
...
tbl_BAF3_status_flags:
- D 1 - - - 0x019B03 06:BAF3: 00        .byte $00   ; nothing
- D 1 - - - 0x019B04 06:BAF4: 00        .byte $00   ; nothing
- D 1 - - - 0x019B05 06:BAF5: 00        .byte $00   ; nothing
- D 1 - - - 0x019B06 06:BAF6: 00        .byte $00   ; nothing
- D 1 - - - 0x019B07 06:BAF7: 00        .byte $00   ; nothing
- D 1 - - - 0x019B08 06:BAF8: 02        .byte $02   ; jump
- D 1 - - - 0x019B09 06:BAF9: 08        .byte $08   ; stop
- D 1 - - - 0x019B0A 06:BAFA: 08        .byte $08   ; stop

loc_BAFB_enemy:
C D 1 - - - 0x019B0B 06:BAFB: A2 01     LDX #$01                          ;
C - - - - - 0x019B0D 06:BAFD: 86 1A     STX vTempCounter1A                ; set loop counter (the enemyA number)
bra_BAFF_loop:
C - - - - - 0x019B0F 06:BAFF: A6 1A     LDX vTempCounter1A                ; prepares an input parameter
C - - - - - 0x019B11 06:BB01: 20 8A BB  JSR sub_BB8A_status_behavior      ;
C - - - - - 0x019B14 06:BB04: A6 1A     LDX vTempCounter1A                ; X <~ loop counter
C - - - - - 0x019B16 06:BB06: BD 20 03  LDA vEnemyAStatus,X               ;
C - - - - - 0x019B19 06:BB09: C9 E0     CMP #$E0                          ;
C - - - - - 0x019B1B 06:BB0B: B0 2A     BCS bra_BB37_next                 ; If vEnemyAStatus >= 0xE0
C - - - - - 0x019B1D 06:BB0D: C9 C0     CMP #$C0                          ;
C - - - - - 0x019B1F 06:BB0F: 90 26     BCC bra_BB37_next                 ; If vEnemyAStatus < 0xC0 else only 0xCX or 0xDX
C - - - - - 0x019B21 06:BB11: 20 75 BB  JSR sub_BB75_prepare_hitbox       ;
C - - - - - 0x019B24 06:BB14: 20 60 D6  JSR sub_D660_is_bomb_exploding    ;
C - - - - - 0x019B27 06:BB17: B0 0B     BCS @bra_BB24_bomb_hit            ; If the bomb is exploding
C - - - - - 0x019B29 06:BB19: A5 5F     LDA vChrLiveStatus                ;
C - - - - - 0x019B2B 06:BB1B: 29 02     AND #$02                          ; CONSTANT - Goemon
C - - - - - 0x019B2D 06:BB1D: F0 0B     BEQ bra_BB2A_check_bullets        ; If the character isn't Goemon
C - - - - - 0x019B2F 06:BB1F: 20 06 D6  JSR sub_D606_have_intersect_sword ;
C - - - - - 0x019B32 06:BB22: 90 10     BCC bra_BB34_no_intersect         ; If the intersect doesn't exist
@bra_BB24_bomb_hit:
C - - - - - 0x019B34 06:BB24: 20 5E BB  JSR sub_BB5E_final_hit            ;
C - - - - - 0x019B37 06:BB27: 4C 37 BB  JMP loc_BB37_next                 ;

bra_BB2A_check_bullets:
C - - - - - 0x019B3A 06:BB2A: A6 7A     LDX vBulletCount                      ; set loop counter
@bra_BB2C_loop:                                                               ; loop by x
C - - - - - 0x019B3C 06:BB2C: 20 B6 D5  JSR sub_D5B6_have_intersect_bullet    ;
C - - - - - 0x019B3F 06:BB2F: B0 0B     BCS bra_BB3C_bullet_hit               ; If the intersect is exist
C - - - - - 0x019B41 06:BB31: CA        DEX                                   ; decrement loop counter
C - - - - - 0x019B42 06:BB32: 10 F8     BPL @bra_BB2C_loop                    ; If Register X >= 0x00
bra_BB34_no_intersect:
C - - - - - 0x019B44 06:BB34: 20 62 D5  JSR sub_D562_has_character_damage     ;
loc_BB37_next:
bra_BB37_next:
C D 1 - - - 0x019B47 06:BB37: C6 1A     DEC vTempCounter1A                    ; decrements loop counter
C - - - - - 0x019B49 06:BB39: 10 C4     BPL bra_BAFF_loop                     ; If vTempCounter1A >= 0x00
C - - - - - 0x019B4B 06:BB3B: 60        RTS                                   ;

bra_BB3C_bullet_hit:
C - - - - - 0x019B4C 06:BB3C: A9 00     LDA #$00                       ;
C - - - - - 0x019B4E 06:BB3E: 95 8F     STA vBulletStatus,X            ; clear
C - - - - - 0x019B50 06:BB40: A6 1A     LDX vTempCounter1A             ; X <~ loop counter
C - - - - - 0x019B52 06:BB42: BD 20 03  LDA vEnemyAStatus,X            ;
C - - - - - 0x019B55 06:BB45: 29 02     AND #$02                       ; CONSTANT - 'jump' status
C - - - - - 0x019B57 06:BB47: D0 0A     BNE @bra_BB53_skip             ; If 'jump' status is activated
C - - - - - 0x019B59 06:BB49: A9 80     LDA #$80                       ; Initializes a jump counter (for the overdrive)
C - - - - - 0x019B5B 06:BB4B: 9D 4A 03  STA vEnemyAJumpCounter,X       ;
C - - - - - 0x019B5E 06:BB4E: A9 04     LDA #$04                       ; CONSTANT - 'overdrive' status
C - - - - - 0x019B60 06:BB50: 20 5F BD  JSR sub_BD5F_change_substatus  ;
@bra_BB53_skip:
C - - - - - 0x019B63 06:BB53: DE 50 03  DEC vEnemyAHealthPoints,X      ;
C - - - - - 0x019B66 06:BB56: D0 DF     BNE bra_BB37_next              ; If HPoints > 0x00
C - - - - - 0x019B68 06:BB58: 20 5E BB  JSR sub_BB5E_final_hit         ;
C - - - - - 0x019B6B 06:BB5B: 4C 37 BB  JMP loc_BB37_next              ;

sub_BB5E_final_hit:
C - - - - - 0x019B6E 06:BB5E: A6 1A     LDX vTempCounter1A             ;
C - - - - - 0x019B70 06:BB60: A9 22     LDA #$22                       ; CONSTANT - 'the jump' + 'the dying' status
C - - - - - 0x019B72 06:BB62: 20 5F BD  JSR sub_BD5F_change_substatus  ;
C - - - - - 0x019B75 06:BB65: A9 10     LDA #$10                       ; Initializes a jump counter
C - - - - - 0x019B77 06:BB67: 9D 4A 03  STA vEnemyAJumpCounter,X       ;
C - - - - - 0x019B7A 06:BB6A: A9 03     LDA #$03                       ; CONSTANT - jump by side
C - - - - - 0x019B7C 06:BB6C: 9D 56 03  STA vEnemyAJumpType,X          ;
C - - - - - 0x019B7F 06:BB6F: A9 00     LDA #$00                       ;
C - - - - - 0x019B81 06:BB71: 9D 44 03  STA vEnemyAFrameCounter,X      ; reset a counter
C - - - - - 0x019B84 06:BB74: 60        RTS                            ;

sub_BB75_prepare_hitbox:
C - - - - - 0x019B85 06:BB75: A0 00     LDY #$00                     ;
C - - - - - 0x019B87 06:BB77: BD 2C 03  LDA vEnemyAPosY,X            ;
C - - - - - 0x019B8A 06:BB7A: 85 AD     STA vEnemyHitBoxY            ; <~ posY + absolute hitBoxY
C - - - - - 0x019B8C 06:BB7C: BD 32 03  LDA vEnemyAScreenPosX,X      ;
C - - - - - 0x019B8F 06:BB7F: 85 AE     STA vEnemyHitBoxX            ; <~ posX + absolute hitBoxX
C - - - - - 0x019B91 06:BB81: A9 1E     LDA #$1E                     ;
C - - - - - 0x019B93 06:BB83: 85 AF     STA vEnemyHitBoxH            ; <~ hitBoxH
C - - - - - 0x019B95 06:BB85: A9 08     LDA #$08                     ;
C - - - - - 0x019B97 06:BB87: 85 B0     STA vEnemyHitBoxW            ; <~ hitBoxW
bra_BB89_RTS:
C - - - - - 0x019B99 06:BB89: 60        RTS                          ;

sub_BB8A_status_behavior:
C - - - - - 0x019B9A 06:BB8A: BD 20 03  LDA vEnemyAStatus,X                       ;
C - - - - - 0x019B9D 06:BB8D: 10 FA     BPL bra_BB89_RTS                          ; If the status isn't used
C - - - - - 0x019B9F 06:BB8F: BD 20 03  LDA vEnemyAStatus,X                       ; !(WHY?)
C - - - - - 0x019BA2 06:BB92: 4A        LSR                                       ;
C - - - - - 0x019BA3 06:BB93: 20 B8 D0  JSR sub_D0B8_change_stack_pointer_by_bits ; bank_FF

- D 1 - I - 0x019BA6 06:BB96: 82 BC     .addr loc_BC83_jump - 1   ; 0x02
- D 1 - I - 0x019BA8 06:BB98: A3 BB     .addr loc_BBA4_main - 1   ; 0x04
- D 1 - I - 0x019BAA 06:BB9A: A3 BB     .addr loc_BBA4_main - 1   ; 0x08
- D - - - - 0x019BAC 06:BB9C: A3 BB     .addr loc_BBA4_main - 1   ; 0x10
- D 1 - I - 0x019BAE 06:BB9E: 16 BD     .addr loc_BD17_dying - 1  ; 0x20
- D 1 - I - 0x019BB0 06:BBA0: A3 BB     .addr loc_BBA4_main - 1   ; 0x40
- D 1 - I - 0x019BB2 06:BBA2: A3 BB     .addr loc_BBA4_main - 1   ; 0x80

loc_BBA4_main:
C - - - - - 0x019BB4 06:BBA4: BD 2C 03  LDA vEnemyAPosY,X                         ;
C - - - - - 0x019BB7 06:BBA7: 85 00     STA $0000                                 ;
C - - - - - 0x019BB9 06:BBA9: E6 00     INC $0000                                 ; prepare an input parameter (EnemyAPosY + 1)
C - - - - - 0x019BBB 06:BBAB: 20 58 D3  JSR sub_D358_check_enemyA_collision_by_Y  ;
C - - - - - 0x019BBE 06:BBAE: D0 07     BNE bra_BBB7_skip                         ; If the collisions by Y-position exists
C - - - - - 0x019BC0 06:BBB0: A9 1C     LDA #$1C                                  ; CONSTANT - a jump counter value
C - - - - - 0x019BC2 06:BBB2: A0 02     LDY #$02                                  ; CONSTANT - jumping off, free fall
C - - - - - 0x019BC4 06:BBB4: 4C 72 BC  JMP loc_BC72_activate_jump_status         ;

bra_BBB7_skip:
C - - - - - 0x019BC7 06:BBB7: 20 30 BD  JSR sub_BD30_try_to_change_self ;
C - - - - - 0x019BCA 06:BBBA: BD 20 03  LDA vEnemyAStatus,X             ;
C - - - - - 0x019BCD 06:BBBD: 29 0A     AND #$0A                        ; CONSTANT - 'stop' + 'jump' status
C - - - - - 0x019BCF 06:BBBF: F0 07     BEQ bra_BBC8_skip               ; If 'stop' and 'jump' status isn't activated
C - - - - - 0x019BD1 06:BBC1: C9 02     CMP #$02                        ; CONSTANT - 'jump' status
C - - - - - 0x019BD3 06:BBC3: D0 06     BNE bra_BBCB_stopping           ; If 'jump' status isn't activated
C - - - - - 0x019BD5 06:BBC5: 4C 6E BC  JMP loc_BC6E_mini_jump          ;

bra_BBC8_skip:
C - - - - - 0x019BD8 06:BBC8: 20 18 BC  JSR sub_BC18_try_movements      ;
bra_BBCB_stopping:
C - - - - - 0x019BDB 06:BBCB: BD 44 03  LDA vEnemyAFrameCounter,X       ;
C - - - - - 0x019BDE 06:BBCE: 0A        ASL                             ;
C - - - - - 0x019BDF 06:BBCF: 0A        ASL                             ; *4
C - - - - - 0x019BE0 06:BBD0: A8        TAY                             ; prepares the sprite_magic2 (The offset by the address)
loc_BBD1_prepare_rendering:
C D 1 - - - 0x019BE1 06:BBD1: BD 38 03  LDA vEnemyAPosXLow,X            ;
C - - - - - 0x019BE4 06:BBD4: 85 00     STA $0000                       ; prepares the 1st parameter
C - - - - - 0x019BE6 06:BBD6: BD 3E 03  LDA vEnemyAPosXHigh,X           ;
C - - - - - 0x019BE9 06:BBD9: 85 01     STA $0001                       ; prepares the 2nd parameter
C - - - - - 0x019BEB 06:BBDB: 20 7B D6  JSR sub_D67B_out_of_sight       ;
C - - - - - 0x019BEE 06:BBDE: 90 03     BCC bra_BBE3_skip               ; If the enemy is visible
C - - - - - 0x019BF0 06:BBE0: 4C 7F D7  JMP loc_D77F_free_enemyA        ;

bra_BBE3_skip:
C - - - - - 0x019BF3 06:BBE3: 20 AC D6  JSR sub_D6AC_out_of_screen      ;
C - - - - - 0x019BF6 06:BBE6: 90 03     BCC bra_BBEB_skip               ; If the enemy is on the screen
C - - - - - 0x019BF8 06:BBE8: 4C 41 D7  JMP loc_D741_enemyA_off_screen  ;

bra_BBEB_skip:
C - - - - - 0x019BFB 06:BBEB: 20 25 D7  JSR sub_D725_enemyA_on_screen           ;
C - - - - - 0x019BFE 06:BBEE: C0 E0     CPY #$E0                                ; CONSTANT - death frame #1
C - - - - - 0x019C00 06:BBF0: 90 03     BCC bra_BBF5_skip                       ;
C - - - - - 0x019C02 06:BBF2: 4C 89 D9  JMP loc_D989_add_enemyA_sprite_magic_v1 ;

bra_BBF5_skip:
C - - - - - 0x019C05 06:BBF5: 98        TYA                           ;
C - - - - - 0x019C06 06:BBF6: 18        CLC                           ;
C - - - - - 0x019C07 06:BBF7: 6D 02 03  ADC vEnemyASpriteMagic2       ; + Y ~> sprite_magic2
C - - - - - 0x019C0A 06:BBFA: 85 01     STA $0001                     ;
C - - - - - 0x019C0C 06:BBFC: AD 03 03  LDA vEnemyASpriteMagic3       ; ~> sprite_magic3
C - - - - - 0x019C0F 06:BBFF: 85 02     STA $0002                     ;
C - - - - - 0x019C11 06:BC01: BD 20 03  LDA vEnemyAStatus,X           ;
C - - - - - 0x019C14 06:BC04: 29 04     AND #$04                      ; CONSTANT - 'overdrive' status
C - - - - - 0x019C16 06:BC06: F0 0D     BEQ @bra_BC15_add             ; If 'overdrive' status isn't activated
C - - - - - 0x019C18 06:BC08: BD 4A 03  LDA vEnemyAJumpCounter,X      ;
C - - - - - 0x019C1B 06:BC0B: C9 08     CMP #$08                      ; CONSTANT - the end point of the flashing
C - - - - - 0x019C1D 06:BC0D: 90 06     BCC @bra_BC15_add             ; If JumpCounter < 0x08
C - - - - - 0x019C1F 06:BC0F: 29 02     AND #$02                      ; CONSTANT - OAM-attribute flag (1 of 2)
C - - - - - 0x019C21 06:BC11: 45 02     EOR $0002                     ;
C - - - - - 0x019C23 06:BC13: 85 02     STA $0002                     ; the flashing, frequency - 4 frames
@bra_BC15_add:
C - - - - - 0x019C25 06:BC15: 4C 33 CE  JMP loc_CE33_add_sprite_magic ; bank FF

sub_BC18_try_movements:
C - - - - - 0x019C28 06:BC18: BD 20 03  LDA vEnemyAStatus,X                      ;
C - - - - - 0x019C2B 06:BC1B: 6A        ROR                                      ;
C - - - - - 0x019C2C 06:BC1C: 90 06     BCC bra_BC24_skip                        ; If the enemy is looking to the right
C - - - - - 0x019C2E 06:BC1E: 20 2A BC  JSR sub_BC2A_try_movement_on_the_left    ;
loc_BC21_inc:
C D 1 - - - 0x019C31 06:BC21: 4C AE D9  JMP loc_D9AE_inc_enemyA_frame_counter    ;

bra_BC24_skip:
C - - - - - 0x019C34 06:BC24: 20 5A BC  JSR sub_BC5A_try_movement_on_the_right   ;
C - - - - - 0x019C37 06:BC27: 4C 21 BC  JMP loc_BC21_inc                         ;

; In: Register X - the enemyA number
sub_BC2A_try_movement_on_the_left:
C - - - - - 0x019C3A 06:BC2A: 20 CA D7  JSR sub_D7CA_check_enemyA_movement_on_the_left ;
C - - - - - 0x019C3D 06:BC2D: F0 0F     BEQ bra_BC3E_try_jump_over                     ; If the movement isn't allowed
C - - - - - 0x019C3F 06:BC2F: BD 20 03  LDA vEnemyAStatus,X                            ;
C - - - - - 0x019C42 06:BC32: 29 04     AND #$04                                       ; CONSTANT - 'overdrive' status
C - - - - - 0x019C44 06:BC34: D0 05     BNE @bra_BC3B_skip                             ; If 'overdrive' status is activated
C - - - - - 0x019C46 06:BC36: A5 2C     LDA vLowCounter                                ;
C - - - - - 0x019C48 06:BC38: 6A        ROR                                            ;
C - - - - - 0x019C49 06:BC39: 90 1E     BCC bra_BC59_RTS                               ; Branch if vLowCounter multiple of 2 (50% chance)
@bra_BC3B_skip:
C - - - - - 0x019C4B 06:BC3B: 4C FD D6  JMP loc_D6FD_dec_EnemyAPosXLow_unsafe          ;

bra_BC3E_try_jump_over:
C - - - - - 0x019C4E 06:BC3E: BD 20 03  LDA vEnemyAStatus,X             ;
C - - - - - 0x019C51 06:BC41: 29 20     AND #$20                        ; CONSTANT - 'the dying' status
C - - - - - 0x019C53 06:BC43: D0 14     BNE bra_BC59_RTS                ; If the enemy is dying
C - - - - - 0x019C55 06:BC45: A9 02     LDA #$02                        ; CONSTANT - 'jump' status
C - - - - - 0x019C57 06:BC47: 20 5F BD  JSR sub_BD5F_change_substatus   ;
C - - - - - 0x019C5A 06:BC4A: A9 14     LDA #$14                        ; Initializes a jump counter
C - - - - - 0x019C5C 06:BC4C: 9D 4A 03  STA vEnemyAJumpCounter,X        ;
C - - - - - 0x019C5F 06:BC4F: A9 03     LDA #$03                        ; CONSTANT - jump by side
C - - - - - 0x019C61 06:BC51: 9D 56 03  STA vEnemyAJumpType,X           ;
C - - - - - 0x019C64 06:BC54: A9 00     LDA #$00                        ;
C - - - - - 0x019C66 06:BC56: 9D 44 03  STA vEnemyAFrameCounter,X       ; reset a counter
bra_BC59_RTS:
C - - - - - 0x019C69 06:BC59: 60        RTS                             ;

; In: Register X - the enemyA number
sub_BC5A_try_movement_on_the_right:
C - - - - - 0x019C6A 06:BC5A: 20 BF D7  JSR sub_D7BF_check_enemyA_movement_on_the_right ;
C - - - - - 0x019C6D 06:BC5D: F0 DF     BEQ bra_BC3E_try_jump_over                      ; If the movement isn't allowed
C - - - - - 0x019C6F 06:BC5F: BD 20 03  LDA vEnemyAStatus,X                             ;
C - - - - - 0x019C72 06:BC62: 29 04     AND #$04                                        ; CONSTANT - 'overdrive' status
C - - - - - 0x019C74 06:BC64: D0 05     BNE @bra_BC6B_skip                              ; If 'overdrive' status is activated
C - - - - - 0x019C76 06:BC66: A5 2C     LDA vLowCounter                                 ;
C - - - - - 0x019C78 06:BC68: 6A        ROR                                             ;
C - - - - - 0x019C79 06:BC69: 90 EE     BCC bra_BC59_RTS                                ; Branch if vLowCounter multiple of 2 (50% chance)
@bra_BC6B_skip:
C - - - - - 0x019C7B 06:BC6B: 4C 1C D7  JMP loc_D71C_inc_EnemyAPosXLow_unsafe           ;

loc_BC6E_mini_jump:
C D 1 - - - 0x019C7E 06:BC6E: A9 14     LDA #$14                                ; CONSTANT - a jump counter value
C - - - - - 0x019C80 06:BC70: A0 03     LDY #$03                                ; CONSTANT - jump by side
; In: Register A - a jump counter value
; In: Register Y - a jump type
; In: Register X - the enemyA number
; In: $0000 - EnemyAPosY
loc_BC72_activate_jump_status:
C D 1 - - - 0x019C82 06:BC72: 9D 4A 03  STA vEnemyAJumpCounter,X                ;
C - - - - - 0x019C85 06:BC75: 98        TYA                                     ;
C - - - - - 0x019C86 06:BC76: 9D 56 03  STA vEnemyAJumpType,X                   ;
C - - - - - 0x019C89 06:BC79: A9 02     LDA #$02                                ; CONSTANT - the jump
C - - - - - 0x019C8B 06:BC7B: 20 5F BD  JSR sub_BD5F_change_substatus           ;
C - - - - - 0x019C8E 06:BC7E: A9 00     LDA #$00                                ;
C - - - - - 0x019C90 06:BC80: 9D 44 03  STA vEnemyAFrameCounter,X               ; reset a counter
loc_BC83_jump:
C - - - - - 0x019C93 06:BC83: BD 2C 03  LDA vEnemyAPosY,X                       ;
C - - - - - 0x019C96 06:BC86: C9 DF     CMP #$DF                                ; CONSTANT - Maximum allowed Y-value on the screen
C - - - - - 0x019C98 06:BC88: B0 1E     BCS bra_BCA8_skip                       ; If PosY >= 0xDF
C - - - - - 0x019C9A 06:BC8A: BD 56 03  LDA vEnemyAJumpType,X                   ;
C - - - - - 0x019C9D 06:BC8D: C9 03     CMP #$03                                ; CONSTANT - jump by side
C - - - - - 0x019C9F 06:BC8F: D0 17     BNE bra_BCA8_skip                       ; If EnemyAJumpType != 0x03
C - - - - - 0x019CA1 06:BC91: BD 20 03  LDA vEnemyAStatus,X                     ;
C - - - - - 0x019CA4 06:BC94: 6A        ROR                                     ;
C - - - - - 0x019CA5 06:BC95: 90 0A     BCC bra_BCA1_right                      ; If the enemy is looking to the right
C - - - - - 0x019CA7 06:BC97: 29 10     AND #$10                                ; CONSTANT - the dying + shift right
C - - - - - 0x019CA9 06:BC99: D0 0A     BNE bra_BCA5_invert                     ; If the enemy is dying
bra_BC9B_invert:
C - - - - - 0x019CAB 06:BC9B: 20 2A BC  JSR sub_BC2A_try_movement_on_the_left   ;
C - - - - - 0x019CAE 06:BC9E: 4C A8 BC  JMP loc_BCA8_continue                   ;

bra_BCA1_right:
C - - - - - 0x019CB1 06:BCA1: 29 10     AND #$10                                ; CONSTANT - the dying + shift right
C - - - - - 0x019CB3 06:BCA3: D0 F6     BNE bra_BC9B_invert                     ; If the enemy is dying
bra_BCA5_invert:
C - - - - - 0x019CB5 06:BCA5: 20 5A BC  JSR sub_BC5A_try_movement_on_the_right  ;
bra_BCA8_skip:
loc_BCA8_continue:
C D 1 - - - 0x019CB8 06:BCA8: BC 4A 03  LDY vEnemyAJumpCounter,X                ;
C - - - - - 0x019CBB 06:BCAB: B9 5D E3  LDA tbl_E35D_jump_posY_offset,Y         ; Y = [0x00-0x2F]
C - - - - - 0x019CBE 06:BCAE: 18        CLC                                     ;
C - - - - - 0x019CBF 06:BCAF: 7D 2C 03  ADC vEnemyAPosY,X                       ;
C - - - - - 0x019CC2 06:BCB2: C9 DF     CMP #$DF                                ; CONSTANT - Limit 1 for Y-position
C - - - - - 0x019CC4 06:BCB4: 90 03     BCC @bra_BCB9_skip                      ; If Register A < 0xDF
C - - - - - 0x019CC6 06:BCB6: A0 DF     LDY #$DF                                ;
C - - - - - 0x019CC8 06:BCB8: 98        TYA                                     ; A <~ 0xDF
@bra_BCB9_skip:
C - - - - - 0x019CC9 06:BCB9: 9D 2C 03  STA vEnemyAPosY,X                       ; Resolves a new Y-position of the enemy after jumping
C - - - - - 0x019CCC 06:BCBC: BC 4A 03  LDY vEnemyAJumpCounter,X                ;
C - - - - - 0x019CCF 06:BCBF: C0 18     CPY #$18                                ; CONSTANT - a maximum amplitude
C - - - - - 0x019CD1 06:BCC1: 90 34     BCC bra_BCF7_inc                        ; If JumpCounter < 0x18
C - - - - - 0x019CD3 06:BCC3: C9 DF     CMP #$DF                                ; CONSTANT - Maximum allowed Y-value on the screen
C - - - - - 0x019CD5 06:BCC5: 90 05     BCC bra_BCCC_skip                       ; If EnemyPosY < 0xDF
C - - - - - 0x019CD7 06:BCC7: A0 FF     LDY #$FF                                ; prepares the sprite_magic2 (The offset by the address), death mark
C - - - - - 0x019CD9 06:BCC9: 4C D1 BB  JMP loc_BBD1_prepare_rendering          ;

; In: Register X - the enemyA number
; In: $0000 - EnemyAPosY
bra_BCCC_skip:
C - - - - - 0x019CDC 06:BCCC: 85 00     STA $0000                                 ;
C - - - - - 0x019CDE 06:BCCE: E6 00     INC $0000                                 ;
C - - - - - 0x019CE0 06:BCD0: 20 58 D3  JSR sub_D358_check_enemyA_collision_by_Y  ;
C - - - - - 0x019CE3 06:BCD3: F0 22     BEQ bra_BCF7_inc                          ; If the collisions by Y-position doesn't exist
C - - - - - 0x019CE5 06:BCD5: C9 02     CMP #$02                                  ; CONSTANT - a weak collision
C - - - - - 0x019CE7 06:BCD7: F0 07     BEQ bra_BCE0_weak                         ; If the collision is weak
C - - - - - 0x019CE9 06:BCD9: 20 47 D3  JSR sub_D347_check_landing_enemyA         ;
C - - - - - 0x019CEC 06:BCDC: D0 0D     BNE bra_BCEB_landing                      ; If the landing is allow
C - - - - - 0x019CEE 06:BCDE: F0 17     BEQ bra_BCF7_inc                          ; Always true

bra_BCE0_weak:
C - - - - - 0x019CF0 06:BCE0: 20 47 D3  JSR sub_D347_check_landing_enemyA         ;
C - - - - - 0x019CF3 06:BCE3: F0 12     BEQ bra_BCF7_inc                          ; If the landing is disallow
C - - - - - 0x019CF5 06:BCE5: 20 64 D0  JSR sub_D064_generate_rng                 ;
C - - - - - 0x019CF8 06:BCE8: 6A        ROR                                       ;
C - - - - - 0x019CF9 06:BCE9: 90 0C     BCC bra_BCF7_inc                          ; 50% chance branch
bra_BCEB_landing:
C - - - - - 0x019CFB 06:BCEB: 20 A8 D7  JSR sub_D7A8_correction_EnemyAPosY        ;
C - - - - - 0x019CFE 06:BCEE: BD 20 03  LDA vEnemyAStatus,X                       ;
C - - - - - 0x019D01 06:BCF1: 29 20     AND #$20                                  ; CONSTANT - the dying
C - - - - - 0x019D03 06:BCF3: D0 1D     BNE bra_BD12_start_dying_ex               ; If the enemy is dying
C - - - - - 0x019D05 06:BCF5: F0 0A     BEQ bra_BD01_clear                        ; Always true

bra_BCF7_inc:
C - - - - - 0x019D07 06:BCF7: FE 4A 03  INC vEnemyAJumpCounter,X                  ;
C - - - - - 0x019D0A 06:BCFA: A9 2F     LDA #$2F                                  ; CONSTANT - a maximum jump value
C - - - - - 0x019D0C 06:BCFC: DD 4A 03  CMP vEnemyAJumpCounter,X                  ;
C - - - - - 0x019D0F 06:BCFF: B0 03     BCS bra_BD04_skip                         ; If vEnemyAJumpCounter <= 0x2F, i.e. less than maximum
bra_BD01_clear:
C - - - - - 0x019D11 06:BD01: 9D 4A 03  STA vEnemyAJumpCounter,X                  ; reassign
bra_BD04_skip:
C - - - - - 0x019D14 06:BD04: A0 08     LDY #$08                                  ; an input parameter - sprite_magic2 (a jump frame)
C - - - - - 0x019D16 06:BD06: BD 20 03  LDA vEnemyAStatus,X                       ;
C - - - - - 0x019D19 06:BD09: 29 20     AND #$20                                  ; CONSTANT - the dying
C - - - - - 0x019D1B 06:BD0B: F0 02     BEQ @bra_BD0F_skip                        ; If the enemy isn't dying
C - - - - - 0x019D1D 06:BD0D: A0 0C     LDY #$0C                                  ; an input parameter - sprite_magic2 (a jump with damage frame)
@bra_BD0F_skip:
C - - - - - 0x019D1F 06:BD0F: 4C D1 BB  JMP loc_BBD1_prepare_rendering            ;

bra_BD12_start_dying_ex:
C - - - - - 0x019D22 06:BD12: A9 30     LDA #$30                          ; initializes a jump counter
C - - - - - 0x019D24 06:BD14: 9D 4A 03  STA vEnemyAJumpCounter,X          ;
loc_BD17_dying:
C - - - - - 0x019D27 06:BD17: DE 4A 03  DEC vEnemyAJumpCounter,X          ; updates the counter value
C - - - - - 0x019D2A 06:BD1A: D0 03     BNE bra_BD1F_death_rendering      ; If JumpCounter != 0x00
C - - - - - 0x019D2C 06:BD1C: 4C 7F D7  JMP loc_D77F_free_enemyA          ;

bra_BD1F_death_rendering:
C - - - - - 0x019D2F 06:BD1F: BD 4A 03  LDA vEnemyAJumpCounter,X              ;
C - - - - - 0x019D32 06:BD22: 20 5F D0  JSR sub_accumulator_shift_right_by_4  ;
C - - - - - 0x019D35 06:BD25: A8        TAY                                   ; y <~ 0, 1, or 2 (high byte value of the JumpCounter)
C - - - - - 0x019D36 06:BD26: B9 2D BD  LDA tbl_BD2D_frames_,Y                ;
C - - - - - 0x019D39 06:BD29: A8        TAY                                   ; prepares the sprite_magic2 (The offset by the address)
C - - - - - 0x019D3A 06:BD2A: 4C D1 BB  JMP loc_BBD1_prepare_rendering        ;

tbl_BD2D_frames_:
- D 1 - - - 0x019D3D 06:BD2D: E4        .byte $E4   ; death frame #2
- D 1 - - - 0x019D3E 06:BD2E: E0        .byte $E0   ; death frame #1
- D 1 - - - 0x019D3F 06:BD2F: 10        .byte $10   ; damage frame

sub_BD30_try_to_change_self:
C - - - - - 0x019D40 06:BD30: BD 4A 03  LDA vEnemyAJumpCounter,X           ;
C - - - - - 0x019D43 06:BD33: F0 0A     BEQ @bra_BD3F_skip                 ; If EnemyAJumpCounter == 0x00
C - - - - - 0x019D45 06:BD35: DE 4A 03  DEC vEnemyAJumpCounter,X           ;
C - - - - - 0x019D48 06:BD38: D0 31     BNE bra_BD6B_RTS                   ; If EnemyAJumpCounter != 0x00
C - - - - - 0x019D4A 06:BD3A: A9 00     LDA #$00                           ; clear substatus
C - - - - - 0x019D4C 06:BD3C: 20 5F BD  JSR sub_BD5F_change_substatus      ;
@bra_BD3F_skip:
C - - - - - 0x019D4F 06:BD3F: 20 6C BD  JSR sub_BD6C_try_change_direction  ;
C - - - - - 0x019D52 06:BD42: A5 2C     LDA vLowCounter                    ;
C - - - - - 0x019D54 06:BD44: 29 3F     AND #$3F                           ;
C - - - - - 0x019D56 06:BD46: D0 23     BNE bra_BD6B_RTS                   ; Branch if vLowCounter doesn't multiple of 64 (vLowCounter % 64 != 0)
C - - - - - 0x019D58 06:BD48: 20 64 D0  JSR sub_D064_generate_rng          ;
C - - - - - 0x019D5B 06:BD4B: 6A        ROR                                ;
C - - - - - 0x019D5C 06:BD4C: B0 1D     BCS bra_BD6B_RTS                   ; 50% chance branch
C - - - - - 0x019D5E 06:BD4E: 29 07     AND #$07                           ;
C - - - - - 0x019D60 06:BD50: A8        TAY                                ; y is {0x00, ... , 0x07}
C - - - - - 0x019D61 06:BD51: B9 F3 BA  LDA tbl_BAF3_status_flags,Y        ;
C - - - - - 0x019D64 06:BD54: C9 08     CMP #$08                           ; CONSTANT - 'stop' status
C - - - - - 0x019D66 06:BD56: D0 07     BNE bra_BD5F_change_substatus      ; If 'stop' status isn't generated
C - - - - - 0x019D68 06:BD58: 48        PHA                                ; store a status
C - - - - - 0x019D69 06:BD59: A9 20     LDA #$20                           ; An initialize jump value for 'stop' status
C - - - - - 0x019D6B 06:BD5B: 9D 4A 03  STA vEnemyAJumpCounter,X           ;
C - - - - - 0x019D6E 06:BD5E: 68        PLA                                ; retrieve a status ($BD58)
; In: Register A - an new status
...
tbl_BD7E_hitboxes:
- D 1 - - - 0x019D8E 06:BD7E: 00        .byte $00, $00, $03, $04   ; the blade is hidden
- D 1 - - - 0x019D92 06:BD82: 00        .byte $00, $F8, $08, $08   ; left
- D 1 - - - 0x019D96 06:BD86: 00        .byte $00, $FA, $0C, $06   ; left-up
- D 1 - - - 0x019D9A 06:BD8A: 00        .byte $00, $00, $10, $08   ; up
- D 1 - - - 0x019D9E 06:BD8E: 00        .byte $00, $06, $0C, $06   ; right-up
- D 1 - - - 0x019DA2 06:BD92: 00        .byte $00, $08, $08, $08   ; right

loc_BD96_trap:
C D 1 - - - 0x019DA6 06:BD96: A2 01     LDX #$01                              ;
C - - - - - 0x019DA8 06:BD98: 86 1A     STX vTempCounter1A                    ; set loop counter (the enemyB number)
bra_BD9A_loop:                                                                ; loop by vTempCounter1A (2 times)
C - - - - - 0x019DAA 06:BD9A: A6 1A     LDX vTempCounter1A                    ; prepares the input parameter
C - - - - - 0x019DAC 06:BD9C: 20 0D BE  JSR sub_BE0D_main_behavior            ;
C - - - - - 0x019DAF 06:BD9F: A6 1A     LDX vTempCounter1A                    ; X <~ the enemyB number
C - - - - - 0x019DB1 06:BDA1: BD 5C 03  LDA vEnemyBStatus,X                   ;
C - - - - - 0x019DB4 06:BDA4: 10 16     BPL bra_BDBC_next                     ; If the status isn't used
C - - - - - 0x019DB6 06:BDA6: 20 E9 BD  JSR sub_BDE9_prepare_hitbox           ;
C - - - - - 0x019DB9 06:BDA9: A5 5F     LDA vChrLiveStatus                    ;
C - - - - - 0x019DBB 06:BDAB: 29 02     AND #$02                              ; CONSTANT - Goemon
C - - - - - 0x019DBD 06:BDAD: D0 0A     BNE @bra_BDB9_skip_check_bullets      ; If the character is Goemon
C - - - - - 0x019DBF 06:BDAF: A6 7A     LDX vBulletCount                      ; set loop counter
@bra_BDB1_loop:                                                               ; loop by x
C - - - - - 0x019DC1 06:BDB1: 20 B6 D5  JSR sub_D5B6_have_intersect_bullet    ;
C - - - - - 0x019DC4 06:BDB4: B0 0B     BCS bra_BDC1_bullet_hit               ; If the intersect is exist
C - - - - - 0x019DC6 06:BDB6: CA        DEX                                   ; decrement loop counter
C - - - - - 0x019DC7 06:BDB7: 10 F8     BPL @bra_BDB1_loop                    ; If Register X >= 0x00
@bra_BDB9_skip_check_bullets:
C - - - - - 0x019DC9 06:BDB9: 20 62 D5  JSR sub_D562_has_character_damage     ;
bra_BDBC_next:
loc_BDBC_next:
C - - - - - 0x019DCC 06:BDBC: C6 1A     DEC vTempCounter1A                    ; decrements loop counter
C - - - - - 0x019DCE 06:BDBE: 10 DA     BPL bra_BD9A_loop                     ; If vTempCounter1A >= 0x00
C - - - - - 0x019DD0 06:BDC0: 60        RTS                                   ;

bra_BDC1_bullet_hit:
C - - - - - 0x019DD1 06:BDC1: A9 00     LDA #$00                     ;
C - - - - - 0x019DD3 06:BDC3: 95 8F     STA vBulletStatus,X          ; clear
C - - - - - 0x019DD5 06:BDC5: 4C BC BD  JMP loc_BDBC_next            ;

sub_BDC8_get_turn_position:
C - - - - - 0x019DD8 06:BDC8: A0 00     LDY #$00                     ; the value by default
C - - - - - 0x019DDA 06:BDCA: BD 86 03  LDA vEnemyBJumpCounter,X     ;
C - - - - - 0x019DDD 06:BDCD: 29 7F     AND #$7F                     ;
C - - - - - 0x019DDF 06:BDCF: C9 50     CMP #$50                     ;
C - - - - - 0x019DE1 06:BDD1: B0 15     BCS @bra_BDE8_RTS            ; If |vJumpCounter| >= 0x50
C - - - - - 0x019DE3 06:BDD3: C8        INY                          ; Y = 1 (left)
C - - - - - 0x019DE4 06:BDD4: C9 40     CMP #$40                     ;
C - - - - - 0x019DE6 06:BDD6: B0 10     BCS @bra_BDE8_RTS            ; If |vJumpCounter| >= 0x40
C - - - - - 0x019DE8 06:BDD8: C8        INY                          ; Y = 2 (left-up)
C - - - - - 0x019DE9 06:BDD9: C9 30     CMP #$30                     ;
C - - - - - 0x019DEB 06:BDDB: B0 0B     BCS @bra_BDE8_RTS            ; If |vJumpCounter| >= 0x30
C - - - - - 0x019DED 06:BDDD: C8        INY                          ; Y = 3 (up)
C - - - - - 0x019DEE 06:BDDE: C9 20     CMP #$20                     ;
C - - - - - 0x019DF0 06:BDE0: B0 06     BCS @bra_BDE8_RTS            ; If |vJumpCounter| >= 0x20
C - - - - - 0x019DF2 06:BDE2: C8        INY                          ; Y = 4 (right-up)
C - - - - - 0x019DF3 06:BDE3: C9 10     CMP #$10                     ;
C - - - - - 0x019DF5 06:BDE5: B0 01     BCS @bra_BDE8_RTS            ; If |vJumpCounter| >= 0x10
C - - - - - 0x019DF7 06:BDE7: C8        INY                          ; Y = 5 (right)
@bra_BDE8_RTS:
C - - - - - 0x019DF8 06:BDE8: 60        RTS                          ;

sub_BDE9_prepare_hitbox:
C - - - - - 0x019DF9 06:BDE9: 20 C8 BD  JSR sub_BDC8_get_turn_position  ;
C - - - - - 0x019DFC 06:BDEC: 98        TYA                             ;
C - - - - - 0x019DFD 06:BDED: 0A        ASL                             ;
C - - - - - 0x019DFE 06:BDEE: 0A        ASL                             ; *4, bacause the table contains 4 bytes in one row
C - - - - - 0x019DFF 06:BDEF: A8        TAY                             ;
C - - - - - 0x019E00 06:BDF0: BD 68 03  LDA vEnemyBPosY,X               ;
C - - - - - 0x019E03 06:BDF3: 18        CLC                             ;
C - - - - - 0x019E04 06:BDF4: 79 7E BD  ADC tbl_BD7E_hitboxes,Y         ;
C - - - - - 0x019E07 06:BDF7: 85 AD     STA vEnemyHitBoxY               ; <~ posY + absolute hitBoxY
C - - - - - 0x019E09 06:BDF9: BD 6E 03  LDA vEnemyBScreenPosX,X         ;
C - - - - - 0x019E0C 06:BDFC: 18        CLC                             ;
C - - - - - 0x019E0D 06:BDFD: 79 7F BD  ADC tbl_BD7E_hitboxes + 1,Y     ;
C - - - - - 0x019E10 06:BE00: 85 AE     STA vEnemyHitBoxX               ; <~ posX + absolute hitBoxX
C - - - - - 0x019E12 06:BE02: B9 80 BD  LDA tbl_BD7E_hitboxes + 2,Y     ;
C - - - - - 0x019E15 06:BE05: 85 AF     STA vEnemyHitBoxH               ; <~ hitBoxH
C - - - - - 0x019E17 06:BE07: B9 81 BD  LDA tbl_BD7E_hitboxes + 3,Y     ;
C - - - - - 0x019E1A 06:BE0A: 85 B0     STA vEnemyHitBoxW               ; <~ hitBoxW
bra_BE0C_RTS:
C - - - - - 0x019E1C 06:BE0C: 60        RTS                             ;

; In: Register X - the enemyB number
sub_BE0D_main_behavior:
C - - - - - 0x019E1D 06:BE0D: BD 5C 03  LDA vEnemyBStatus,X             ;
C - - - - - 0x019E20 06:BE10: 10 FA     BPL bra_BE0C_RTS                ; If the status isn't used
C - - - - - 0x019E22 06:BE12: FE 86 03  INC vEnemyBJumpCounter,X        ; updates for every function call
C - - - - - 0x019E25 06:BE15: 20 C8 BD  JSR sub_BDC8_get_turn_position  ;
C - - - - - 0x019E28 06:BE18: 98        TYA                             ;
C - - - - - 0x019E29 06:BE19: 0A        ASL                             ; *2
C - - - - - 0x019E2A 06:BE1A: A8        TAY                             ;
C - - - - - 0x019E2B 06:BE1B: BD 74 03  LDA vEnemyBPosXLow,X            ;
C - - - - - 0x019E2E 06:BE1E: 85 00     STA $0000                       ; prepares the 1st parameter
C - - - - - 0x019E30 06:BE20: BD 7A 03  LDA vEnemyBPosXHigh,X           ;
C - - - - - 0x019E33 06:BE23: 85 01     STA $0001                       ; prepares the 2nd parameter
C - - - - - 0x019E35 06:BE25: 20 7B D6  JSR sub_D67B_out_of_sight       ;
C - - - - - 0x019E38 06:BE28: 90 03     BCC bra_BE2D_skip               ; If the trap is visible
C - - - - - 0x019E3A 06:BE2A: 4C 73 D8  JMP loc_D873_free_enemyB        ;

; In: Register Y - sprite_magic2 (The offset by the address)
bra_BE2D_skip:
C - - - - - 0x019E3D 06:BE2D: 20 AC D6  JSR sub_D6AC_out_of_screen        ;
C - - - - - 0x019E40 06:BE30: 90 03     BCC bra_BE35_skip                 ; If the trap is on the screen
C - - - - - 0x019E42 06:BE32: 4C 4D D8  JMP loc_D84D_enemyB_off_screen    ;

; In: Register Y - sprite_magic2 (The offset by the address)
bra_BE35_skip:
C - - - - - 0x019E45 06:BE35: BD 68 03  LDA vEnemyBPosY,X             ;
C - - - - - 0x019E48 06:BE38: 85 00     STA $0000                     ; ~> sprite magic1
C - - - - - 0x019E4A 06:BE3A: A5 03     LDA $0003                     ; from sub_D6AC_out_of_screen
C - - - - - 0x019E4C 06:BE3C: 9D 6E 03  STA vEnemyBScreenPosX,X       ;
C - - - - - 0x019E4F 06:BE3F: 98        TYA                           ;
C - - - - - 0x019E50 06:BE40: 18        CLC                           ;
C - - - - - 0x019E51 06:BE41: 69 4A     ADC #$4A                      ; + Y ~> sprite_magic2
C - - - - - 0x019E53 06:BE43: 85 01     STA $0001                     ;
C - - - - - 0x019E55 06:BE45: A9 07     LDA #$07                      ; ~> sprite_magic3
C - - - - - 0x019E57 06:BE47: 85 02     STA $0002                     ;
