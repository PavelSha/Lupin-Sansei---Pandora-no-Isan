...
C - - - - - 0x018907 06:A8F7: D9 7F A7  CMP tbl_A77F_shot_time,Y      ;
C - - - - - 0x01890A 06:A8FA: D0 10     BNE bra_A90C_next             ; If JumpCounter != a shot time
C - - - - - 0x01890C 06:A8FC: A9 17     LDA #$17                      ; a shot sound (for bazooka man)
