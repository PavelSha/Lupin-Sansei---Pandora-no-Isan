...
.export sub_CDEE_prepare_activable_items_after_damage
...
C - - - - - 0x01CC7C 07:CC6C: D0 F8     BNE bra_CC66_return_true
...
C - - - - - 0x01CC87 07:CC77: 10 F7     BPL @bra_CC70_loop
...
C - - - - - 0x01DAB4 07:DAA4: 99 04 06  STA vCachePalette + 4,Y
