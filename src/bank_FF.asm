...
C - - - - - 0x01C02C 07:C01C: 9D 00 02  STA $0200,X                                ; [$0200-$02FF] in 0
C - - - - - 0x01C02F 07:C01F: 9D 00 03  STA $0300,X                                ; [$0300-$03FF] in 0
C - - - - - 0x01C032 07:C022: 9D 00 04  STA $0400,X                                ; [$0400-$04FF] in 0
C - - - - - 0x01C035 07:C025: 9D 00 05  STA $0500,X                                ; [$0500-$05FF] in 0
C - - - - - 0x01C038 07:C028: 9D 00 06  STA vCachePalette,X                        ; [$0600-$06FF] in 0
C - - - - - 0x01C03B 07:C02B: 9D 00 07  STA vStartOAM,X                            ; [$0700-$07FF] in 0
C - - - - - 0x01C03E 07:C02E: E8        INX                                        ; increment counter x
C - - - - - 0x01C03F 07:C02F: D0 EB     BNE @bra_C01C_memset_zero                  ;
@bra_C031_loop:                                                                    ; loop by x
C - - - - - 0x01C041 07:C031: 95 00     STA $0000,X                                ; [$0000-$0098] in 0
...
C - - - - - 0x01C04A 07:C03A: 95 00     STA $0000,X                                ; [$00A7-$00FF] in 0
...
C - - - - - 0x01C05D 07:C04D: 8D 01 80  STA MMC3_Bank_data                         ; switch bank 06_2 in $A000-$BFFF
...
C - - - - - 0x01C079 07:C069: 86 1F     STX vPlayer2BtnPressed                     ; clear
...
; Only for test mode
C - - - - - 0x01C144 07:C134: A5 1F     LDA vPlayer2BtnPressed        ;
...
C - - - - - 0x01C14A 07:C13A: 45 20     EOR vLastP2BtnPressed         ;
C - - - - - 0x01C14C 07:C13C: 29 02     AND #BIT_BUTTON_B             ; avoid looping
C - - - - - 0x01C14E 07:C13E: F0 08     BEQ bra_C148_skip             ; If vPlayer2BtnPressed = vLastP2BtnPressed
C - - - - - 0x01C150 07:C140: 85 20     STA vLastP2BtnPressed         ; <~ #BIT_BUTTON_B
...
@bra_C183_skip:
C - - - - - 0x01C193 07:C183: CD 09 01  CMP vLastLevel                                ;
C - - - - - 0x01C196 07:C186: 90 03     BCC @bra_C18B_skip                            ; If vNoLevel < vLastLevel
C - - - - - 0x01C198 07:C188: 8D 09 01  STA vLastLevel                                ; updates vLastLevel
@bra_C18B_skip:
...
C - - - - - 0x01C24E 07:C23E: CD 09 01  CMP vLastLevel                            ;
C - - - - - 0x01C251 07:C241: 90 03     BCC @bra_C246_skip                        ; If vNoLevel < vLastLevel
C - - - - - 0x01C253 07:C243: 8D 09 01  STA vLastLevel                            ; updates
@bra_C246_skip:
...
C - - - - - 0x01C2F7 07:C2E7: 8D 09 01  STA vLastLevel                            ; clear
...
C - - - - - 0x01C371 07:C361: 99 B7 06  STA vSpriteMagics,Y      ; [0x06B7-0x06F6] in 0xF0
...
C - - - - - 0x01C3E9 07:C3D9: E6 2B     INC vNmiCounter   ;
C - - - - - 0x01C3EB 07:C3DB: 60        RTS               ; 

C - - - - - 0x01C3EC 07:C3DC: A5 2B     LDA vNmiCounter        ; !(UNUSED), not used
...
C - - - - - 0x01C4B7 07:C4A7: A5 1E     LDA vPlayer1BtnPressed    ;
C - - - - - 0x01C4B9 07:C4A9: 85 21     STA vLastP1BtnPressed     ; store a last button state (player1)
C - - - - - 0x01C4BB 07:C4AB: A5 1F     LDA vPlayer2BtnPressed    ;
C - - - - - 0x01C4BD 07:C4AD: 85 20     STA vLastP2BtnPressed     ; store a last button state (player2)
...
C - - - - - 0x01C4D1 07:C4C1: 66 1E     ROR vPlayer1BtnPressed    ;
C - - - - - 0x01C4D3 07:C4C3: AD 17 40  LDA JOY2                  ;
C - - - - - 0x01C4D6 07:C4C6: 29 03     AND #$03                  ;
C - - - - - 0x01C4D8 07:C4C8: C9 01     CMP #$01                  ;
C - - - - - 0x01C4DA 07:C4CA: 66 1F     ROR vPlayer2BtnPressed    ; Standard Read for 2 Controllers and Famicom (https://www.nesdev.org/wiki/Controller_reading_code)
...
C - - - - - 0x01C4E3 07:C4D3: A5 1E     LDA vPlayer1BtnPressed          ;
...
C - - - - - 0x01C572 07:C562: 85 2D     STA vHighCounter         ; clear
...
C - - - - - 0x01C588 07:C578: A5 2D     LDA vHighCounter                      ;
...
C - - - - - 0x01C5E5 07:C5D5: AD 09 01  LDA vLastLevel             ;
...
C - - - - - 0x01C600 07:C5F0: 8D 04 07  STA vOAM_2                 ; Y-position <~ 0x8F or 0x9F
C - - - - - 0x01C603 07:C5F3: 8D 08 07  STA vOAM_3                 ; Y-position <~ 0x8F or 0x9F
C - - - - - 0x01C606 07:C5F6: A9 62     LDA #$62                   ; 
C - - - - - 0x01C608 07:C5F8: 8D 05 07  STA vOAM_2_2b              ; Tile number #1 <~ 0x62
C - - - - - 0x01C60B 07:C5FB: A9 63     LDA #$63                   ;
C - - - - - 0x01C60D 07:C5FD: 8D 09 07  STA vOAM_3_2b              ; Tile number #2 <~ 0x63
C - - - - - 0x01C610 07:C600: A9 00     LDA #$00                   ;
C - - - - - 0x01C612 07:C602: 8D 06 07  STA vOAM_2_3b              ; The attributes <~ 0x00
C - - - - - 0x01C615 07:C605: 8D 0A 07  STA vOAM_3_3b              ; The attributes <~ 0x00
C - - - - - 0x01C618 07:C608: A9 50     LDA #$50                   ;
C - - - - - 0x01C61A 07:C60A: 8D 07 07  STA vOAM_2_4b              ; X-position <~ 0x50
C - - - - - 0x01C61D 07:C60D: 18        CLC                        ;
C - - - - - 0x01C61E 07:C60E: 69 08     ADC #$08                   ;
C - - - - - 0x01C620 07:C610: 8D 0B 07  STA vOAM_3_4b              ; X-position <~ 0x58
bra_C613_RTS:
...
C - - - - - 0x01C725 07:C715: 85 02     STA $0002                                      ; Low address
C - - - - - 0x01C727 07:C717: B9 79 94  LDA tbl_select_characters_dialog_radio + 1,Y   ;
C - - - - - 0x01C72A 07:C71A: 85 03     STA $0003                                      ; High address
...
C - - - - - 0x01C732 07:C722: 85 02     STA $0002                                      ; Low address
C - - - - - 0x01C734 07:C724: B9 61 94  LDA tbl_select_characters_dialog_losing + 1,Y  ;
C - - - - - 0x01C737 07:C727: 85 03     STA $0003                                      ; High address
...
; In: $0002 - Low address for ppu buffer data
; In: $0003 - High address for ppu buffer data
...
C - - - - - 0x01C775 07:C765: 85 14     STA $0014                             ; low PPU address
C - - - - - 0x01C777 07:C767: B9 15 C6  LDA tbl_C614_PPU_address + 1,Y        ;
C - - - - - 0x01C77A 07:C76A: 85 15     STA $0015                             ; high PPU address
C - - - - - 0x01C77C 07:C76C: A9 33     LDA #$33                              ;
C - - - - - 0x01C77E 07:C76E: 85 16     STA $0016                             ; low address
C - - - - - 0x01C780 07:C770: A9 06     LDA #$06                              ;
C - - - - - 0x01C782 07:C772: 85 17     STA $0017                             ; high address ($0633)
C - - - - - 0x01C784 07:C774: A9 14     LDA #$14                              ;
C - - - - - 0x01C786 07:C776: 85 18     STA $0018                             ; the number of the tiles
...
C - - - - - 0x01C792 07:C782: 85 00     STA $0000                   ; the out parameter
...
C - - - - - 0x01C80A 07:C7FA: 85 00     STA $0000                                     ; ~> sprite_magic1 (Y pos)
...
C - - - - - 0x01C815 07:C805: 85 00     STA $0000                                     ;
...
C - - - - - 0x01C820 07:C810: 85 00     STA $0000                                     ;
...
C - - - - - 0x01C82C 07:C81C: 85 00     STA $0000                                     ;
...
C - - - - - 0x01C842 07:C832: 85 03     STA $0003                                     ;
C - - - - - 0x01C844 07:C834: 98        TYA                                           ;
C - - - - - 0x01C845 07:C835: 18        CLC                                           ;
C - - - - - 0x01C846 07:C836: 69 70     ADC #$70                                      ; ~> sprite_magic2 (see vSpriteMagic2)
C - - - - - 0x01C848 07:C838: 85 01     STA $0001                                     ;
C - - - - - 0x01C84A 07:C83A: A9 20     LDA #$20                                      ; ~> sprite_magic3 (see vSpriteMagic3)
C - - - - - 0x01C84C 07:C83C: 85 02     STA $0002                                     ;
...
C - - - - - 0x01C871 07:C861: 85 0F     STA vTempCounterF                     ; set loop counter
bra_C863_loop:                                                                ; loop counter (4 times)
C - - - - - 0x01C873 07:C863: 20 89 D0  JSR sub_D089_render_14_15_16_17_18_v2 ;
C - - - - - 0x01C876 07:C866: A5 14     LDA $0014                             ;
C - - - - - 0x01C878 07:C868: 18        CLC                                   ;
C - - - - - 0x01C879 07:C869: 69 20     ADC #$20                              ;
C - - - - - 0x01C87B 07:C86B: 85 14     STA $0014                             ; shifts PPU address for next row
C - - - - - 0x01C87D 07:C86D: A5 15     LDA $0015                             ;
C - - - - - 0x01C87F 07:C86F: 69 00     ADC #$00                        	  ;
C - - - - - 0x01C881 07:C871: 85 15     STA $0015                             ; shift high address by Carry flag
C - - - - - 0x01C883 07:C873: A5 16     LDA $0016                             ;
C - - - - - 0x01C885 07:C875: 18        CLC                                   ;
C - - - - - 0x01C886 07:C876: 65 18     ADC $0018                             ;
C - - - - - 0x01C888 07:C878: 85 16     STA $0016                             ; shifts ROM-address value by count of the bytes ($0018 contains 0x03)
C - - - - - 0x01C88A 07:C87A: A5 17     LDA $0017                             ;
C - - - - - 0x01C88C 07:C87C: 69 00     ADC #$00                              ;
C - - - - - 0x01C88E 07:C87E: 85 17     STA $0017                             ; shift high ROM-address value by Carry flag
C - - - - - 0x01C890 07:C880: C6 0F     DEC vTempCounterF                     ; decrement loop counter
C - - - - - 0x01C892 07:C882: 10 DF     BPL bra_C863_loop                     ; If vTempCounterF < 0x80
...
@bra_C893_skip:
C - - - - - 0x01C8A3 07:C893: A5 1E     LDA vPlayer1BtnPressed            ;
...
C - - - - - 0x01C8A9 07:C899: 45 21     EOR vLastP1BtnPressed             ;
C - - - - - 0x01C8AB 07:C89B: 29 08     AND #BIT_BUTTON_START             ; avoid looping
C - - - - - 0x01C8AD 07:C89D: F0 34     BEQ bra_C8D3_RTS                  ; If vPlayer1BtnPressed = vLastP1BtnPressed
...
C - - - - - 0x01C8E9 07:C8D9: DD 00 01  CMP vCacheYoshikawa,X  ;
...
C - - - - - 0x01C901 07:C8F1: 9D 00 01  STA vCacheYoshikawa,X    ; set Yoshikawa
...
C - - - - - 0x01C925 07:C915: 95 00     STA $0000,X              ;
...
C - - - - - 0x01C92E 07:C91E: 85 08     STA $0008               ; $0008 <~ 0x80
C - - - - - 0x01C930 07:C920: A9 80     LDA #$80                ;
C - - - - - 0x01C932 07:C922: 85 09     STA $0009               ; $0009 <~ 0x80
...
C - - - - - 0x01C936 07:C926: 85 07     STA $0007               ; $0007 <~ 0x00
C - - - - - 0x01C938 07:C928: A0 07     LDY #$07                ; set loop counter
@bra_C92A_loop:                                                 ; loop by y (7 times)
C - - - - - 0x01C93A 07:C92A: B5 00     LDA $0000,X             ; load a score symbol
C - - - - - 0x01C93C 07:C92C: F0 02     BEQ @bra_C930_skip      ; If symbol == '0'
C - - - - - 0x01C93E 07:C92E: C6 07     DEC $0007               ; marks that it's the first non-null symbol
@bra_C930_skip:
C - - - - - 0x01C940 07:C930: 24 07     BIT $0007               ;
...
C - - - - - 0x01C948 07:C938: A5 08     LDA $0008               ; 0x80 + 0x80 -> 0x00, the tile number for blank
@bra_C93A_skip:
C - - - - - 0x01C94A 07:C93A: 18        CLC                     ;
C - - - - - 0x01C94B 07:C93B: 65 09     ADC $0009               ; 0x80 - '0', 0x81 - '1', 0x82 - '2', 0x83 - '3', ... , 0x89 - '9'
...
C - - - - - 0x01C9EE 07:C9DE: 86 07     STX $0007                    ; fact of displaying some digit
...
C - - - - - 0x01C9F6 07:C9E6: 24 07     BIT $0007                    ;
C - - - - - 0x01C9F8 07:C9E8: 30 04     BMI @bra_C9EE_skip           ; Branch If $0007 == 0%1XXXXXXX
...
@bra_C9EE_skip:
C - - - - - 0x01C9FE 07:C9EE: C6 07     DEC $0007                    ;
...
C - - - - - 0x01CA0B 07:C9FB: BD 00 02  LDA vItems,X                 ;
...
C - - - - - 0x01CA91 07:CA81: 85 1A     STA vTempCounter1A      ; set loop counter
@bra_CA83_loop:                                                 ; loop by vTempCounter1A
C - - - - - 0x01CA93 07:CA83: A6 1A     LDX vTempCounter1A      ;
...
C - - - - - 0x01CA9C 07:CA8C: BD 00 02  LDA vItems,X            ;
...
@bra_CABA_skip:
C - - - - - 0x01CACA 07:CABA: C6 1A     DEC vTempCounter1A           ; decrement vTempCounter1A
...
C - - - - - 0x01CB62 07:CB52: 85 14     STA vNonUsed14                          ; !(UNUSED)
...
@bra_CB64_skip:
C - - - - - 0x01CB74 07:CB64: BD 00 02  LDA vItems,X                            ;
C - - - - - 0x01CB77 07:CB67: D0 17     BNE bra_CB80_found                      ; If the number of the current item > 0
C - - - - - 0x01CB79 07:CB69: C6 12     DEC vTempCheckButtons                   ; some finite number (at the start - 0xC0)
...
C - - - - - 0x01CBC1 07:CBB1: 85 01     STA $0001                                 ; caches an offset
...
C - - - - - 0x01CBDE 07:CBCE: 65 01     ADC $0001                                 ; adds an offset
...
C - - - - - 0x01CC16 07:CC06: BD 00 02  LDA vItems,X               ;
...
@bra_CC1B_skip:
C - - - - - 0x01CC2B 07:CC1B: BD 00 02  LDA vItems,X               ;
...
C - - - - - 0x01CC4C 07:CC3C: 85 00     STA $0000                        ; Low address
C - - - - - 0x01CC4E 07:CC3E: B9 47 CC  LDA tbl_CC46_item_handlers + 1,Y ;
C - - - - - 0x01CC51 07:CC41: 85 01     STA $0001                        ; High address
C - - - - - 0x01CC53 07:CC43: 6C 00 00  JMP ($0000)                      ;
...
C - - - - - 0x01CCD3 07:CCC3: B1 00     LDA ($0000),Y                            ; load a background color
...
loc_CD13_use_item:
sub_CD13_use_item:
C D 2 - - - 0x01CD23 07:CD13: DE 00 02  DEC vItems,X          ; Decrement an item
...
C - - - - - 0x01CDB0 07:CDA0: 85 00     STA $0000                            ; Low address
C - - - - - 0x01CDB2 07:CDA2: B9 BF CD  LDA tbl_CDBE_item_dec_callback + 1,Y ;
C - - - - - 0x01CDB5 07:CDA5: 85 01     STA $0001                            ; High address
C - - - - - 0x01CDB7 07:CDA7: 6C 00 00  JMP ($0000)                          ;
...
C - - - - - 0x01CDE0 07:CDD0: AD 05 02  LDA vBreathingApparatusItem               ;
...
C - - - - - 0x01CE15 07:CE05: BD 00 02  LDA vItems,X                ;
...
; in: $0000 - sprite magic1 (Y-position)
; in: $0001 - sprite magic2 (see vSpriteMagic2)
; in: $0002 - sprite magic3 (see vSpriteMagic3)
; in: $0003 - sprite magic4 (X-position)
...
C - - - - - 0x01CE4C 07:CE3C: A5 00     LDA $0000               ;
C - - - - - 0x01CE4E 07:CE3E: 99 B7 06  STA vSpriteMagic1,Y     ;
C - - - - - 0x01CE51 07:CE41: A5 01     LDA $0001               ;
C - - - - - 0x01CE53 07:CE43: 99 B8 06  STA vSpriteMagic2,Y     ;
C - - - - - 0x01CE56 07:CE46: A5 02     LDA $0002               ;
C - - - - - 0x01CE58 07:CE48: 99 B9 06  STA vSpriteMagic3,Y     ;
C - - - - - 0x01CE5B 07:CE4B: A5 03     LDA $0003               ;
C - - - - - 0x01CE5D 07:CE4D: 99 BA 06  STA vSpriteMagic4,Y     ;
...
; in: Register X - the offset of the sprite address [$80XX-$83XX]
; in: $0000 - The character's position along the Y axis relative to the screen
; in: $0001 - The character's position along the X axis relative to the screen
sub_CE5A_render_character:
loc_CE5A_render_character:
C D 2 - - - 0x01CE6A 07:CE5A: A9 00     LDA #$00                     ;
C - - - - - 0x01CE6C 07:CE5C: 85 08     STA $0008                    ; clear
C - - - - - 0x01CE6E 07:CE5E: 85 09     STA $0009                    ; clear
...
C - - - - - 0x01CE89 07:CE79: 85 05     STA $0005                    ; a high byte address [0x80-0x83]
C - - - - - 0x01CE8B 07:CE7B: A9 00     LDA #$00                     ;
C - - - - - 0x01CE8D 07:CE7D: 85 04     STA $0004                    ; a low byte address
C - - - - - 0x01CE8F 07:CE7F: 8A        TXA                          ; shift by x (x - an input parameter)
C - - - - - 0x01CE90 07:CE80: A8        TAY                          ;
C - - - - - 0x01CE91 07:CE81: B1 04     LDA ($0004),Y                ;
C - - - - - 0x01CE93 07:CE83: 85 02     STA $0002                    ; Assinged a high byte address
C - - - - - 0x01CE95 07:CE85: C8        INY                          ;
C - - - - - 0x01CE96 07:CE86: B1 04     LDA ($0004),Y                ;
C - - - - - 0x01CE98 07:CE88: 85 03     STA $0003                    ; Assinged a low byte address
...
C - - - - - 0x01CEA2 07:CE92: B1 02     LDA ($0002),Y                ; get a tile count
C - - - - - 0x01CEA4 07:CE94: 85 05     STA vTempCounter5            ; set loop counter
C - - - - - 0x01CEA6 07:CE96: F0 54     BEQ bra_CEEC_end             ; If vTempCounter5 == 0x00
...
bra_CE99_loop:                                                       ; loop by vTempCounter5
C D 2 - - - 0x01CEA9 07:CE99: A9 00     LDA #$00                     ;
C - - - - - 0x01CEAB 07:CE9B: 85 04     STA $0004                    ; clear
C - - - - - 0x01CEAD 07:CE9D: B1 02     LDA ($0002),Y                ; 1 of 4 (Y-position)
C - - - - - 0x01CEAF 07:CE9F: 10 02     BPL @bra_CEA3_skip           ; If Register A < 0x80
C - - - - - 0x01CEB1 07:CEA1: C6 04     DEC $0004                    ; 0x00 -> 0xFF (The position may be negative!)
@bra_CEA3_skip:
C - - - - - 0x01CEB3 07:CEA3: 18        CLC                          ;
C - - - - - 0x01CEB4 07:CEA4: 65 00     ADC $0000                    ;
C - - - - - 0x01CEB6 07:CEA6: 9D 00 07  STA vStartOAM,X              ; set Y-position
C - - - - - 0x01CEB9 07:CEA9: A5 04     LDA $0004                    ; $0004 is {0x00, 0xFF}, for 0xFF the overflow should be (it's the correction for negative Y-position)
C - - - - - 0x01CEBB 07:CEAB: 65 08     ADC $0008                    ;
...
C - - - - - 0x01CEC0 07:CEB0: B1 02     LDA ($0002),Y                ; 2 of 4
...
C - - - - - 0x01CEC6 07:CEB6: B1 02     LDA ($0002),Y                ; 3 of 4
...
C - - - - - 0x01CED0 07:CEC0: 85 04     STA $0004                    ; clear
C - - - - - 0x01CED2 07:CEC2: B1 02     LDA ($0002),Y                ; 4 of 4
C - - - - - 0x01CED4 07:CEC4: 10 02     BPL @bra_CEC8_skip           ; If Register A < 0x80
C - - - - - 0x01CED6 07:CEC6: C6 04     DEC $0004                    ; 0x00 -> 0xFF (The position may be negative!)
@bra_CEC8_skip:
C - - - - - 0x01CED8 07:CEC8: 18        CLC                          ;
C - - - - - 0x01CED9 07:CEC9: 65 01     ADC $0001                    ;
C - - - - - 0x01CEDB 07:CECB: 85 06     STA $0006                    ; store X-position temporarily
C - - - - - 0x01CEDD 07:CECD: A5 04     LDA $0004                    ; $0004 is {0x00, 0xFF}, for 0xFF the overflow should be (it's the correction for negative X-position)
C - - - - - 0x01CEDF 07:CECF: 65 09     ADC $0009                    ;
C - - - - - 0x01CEE1 07:CED1: D0 1F     BNE bra_CEF2_blank           ; If Register A != 0x00 (it is an unacceptable sprite)
C - - - - - 0x01CEE3 07:CED3: A5 06     LDA $0006                    ;
...
C - - - - - 0x01CEF6 07:CEE6: C6 05     DEC vTempCounter5            ; decrement counter
C - - - - - 0x01CEF8 07:CEE8: D0 AF     BNE bra_CE99_loop            ; If vTempCounter5 > 0 (The sprites ($0002,$0003) are exist)
bra_CEEA_end:
...
C - - - - - 0x01CF25 07:CF15: B9 B7 06  LDA vSpriteMagic1,Y                    ;
...
C - - - - - 0x01CF31 07:CF21: B9 BA 06  LDA vSpriteMagic4,Y        ;
C - - - - - 0x01CF34 07:CF24: 85 01     STA $0001                  ; <~ X-position
C - - - - - 0x01CF36 07:CF26: B9 B9 06  LDA vSpriteMagic3,Y        ;
C - - - - - 0x01CF39 07:CF29: 48        PHA                        ; store vSpriteMagic3
C - - - - - 0x01CF3A 07:CF2A: 48        PHA                        ; store vSpriteMagic3
C - - - - - 0x01CF3B 07:CF2B: 48        PHA                        ; store vSpriteMagic3
C - - - - - 0x01CF3C 07:CF2C: A2 0B     LDX #$0B                   ; bank 05 (2 page)
C - - - - - 0x01CF3E 07:CF2E: 29 30     AND #$30                   ;
C - - - - - 0x01CF40 07:CF30: F0 08     BEQ @bra_CF3A_set_bank     ; If SSBB = 0xXX00 (see vSpriteMagic3)
C - - - - - 0x01CF42 07:CF32: A2 05     LDX #$05                   ; bank 02 (2 page)
C - - - - - 0x01CF44 07:CF34: C9 10     CMP #$10                   ;
C - - - - - 0x01CF46 07:CF36: F0 02     BEQ @bra_CF3A_set_bank     ; If SSBB = 0xXX01 (see vSpriteMagic3)
...
C - - - - - 0x01CF52 07:CF42: 68        PLA                        ; retrieve vSpriteMagic3 ($CF2B)
C - - - - - 0x01CF53 07:CF43: 29 03     AND #$03                   ;
C - - - - - 0x01CF55 07:CF45: 85 45     STA vCharacterRenderData   ; put the OAM-attributes
C - - - - - 0x01CF57 07:CF47: 68        PLA                        ; retrieve vSpriteMagic3 ($CF2A)
C - - - - - 0x01CF58 07:CF48: 29 04     AND #$04                   ;
C - - - - - 0x01CF5A 07:CF4A: F0 02     BEQ @bra_CF4E_skip         ; If XCOO = 0xX0XX (see vSpriteMagic3)
C - - - - - 0x01CF5C 07:CF4C: A9 40     LDA #$40                   ; using next CHR-page size 1 Kb
@bra_CF4E_skip:
C - - - - - 0x01CF5E 07:CF4E: 85 0A     STA $000A                  ; 0x00 or 0x40
C - - - - - 0x01CF60 07:CF50: 68        PLA                        ; retrieve vSpriteMagic3 ($CF29)
...
C - - - - - 0x01CF68 07:CF58: 85 05     STA $0005                  ; High address
C - - - - - 0x01CF6A 07:CF5A: A9 00     LDA #$00                   ;
C - - - - - 0x01CF6C 07:CF5C: 85 04     STA $0004                  ; Low address
C - - - - - 0x01CF6E 07:CF5E: B9 B8 06  LDA vSpriteMagic2,Y        ;
C - - - - - 0x01CF71 07:CF61: A8        TAY                        ; 1 of 2 bytes
C - - - - - 0x01CF72 07:CF62: B1 04     LDA ($0004),Y              ;
C - - - - - 0x01CF74 07:CF64: 85 02     STA $0002                  ; Low address
C - - - - - 0x01CF76 07:CF66: C8        INY                        ; 2 of 2 bytes
C - - - - - 0x01CF77 07:CF67: B1 04     LDA ($0004),Y              ;
C - - - - - 0x01CF79 07:CF69: 85 03     STA $0003                  ; High address
C - - - - - 0x01CF7B 07:CF6B: A0 00     LDY #$00                   ;
C - - - - - 0x01CF7D 07:CF6D: B1 02     LDA ($0002),Y              ; Tile count
C - - - - - 0x01CF7F 07:CF6F: 85 05     STA vTempCounter5          ; set loop counter
...
C - - - - - 0x01CF88 07:CF78: 85 04     STA $0004                  ; clear
C - - - - - 0x01CF8A 07:CF7A: B1 02     LDA ($0002),Y              ; 1 of 4
C - - - - - 0x01CF8C 07:CF7C: 10 02     BPL @bra_CF80_skip         ; If Register A < 0x80
C - - - - - 0x01CF8E 07:CF7E: C6 04     DEC $0004                  ; 0x00 -> 0xFF (The position may be negative!)
@bra_CF80_skip:
C - - - - - 0x01CF90 07:CF80: 18        CLC                        ;
C - - - - - 0x01CF91 07:CF81: 65 00     ADC $0000                  ; adds starting Y-point
C - - - - - 0x01CF93 07:CF83: 9D 00 07  STA vStartOAM,X            ; set Y-position
C - - - - - 0x01CF96 07:CF86: A5 04     LDA $0004                  ;
...
C - - - - - 0x01CF9D 07:CF8D: B1 02     LDA ($0002),Y              ; 2 of 4
C - - - - - 0x01CF9F 07:CF8F: 05 0A     ORA $000A                  ; 0x00 or 0x40 (current or next CHR-page size 1 Kb)
...
C - - - - - 0x01CFA5 07:CF95: B1 02     LDA ($0002),Y              ; 3 of 4
...
C - - - - - 0x01CFAF 07:CF9F: 85 04     STA $0004                  ; clear
C - - - - - 0x01CFB1 07:CFA1: B1 02     LDA ($0002),Y              ; 4 of 4
C - - - - - 0x01CFB3 07:CFA3: 10 02     BPL bra_CFA7_skip          ; If Register A < 0x80
C - - - - - 0x01CFB5 07:CFA5: C6 04     DEC $0004                  ; 0x00 -> 0xFF (The position may be negative!)
bra_CFA7_skip:
C - - - - - 0x01CFB7 07:CFA7: 18        CLC                        ;
C - - - - - 0x01CFB8 07:CFA8: 65 01     ADC $0001                  ;
C - - - - - 0x01CFBA 07:CFAA: 85 06     STA $0006                  ; store X-position temporarily
C - - - - - 0x01CFBC 07:CFAC: A5 04     LDA $0004                  ;
C - - - - - 0x01CFBE 07:CFAE: 69 00     ADC #$00                   ;
C - - - - - 0x01CFC0 07:CFB0: D0 25     BNE bra_CFD7_skip_sprite   ; If Register A != 0x00 (sprite off screen)
C - - - - - 0x01CFC2 07:CFB2: A5 06     LDA $0006                  ;
...
C - - - - - 0x01CFD2 07:CFC2: C6 05     DEC vTempCounter5          ; decrement loop counter
...
C - - - - - 0x01D089 07:D079: 85 12     STA vTempCheckButtons    ;
C - - - - - 0x01D08B 07:D07B: A5 1C     LDA vBtnPressedInGame    ;
C - - - - - 0x01D08D 07:D07D: 25 12     AND vTempCheckButtons    ;
...
C - - - - - 0x01D093 07:D083: 25 12     AND vTempCheckButtons    ;
@bra_D085_RTS:
C - - - - - 0x01D095 07:D085: 60        RTS                      ;

; In: $0012-$0013 - an input address
; Register A - position by the content (indirect $0012-$0013)
...
C - - - - - 0x01D0B3 07:D0A3: 85 14     STA $0014          ;
C - - - - - 0x01D0B5 07:D0A5: 0A        ASL                ;
C - - - - - 0x01D0B6 07:D0A6: 0A        ASL                ;
C - - - - - 0x01D0B7 07:D0A7: 18        CLC                ;
C - - - - - 0x01D0B8 07:D0A8: 65 14     ADC $0014          ; get the content offset (5 byte each * Register A)
...
C - - - - - 0x01D0BF 07:D0AF: 95 14     STA $0014,X        ; prepare $0014 or $0015 or $0016 or $0017 or $0018
...
C - - - - - 0x01D0E8 07:D0D8: 85 00     STA $0000                ; high ppu address -> $0000
C - - - - - 0x01D0EA 07:D0DA: 86 01     STX $0001                ; low ppu address ->  $0001
...
C - - - - - 0x01D0F6 07:D0E6: 85 02     STA $0002                ; ppu buffer count -> $0002
C - - - - - 0x01D0F8 07:D0E8: A2 00     LDX #$00                 ;
loc_D0EA_loop:
bra_D0EA_repeat:
C D 2 - - - 0x01D0FA 07:D0EA: A5 00     LDA $0000                ;
C - - - - - 0x01D0FC 07:D0EC: 8D 06 20  STA PPU_ADDRESS          ;
C - - - - - 0x01D0FF 07:D0EF: A5 01     LDA $0001                ;
...
C - - - - - 0x01D10D 07:D0FD: C6 02     DEC $0002                ; decrement count
...
C - - - - - 0x01D114 07:D104: A5 01     LDA $0001                ;
...
C - - - - - 0x01D11C 07:D10C: 85 01     STA $0001                ; !(UNUSED), <~ 0x1F
C - - - - - 0x01D11E 07:D10E: A5 00     LDA $0000                ; !(UNUSED)
C - - - - - 0x01D120 07:D110: 49 04     EOR #$04                 ; !(UNUSED)
C - - - - - 0x01D122 07:D112: 85 00     STA $0000                ; !(UNUSED), toggle trick for name tables, e.g. 0x20 -> 0x24, 0x22 -> 0x26, 0x24 -> 0x20
C - - - - - 0x01D124 07:D114: D0 D4     BNE bra_D0EA_repeat      ; !(UNUSED), Always true, $0000 >= 0x20

bra_D116_skip:
C - - - - - 0x01D126 07:D116: E6 01     INC $0001                ; increment low ppu address
...
@bra_D13F_skip:
C - - - - - 0x01D14F 07:D13F: 85 00     STA $0000                     ; set loop counter
C - - - - - 0x01D151 07:D141: A2 00     LDX #$00                      ;
@bra_D143_loop:                                                       ; loop by $0000
C - - - - - 0x01D153 07:D143: BD 33 06  LDA vPpuBufferData,X          ;
C - - - - - 0x01D156 07:D146: 8D 07 20  STA PPU_DATA                  ;
C - - - - - 0x01D159 07:D149: E8        INX                           ;
C - - - - - 0x01D15A 07:D14A: C6 00     DEC $0000                     ; decrement $0000
C - - - - - 0x01D15C 07:D14C: D0 F5     BNE @bra_D143_loop            ; If $0000 != 0
bra_D14E_clear:
...
@bra_D1CB_skip:
C - - - - - 0x01D1DB 07:D1CB: 85 02     STA $0002                           ; puts vLowViewPortPosX - 0x40
...
@bra_D201_skip:
C - - - - - 0x01D211 07:D201: 85 02     STA $0002                                       ; puts vLowViewPortPosX + 0x40
; In: $0002 - low X-position
...
C - - - - - 0x01D22C 07:D21C: 85 01     STA $0001                                       ; set zero
C - - - - - 0x01D22E 07:D21E: A5 02     LDA $0002                                       ;
...
C - - - - - 0x01D23B 07:D22B: A5 02     LDA $0002                                       ;
C - - - - - 0x01D23D 07:D22D: 29 F0     AND #$F0                                        ;
C - - - - - 0x01D23F 07:D22F: 4A        LSR                                             ;
C - - - - - 0x01D240 07:D230: 85 02     STA $0002                                       ;
C - - - - - 0x01D242 07:D232: 4A        LSR                                             ;
C - - - - - 0x01D243 07:D233: 18        CLC                                             ;
C - - - - - 0x01D244 07:D234: 65 02     ADC $0002                                       ; put in Register A a whole $0002 that is a multiple of 12
...
C - - - - - 0x01D24A 07:D23A: 85 52     STA vBackgroundScreenIndexes                    ; low address + offset
...
C - - - - - 0x01D256 07:D246: 85 53     STA vHighBackgroundScreenIndexes                ; high address + offset
C - - - - - 0x01D258 07:D248: 68        PLA                                             ; retrieve A ($D241)
C - - - - - 0x01D259 07:D249: 20 5E D0  JSR sub_accumulator_shift_right_by_5            ;
C - - - - - 0x01D25C 07:D24C: 85 02     STA $0002                                       ; puts a bank data, using 0xXXX00000 from 0xBBBAAAAA
...
C - - - - - 0x01D272 07:D262: A5 02     LDA $0002                                       ;
C - - - - - 0x01D274 07:D264: 8D 01 80  STA MMC3_Bank_data                              ; switch $0002 (PRG) in 0x8000-09FFF
C - - - - - 0x01D277 07:D267: A9 00     LDA #$00                                        ;
C - - - - - 0x01D279 07:D269: 85 07     STA $0007                                       ; set zero
C - - - - - 0x01D27B 07:D26B: B1 52     LDA (vBackgroundScreenIndexes),Y                ; loads the index of quartet tiles
C - - - - - 0x01D27D 07:D26D: 0A        ASL                                             ;
C - - - - - 0x01D27E 07:D26E: 26 07     ROL $0007                                       ;
C - - - - - 0x01D280 07:D270: 0A        ASL                                             ;
C - - - - - 0x01D281 07:D271: 26 07     ROL $0007                                       ; $0007 = {0x00, 0x01, 0x02, 0x03}
C - - - - - 0x01D283 07:D273: 18        CLC                                             ;
C - - - - - 0x01D284 07:D274: 65 50     ADC vTempValue50                                ; low address = vTempValue50 + ((vBackgroundScreenIndexes) << 2)
C - - - - - 0x01D286 07:D276: 85 06     STA $0006                                       ; puts a low address of ppu datas
...
@bra_D28B_skip:
C - - - - - 0x01D29B 07:D28B: B1 06     LDA ($0006),Y                                   ;
...
C - - - - - 0x01D2E0 07:D2D0: 85 02     STA $0002                                       ; low address
...
C - - - - - 0x01D2F7 07:D2E7: A5 01     LDA $0001          ;
C - - - - - 0x01D2F9 07:D2E9: 29 F0     AND #$F0           ;
C - - - - - 0x01D2FB 07:D2EB: 4A        LSR                ;
C - - - - - 0x01D2FC 07:D2EC: 85 04     STA $0004          ;
C - - - - - 0x01D2FE 07:D2EE: 4A        LSR                ; 
C - - - - - 0x01D2FF 07:D2EF: 18        CLC                ;
C - - - - - 0x01D300 07:D2F0: 65 04     ADC $0004          ;
C - - - - - 0x01D302 07:D2F2: 85 04     STA $0004          ;
C - - - - - 0x01D304 07:D2F4: A5 00     LDA $0000          ;
...
C - - - - - 0x01D314 07:D304: 65 04     ADC $0004                                       ; get point(x, y)
...
C - - - - - 0x01D31E 07:D30E: 85 52     STA vBackgroundScreenIndexes                    ; low address
...
C - - - - - 0x01D326 07:D316: 85 53     STA vHighBackgroundScreenIndexes                ; high address
C - - - - - 0x01D328 07:D318: 68        PLA                                             ; retrieve A, point(x, y) ($D306)
C - - - - - 0x01D329 07:D319: A8        TAY                                             ;
C - - - - - 0x01D32A 07:D31A: B1 52     LDA (vBackgroundScreenIndexes),Y                ; put a index of the metatiles
...
C - - - - - 0x01D335 07:D325: E6 0F     INC $000F                                       ; increment a high address (an offset)
@bra_D327_skip:
C - - - - - 0x01D337 07:D327: A5 00     LDA $0000                                       ; load Y-position
...
@bra_D32E_skip:
C - - - - - 0x01D33E 07:D32E: B1 0E     LDA ($000E),Y                                   ; load a collision value
C - - - - - 0x01D340 07:D330: 85 04     STA $0004                                       ;
C - - - - - 0x01D342 07:D332: A5 01     LDA $0001                                       ; load X-position
C - - - - - 0x01D344 07:D334: 29 08     AND #$08                                        ;
C - - - - - 0x01D346 07:D336: F0 08     BEQ @bra_D340_skip                              ; If it is a X-border of the screen block
C - - - - - 0x01D348 07:D338: 46 04     LSR $0004                                       ;
C - - - - - 0x01D34A 07:D33A: 46 04     LSR $0004                                       ;
C - - - - - 0x01D34C 07:D33C: 46 04     LSR $0004                                       ;
C - - - - - 0x01D34E 07:D33E: 46 04     LSR $0004                                       ; gets high half-byte
@bra_D340_skip:
C - - - - - 0x01D350 07:D340: 68        PLA                                             ;
C - - - - - 0x01D351 07:D341: AA        TAX                                             ; retrieve x (see D2E6)
C - - - - - 0x01D352 07:D342: A5 04     LDA $0004                                       ;
...
C - - - - - 0x01D391 07:D381: 85 01     STA $0001                                ; store a left collision value
C - - - - - 0x01D393 07:D383: 68        PLA                                      ; retrieve a right collision value ($D375)
C - - - - - 0x01D394 07:D384: 85 02     STA $0002                                ; store a right collision value
C - - - - - 0x01D396 07:D386: 05 01     ORA $0001                                ;
...
C - - - - - 0x01D39A 07:D38A: 65 01     ADC $0001                        ; 
C - - - - - 0x01D39C 07:D38C: 85 01     STA $0001                        ;
...
C - - - - - 0x01D3B0 07:D3A0: 65 01     ADC $0001                        ;
C - - - - - 0x01D3B2 07:D3A2: 85 01     STA $0001                        ;
...
C - - - - - 0x01D3DE 07:D3CE: A5 00     LDA $0000                 ;
...
C - - - - - 0x01D3EF 07:D3DF: A5 01     LDA $0001                 ;
...
C - - - - - 0x01D449 07:D439: 85 00     STA $0000                         ;
...
C - - - - - 0x01D452 07:D442: 85 01     STA $0001                         ;
...
C - - - - - 0x01D45A 07:D44A: B1 00     LDA ($0000),Y                            ;
...
C - - - - - 0x01D470 07:D460: B1 00     LDA ($0000),Y                                   ;
...
C - - - - - 0x01D485 07:D475: 85 02     STA $0002                                       ; low address
...
C - - - - - 0x01D48E 07:D47E: 85 03     STA $0003                                       ; high address
C - - - - - 0x01D490 07:D480: A0 05     LDY #$05                                        ; set loop counter
@bra_D482_loop:                                                                         ; loop by y (6 times)
C - - - - - 0x01D492 07:D482: B1 02     LDA ($0002),Y                                   ; 
...
; Out: the CPU-address in [$000E-$000F]
...
C - - - - - 0x01D566 07:D556: 85 0E     STA $000E                            ; Low address
...
C - - - - - 0x01D56F 07:D55F: 85 0F     STA $000F                            ; High address
...
C - - - - - 0x01D59D 07:D58D: AD 07 02  LDA vBulletProofVestItem                     ;
...
C - - - - - 0x01D602 07:D5F2: 85 12     STA $0012                    ; $0012 (cache) <~ vEnemyHitBoxW + vTmpHitBoxW
...
@bra_D5FE_skip:
C - - - - - 0x01D60E 07:D5FE: C5 12     CMP $0012                    ;
...
bra_D67D:
C - - - - - 0x01D68D 07:D67D: 85 0D     STA $000D              ; $000D <~ 0x40
C - - - - - 0x01D68F 07:D67F: A5 27     LDA vLowViewPortPosX   ;
C - - - - - 0x01D691 07:D681: 18        CLC                    ;
C - - - - - 0x01D692 07:D682: 65 0D     ADC $000D              ;
C - - - - - 0x01D694 07:D684: 85 02     STA $0002              ; $0002 <~ LowPosX + 0x40
C - - - - - 0x01D696 07:D686: A5 4B     LDA vHighViewPortPosX  ;
C - - - - - 0x01D698 07:D688: 69 01     ADC #$01               ;
C - - - - - 0x01D69A 07:D68A: 85 03     STA $0003              ; $0003 <~ HighPosX + 0x01 (+1 with overflow)
...
C - - - - - 0x01D6A6 07:D696: E5 0D     SBC $000D              ;
C - - - - - 0x01D6A8 07:D698: 85 02     STA $0002              ; $0002 <~ LowPosX - 0x40
C - - - - - 0x01D6AA 07:D69A: A5 4B     LDA vHighViewPortPosX  ;
C - - - - - 0x01D6AC 07:D69C: E9 00     SBC #$00               ;
C - - - - - 0x01D6AE 07:D69E: 85 03     STA $0003              ; $0003 <~ HighPosX - 0x01 (+1 with overflow)
C - - - - - 0x01D6B0 07:D6A0: 90 09     BCC bra_D6AB_RTS       ; If vHighViewPortPosX:vLowViewPortPosX < 0x00:0x40
sub_D6A2_sub:
C - - - - - 0x01D6B2 07:D6A2: A5 02     LDA $0002              ;
C - - - - - 0x01D6B4 07:D6A4: 38        SEC                    ;
C - - - - - 0x01D6B5 07:D6A5: E5 00     SBC $0000              ;
C - - - - - 0x01D6B7 07:D6A7: A5 03     LDA $0003              ;
C - - - - - 0x01D6B9 07:D6A9: E5 01     SBC $0001              ;
bra_D6AB_RTS:
...
C - - - - - 0x01D6BC 07:D6AC: A5 00     LDA $0000                ;
C - - - - - 0x01D6BE 07:D6AE: 38        SEC                      ;
C - - - - - 0x01D6BF 07:D6AF: E5 27     SBC vLowViewPortPosX     ;
C - - - - - 0x01D6C1 07:D6B1: 85 03     STA $0003                ; $0003 <~ $0000 - vLowViewPortPosX
C - - - - - 0x01D6C3 07:D6B3: A5 01     LDA $0001                ;
...
C - - - - - 0x01D738 07:D728: 85 00     STA $0000                   ; ~> sprite magic1
C - - - - - 0x01D73A 07:D72A: A5 03     LDA $0003                   ;
...
C - - - - - 0x01D768 07:D758: 85 D7     STA vTempGapHighChrPosX            ; prepare an input parameter
...
C - - - - - 0x01D784 07:D774: 69 D8     ADC #$D8                           ; ~> sprite_magic2 (see vSpriteMagic2)
C - - - - - 0x01D786 07:D776: 85 01     STA $0001                          ; 0xD8, 0xDA, 0xDC or 0xDE
C - - - - - 0x01D788 07:D778: A9 40     LDA #$40                           ; ~> sprite_magic3 (see vSpriteMagic3)
C - - - - - 0x01D78A 07:D77A: 85 02     STA $0002                          ; $8100, bank 05 (2 page)
...
C - - - - - 0x01D804 07:D7F4: 85 00     STA $0000                                ; <~ vEnemyAPosY + PosY
...
C - - - - - 0x01D844 07:D834: 85 00     STA $0000                   ; ~> sprite magic1
C - - - - - 0x01D846 07:D836: A5 03     LDA $0003                   ;
...
C - - - - - 0x01D874 07:D864: 85 D7     STA vTempGapHighChrPosX              ; prepare an input parameter
...
C - - - - - 0x01D8EF 07:D8DF: 85 00     STA $0000                                   ; <~ vEnemyBPosY + PosY
...
C - - - - - 0x01D916 07:D906: BD B6 03  LDA vItemPosXLow,X         ; !(UNUSED)
C - - - - - 0x01D919 07:D909: 38        SEC                        ; !(UNUSED)
C - - - - - 0x01D91A 07:D90A: E9 F0     SBC #$F0                   ; !(UNUSED)
C - - - - - 0x01D91C 07:D90C: BD BC 03  LDA vItemPosXHigh,X        ; !(UNUSED)
C - - - - - 0x01D91F 07:D90F: E5 4A     SBC vNearCurrentRoomLength ; !(UNUSED)
...
C - - - - - 0x01D94D 07:D93D: 85 00     STA $0000              ;
; In: Register X - the enemyA number
; Out: $0001 - EnemyAPosXLow
...
C - - - - - 0x01D957 07:D947: 85 01     STA $0001              ;
...
C - - - - - 0x01D960 07:D950: 85 00     STA $0000                 ;
; In: Register X - the enemyB number
; Out: $0001 - EnemyBPosXLow
...
C - - - - - 0x01D97A 07:D96A: 85 01     STA $0001                 ; !(UNUSED), not used ???
...
loc_D996_adding:
C D 2 - - - 0x01D9A6 07:D996: 85 01     STA $0001                       ; ~> sprite_magic2 (see vSpriteMagic2)
C - - - - - 0x01D9A8 07:D998: A9 41     LDA #$41                        ;
C - - - - - 0x01D9AA 07:D99A: 85 02     STA $0002                       ; ~> sprite_magic3 (see vSpriteMagic3)
...
C - - - - - 0x01D9B3 07:D9A3: 69 D0     ADC #$D0                        ; ~> sprite_magic2 (see vSpriteMagic2)
C - - - - - 0x01D9B5 07:D9A5: 85 01     STA $0001                       ; <~ (0xD0, 0xD2, 0xD4, 0xD6)
C - - - - - 0x01D9B7 07:D9A7: A9 40     LDA #$40                        ; ~> sprite_magic3 (see vSpriteMagic3)
C - - - - - 0x01D9B9 07:D9A9: 85 02     STA $0002                       ;
...
bra_DA0B_valid:
C - - - - - 0x01DA1B 07:DA0B: C5 D7     CMP vTempGapHighChrPosX                         ;
...
C - - - - - 0x01DA73 07:DA63: 85 00     STA $0000                        ; prepares the 1st parameter
C - - - - - 0x01DA75 07:DA65: BD BC 03  LDA vItemPosXHigh,X              ;
C - - - - - 0x01DA78 07:DA68: 85 01     STA $0001                        ; prepares the 2nd parameter
...
C - - - - - 0x01DA85 07:DA75: 85 00     STA $0000                        ; ~> sprite magic1
C - - - - - 0x01DA87 07:DA77: A5 03     LDA $0003                        ; from sub_D6AC_out_of_screen
C - - - - - 0x01DA89 07:DA79: 9D B0 03  STA vItemScreenPosX,X            ;
; In: Register Y - sprite_magic2 (The offset by the address)
loc_DA7C_add_sprite_magic_in_05_p1:
C D 2 - - - 0x01DA8C 07:DA7C: 84 01     STY $0001                        ;
C - - - - - 0x01DA8E 07:DA7E: A9 60     LDA #$60                         ; ~> sprite_magic3
C - - - - - 0x01DA90 07:DA80: 85 02     STA $0002                        ;
...
C - - - - - 0x01DBE1 07:DBD1: 85 00     STA $0000                                    ; prepare an input parameter
C - - - - - 0x01DBE3 07:DBD3: A5 64     LDA vScreenChrPosX                           ;
C - - - - - 0x01DBE5 07:DBD5: 85 01     STA $0001                                    ; prepare an input parameter
...
C - - - - - 0x01DC3D 07:DC2D: 85 00     STA $0000                                  ; prepare an input parameter (for render)
C - - - - - 0x01DC3F 07:DC2F: A5 64     LDA vScreenChrPosX                         ;
C - - - - - 0x01DC41 07:DC31: 85 01     STA $0001                                  ; prepare an input parameter (for render)
...
C - - - - - 0x01DE2D 07:DE1D: 85 00     STA $0000                       ;
...
C - - - - - 0x01DE4B 07:DE3B: 85 00     STA $0000                       ; !(WHY?), seems to be excessive
...
C - - - - - 0x01DE54 07:DE44: E6 00     INC $0000                                   ; <~ vScreenChrPosY + 1, prepare an input parameter
...
C - - - - - 0x01DEF8 07:DEE8: 85 D7     STA vTempGapHighChrPosX                   ; prepare an input parameter
...
C - - - - - 0x01DF04 07:DEF4: AD 05 02  LDA vBreathingApparatusItem               ;
C - - - - - 0x01DF07 07:DEF7: D0 05     BNE @bra_DEFE_skip                        ; if vBreathingApparatusItem != 0x00
C - - - - - 0x01DF09 07:DEF9: AD 06 02  LDA vHeliumBalloonItem                    ;
...
C - - - - - 0x01DF18 07:DF08: AD 05 02  LDA vBreathingApparatusItem               ;
...
C - - - - - 0x01DF31 07:DF21: AD 06 02  LDA vHeliumBalloonItem                     ;
...
C - - - - - 0x01E0EA 07:E0DA: 65 02     ADC $0002                           ;
...
C - - - - - 0x01E0FB 07:E0EB: E5 02     SBC $0002                           ;
...
@bra_E12F_assign:
C - - - - - 0x01E13F 07:E12F: 84 02     STY $0002                            ;
...
C - - - - - 0x01E164 07:E154: A4 0A     LDY $000A                        ; initializes the frame offset
...
C - - - - - 0x01E177 07:E167: 69 A8     ADC #$A8                         ; + Y ~> sprite_magic2 (see vSpriteMagic2)
C - - - - - 0x01E179 07:E169: 85 01     STA $0001                        ;
C - - - - - 0x01E17B 07:E16B: A9 40     LDA #$40                         ; ~> sprite_magic3 (see vSpriteMagic3)
C - - - - - 0x01E17D 07:E16D: 85 02     STA $0002                        ; $8100, bank 05 (2 page)
C - - - - - 0x01E17F 07:E16F: B5 80     LDA vBulletPosY,X                ;
C - - - - - 0x01E181 07:E171: 85 00     STA $0000                        ; ~> sprite_magic1 (see vSpriteMagic1)
C - - - - - 0x01E183 07:E173: A5 03     LDA $0003                        ; sprite_magic4, assigned in $E1A8, $E20F
...
C - - - - - 0x01E190 07:E180: E5 02     SBC $0002                          ;
...
C - - - - - 0x01E1A1 07:E191: 65 02     ADC $0002                          ;
...
@bra_E1A5_skip:
C - - - - - 0x01E1B5 07:E1A5: 84 02     STY $0002                       ;
...
@bra_E1BD_assign:
C - - - - - 0x01E1CD 07:E1BD: 84 0A     STY $000A                            ;
...
C - - - - - 0x01E1F3 07:E1E3: 85 00     STA $0000                            ; 0x01 - odd numner, 0x00 - even number
C - - - - - 0x01E1F5 07:E1E5: A5 2B     LDA vNmiCounter                      ;
C - - - - - 0x01E1F7 07:E1E7: 29 01     AND #$01                             ; A <~ 0x00 or 0x01 (0 - even vNmiCounter, 1 - odd vNmiCounter)
C - - - - - 0x01E1F9 07:E1E9: C5 00     CMP $0000                            ;
C - - - - - 0x01E1FB 07:E1EB: D0 1A     BNE bra_E207_final_check             ; if the parity doesn't match
C - - - - - 0x01E1FD 07:E1ED: B5 80     LDA vBulletPosY,X                    ;
C - - - - - 0x01E1FF 07:E1EF: 85 00     STA $0000                            ; prepares 1st input parameter
C - - - - - 0x01E201 07:E1F1: B5 85     LDA vBulletLowPosX,X                 ;
C - - - - - 0x01E203 07:E1F3: 85 01     STA $0001                            ; prepares 2nd input parameter
...
C - - - - - 0x01E215 07:E205: 84 0A     STY $000A                            ;
bra_E207_final_check:
C - - - - - 0x01E217 07:E207: B5 85     LDA vBulletLowPosX,X                 ;
C - - - - - 0x01E219 07:E209: 85 00     STA $0000                            ; prepares X-position
C - - - - - 0x01E21B 07:E20B: B5 8A     LDA vBulletHighPosX,X                ;
C - - - - - 0x01E21D 07:E20D: 85 01     STA $0001                            ; prepares macro X-position
...
loc_E22F_render:
C D 3 - - - 0x01E23F 07:E22F: E6 05     INC vTempCounter5                    ; set loop counter = 1
...
C - - - - - 0x01E250 07:E240: 85 00     STA $0000                            ; prepare 1st parameter (for render)
C - - - - - 0x01E252 07:E242: A5 64     LDA vScreenChrPosX                   ;
C - - - - - 0x01E254 07:E244: 85 01     STA $0001                            ; prepare 2nd parameter (for render)
...
C - - - - - 0x01E267 07:E257: A5 00     LDA $0000                        ;
C - - - - - 0x01E269 07:E259: 18        CLC                              ;
C - - - - - 0x01E26A 07:E25A: 7D 8D E3  ADC tbl_E38D_offsets,X           ;
C - - - - - 0x01E26D 07:E25D: 85 00     STA $0000                        ; <~ $0000 + the offset by Y
C - - - - - 0x01E26F 07:E25F: A5 01     LDA $0001                        ;
C - - - - - 0x01E271 07:E261: 18        CLC                              ;
C - - - - - 0x01E272 07:E262: 7D 8E E3  ADC tbl_E38D_offsets + 1,X       ;
C - - - - - 0x01E275 07:E265: 85 01     STA $0001                        ; <~ $0001 + the offset by X
...
C - - - - - 0x01E2AB 07:E29B: A5 1F     LDA vPlayer2BtnPressed       ;
...
C - - - - - 0x01E2B1 07:E2A1: 45 20     EOR vLastP2BtnPressed        ; The double click protection
...
C - - - - - 0x01E2E0 07:E2D0: FE 00 02  INC vItems,X                    ; +1 for the selected item
...
C - - - - - 0x01E4C3 07:E4B3: 85 00     STA $0000                                  ; prepares the 1st parameter
C - - - - - 0x01E4C5 07:E4B5: BD E0 03  LDA vBubblePosXHigh,X                      ;
C - - - - - 0x01E4C8 07:E4B8: 85 01     STA $0001                                  ; prepares the 2nd parameter
...
C - - - - - 0x01E4D2 07:E4C2: 85 00     STA $0000                                  ; ~> sprite magic1
C - - - - - 0x01E4D4 07:E4C4: A5 03     LDA $0003                                  ; from sub_D6AC_out_of_screen
C - - - - - 0x01E4D6 07:E4C6: 85 01     STA $0001                                  ; ~> sprite magic2
...
; Out: $0000 - vScreenChrPosY with increment
sub_E5AB_short_collision_by_increment:
C - - - - - 0x01E5BB 07:E5AB: 18        CLC                                     ;
C - - - - - 0x01E5BC 07:E5AC: 65 6A     ADC vScreenChrPosY                      ;
C - - - - - 0x01E5BE 07:E5AE: 85 00     STA $0000                               ;
C - - - - - 0x01E5C0 07:E5B0: E6 00     INC $0000                               ; an offset (+1)
...
C - - - - - 0x01E60F 07:E5FF: A5 00     LDA $0000                                   ;
C - - - - - 0x01E611 07:E601: 38        SEC                                         ;
C - - - - - 0x01E612 07:E602: E9 10     SBC #$10                                    ;
C - - - - - 0x01E614 07:E604: 85 00     STA $0000                                   ; $0000 <~ ChrPosY - 20
...
C - - - - - 0x01E61D 07:E60D: A5 00     LDA $0000                                   ;
C - - - - - 0x01E61F 07:E60F: 38        SEC                                         ;
C - - - - - 0x01E620 07:E610: E9 07     SBC #$07                                    ;
C - - - - - 0x01E622 07:E612: 85 00     STA $0000                                   ; $0000 <~ ChrPosY - 27
...
C - - - - - 0x01E62F 07:E61F: 85 00     STA $0000                             ; prepare an input parameter (ChrPosY - 4)
...
C - - - - - 0x01E6D4 07:E6C4: 85 01     STA $0001                                    ; prepare 2nd parameter (for render)
...
C - - - - - 0x01E704 07:E6F4: 85 00     STA $0000                                    ; prepare 1st parameter (a Y-position of the jet-pack)
...
@bra_E711_skip:
C - - - - - 0x01E721 07:E711: 85 05     STA $0005                       ; <~ an offset
C - - - - - 0x01E723 07:E713: A5 6A     LDA vScreenChrPosY              ;
C - - - - - 0x01E725 07:E715: 18        CLC                             ;
C - - - - - 0x01E726 07:E716: 65 05     ADC $0005                       ; <~ ChrPosY + offset
C - - - - - 0x01E728 07:E718: 85 00     STA $0000                       ; prepare 1st parameter (a Y-position of the jet-pack)
...
C - - - - - 0x01E7B6 07:E7A6: 85 01     STA $0001                        ; store low x-position relative to the starting screen
...
C - - - - - 0x01E7C5 07:E7B5: 85 02     STA $0002                        ; store low x-position relative to the ending screen
...
C - - - - - 0x01E7E6 07:E7D6: 85 03     STA $0003                  ;
...
C - - - - - 0x01E7ED 07:E7DD: A5 01     LDA $0001                  ;
C - - - - - 0x01E7EF 07:E7DF: 20 73 D0  JSR sub_D073_invert_sign   ;
C - - - - - 0x01E7F2 07:E7E2: 85 02     STA $0002                  ; get an distance to the top point along the Y axis
bra_E7E4_skip:
C - - - - - 0x01E7F4 07:E7E4: A5 6A     LDA vScreenChrPosY         ; 
C - - - - - 0x01E7F6 07:E7E6: 38        SEC                        ;
C - - - - - 0x01E7F7 07:E7E7: E5 03     SBC $0003                  ; $0003 + $0002 = top - leg of a right triangle
C - - - - - 0x01E7F9 07:E7E9: 38        SEC                        ;
C - - - - - 0x01E7FA 07:E7EA: E5 02     SBC $0002                  ;
C - - - - - 0x01E7FC 07:E7EC: B0 03     BCS @bra_E7F1_skip         ; If vScreenChrPosY <= $0002 + $0003
...
C - - - - - 0x01E805 07:E7F5: A5 03     LDA $0003                  ;
C - - - - - 0x01E807 07:E7F7: 18        CLC                        ;
C - - - - - 0x01E808 07:E7F8: 65 02     ADC $0002                  ;
...
@bra_E8A0_skip:
C - - - - - 0x01E8B0 07:E8A0: 86 00     STX $0000                               ; <~ 0x01 or 0x03
C - - - - - 0x01E8B2 07:E8A2: A5 2C     LDA vLowCounter                         ;
C - - - - - 0x01E8B4 07:E8A4: 25 00     AND $0000                               ;
...
C - - - - - 0x01E93E 07:E92E: 85 00     STA $0000                                ;
C - - - - - 0x01E940 07:E930: E6 00     INC $0000                                ; <~ vScreenChrPosY + 1, prepare an input parameter
...
C - - - - - 0x01E949 07:E939: 85 00     STA $0000                                ;
C - - - - - 0x01E94B 07:E93B: E6 00     INC $0000                                ; <~ vScreenChrPosY + 1, prepare an input parameter
...
C - - - - - 0x01E9F1 07:E9E1: 85 00     STA $0000                             ; prepare an input parameter
...
C - - - - - 0x01E9FF 07:E9EF: 85 00     STA $0000                             ;
C - - - - - 0x01EA01 07:E9F1: E6 00     INC $0000                             ;
C - - - - - 0x01EA03 07:E9F3: E6 00     INC $0000                             ; <~ vScreenChrPosY + 2, prepare an input parameter
...
C - - - - - 0x01EA38 07:EA28: 85 00     STA $0000                            ; <~ vLowViewPortPosX + 0x14
C - - - - - 0x01EA3A 07:EA2A: A5 4B     LDA vHighViewPortPosX                ;
C - - - - - 0x01EA3C 07:EA2C: 69 00     ADC #$00                             ;
C - - - - - 0x01EA3E 07:EA2E: 85 01     STA $0001                            ; <~ vHighViewPortPosX (+1 with overflow)
C - - - - - 0x01EA40 07:EA30: A5 66     LDA vLowChrPosX                      ;
C - - - - - 0x01EA42 07:EA32: 38        SEC                                  ;
C - - - - - 0x01EA43 07:EA33: E5 00     SBC $0000                            ;
C - - - - - 0x01EA45 07:EA35: A5 68     LDA vHighChrPosX                     ;
C - - - - - 0x01EA47 07:EA37: E5 01     SBC $0001                            ;
...
C - - - - - 0x01EA50 07:EA40: 85 00     STA $0000                            ; <~ vLowViewPortPosX - 0x20
C - - - - - 0x01EA52 07:EA42: A5 4B     LDA vHighViewPortPosX                ;
C - - - - - 0x01EA54 07:EA44: 69 00     ADC #$00                             ;
C - - - - - 0x01EA56 07:EA46: 85 01     STA $0001                            ; <~ vHighViewPortPosX (+1 with overflow)
C - - - - - 0x01EA58 07:EA48: A5 66     LDA vLowChrPosX                      ;
C - - - - - 0x01EA5A 07:EA4A: 38        SEC                                  ;
C - - - - - 0x01EA5B 07:EA4B: E5 00     SBC $0000                            ;
C - - - - - 0x01EA5D 07:EA4D: A5 68     LDA vHighChrPosX                     ;
C - - - - - 0x01EA5F 07:EA4F: E5 01     SBC $0001                            ;
...
C - - - - - 0x01EA63 07:EA53: A5 00     LDA $0000                            ;
C - - - - - 0x01EA65 07:EA55: 85 66     STA vLowChrPosX                      ; assigns a new low value
C - - - - - 0x01EA67 07:EA57: A5 01     LDA $0001                            ;
...
C D 3 - - - 0x01EB03 07:EAF3: 85 01     STA $0001                      ; $0001 <~ the hill height
C - - - - - 0x01EB05 07:EAF5: A9 C8     LDA #$C8                       ; CONSTANT - lower part of the hill
C - - - - - 0x01EB07 07:EAF7: 38        SEC                            ;
C - - - - - 0x01EB08 07:EAF8: E5 01     SBC $0001                      ;
C - - - - - 0x01EB0A 07:EAFA: 85 01     STA $0001                      ; $0001 <~ 0xC8 - the hill height
C - - - - - 0x01EB0C 07:EAFC: C5 00     CMP $0000                      ;
C - - - - - 0x01EB0E 07:EAFE: B0 EB     BCS bra_EAEB_return_false      ; If $0001 >= $0000 (higher than the hill)
C - - - - - 0x01EB10 07:EB00: A9 C7     LDA #$C7                       ;
C - - - - - 0x01EB12 07:EB02: C5 00     CMP $0000                      ;
...
C - - - - - 0x01EB70 07:EB60: 85 00     STA $0000                        ; !(WHY?)
...
bra_EB74_skip:
C - - - - - 0x01EB84 07:EB74: 85 00     STA $0000                                 ;
C - - - - - 0x01EB86 07:EB76: E6 00     INC $0000                                 ; <~ vScreenChrPosY + 1, prepare an input parameter
...
C - - - - - 0x01EBF2 07:EBE2: 84 01     STY $0001                               ; ~> sprite_magic2 (see vSpriteMagic2)
...
C - - - - - 0x01EBFB 07:EBEB: 85 00     STA $0000                               ; <~ sprite_magic1
C - - - - - 0x01EBFD 07:EBED: A5 64     LDA vScreenChrPosX                      ;
C - - - - - 0x01EBFF 07:EBEF: 85 03     STA $0003                               ; <~ sprite_magic4
C - - - - - 0x01EC01 07:EBF1: A9 60     LDA #$60                                ; ~> sprite_magic3 (see vSpriteMagic3)
C - - - - - 0x01EC03 07:EBF3: 85 02     STA $0002                               ; $8100, bank 05 (1 page), see $8174
...
C - - - - - 0x01EC5A 07:EC4A: 85 00     STA $0000                       ; prepare 1st parameter (for render)
C - - - - - 0x01EC5C 07:EC4C: A5 66     LDA vLowChrPosX                 ;
C - - - - - 0x01EC5E 07:EC4E: 85 01     STA $0001                       ; prepare 2nd parameter (for render)
...
C - - - - - 0x01EC77 07:EC67: 85 00     STA $0000                       ; prepare 1st parameter (for render)
C - - - - - 0x01EC79 07:EC69: A5 64     LDA vScreenChrPosX              ;
C - - - - - 0x01EC7B 07:EC6B: 85 01     STA $0001                       ; prepare 2nd parameter (for render)
...
C - - - - - 0x01ECCB 07:ECBB: 85 00     STA $0000                       ; <~ ChrPosY + offset, prepare 1st parameter (for render)
C - - - - - 0x01ECCD 07:ECBD: A5 64     LDA vScreenChrPosX              ;
C - - - - - 0x01ECCF 07:ECBF: 85 01     STA $0001                       ; prepare 2nd parameter (for render)
...
C - - - - - 0x01EE75 07:EE65: 85 00     STA $0000                  ; Low address
C - - - - - 0x01EE77 07:EE67: B9 BB FC  LDA tbl_FCBA_enemies + 1,Y ;
C - - - - - 0x01EE7A 07:EE6A: 85 01     STA $0001                  ; High address
C - - - - - 0x01EE7C 07:EE6C: 6C 00 00  JMP ($0000)                ;
...
C - - - - - 0x01EF9A 07:EF8A: E6 2D     INC vHighCounter        ;
@bra_EF8C_RTS:                                                  
...
C - - - - - 0x01EFAA 07:EF9A: 9D 00 02  STA vItems,X                                ; 0x0200-0x0209 in 0
...
C - - - - - 0x01EFC9 07:EFB9: 85 00     STA $0000                                   ;
C - - - - - 0x01EFCB 07:EFBB: 0A        ASL                                         ;
C - - - - - 0x01EFCC 07:EFBC: 18        CLC                                         ;
C - - - - - 0x01EFCD 07:EFBD: 65 00     ADC $0000                                   ; A <~ vNoLevel * 3, because the offset is 3 bytes
...
C - - - - - 0x01F010 07:F000: 9D 0A 02  STA vItems + 10,X                   ; clear items
...
C - - - - - 0x01F0A3 07:F093: A5 0A     LDA $000A                       ; type of an enemy
...
C - - - - - 0x01F0CC 07:F0BC: A5 0A     LDA $000A                       ; type of an enemy
...
C - - - - - 0x01F0E1 07:F0D1: A5 0A     LDA $000A                          ;
...
C - - - - - 0x01F189 07:F179: A5 0A     LDA $000A                             ;
...
C - - - - - 0x01F1B0 07:F1A0: 85 02     STA $0002                     ;
...
C - - - - - 0x01F1BA 07:F1AA: 85 0B     STA $000B                     ; prepares an input parameter
...
C - - - - - 0x01F1C5 07:F1B5: 85 01     STA $0001                     ; X-position <~ vLowViewPortPosX + 10 or vLowViewPortPosX - 10
C - - - - - 0x01F1C7 07:F1B7: A5 4B     LDA vHighViewPortPosX         ;
C - - - - - 0x01F1C9 07:F1B9: 69 00     ADC #$00                      ;
C - - - - - 0x01F1CB 07:F1BB: 85 00     STA $0000                     ; macro X-position <~ vHighViewPortPosX (+1 with overflow)
...
C - - - - - 0x01F1D4 07:F1C4: 85 0A     STA $000A                     ;
...
C - - - - - 0x01F1EC 07:F1DC: 65 01     ADC $0001                     ;
C - - - - - 0x01F1EE 07:F1DE: 85 01     STA $0001                     ; X-position <~ X-position + 8 or X-position - 8
C - - - - - 0x01F1F0 07:F1E0: A5 00     LDA $0000                     ;
C - - - - - 0x01F1F2 07:F1E2: 65 12     ADC $0012                     ;
C - - - - - 0x01F1F4 07:F1E4: 85 00     STA $0000                     ; macro X-position <~ macro X-position + 0 or macro X-position - 1 (+1 with overflow)
...
C - - - - - 0x01F203 07:F1F3: A5 00     LDA $0000                      ;
...
C - - - - - 0x01F20A 07:F1FA: A5 01     LDA $0001                      ;
...
@bra_F208_skip:
C - - - - - 0x01F218 07:F208: A5 00     LDA $0000                      ;
...
C - - - - - 0x01F21F 07:F20F: A5 01     LDA $0001                      ;
...
C D 3 - - - 0x01F269 07:F259: A5 2B     LDA vNmiCounter               ;
...
@bra_F271_skip:
C - - - - - 0x01F281 07:F271: 84 0B     STY $000B                     ; <~ 0x00 or 0x01
C - - - - - 0x01F283 07:F273: 18        CLC                           ;
C - - - - - 0x01F284 07:F274: 65 27     ADC vLowViewPortPosX          ;
C - - - - - 0x01F286 07:F276: 85 01     STA $0001                     ; <~ vLowViewPortPosX + 8 or vLowViewPortPosX - 8
C - - - - - 0x01F288 07:F278: A5 4B     LDA vHighViewPortPosX         ;
C - - - - - 0x01F28A 07:F27A: 69 00     ADC #$00                      ;
C - - - - - 0x01F28C 07:F27C: 85 00     STA $0000                     ; <~ vHighViewPortPosX (+1 with overflow)
C - - - - - 0x01F28E 07:F27E: A9 25     LDA #$25                      ; CONSTANT - Diver
C - - - - - 0x01F290 07:F280: 85 0A     STA $000A                     ; prepare an input parameter (enemy type)
...
C - - - - - 0x01F29E 07:F28E: 85 02     STA $0002                     ; prepare an input parameter (Y-position)
...
C - - - - - 0x01F2A5 07:F295: A5 00     LDA $0000                            ;
...
C - - - - - 0x01F2AA 07:F29A: A5 02     LDA $0002                            ;
C - - - - - 0x01F2AC 07:F29C: 48        PHA                                  ; diposit Y-position ($F29C)
C - - - - - 0x01F2AD 07:F29D: 85 00     STA $0000                            ; prepares 1st input parameter
...
C - - - - - 0x01F2BB 07:F2AB: 85 02     STA $0002                            ;
C - - - - - 0x01F2BD 07:F2AD: 68        PLA                                  ; retrieve macro X-position (see $F297)
C - - - - - 0x01F2BE 07:F2AE: 85 00     STA $0000                            ;
...
; Out: $000B - the direction of appearance (0x00 - right, 0x01 - left)
; Out: $000C - For 0x80 - with the projectile
...
bra_F2D6_skip:
C - - - - - 0x01F2E6 07:F2D6: 85 00     STA $0000                ; Register A has 0x00 or 0x01
C - - - - - 0x01F2E8 07:F2D8: A5 6C     LDA vChrStatus           ;
C - - - - - 0x01F2EA 07:F2DA: 29 01     AND #$01                 ; only left or right
C - - - - - 0x01F2EC 07:F2DC: 45 00     EOR $0000                ;
C - - - - - 0x01F2EE 07:F2DE: 85 0B     STA $000B                ; 0x00 or 0x01
C - - - - - 0x01F2F0 07:F2E0: A5 4B     LDA vHighViewPortPosX    ;
C - - - - - 0x01F2F2 07:F2E2: 18        CLC                      ; 
C - - - - - 0x01F2F3 07:F2E3: 65 0B     ADC $000B                ;
C - - - - - 0x01F2F5 07:F2E5: 85 01     STA $0001                ; <~ vHighViewPortPosX or vHighViewPortPosX + 1
...
C - - - - - 0x01F2FB 07:F2EB: C5 01     CMP $0001                ;
...
C - - - - - 0x01F305 07:F2F5: E6 13     INC $0013                ; increment the high address
...
C - - - - - 0x01F320 07:F310: 85 00     STA $0000                 ; store 1 item value
C - - - - - 0x01F322 07:F312: C8        INY                       ; 2 of 4
C - - - - - 0x01F323 07:F313: B1 12     LDA ($0012),Y             ;
C - - - - - 0x01F325 07:F315: 85 01     STA $0001                 ; store 2 item value
C - - - - - 0x01F327 07:F317: C8        INY                       ; 3 of 4
C - - - - - 0x01F328 07:F318: B1 12     LDA ($0012),Y             ;
C - - - - - 0x01F32A 07:F31A: 85 02     STA $0002                 ; store 3 item value
C - - - - - 0x01F32C 07:F31C: C8        INY                       ; 4 of 4
C - - - - - 0x01F32D 07:F31D: B1 12     LDA ($0012),Y             ;
C - - - - - 0x01F32F 07:F31F: 85 0C     STA $000C                 ; store 4 item value
C - - - - - 0x01F331 07:F321: 29 7F     AND #$7F                  ;
C - - - - - 0x01F333 07:F323: 85 0A     STA $000A                 ; store a type or an index
...
C - - - - - 0x01F33F 07:F32F: 85 14     STA $0014                             ; Low address
C - - - - - 0x01F341 07:F331: BD 89 F8  LDA tbl_F888_enemy_appearance + 1,X   ;
C - - - - - 0x01F344 07:F334: 85 15     STA $0015                             ; High address
C - - - - - 0x01F346 07:F336: 6C 14 00  JMP ($0014)                           ;
...
C - - - - - 0x01F379 07:F369: A5 0B     LDA $000B               ;
...
C - - - - - 0x01F400 07:F3F0: B9 21 BD  LDA tbl_ptr_enemy_t3_sprite_params_ + 5,Y   ; <~ sprite_magic3 (see vSpriteMagic3)
...
C - - - - - 0x01F419 07:F409: A5 0C     LDA $000C                                   ;
...
C - - - - - 0x01F43C 07:F42C: A5 0B     LDA $000B                                   ;
...
@bra_F464_skip:
C - - - - - 0x01F474 07:F464: A5 0B     LDA $000B                                   ;
...
C - - - - - 0x01F4B5 07:F4A5: A0 43     LDY #$43                                    ; for sprite_magic3 (see vSpriteMagic3) (Bank 05, Page 2, $8100)
...
C - - - - - 0x01F4BE 07:F4AE: A0 47     LDY #$47                                    ; for sprite_magic3 (see vSpriteMagic3)
@bra_F4B0_skip:
...
C - - - - - 0x01F4D5 07:F4C5: 8D 07 03  STA vEnemyBSpriteMagic3                     ; <~ sprite_magic3 (see vSpriteMagic3) (Bank 05, Page 2, $8000)
...
C - - - - - 0x01F4F0 07:F4E0: A5 00     LDA $0000                           ;
...
@bra_F4EB_skip:
C - - - - - 0x01F4FB 07:F4EB: A5 01     LDA $0001                           ;
...
C - - - - - 0x01F503 07:F4F3: A5 00     LDA $0000                           ;
...
C - - - - - 0x01F50F 07:F4FF: A5 02     LDA $0002                           ;
...
C - - - - - 0x01F532 07:F522: A9 46     LDA #$46                            ; <~ sprite_magic3 (see vSpriteMagic3)
...
C - - - - - 0x01F53B 07:F52B: A9 42     LDA #$42                            ; <~ sprite_magic3 (see vSpriteMagic3)
@bra_F52D_skip:
...
C - - - - - 0x01F593 07:F583: A9 46     LDA #$46                                  ; <~ sprite_magic3 (see vSpriteMagic3)
...
C - - - - - 0x01F5D7 07:F5C7: B9 D5 BD  LDA tbl_ptr_enemy_t2_sprite_params_ + 3,Y   ; <~ sprite_magic3 (see vSpriteMagic3)
...
bra_F5E3_bird:
C - - - - - 0x01F5F3 07:F5E3: A5 0B     LDA $000B                                   ;
...
C - - - - - 0x01F60D 07:F5FD: A5 0B     LDA $000B                                   ;
...
C - - - - - 0x01F67F 07:F66F: A5 0B     LDA $000B                              ;
...
C - - - - - 0x01F69B 07:F68B: A9 46     LDA #$46                               ; <~ sprite_magic3 (see vSpriteMagic3)
...
C - - - - - 0x01F6AE 07:F69E: A9 86     LDA #$86                               ; <~ sprite_magic3 (see vSpriteMagic3)
...
C - - - - - 0x01F6BD 07:F6AD: A5 01     LDA $0001                       ;
...
C - - - - - 0x01F6DD 07:F6CD: A9 46     LDA #$46                              ; <~ sprite_magic3 (see vSpriteMagic3)
...
C - - - - - 0x01F726 07:F716: A5 00     LDA $0000                        ;
...
C - - - - - 0x01F72D 07:F71D: A5 01     LDA $0001                        ;
...
C - - - - - 0x01F762 07:F752: 8D 07 03  STA vEnemyBSpriteMagic3                ; <~ sprite_magic3 (see vSpriteMagic3) (Bank 05, Page 2, $8000)
...
bra_F928_skip:
C - - - - - 0x01F938 07:F928: 85 00     STA $0000                          ;
...
C - - - - - 0x01F942 07:F932: A5 00     LDA $0000                          ;
...
C - - - - - 0x01F951 07:F941: A5 00     LDA $0000                          ;
...
@bra_F949_skip:
C - - - - - 0x01F959 07:F949: 86 01     STX $0001                          ; set an allowable tolerance
...
C - - - - - 0x01F96A 07:F95A: C5 01     CMP $0001                          ;
...
C - - - - - 0x01F9F5 07:F9E5: 85 00     STA $0000                        ; <~ wall X-position (low) - bomb X-position (low)
...
C - - - - - 0x01F9FD 07:F9ED: 85 01     STA $0001                        ; <~ wall X-position (high) - bomb X-position (high)
C - - - - - 0x01F9FF 07:F9EF: B0 0B     BCS @bra_F9FC_skip               ; If wall X-position (high) >= bomb X-position (high)
C - - - - - 0x01FA01 07:F9F1: A5 00     LDA $0000                        ; here $0000 < 0x00
C - - - - - 0x01FA03 07:F9F3: 20 73 D0  JSR sub_D073_invert_sign         ;
C - - - - - 0x01FA06 07:F9F6: 85 00     STA $0000                        ; <~ |wall X-position (low) - bomb X-position (low)|
C - - - - - 0x01FA08 07:F9F8: A5 01     LDA $0001                        ;
...
C - - - - - 0x01FA0E 07:F9FE: A5 00     LDA $0000                        ; <~ |wall X-position (low) - bomb X-position (low)|
...
@bra_FBA2_skip:
C - - - - - 0x01FBB2 07:FBA2: 85 01     STA $0001                    ; Register A has 0x00 or 0x01
C - - - - - 0x01FBB4 07:FBA4: A5 C4     LDA vCheckpoint              ;
C - - - - - 0x01FBB6 07:FBA6: 0A        ASL                          ;
C - - - - - 0x01FBB7 07:FBA7: 26 01     ROL $0001                    ;
C - - - - - 0x01FBB9 07:FBA9: 0A        ASL                          ;
C - - - - - 0x01FBBA 07:FBAA: 26 01     ROL $0001                    ; *4 or *8, because the checkpoint position have 4 bytes
C - - - - - 0x01FBBC 07:FBAC: 18        CLC                          ;
C - - - - - 0x01FBBD 07:FBAD: 6D 0A 80  ADC tbl_ptr_checkpoints      ;
C - - - - - 0x01FBC0 07:FBB0: 85 00     STA $0000                    ; Low address
C - - - - - 0x01FBC2 07:FBB2: A5 01     LDA $0001                    ; main list = {0x00, 0x01, 0x02, 0x03}, secondary list = {0x04, 0x05, 0x06, 0x07}
C - - - - - 0x01FBC4 07:FBB4: 6D 0B 80  ADC tbl_ptr_checkpoints + 1  ;
C - - - - - 0x01FBC7 07:FBB7: 85 01     STA $0001                    ; High address
C - - - - - 0x01FBC9 07:FBB9: A0 00     LDY #$00                     ; 1 of 4 bytes
C - - - - - 0x01FBCB 07:FBBB: B1 00     LDA ($0000),Y                ;
C - - - - - 0x01FBCD 07:FBBD: 85 46     STA vNoRoom                  ;
C - - - - - 0x01FBCF 07:FBBF: C8        INY                          ; 2 of 4 bytes
C - - - - - 0x01FBD0 07:FBC0: B1 00     LDA ($0000),Y                ;
C - - - - - 0x01FBD2 07:FBC2: 85 4B     STA vHighViewPortPosX        ;
C - - - - - 0x01FBD4 07:FBC4: C8        INY                          ; 3 of 4 bytes
C - - - - - 0x01FBD5 07:FBC5: B1 00     LDA ($0000),Y                ;
C - - - - - 0x01FBD7 07:FBC7: 85 27     STA vLowViewPortPosX         ;
C - - - - - 0x01FBD9 07:FBC9: C8        INY                          ; 4 of 4 bytes
C - - - - - 0x01FBDA 07:FBCA: B1 00     LDA ($0000),Y                ;
